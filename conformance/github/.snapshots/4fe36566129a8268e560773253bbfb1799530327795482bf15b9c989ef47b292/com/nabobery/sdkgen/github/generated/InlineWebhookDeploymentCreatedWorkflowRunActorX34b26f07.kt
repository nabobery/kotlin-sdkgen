 ...
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-created/properties/workflow_run/properties/actor
 */
@Serializable(with = InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07.Serializer::class)
public class InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07(
  public val id: Int,
  ...
  public val type: InlineWebhookDeploymentCreatedWorkflowRunActorTypeXd9875589? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentCreatedWorkflowRunActorTypeXd9875589? = null
    ...
    public fun build(): InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07 must be a JSON object")
      ...
      return InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentCreatedWorkflowRunActorTypeXd9875589>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07")
...
public fun inlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07(block: InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07.Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07 = InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07 is missing required property '" + name + "'")
