 ...
 * d_via_github_app
 */
@Serializable(with = InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4.Serializer::class)
public class InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 internal constructor(
  /**
  ...
  public val owner: InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppEventsItemX09c5d884>>,
  private val permissionsState:
      FieldState<InlineWebhookDeploymentCreatedDeploymentPermissionsX4fa26435>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppEventsItemX09c5d884>>
   ...
   */
  public val events:
      List<InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppEventsItemX09c5d884>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookDeploymentCreatedDeploymentPermissionsX4fa26435?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3?
    ...
    private var permissionsState:
        FieldState<InlineWebhookDeploymentCreatedDeploymentPermissionsX4fa26435> = FieldState.Absent

    /**
     * The set of permissions for the GitHub app
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookDeploymentCreatedDeploymentPermissionsX4fa26435?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 {
      ...
      return InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4")
...
public fun inlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4(block: InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4.Builder.() -> Unit): InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 = InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppXa4d8a8e4 property '" + name + "' is not nullable")
