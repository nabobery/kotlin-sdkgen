 ...
 * d/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerTypeX3293cfb3? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerTypeX3293cfb3? = null
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce must be a JSON object")
      ...
      return InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerTypeX3293cfb3>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce")
...
public fun inlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce(block: InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce = InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce is missing required property '" + name + "'")
