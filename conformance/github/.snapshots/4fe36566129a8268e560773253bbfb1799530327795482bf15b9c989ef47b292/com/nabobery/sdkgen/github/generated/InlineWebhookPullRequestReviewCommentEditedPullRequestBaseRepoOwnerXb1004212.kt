 ...
 * roperties/base/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-edited/properties/pull_request/p
 * roperties/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212.Serializer::class)
public class InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerTypeX706bbd48? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerTypeX706bbd48>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212")
...
public fun inlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212(block: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212 = InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212 is missing required property '" + name + "'")
