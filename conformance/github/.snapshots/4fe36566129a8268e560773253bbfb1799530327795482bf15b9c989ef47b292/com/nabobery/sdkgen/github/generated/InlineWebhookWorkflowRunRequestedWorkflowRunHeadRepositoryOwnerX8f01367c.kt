 ...
 * ad_repository/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-workflow-run-requested/properties/workflow_run/properties/he
 * ad_repository/properties/owner
 */
@Serializable(with = InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c.Serializer::class)
public class InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c(
  public val id: Int,
  ...
  public val type:
      InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerTypeX47a476ee? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerTypeX47a476ee? =
        null
    ...
    public fun build(): InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c must be a JSON object")
      ...
      return InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerTypeX47a476ee>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c")
...
public fun inlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c(block: InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c.Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c = InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c is missing required property '" + name + "'")
