 ...
 * A GitHub user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-simple-user
 */
@Serializable(with = NullableSimpleUser.Serializer::class)
public class NullableSimpleUser internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): NullableSimpleUser {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): NullableSimpleUser = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<NullableSimpleUser> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): NullableSimpleUser {
      val jsonDecoder = decoder.requireJsonDecoder("NullableSimpleUser")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("NullableSimpleUser must be a JSON object")
      ...
      if (!rawObject.containsKey("gravatar_id")) {
        throw SerializationException("NullableSimpleUser is missing required property 'gravatar_id'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: NullableSimpleUser) {
      val jsonEncoder = encoder.requireJsonEncoder("NullableSimpleUser")
...
public fun nullableSimpleUser(block: NullableSimpleUser.Builder.() -> Unit): NullableSimpleUser = NullableSimpleUser.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NullableSimpleUser is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("NullableSimpleUser property '" + name + "' is not nullable")
