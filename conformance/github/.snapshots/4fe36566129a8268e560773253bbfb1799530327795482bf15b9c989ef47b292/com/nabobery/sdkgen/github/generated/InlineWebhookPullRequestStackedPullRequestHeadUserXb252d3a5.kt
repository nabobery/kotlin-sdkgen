 ...
 * /properties/user
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestStackedPullRequestHeadUserTypeXbfe3e7fc? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestStackedPullRequestHeadUserTypeXbfe3e7fc? = null
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5 must be a JSON object")
      ...
      return InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestStackedPullRequestHeadUserTypeXbfe3e7fc>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5")
...
public fun inlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5(block: InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5 = InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestHeadUserXb252d3a5 is missing required property '" + name + "'")
