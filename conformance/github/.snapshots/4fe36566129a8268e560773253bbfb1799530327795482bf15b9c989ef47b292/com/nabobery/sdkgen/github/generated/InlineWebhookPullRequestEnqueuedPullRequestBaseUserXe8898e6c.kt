 ...
 * e/properties/user
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestEnqueuedPullRequestBaseUserTypeXd1b0b6b4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestEnqueuedPullRequestBaseUserTypeXd1b0b6b4? = null
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c must be a JSON object")
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestBaseUserTypeXd1b0b6b4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c(block: InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c = InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseUserXe8898e6c is missing required property '" + name + "'")
