...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/discussion/properties/reactions.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/discussion/properties/reactions
 */
@Serializable(with = InlineDiscussionReactionsX5076693c.Serializer::class)
public class InlineDiscussionReactionsX5076693c(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineDiscussionReactionsX5076693c {
      ...
      return InlineDiscussionReactionsX5076693c(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineDiscussionReactionsX5076693c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineDiscussionReactionsX5076693c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineDiscussionReactionsX5076693c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineDiscussionReactionsX5076693c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineDiscussionReactionsX5076693c must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineDiscussionReactionsX5076693c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineDiscussionReactionsX5076693c")
...
public fun inlineDiscussionReactionsX5076693c(block: InlineDiscussionReactionsX5076693c.Builder.() -> Unit): InlineDiscussionReactionsX5076693c = InlineDiscussionReactionsX5076693c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineDiscussionReactionsX5076693c is missing required property '" + name + "'")
