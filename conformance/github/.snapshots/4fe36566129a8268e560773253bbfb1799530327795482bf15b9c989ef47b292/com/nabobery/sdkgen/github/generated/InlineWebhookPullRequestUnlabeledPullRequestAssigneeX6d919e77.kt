 ...
 * signee
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnlabeledPullRequestAssigneeTypeXf53b6632? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlabeledPullRequestAssigneeTypeXf53b6632? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestAssigneeTypeXf53b6632>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77(block: InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77 = InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestAssigneeX6d919e77 is missing required property '" + name + "'")
