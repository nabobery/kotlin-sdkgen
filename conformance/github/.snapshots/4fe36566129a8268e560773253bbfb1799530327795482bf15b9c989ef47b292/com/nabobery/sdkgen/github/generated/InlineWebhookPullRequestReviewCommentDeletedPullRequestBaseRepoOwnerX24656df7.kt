 ...
 * properties/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7.Serializer::class)
public class InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe8fbbPullRequestBaseRepoOwnerTypeXa79fd563? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe8fbbPullRequestBaseRepoOwnerTypeXa79fd563? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe8fbbPullRequestBaseRepoOwnerTypeXa79fd563>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7")
...
public fun inlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7(block: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7 = InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7 is missing required property '" + name + "'")
