...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-reopened/properties/issue/properties/reactions.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-reopened/properties/issue/properties/reactions
 */
@Serializable(with = InlineWebhookIssuesReopenedIssueReactionsX6e90bd51.Serializer::class)
public class InlineWebhookIssuesReopenedIssueReactionsX6e90bd51(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssuesReopenedIssueReactionsX6e90bd51 {
      ...
      return InlineWebhookIssuesReopenedIssueReactionsX6e90bd51(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesReopenedIssueReactionsX6e90bd51 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesReopenedIssueReactionsX6e90bd51> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesReopenedIssueReactionsX6e90bd51 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesReopenedIssueReactionsX6e90bd51")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesReopenedIssueReactionsX6e90bd51 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesReopenedIssueReactionsX6e90bd51) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesReopenedIssueReactionsX6e90bd51")
...
public fun inlineWebhookIssuesReopenedIssueReactionsX6e90bd51(block: InlineWebhookIssuesReopenedIssueReactionsX6e90bd51.Builder.() -> Unit): InlineWebhookIssuesReopenedIssueReactionsX6e90bd51 = InlineWebhookIssuesReopenedIssueReactionsX6e90bd51.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesReopenedIssueReactionsX6e90bd51 is missing required property '" + name + "'")
