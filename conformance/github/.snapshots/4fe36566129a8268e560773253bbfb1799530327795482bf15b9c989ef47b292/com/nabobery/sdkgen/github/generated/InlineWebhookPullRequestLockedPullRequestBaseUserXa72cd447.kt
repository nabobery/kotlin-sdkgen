 ...
 * properties/user
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestLockedPullRequestBaseUserTypeX045977c2? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLockedPullRequestBaseUserTypeX045977c2? = null
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447 must be a JSON object")
      ...
      return InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestBaseUserTypeX045977c2>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447")
...
public fun inlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447(block: InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447 = InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestBaseUserXa72cd447 is missing required property '" + name + "'")
