...
public class InlineOrgsSettingsNetworkConfigurationsPostRequestJsonX1d548ca6(
  ...
  failoverNetworkSettingsIds: List<String>? = null,
) {
  /**
  ...
  public val failoverNetworkSettingsIds: List<String>? =
      failoverNetworkSettingsIds?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    public var networkSettingsIds: List<String>
      get() = requireNotNull(networkSettingsIdsValue) { "networkSettingsIds is required" }.toList()
      set(`value`) {
        networkSettingsIdsValue = value.toList()
      }
    ...
    private var failoverNetworkSettingsIdsValue: List<String>? = null
    ...
    public var failoverNetworkSettingsIds: List<String>?
      get() = failoverNetworkSettingsIdsValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        failoverNetworkSettingsIdsValue = value?.let { collection0 -> collection0.toList() }
      }
  ...
  internal object Serializer : KSerializer<InlineOrgsSettingsNetworkConfigurationsPostRequestJsonX1d548ca6> {
