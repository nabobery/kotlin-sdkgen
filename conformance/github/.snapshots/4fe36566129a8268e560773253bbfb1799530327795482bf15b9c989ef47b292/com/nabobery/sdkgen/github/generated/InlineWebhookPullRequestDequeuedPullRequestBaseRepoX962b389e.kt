 ...
 * e/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestDequeuedPullRequestBaseRepoCreatedAtX5d4d8c29,
  /**
  ...
  public val license: InlineWebhookPullRequestDequeuedPullRequestBaseRepoLicenseXb969ab12?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestDequeuedPullRequestBaseRepoPushedAtX3ec2f50b?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestDequeuedPullRequestBaseRepoVisibilityX6de3ad2e,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestDequeuedPullRequestBaseRepoMergeCommitMessageX2e290127>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestDequeuedPullRequestBaseRepoMergeCommitTitleX9823aa46>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestDequeuedPullRequestBaseRepoPermissionsX8ed8e9d4>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestDea21dPullRequestBasePullRequestCreationP824dXfd49f90f>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestDea21dPullRequestBaseSquashMergeCommitMessageX3c23bac0>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestDea21dPullRequestBaseRepoSquashMergeCommitTitleX7abcaed2>,
  ...
  public val permissions: InlineWebhookPullRequestDequeuedPullRequestBaseRepoPermissionsX8ed8e9d4?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestDequeuedPullRequestBaseRepoCreatedAtX5d4d8c29,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestDequeuedPullRequestBaseRepoLicenseXb969ab12?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestDequeuedPullRequestBaseRepoPushedAtX3ec2f50b?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestDequeuedPullRequestBaseRepoVisibilityX6de3ad2e,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestDequeuedPullRequestBaseRepoCreatedAtX5d4d8c29? = null

    public var createdAt: InlineWebhookPullRequestDequeuedPullRequestBaseRepoCreatedAtX5d4d8c29
    ...
    private var visibilityValue:
        InlineWebhookPullRequestDequeuedPullRequestBaseRepoVisibilityX6de3ad2e? = null

    public var visibility: InlineWebhookPullRequestDequeuedPullRequestBaseRepoVisibilityX6de3ad2e
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestDequeuedPullRequestBaseRepoLicenseXb969ab12?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestDequeuedPullRequestBaseRepoLicenseXb969ab12?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestDequeuedPullRequestBaseRepoPushedAtX3ec2f50b?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestDequeuedPullRequestBaseRepoPushedAtX3ec2f50b?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestDequeuedPullRequestBaseRepoPermissionsX8ed8e9d4?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e {
      ...
      return InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestDequeuedPullRequestBaseRepoCreatedAtX5d4d8c29>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestDequeuedPullRequestBaseRepoVisibilityX6de3ad2e>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestBaseRepoLicenseXb969ab12?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestBaseRepoPushedAtX3ec2f50b?>(requireNotNull(element)) }
      return InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e")
...
public fun inlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e(block: InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e = InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoX962b389e property '" + name + "' is not nullable")
