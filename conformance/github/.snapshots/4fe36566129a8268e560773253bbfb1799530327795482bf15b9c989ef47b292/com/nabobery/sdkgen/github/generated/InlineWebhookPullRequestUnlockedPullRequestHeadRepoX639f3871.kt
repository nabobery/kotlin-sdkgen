 ...
 * d/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestUnlockedPullRequestHeadRepoCreatedAtX1d612e59,
  /**
  ...
  public val license: InlineWebhookPullRequestUnlockedPullRequestHeadRepoLicenseXd27bccf2?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestUnlockedPullRequestHeadRepoPushedAtXff10bf55?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestUnlockedPullRequestHeadRepoVisibilityXd7c3a6c5,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUnlockedPullRequestHeadRepoMergeCommitMessageX3834f337>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUnlockedPullRequestHeadRepoMergeCommitTitleX30bb4e8f>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestUnlockedPullRequestHeadRepoPermissionsX1d5df006>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestUnc059PullRequestHeadPullRequestCreationP824dXce1a4845>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUnc059PullRequestHeadSquashMergeCommitMessageXd1d88b35>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUnc059PullRequestHeadRepoSquashMergeCommitTitleXa69e5a79>,
  ...
  public val mergeCommitTitle:
      InlineWebhookPullRequestUnlockedPullRequestHeadRepoMergeCommitTitleX30bb4e8f?
    get() = mergeCommitTitleState.valueOrNull()

  public val organization: String?
    get() = organizationState.valueOrNull()

  public val permissions: InlineWebhookPullRequestUnlockedPullRequestHeadRepoPermissionsX1d5df006?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestUnlockedPullRequestHeadRepoCreatedAtX1d612e59,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestUnlockedPullRequestHeadRepoLicenseXd27bccf2?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestUnlockedPullRequestHeadRepoPushedAtXff10bf55?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestUnlockedPullRequestHeadRepoVisibilityXd7c3a6c5,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestUnlockedPullRequestHeadRepoCreatedAtX1d612e59? = null

    public var createdAt: InlineWebhookPullRequestUnlockedPullRequestHeadRepoCreatedAtX1d612e59
    ...
    private var visibilityValue:
        InlineWebhookPullRequestUnlockedPullRequestHeadRepoVisibilityXd7c3a6c5? = null

    public var visibility: InlineWebhookPullRequestUnlockedPullRequestHeadRepoVisibilityXd7c3a6c5
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestUnlockedPullRequestHeadRepoLicenseXd27bccf2?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestUnlockedPullRequestHeadRepoLicenseXd27bccf2?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestUnlockedPullRequestHeadRepoPushedAtXff10bf55?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestUnlockedPullRequestHeadRepoPushedAtXff10bf55?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestUnlockedPullRequestHeadRepoPermissionsX1d5df006?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 {
      ...
      return InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestUnlockedPullRequestHeadRepoCreatedAtX1d612e59>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestUnlockedPullRequestHeadRepoVisibilityXd7c3a6c5>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestHeadRepoLicenseXd27bccf2?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestHeadRepoPushedAtXff10bf55?>(requireNotNull(element)) }
      return InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871")
...
public fun inlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871(block: InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 = InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoX639f3871 property '" + name + "' is not nullable")
