 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-edited/properties/issue/allOf/0
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 internal constructor(
  public val activeLockReason: InlineWebhookIssueCommentEditedIssueAllOf1ActiveLockReasonX17a71ec6?,
  assignees: List<InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0?>,
  /**
   ...
   */
  public val milestone: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012?,
  private val assigneeState:
      FieldState<InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544?>,
  private val draftState: FieldState<Boolean>,
  private val issueDependenciesSummaryState: FieldState<IssueDependenciesSummary>,
  labelsState: FieldState<List<InlineWebhookIssueCommentEditedIssueAllOf1LabelsItemX107ab005>>,
  private val lockedState: FieldState<Boolean>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8?>,
  private val pullRequestState:
      FieldState<InlineWebhookIssueCommentEditedIssueAllOf1PullRequestXca1f0433>,
  private val stateState: FieldState<InlineWebhookIssueCommentEditedIssueAllOf1StateX9cd22ab6>,
  ...
  public val assignees: List<InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0?> =
      assignees.toList()

  private val labelsState:
      FieldState<List<InlineWebhookIssueCommentEditedIssueAllOf1LabelsItemX107ab005>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544?
  ...
  public val labels: List<InlineWebhookIssueCommentEditedIssueAllOf1LabelsItemX107ab005>?
  ...
  public val performedViaGithubApp:
      InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8?
    get() = performedViaGithubAppState.valueOrNull()

  public val pullRequest: InlineWebhookIssueCommentEditedIssueAllOf1PullRequestXca1f0433?
    get() = pullRequestState.valueOrNull()

  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssueCommentEditedIssueAllOf1StateX9cd22ab6?
  ...
  public constructor(
    activeLockReason: InlineWebhookIssueCommentEditedIssueAllOf1ActiveLockReasonX17a71ec6?,
    assignees: List<InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0?>,
    authorAssociation: InlineWebhookIssueCommentEditedIssueAllOf1AuthorAssociationX149c4916,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    id: Long,
    labelsUrl: String,
    milestone: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955,
    repositoryUrl: String,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012?,
  ...
  public class Builder {
    private var assigneesValue:
        List<InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0?>? = null

    public var assignees: List<InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0?>
    ...
    private var authorAssociationValue:
        InlineWebhookIssueCommentEditedIssueAllOf1AuthorAssociationX149c4916? = null
    ...
    private var reactionsValue: InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955? = null

    public var reactions: InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955
    ...
    private var activeLockReasonState:
        FieldState<InlineWebhookIssueCommentEditedIssueAllOf1ActiveLockReasonX17a71ec6?> =
        FieldState.Absent
    ...
    private var milestoneState:
        FieldState<InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012?
    ...
    private var assigneeState:
        FieldState<InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544?> = FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var assignee: InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544?
      get() = assigneeState.valueOrNull()
      set(`value`) {
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhookIssueCommentEditedIssueAllOf1LabelsItemX107ab005>?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhookIssueCommentEditedIssueAllOf1PullRequestXca1f0433?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssueCommentEditedIssueAllOf1StateX9cd22ab6> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var state: InlineWebhookIssueCommentEditedIssueAllOf1StateX9cd22ab6?
      get() = stateState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 {
      ...
      return InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhookIssueCommentEditedIssueAllOf1AuthorAssociationX149c4916>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955>(rawObject, "reactions")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentEditedIssueAllOf1ActiveLockReasonX17a71ec6?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012?>(requireNotNull(element)) }
      return InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf1X5c454d50(block: InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 = InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1X5c454d50 property '" + name + "' is not nullable")
