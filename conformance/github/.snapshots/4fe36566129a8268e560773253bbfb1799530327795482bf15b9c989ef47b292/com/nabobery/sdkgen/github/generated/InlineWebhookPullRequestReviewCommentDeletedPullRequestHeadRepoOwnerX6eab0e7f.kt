 ...
 * properties/head/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-deleted/properties/pull_request/
 * properties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f.Serializer::class)
public class InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe8fbbPullRequestHeadRepoOwnerTypeX87454b5e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe8fbbPullRequestHeadRepoOwnerTypeX87454b5e? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe8fbbPullRequestHeadRepoOwnerTypeX87454b5e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f")
...
public fun inlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f(block: InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f = InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f is missing required property '" + name + "'")
