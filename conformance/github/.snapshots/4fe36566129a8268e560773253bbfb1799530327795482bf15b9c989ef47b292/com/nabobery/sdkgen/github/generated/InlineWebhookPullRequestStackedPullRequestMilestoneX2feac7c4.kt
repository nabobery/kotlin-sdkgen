 ...
 * stone
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4(
  /**
  ...
  public val creator: InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce?,
   ...
   */
  public val state: InlineWebhookPullRequestStackedPullRequestMilestoneStateX3d573275,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookPullRequestStackedPullRequestMilestoneStateX3d573275? =
        null

    public var state: InlineWebhookPullRequestStackedPullRequestMilestoneStateX3d573275
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce?
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4 {
      ...
      return InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestStackedPullRequestMilestoneStateX3d573275>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4")
...
public fun inlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4(block: InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4 = InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestStackedPullRequestMilestoneX2feac7c4 property '" + name + "' is not nullable")
