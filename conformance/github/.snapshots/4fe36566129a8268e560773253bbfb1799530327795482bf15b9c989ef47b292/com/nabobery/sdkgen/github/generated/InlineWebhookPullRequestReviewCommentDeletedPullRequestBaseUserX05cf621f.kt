 ...
 * properties/base/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f.Serializer::class)
public class InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f(
  public val id: Long,
  ...
  public val type:
      InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserTypeX09e6cc92? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserTypeX09e6cc92? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserTypeX09e6cc92>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f")
...
public fun inlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f(block: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f = InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseUserX05cf621f is missing required property '" + name + "'")
