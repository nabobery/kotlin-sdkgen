 ...
 * request/properties/head/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoCreatedAtXe03c9d0c,
  /**
  ...
  public val license: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoLicenseX659425cf?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoPushedAtX76d1657f?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoVisibilityX9e2470cc,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadMergeCommitMessageX6bec98d5>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoMergeCommitTitleXec8e40bc>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoPermissionsXf27d6b2e>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestPullRequestCreationP824dX16112940>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestSquashMergeCommitMessageX9f4e5487>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestSquashMergeCommitTitleX6ce33183>,
  ...
  public val permissions:
      InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoPermissionsXf27d6b2e?
  ...
  public val squashMergeCommitMessage:
      InlineWebhookPullRequestReacd1OneOf2PullRequestSquashMergeCommitMessageX9f4e5487?
  ...
  public val squashMergeCommitTitle:
      InlineWebhookPullRequestReacd1OneOf2PullRequestSquashMergeCommitTitleX6ce33183?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoCreatedAtXe03c9d0c,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoLicenseX659425cf?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoPushedAtX76d1657f?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoVisibilityX9e2470cc,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoCreatedAtXe03c9d0c? = null

    public var createdAt: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoCreatedAtXe03c9d0c
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoVisibilityX9e2470cc? = null

    public var visibility:
        InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoVisibilityX9e2470cc
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoLicenseX659425cf?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoLicenseX659425cf?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoPushedAtX76d1657f?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoPushedAtX76d1657f?
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f {
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoCreatedAtXe03c9d0c>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoVisibilityX9e2470cc>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoLicenseX659425cf?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoPushedAtX76d1657f?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f(block: InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f = InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadRepoX374ac49f property '" + name + "' is not nullable")
