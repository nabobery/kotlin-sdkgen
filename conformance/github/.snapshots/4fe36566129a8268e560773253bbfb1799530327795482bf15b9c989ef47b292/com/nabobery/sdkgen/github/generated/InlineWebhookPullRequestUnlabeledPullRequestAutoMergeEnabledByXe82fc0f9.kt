 ...
 * to_merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unlabeled/properties/pull_request/properties/au
 * to_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByTypeX286ced37? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByTypeX286ced37? =
        null
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByTypeX286ced37>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9(block: InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9 = InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestAutoMergeEnabledByXe82fc0f9 is missing required property '" + name + "'")
