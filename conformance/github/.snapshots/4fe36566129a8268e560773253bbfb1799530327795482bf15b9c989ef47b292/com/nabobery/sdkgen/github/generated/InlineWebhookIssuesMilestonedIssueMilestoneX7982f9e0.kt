 ...
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-milestoned/properties/issue/properties/milestone
 */
@Serializable(with = InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0.Serializer::class)
public class InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0(
  /**
  ...
  public val creator: InlineWebhookIssuesMilestonedIssueMilestoneCreatorX9e64b4bb?,
   ...
   */
  public val state: InlineWebhookIssuesMilestonedIssueMilestoneStateXda07d6c1,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssuesMilestonedIssueMilestoneStateXda07d6c1? = null

    public var state: InlineWebhookIssuesMilestonedIssueMilestoneStateXda07d6c1
    ...
    private var creatorState:
        FieldState<InlineWebhookIssuesMilestonedIssueMilestoneCreatorX9e64b4bb?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssuesMilestonedIssueMilestoneCreatorX9e64b4bb?
    ...
    public fun build(): InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0 {
      ...
      return InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssuesMilestonedIssueMilestoneStateXda07d6c1>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesMilestonedIssueMilestoneCreatorX9e64b4bb?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0")
...
public fun inlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0(block: InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0.Builder.() -> Unit): InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0 = InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0 property '" + name + "' is not nullable")
