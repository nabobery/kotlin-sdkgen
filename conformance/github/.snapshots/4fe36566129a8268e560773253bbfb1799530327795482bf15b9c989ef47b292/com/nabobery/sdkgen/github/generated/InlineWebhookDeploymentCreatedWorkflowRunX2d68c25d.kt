...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-created/properties/workflow_run.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-created/properties/workflow_run
 */
@Serializable(with = InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d.Serializer::class)
public class InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d internal constructor(
  public val actor: InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07?,
  public val checkSuiteId: Int,
  public val checkSuiteNodeId: String,
  public val conclusion: InlineWebhookDeploymentCreatedWorkflowRunConclusionXcb1586f9?,
  /**
  ...
  pullRequests: List<InlineWebhookDeploymentCreatedWorkflowRunPullRequestsItemX9a025692>,
  ...
  public val status: InlineWebhookDeploymentCreatedWorkflowRunStatusX4fde9441,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val headRepositoryState:
      FieldState<InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd>,
  ...
  referencedWorkflowsState: FieldState<List<InlineWebhookDeploymentCreatedWorkflowRunReferencedWorkflowsItemXe384a357>?>,
  private val repositoryState:
      FieldState<InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84>,
  private val rerunUrlState: FieldState<String>,
  private val triggeringActorState:
      FieldState<InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45?>,
  private val workflowUrlState: FieldState<String>,
) {
  public val pullRequests: List<InlineWebhookDeploymentCreatedWorkflowRunPullRequestsItemX9a025692>
      = pullRequests.toList()

  private val referencedWorkflowsState:
      FieldState<List<InlineWebhookDeploymentCreatedWorkflowRunReferencedWorkflowsItemXe384a357>?> =
  ...
  public val headRepository: InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd?
  ...
  public val referencedWorkflows:
      List<InlineWebhookDeploymentCreatedWorkflowRunReferencedWorkflowsItemXe384a357>?
    get() = referencedWorkflowsState.valueOrNull()

  public val repository: InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84?
    get() = repositoryState.valueOrNull()

  public val rerunUrl: String?
    get() = rerunUrlState.valueOrNull()

  public val triggeringActor: InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45?
  ...
  public constructor(
    actor: InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07?,
    checkSuiteId: Int,
    checkSuiteNodeId: String,
    conclusion: InlineWebhookDeploymentCreatedWorkflowRunConclusionXcb1586f9?,
    createdAt: String,
    displayTitle: String,
    event: String,
    headBranch: String,
    ...
    runNumber: Int,
    runStartedAt: String,
    status: InlineWebhookDeploymentCreatedWorkflowRunStatusX4fde9441,
    updatedAt: String,
    url: String,
    workflowId: Int,
  ) : this(actor = actor,
  ...
  public class Builder {
    ...
    private var pullRequestsValue:
        List<InlineWebhookDeploymentCreatedWorkflowRunPullRequestsItemX9a025692>? = null

    public var pullRequests:
        List<InlineWebhookDeploymentCreatedWorkflowRunPullRequestsItemX9a025692>
    ...
    private var statusValue: InlineWebhookDeploymentCreatedWorkflowRunStatusX4fde9441? = null

    public var status: InlineWebhookDeploymentCreatedWorkflowRunStatusX4fde9441
    ...
    private var actorState: FieldState<InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var actor: InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07?
    ...
    private var conclusionState:
        FieldState<InlineWebhookDeploymentCreatedWorkflowRunConclusionXcb1586f9?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var conclusion: InlineWebhookDeploymentCreatedWorkflowRunConclusionXcb1586f9?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var headRepository: InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd?
      get() = headRepositoryState.valueOrNull()
      set(`value`) {
    ...
    private var repositoryState:
        FieldState<InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84> = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var repository: InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84?
      get() = repositoryState.valueOrNull()
      set(`value`) {
     ...
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var triggeringActor: InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45?
      get() = triggeringActorState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d {
      ...
      return InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d must be a JSON object")
      ...
      val pullRequests = json.decodeRequired<List<InlineWebhookDeploymentCreatedWorkflowRunPullRequestsItemX9a025692>>(rawObject, "pull_requests")
      ...
      val status = json.decodeRequired<InlineWebhookDeploymentCreatedWorkflowRunStatusX4fde9441>(rawObject, "status")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      val workflowId = json.decodeRequired<Int>(rawObject, "workflow_id")
      if (!rawObject.containsKey("actor")) {
        throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d is missing required property 'actor'")
      }
      val actor = rawObject["actor"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookDeploymentCreatedWorkflowRunActorX34b26f07?>(requireNotNull(element)) }
      if (!rawObject.containsKey("conclusion")) {
        throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d is missing required property 'conclusion'")
      }
      val conclusion = rawObject["conclusion"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookDeploymentCreatedWorkflowRunConclusionXcb1586f9?>(requireNotNull(element)) }
      return InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d(
        actor = actor,
        checkSuiteId = checkSuiteId,
        checkSuiteNodeId = checkSuiteNodeId,
        ...
        triggeringActorState = json.decodeOptional(rawObject, "triggering_actor", nullable = true),
        workflowUrlState = json.decodeOptional(rawObject, "workflow_url", nullable = false),
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d")
...
public fun inlineWebhookDeploymentCreatedWorkflowRunX2d68c25d(block: InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d.Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d = InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunX2d68c25d property '" + name + "' is not nullable")
