 ...
 * estone
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117(
  /**
  ...
  public val creator: InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88?,
   ...
   */
  public val state: InlineWebhookPullRequestAssignedPullRequestMilestoneStateXdda0944d,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookPullRequestAssignedPullRequestMilestoneStateXdda0944d? =
        null

    public var state: InlineWebhookPullRequestAssignedPullRequestMilestoneStateXdda0944d
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88?
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117 {
      ...
      return InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestAssignedPullRequestMilestoneStateXdda0944d>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117")
...
public fun inlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117(block: InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117 = InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestAssignedPullRequestMilestoneX5c6f0117 property '" + name + "' is not nullable")
