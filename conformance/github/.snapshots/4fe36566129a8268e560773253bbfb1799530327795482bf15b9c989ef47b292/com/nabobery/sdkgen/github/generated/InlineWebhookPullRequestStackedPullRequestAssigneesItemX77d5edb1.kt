 ...
 * gnees/items
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestStackedPullRequestAssigneesItemTypeX497aeea6? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestStackedPullRequestAssigneesItemTypeX497aeea6? = null
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1 must be a JSON object")
      ...
      return InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestStackedPullRequestAssigneesItemTypeX497aeea6>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1")
...
public fun inlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1(block: InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1 = InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestAssigneesItemX77d5edb1 is missing required property '" + name + "'")
