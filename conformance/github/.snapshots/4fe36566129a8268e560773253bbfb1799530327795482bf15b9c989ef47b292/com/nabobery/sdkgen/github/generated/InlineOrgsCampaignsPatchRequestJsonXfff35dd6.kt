...
public class InlineOrgsCampaignsPatchRequestJsonXfff35dd6 internal constructor(
  ...
  public class Builder {
    ...
    public var managers: List<String>?
      get() = managersState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        val present = requireNotNull(value) { "managers is not nullable; call unsetManagers() to omit it" }
        managersState = FieldState.Value(present.toList())
      }
  ...
  internal object Serializer : KSerializer<InlineOrgsCampaignsPatchRequestJsonXfff35dd6> {
