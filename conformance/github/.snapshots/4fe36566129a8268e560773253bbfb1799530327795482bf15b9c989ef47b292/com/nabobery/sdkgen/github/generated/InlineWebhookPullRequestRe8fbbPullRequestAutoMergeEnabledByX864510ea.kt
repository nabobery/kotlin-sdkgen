 ...
 * properties/auto_merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-deleted/properties/pull_request/
 * properties/auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea.Serializer::class)
public class InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByTypeX92836ef9? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByTypeX92836ef9? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea must be a JSON object")
      ...
      return InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByTypeX92836ef9>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea")
...
public fun inlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea(block: InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea.Builder.() -> Unit): InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea = InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe8fbbPullRequestAutoMergeEnabledByX864510ea is missing required property '" + name + "'")
