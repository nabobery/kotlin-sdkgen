...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-created/properties/comment/properties/reaction
 * s.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-created/properties/comment/properties/reaction
 * s
 */
@Serializable(with = InlineWebhookIssueCommentCreatedCommentReactionsX54113f91.Serializer::class)
public class InlineWebhookIssueCommentCreatedCommentReactionsX54113f91(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentCreatedCommentReactionsX54113f91 {
      ...
      return InlineWebhookIssueCommentCreatedCommentReactionsX54113f91(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedCommentReactionsX54113f91 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedCommentReactionsX54113f91> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedCommentReactionsX54113f91 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedCommentReactionsX54113f91")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedCommentReactionsX54113f91 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedCommentReactionsX54113f91) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedCommentReactionsX54113f91")
...
public fun inlineWebhookIssueCommentCreatedCommentReactionsX54113f91(block: InlineWebhookIssueCommentCreatedCommentReactionsX54113f91.Builder.() -> Unit): InlineWebhookIssueCommentCreatedCommentReactionsX54113f91 = InlineWebhookIssueCommentCreatedCommentReactionsX54113f91.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedCommentReactionsX54113f91 is missing required property '" + name + "'")
