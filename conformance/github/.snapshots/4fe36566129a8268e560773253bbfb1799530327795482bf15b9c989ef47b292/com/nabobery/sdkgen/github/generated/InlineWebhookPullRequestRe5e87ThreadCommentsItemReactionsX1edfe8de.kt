 ...
 * erties/comments/items/properties/reactions.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-thread-unresolved/properties/thread/prop
 * erties/comments/items/properties/reactions
 */
@Serializable(with = InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de.Serializer::class)
public class InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de {
      ...
      return InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de")
...
public fun inlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de(block: InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de.Builder.() -> Unit): InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de = InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe5e87ThreadCommentsItemReactionsX1edfe8de is missing required property '" + name + "'")
