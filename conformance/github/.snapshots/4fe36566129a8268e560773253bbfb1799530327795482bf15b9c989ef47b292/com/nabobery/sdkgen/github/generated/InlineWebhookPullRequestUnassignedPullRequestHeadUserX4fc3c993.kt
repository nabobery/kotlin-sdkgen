 ...
 * ead/properties/user
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestUnassignedPullRequestHeadUserTypeXbce9b341? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnassignedPullRequestHeadUserTypeXbce9b341? = null
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestHeadUserTypeXbce9b341>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993")
...
public fun inlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993(block: InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993 = InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadUserX4fc3c993 is missing required property '" + name + "'")
