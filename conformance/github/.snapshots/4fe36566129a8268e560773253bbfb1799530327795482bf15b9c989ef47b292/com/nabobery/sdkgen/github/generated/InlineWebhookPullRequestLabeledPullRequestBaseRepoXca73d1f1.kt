 ...
 * /properties/repo
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestLabeledPullRequestBaseRepoCreatedAtXe278323c,
  /**
  ...
  public val license: InlineWebhookPullRequestLabeledPullRequestBaseRepoLicenseX4bf18fb5?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestLabeledPullRequestBaseRepoPushedAtX6206adfe?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestLabeledPullRequestBaseRepoVisibilityXd5d1792a,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestLabeledPullRequestBaseRepoMergeCommitMessageXf210a5ed>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestLabeledPullRequestBaseRepoMergeCommitTitleX19a5e093>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestLabeledPullRequestBaseRepoPermissionsXc47b0e47>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestLa835fPullRequestBasePullRequestCreationP824dX561f1968>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestLa835fPullRequestBaseSquashMergeCommitMessageX45160f7e>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestLa835fPullRequestBaseRepoSquashMergeCommitTitleX1f6cc60d>,
  ...
  public val permissions: InlineWebhookPullRequestLabeledPullRequestBaseRepoPermissionsXc47b0e47?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestLabeledPullRequestBaseRepoCreatedAtXe278323c,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestLabeledPullRequestBaseRepoLicenseX4bf18fb5?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestLabeledPullRequestBaseRepoPushedAtX6206adfe?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestLabeledPullRequestBaseRepoVisibilityXd5d1792a,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestLabeledPullRequestBaseRepoCreatedAtXe278323c? = null

    public var createdAt: InlineWebhookPullRequestLabeledPullRequestBaseRepoCreatedAtXe278323c
    ...
    private var visibilityValue:
        InlineWebhookPullRequestLabeledPullRequestBaseRepoVisibilityXd5d1792a? = null

    public var visibility: InlineWebhookPullRequestLabeledPullRequestBaseRepoVisibilityXd5d1792a
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestLabeledPullRequestBaseRepoLicenseX4bf18fb5?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestLabeledPullRequestBaseRepoLicenseX4bf18fb5?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestLabeledPullRequestBaseRepoPushedAtX6206adfe?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestLabeledPullRequestBaseRepoPushedAtX6206adfe?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestLabeledPullRequestBaseRepoPermissionsXc47b0e47?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 {
      ...
      return InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestLabeledPullRequestBaseRepoCreatedAtXe278323c>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestLabeledPullRequestBaseRepoVisibilityXd5d1792a>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestBaseRepoLicenseX4bf18fb5?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestBaseRepoPushedAtX6206adfe?>(requireNotNull(element)) }
      return InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1")
...
public fun inlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1(block: InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 = InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoXca73d1f1 property '" + name + "' is not nullable")
