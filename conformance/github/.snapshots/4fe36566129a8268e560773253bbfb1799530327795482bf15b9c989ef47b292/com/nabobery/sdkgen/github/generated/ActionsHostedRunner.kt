...
public class ActionsHostedRunner internal constructor(
  ...
  public class Builder {
    ...
    public var publicIps: List<PublicIp>?
      get() = publicIpsState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        val present = requireNotNull(value) { "publicIps is not nullable; call unsetPublicIps() to omit it" }
        publicIpsState = FieldState.Value(present.toList())
      }
  ...
  internal object Serializer : KSerializer<ActionsHostedRunner> {
