 ...
 * t/properties/head/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a(
  public val id: Long,
  ...
  public val type:
      InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserTypeX07f8da74? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserTypeX07f8da74?
        = null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserTypeX07f8da74>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a(block: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a = InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadUserX3add5a0a is missing required property '" + name + "'")
