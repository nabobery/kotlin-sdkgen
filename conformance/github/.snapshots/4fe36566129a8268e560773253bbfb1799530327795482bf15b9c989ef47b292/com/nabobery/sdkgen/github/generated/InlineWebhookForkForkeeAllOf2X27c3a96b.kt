...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhook-fork/properties/forkee/allOf/1.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-fork/properties/forkee/allOf/1
 */
@Serializable(with = InlineWebhookForkForkeeAllOf2X27c3a96b.Serializer::class)
public class InlineWebhookForkForkeeAllOf2X27c3a96b(
  ...
  public val topics: List<JsonElement?>? = topics?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    public var language: JsonElement? = null

    public var languagesUrl: String? = null

    public var license: JsonObject? = null

    public var mergesUrl: String? = null

    public var milestonesUrl: String? = null

    public var mirrorUrl: JsonElement? = null
    ...
    public var owner: InlineWebhookForkForkeeAllOf2OwnerX9c8ea267? = null
    ...
    private var topicsValue: List<JsonElement?>? = null

    public var topics: List<JsonElement?>?
    ...
    public fun build(): InlineWebhookForkForkeeAllOf2X27c3a96b = InlineWebhookForkForkeeAllOf2X27c3a96b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookForkForkeeAllOf2X27c3a96b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookForkForkeeAllOf2X27c3a96b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookForkForkeeAllOf2X27c3a96b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookForkForkeeAllOf2X27c3a96b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookForkForkeeAllOf2X27c3a96b must be a JSON object")
      return InlineWebhookForkForkeeAllOf2X27c3a96b(
        ...
        language = rawObject["language"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<JsonElement?>(element) },
        languagesUrl = rawObject["languages_url"]?.let { json.decodeFromJsonElement<String>(it) },
        license = rawObject["license"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<JsonObject?>(element) },
        ...
        mirrorUrl = rawObject["mirror_url"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<JsonElement?>(element) },
        ...
        owner = rawObject["owner"]?.let { json.decodeFromJsonElement<InlineWebhookForkForkeeAllOf2OwnerX9c8ea267>(it) },
        ...
        topics = rawObject["topics"]?.let { json.decodeFromJsonElement<List<JsonElement?>>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookForkForkeeAllOf2X27c3a96b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookForkForkeeAllOf2X27c3a96b")
      ...
      val raw = buildJsonObject {
        ...
        value.language?.let { put("language", json.encodeToJsonElement(it)) }
        ...
        value.mirrorUrl?.let { put("mirror_url", json.encodeToJsonElement(it)) }
...
public fun inlineWebhookForkForkeeAllOf2X27c3a96b(block: InlineWebhookForkForkeeAllOf2X27c3a96b.Builder.() -> Unit): InlineWebhookForkForkeeAllOf2X27c3a96b = InlineWebhookForkForkeeAllOf2X27c3a96b.build(block)
