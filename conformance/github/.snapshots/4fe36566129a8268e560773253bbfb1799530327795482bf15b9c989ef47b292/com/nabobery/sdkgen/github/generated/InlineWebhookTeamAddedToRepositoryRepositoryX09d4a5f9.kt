 ...
 * A git repository
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-team-added-to-repository/properties/repository
 */
@Serializable(with = InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9.Serializer::class)
public class InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookTeamAddedToRepositoryRepositoryCreatedAtXb1a379cc,
  /**
  ...
  public val license: InlineWebhookTeamAddedToRepositoryRepositoryLicenseXe7865da2?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5?,
  /**
  ...
  public val pushedAt: InlineWebhookTeamAddedToRepositoryRepositoryPushedAtX5d129e63?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookTeamAddedToRepositoryRepositoryVisibilityXb7b6a0a2,
  ...
  private val permissionsState:
      FieldState<InlineWebhookTeamAddedToRepositoryRepositoryPermissionsXa76d6bea>,
  ...
  public val permissions: InlineWebhookTeamAddedToRepositoryRepositoryPermissionsXa76d6bea?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookTeamAddedToRepositoryRepositoryCreatedAtXb1a379cc,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookTeamAddedToRepositoryRepositoryLicenseXe7865da2?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookTeamAddedToRepositoryRepositoryPushedAtX5d129e63?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookTeamAddedToRepositoryRepositoryVisibilityXb7b6a0a2,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookTeamAddedToRepositoryRepositoryCreatedAtXb1a379cc? =
        null

    public var createdAt: InlineWebhookTeamAddedToRepositoryRepositoryCreatedAtXb1a379cc
    ...
    private var visibilityValue: InlineWebhookTeamAddedToRepositoryRepositoryVisibilityXb7b6a0a2? =
        null

    public var visibility: InlineWebhookTeamAddedToRepositoryRepositoryVisibilityXb7b6a0a2
    ...
    private var licenseState:
        FieldState<InlineWebhookTeamAddedToRepositoryRepositoryLicenseXe7865da2?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookTeamAddedToRepositoryRepositoryLicenseXe7865da2?
    ...
    private var ownerState: FieldState<InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5?>
        = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookTeamAddedToRepositoryRepositoryPushedAtX5d129e63?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookTeamAddedToRepositoryRepositoryPushedAtX5d129e63?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookTeamAddedToRepositoryRepositoryPermissionsXa76d6bea?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 {
      ...
      return InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookTeamAddedToRepositoryRepositoryCreatedAtXb1a379cc>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookTeamAddedToRepositoryRepositoryVisibilityXb7b6a0a2>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamAddedToRepositoryRepositoryLicenseXe7865da2?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamAddedToRepositoryRepositoryPushedAtX5d129e63?>(requireNotNull(element)) }
      return InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9")
...
public fun inlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9(block: InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9.Builder.() -> Unit): InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 = InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryX09d4a5f9 property '" + name + "' is not nullable")
