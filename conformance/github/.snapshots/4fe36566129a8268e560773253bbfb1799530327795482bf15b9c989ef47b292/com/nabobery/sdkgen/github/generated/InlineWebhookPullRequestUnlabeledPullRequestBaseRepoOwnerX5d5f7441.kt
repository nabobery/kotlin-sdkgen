 ...
 * se/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unlabeled/properties/pull_request/properties/ba
 * se/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerTypeXfcba96e0? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerTypeXfcba96e0? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerTypeXfcba96e0>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441(block: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441 = InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441 is missing required property '" + name + "'")
