...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-team-created/properties/repository/properties/owner.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-team-created/properties/repository/properties/owner
 */
@Serializable(with = InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924.Serializer::class)
public class InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924(
  public val id: Int,
  ...
  public val type: InlineWebhookTeamCreatedRepositoryOwnerTypeX3be43b6e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookTeamCreatedRepositoryOwnerTypeX3be43b6e? = null
    ...
    public fun build(): InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924 must be a JSON object")
      ...
      return InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookTeamCreatedRepositoryOwnerTypeX3be43b6e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924")
...
public fun inlineWebhookTeamCreatedRepositoryOwnerXbfdc2924(block: InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924.Builder.() -> Unit): InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924 = InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924 is missing required property '" + name + "'")
