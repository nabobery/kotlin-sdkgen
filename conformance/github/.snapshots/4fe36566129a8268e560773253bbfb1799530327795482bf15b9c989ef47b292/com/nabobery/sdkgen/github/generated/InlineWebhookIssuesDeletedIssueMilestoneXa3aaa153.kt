 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-deleted/properties/issue/properties/milestone
 */
@Serializable(with = InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153.Serializer::class)
public class InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153(
  /**
  ...
  public val creator: InlineWebhookIssuesDeletedIssueMilestoneCreatorX7e63cdbb?,
   ...
   */
  public val state: InlineWebhookIssuesDeletedIssueMilestoneStateX2d2bf5cf,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssuesDeletedIssueMilestoneStateX2d2bf5cf? = null

    public var state: InlineWebhookIssuesDeletedIssueMilestoneStateX2d2bf5cf
    ...
    private var creatorState: FieldState<InlineWebhookIssuesDeletedIssueMilestoneCreatorX7e63cdbb?>
        = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssuesDeletedIssueMilestoneCreatorX7e63cdbb?
    ...
    public fun build(): InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153 {
      ...
      return InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssuesDeletedIssueMilestoneStateX2d2bf5cf>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesDeletedIssueMilestoneCreatorX7e63cdbb?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153")
...
public fun inlineWebhookIssuesDeletedIssueMilestoneXa3aaa153(block: InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153.Builder.() -> Unit): InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153 = InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153 property '" + name + "' is not nullable")
