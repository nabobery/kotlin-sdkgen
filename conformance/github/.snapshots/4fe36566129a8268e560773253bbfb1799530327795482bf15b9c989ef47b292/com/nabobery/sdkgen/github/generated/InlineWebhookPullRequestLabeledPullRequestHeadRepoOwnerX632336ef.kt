 ...
 * /properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerTypeX7c5cd335? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerTypeX7c5cd335? = null
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef must be a JSON object")
      ...
      return InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerTypeX7c5cd335>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef")
...
public fun inlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef(block: InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef = InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef is missing required property '" + name + "'")
