 ...
 * uested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestDea21dPullRequestRequestedReviewersItemTypeX7a6e3e78? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestDea21dPullRequestRequestedReviewersItemTypeX7a6e3e78? =
        null
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce must be a JSON object")
      ...
      return InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestDea21dPullRequestRequestedReviewersItemTypeX7a6e3e78>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce")
...
public fun inlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce(block: InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce = InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestRequestedReviewersItemOneOf1X5e954dce is missing required property '" + name + "'")
