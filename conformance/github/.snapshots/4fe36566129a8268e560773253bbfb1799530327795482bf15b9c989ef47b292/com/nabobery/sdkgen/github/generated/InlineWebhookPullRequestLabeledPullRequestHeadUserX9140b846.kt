 ...
 * /properties/user
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestLabeledPullRequestHeadUserTypeX0f38c281? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLabeledPullRequestHeadUserTypeX0f38c281? = null
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846 must be a JSON object")
      ...
      return InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestHeadUserTypeX0f38c281>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846")
...
public fun inlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846(block: InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846 = InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadUserX9140b846 is missing required property '" + name + "'")
