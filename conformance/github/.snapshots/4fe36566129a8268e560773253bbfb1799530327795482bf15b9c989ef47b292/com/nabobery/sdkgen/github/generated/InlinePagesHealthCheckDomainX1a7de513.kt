...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/pages-health-check/properties/domain.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/pages-health-check/properties/domain
 */
@Serializable(with = InlinePagesHealthCheckDomainX1a7de513.Serializer::class)
public class InlinePagesHealthCheckDomainX1a7de513(
  ...
  public class Builder {
    ...
    public fun build(): InlinePagesHealthCheckDomainX1a7de513 = InlinePagesHealthCheckDomainX1a7de513(
      caaError = caaError,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlinePagesHealthCheckDomainX1a7de513 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlinePagesHealthCheckDomainX1a7de513> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlinePagesHealthCheckDomainX1a7de513 {
      val jsonDecoder = decoder.requireJsonDecoder("InlinePagesHealthCheckDomainX1a7de513")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlinePagesHealthCheckDomainX1a7de513 must be a JSON object")
      return InlinePagesHealthCheckDomainX1a7de513(
    ...
    override fun serialize(encoder: Encoder, `value`: InlinePagesHealthCheckDomainX1a7de513) {
      val jsonEncoder = encoder.requireJsonEncoder("InlinePagesHealthCheckDomainX1a7de513")
...
public fun inlinePagesHealthCheckDomainX1a7de513(block: InlinePagesHealthCheckDomainX1a7de513.Builder.() -> Unit): InlinePagesHealthCheckDomainX1a7de513 = InlinePagesHealthCheckDomainX1a7de513.build(block)
