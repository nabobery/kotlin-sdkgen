 ...
 * ties/milestone
 */
@Serializable(with = InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449.Serializer::class)
public class InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449(
  /**
  ...
  public val creator: InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f?,
   ...
   */
  public val state: InlineWebhookIssuesOpenedChangesOldIssueMilestoneStateXf2c5e350,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssuesOpenedChangesOldIssueMilestoneStateXf2c5e350? = null

    public var state: InlineWebhookIssuesOpenedChangesOldIssueMilestoneStateXf2c5e350
    ...
    private var creatorState:
        FieldState<InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f?
    ...
    public fun build(): InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449 {
      ...
      return InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssuesOpenedChangesOldIssueMilestoneStateXf2c5e350>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449")
...
public fun inlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449(block: InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449.Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449 = InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueMilestoneXd2fda449 property '" + name + "' is not nullable")
