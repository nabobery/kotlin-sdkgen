...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/pull-request/properties/_links.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/pull-request/properties/_links
 */
@Serializable(with = InlinePullRequestLinksXd573a9fa.Serializer::class)
public class InlinePullRequestLinksXd573a9fa(
  ...
  public class Builder {
    ...
    public fun build(): InlinePullRequestLinksXd573a9fa {
      ...
      return InlinePullRequestLinksXd573a9fa(
        comments = comments,
        commits = commits,
        html = html,
        issue = issue,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlinePullRequestLinksXd573a9fa = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlinePullRequestLinksXd573a9fa> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlinePullRequestLinksXd573a9fa {
      val jsonDecoder = decoder.requireJsonDecoder("InlinePullRequestLinksXd573a9fa")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlinePullRequestLinksXd573a9fa must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlinePullRequestLinksXd573a9fa) {
      val jsonEncoder = encoder.requireJsonEncoder("InlinePullRequestLinksXd573a9fa")
...
public fun inlinePullRequestLinksXd573a9fa(block: InlinePullRequestLinksXd573a9fa.Builder.() -> Unit): InlinePullRequestLinksXd573a9fa = InlinePullRequestLinksXd573a9fa.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlinePullRequestLinksXd573a9fa is missing required property '" + name + "'")
