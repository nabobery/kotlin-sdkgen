 ...
 * r
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestUserXb10ff949.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestUserXb10ff949(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestAssignedPullRequestUserTypeX8a61bd8d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAssignedPullRequestUserTypeX8a61bd8d? = null
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestUserXb10ff949 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAssignedPullRequestUserXb10ff949(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestUserXb10ff949 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestUserXb10ff949> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestUserXb10ff949 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestUserXb10ff949")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestUserXb10ff949 must be a JSON object")
      ...
      return InlineWebhookPullRequestAssignedPullRequestUserXb10ff949(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestUserTypeX8a61bd8d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestUserXb10ff949) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestUserXb10ff949")
...
public fun inlineWebhookPullRequestAssignedPullRequestUserXb10ff949(block: InlineWebhookPullRequestAssignedPullRequestUserXb10ff949.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestUserXb10ff949 = InlineWebhookPullRequestAssignedPullRequestUserXb10ff949.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestUserXb10ff949 is missing required property '" + name + "'")
