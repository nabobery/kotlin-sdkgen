...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/concurrency-group/properties/group_members/items.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/concurrency-group/properties/group_members/items
 */
@Serializable(with = InlineConcurrencyGroupGroupMembersItemXb97fe4d5.Serializer::class)
public class InlineConcurrencyGroupGroupMembersItemXb97fe4d5 internal constructor(
  /**
  ...
  public val status: InlineConcurrencyGroupGroupMembersItemStatusXc4a1e98c,
  ...
  public constructor(
    ...
    runName: String,
    runUrl: String?,
    status: InlineConcurrencyGroupGroupMembersItemStatusXc4a1e98c,
  ...
  public class Builder {
    ...
    private var statusValue: InlineConcurrencyGroupGroupMembersItemStatusXc4a1e98c? = null

    public var status: InlineConcurrencyGroupGroupMembersItemStatusXc4a1e98c
    ...
    public var jobId: Int?
      get() = jobIdState.valueOrNull()
      set(`value`) {
        val present = requireNotNull(value) { "jobId is not nullable; call unsetJobId() to omit it" }
        jobIdState = FieldState.Value(present)
      }
    ...
    public var jobName: String?
      get() = jobNameState.valueOrNull()
      set(`value`) {
        val present = requireNotNull(value) { "jobName is not nullable; call unsetJobName() to omit it" }
        jobNameState = FieldState.Value(present)
      }
    ...
    public fun build(): InlineConcurrencyGroupGroupMembersItemXb97fe4d5 {
      ...
      return InlineConcurrencyGroupGroupMembersItemXb97fe4d5(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineConcurrencyGroupGroupMembersItemXb97fe4d5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineConcurrencyGroupGroupMembersItemXb97fe4d5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineConcurrencyGroupGroupMembersItemXb97fe4d5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineConcurrencyGroupGroupMembersItemXb97fe4d5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineConcurrencyGroupGroupMembersItemXb97fe4d5 must be a JSON object")
      val runId = json.decodeRequired<Int>(rawObject, "run_id")
      val runName = json.decodeRequired<String>(rawObject, "run_name")
      val status = json.decodeRequired<InlineConcurrencyGroupGroupMembersItemStatusXc4a1e98c>(rawObject, "status")
      if (!rawObject.containsKey("run_html_url")) {
        throw SerializationException("InlineConcurrencyGroupGroupMembersItemXb97fe4d5 is missing required property 'run_html_url'")
      }
      ...
      if (!rawObject.containsKey("run_url")) {
        throw SerializationException("InlineConcurrencyGroupGroupMembersItemXb97fe4d5 is missing required property 'run_url'")
      }
      ...
      return InlineConcurrencyGroupGroupMembersItemXb97fe4d5(
        ...
        jobIdState = json.decodeOptional(rawObject, "job_id", nullable = false),
        jobNameState = json.decodeOptional(rawObject, "job_name", nullable = false),
        jobUrlState = json.decodeOptional(rawObject, "job_url", nullable = true),
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineConcurrencyGroupGroupMembersItemXb97fe4d5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineConcurrencyGroupGroupMembersItemXb97fe4d5")
...
public fun inlineConcurrencyGroupGroupMembersItemXb97fe4d5(block: InlineConcurrencyGroupGroupMembersItemXb97fe4d5.Builder.() -> Unit): InlineConcurrencyGroupGroupMembersItemXb97fe4d5 = InlineConcurrencyGroupGroupMembersItemXb97fe4d5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineConcurrencyGroupGroupMembersItemXb97fe4d5 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineConcurrencyGroupGroupMembersItemXb97fe4d5 property '" + name + "' is not nullable")
