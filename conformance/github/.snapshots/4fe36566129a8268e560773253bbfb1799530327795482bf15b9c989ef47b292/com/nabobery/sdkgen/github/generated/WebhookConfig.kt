 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-config
 */
@Serializable(with = WebhookConfig.Serializer::class)
public class WebhookConfig internal constructor(
  ...
  public class Builder {
    ...
    public fun build(): WebhookConfig = WebhookConfig(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhookConfig = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhookConfig> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhookConfig {
      val jsonDecoder = decoder.requireJsonDecoder("WebhookConfig")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhookConfig must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: WebhookConfig) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhookConfig")
...
public fun webhookConfig(block: WebhookConfig.Builder.() -> Unit): WebhookConfig = WebhookConfig.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("WebhookConfig property '" + name + "' is not nullable")
