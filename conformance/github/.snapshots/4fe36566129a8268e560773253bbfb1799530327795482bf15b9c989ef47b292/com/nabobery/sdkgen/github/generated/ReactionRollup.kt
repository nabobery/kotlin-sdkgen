...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/reaction-rollup.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/reaction-rollup
 */
@Serializable(with = ReactionRollup.Serializer::class)
public class ReactionRollup(
  ...
  public class Builder {
    ...
    public fun build(): ReactionRollup {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ReactionRollup = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<ReactionRollup> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ReactionRollup {
      val jsonDecoder = decoder.requireJsonDecoder("ReactionRollup")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReactionRollup must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ReactionRollup) {
      val jsonEncoder = encoder.requireJsonEncoder("ReactionRollup")
...
public fun reactionRollup(block: ReactionRollup.Builder.() -> Unit): ReactionRollup = ReactionRollup.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReactionRollup is missing required property '" + name + "'")
