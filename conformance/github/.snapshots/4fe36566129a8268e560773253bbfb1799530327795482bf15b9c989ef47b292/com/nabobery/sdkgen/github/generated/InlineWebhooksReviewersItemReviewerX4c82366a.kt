...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_reviewers/items/properties/reviewer.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_reviewers/items/properties/reviewer
 */
@Serializable(with = InlineWebhooksReviewersItemReviewerX4c82366a.Serializer::class)
public class InlineWebhooksReviewersItemReviewerX4c82366a(
  public val id: Int,
  ...
  public val type: InlineWebhooksReviewersItemReviewerTypeX524f230a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksReviewersItemReviewerTypeX524f230a? = null
    ...
    public fun build(): InlineWebhooksReviewersItemReviewerX4c82366a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksReviewersItemReviewerX4c82366a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksReviewersItemReviewerX4c82366a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksReviewersItemReviewerX4c82366a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksReviewersItemReviewerX4c82366a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksReviewersItemReviewerX4c82366a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksReviewersItemReviewerX4c82366a must be a JSON object")
      ...
      return InlineWebhooksReviewersItemReviewerX4c82366a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksReviewersItemReviewerTypeX524f230a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksReviewersItemReviewerX4c82366a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksReviewersItemReviewerX4c82366a")
...
public fun inlineWebhooksReviewersItemReviewerX4c82366a(block: InlineWebhooksReviewersItemReviewerX4c82366a.Builder.() -> Unit): InlineWebhooksReviewersItemReviewerX4c82366a = InlineWebhooksReviewersItemReviewerX4c82366a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksReviewersItemReviewerX4c82366a is missing required property '" + name + "'")
