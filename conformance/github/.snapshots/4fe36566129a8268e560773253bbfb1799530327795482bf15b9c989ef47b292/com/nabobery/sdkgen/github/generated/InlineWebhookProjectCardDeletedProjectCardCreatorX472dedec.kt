 ...
 * tor
 */
@Serializable(with = InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec.Serializer::class)
public class InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec(
  public val id: Int,
  ...
  public val type: InlineWebhookProjectCardDeletedProjectCardCreatorTypeXfb9b7183? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookProjectCardDeletedProjectCardCreatorTypeXfb9b7183? = null
    ...
    public fun build(): InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec must be a JSON object")
      ...
      return InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookProjectCardDeletedProjectCardCreatorTypeXfb9b7183>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec")
...
public fun inlineWebhookProjectCardDeletedProjectCardCreatorX472dedec(block: InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec.Builder.() -> Unit): InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec = InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookProjectCardDeletedProjectCardCreatorX472dedec is missing required property '" + name + "'")
