 ...
 * /properties/user
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestLabeledPullRequestBaseUserTypeX6fcfed27? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLabeledPullRequestBaseUserTypeX6fcfed27? = null
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da must be a JSON object")
      ...
      return InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestBaseUserTypeX6fcfed27>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da")
...
public fun inlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da(block: InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da = InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseUserXa48920da is missing required property '" + name + "'")
