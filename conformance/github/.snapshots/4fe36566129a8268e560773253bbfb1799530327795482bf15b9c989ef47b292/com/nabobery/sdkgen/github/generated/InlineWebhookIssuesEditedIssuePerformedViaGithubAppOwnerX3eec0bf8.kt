 ...
 * ub_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-edited/properties/issue/properties/performed_via_gith
 * ub_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8.Serializer::class)
public class InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerTypeXa5bb34ee? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerTypeXa5bb34ee? = null
    ...
    public fun build(): InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8 must be a JSON object")
      ...
      return InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerTypeXa5bb34ee>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8")
...
public fun inlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8(block: InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8.Builder.() -> Unit): InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8 = InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8 is missing required property '" + name + "'")
