...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-locked/properties/issue/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-locked/properties/issue/properties/user
 */
@Serializable(with = InlineWebhookIssuesLockedIssueUserXa148d362.Serializer::class)
public class InlineWebhookIssuesLockedIssueUserXa148d362(
  public val id: Long,
  ...
  public val type: InlineWebhookIssuesLockedIssueUserTypeXda1b3b1b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesLockedIssueUserTypeXda1b3b1b? = null
    ...
    public fun build(): InlineWebhookIssuesLockedIssueUserXa148d362 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesLockedIssueUserXa148d362(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLockedIssueUserXa148d362 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLockedIssueUserXa148d362> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLockedIssueUserXa148d362 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLockedIssueUserXa148d362")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLockedIssueUserXa148d362 must be a JSON object")
      ...
      return InlineWebhookIssuesLockedIssueUserXa148d362(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesLockedIssueUserTypeXda1b3b1b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLockedIssueUserXa148d362) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLockedIssueUserXa148d362")
...
public fun inlineWebhookIssuesLockedIssueUserXa148d362(block: InlineWebhookIssuesLockedIssueUserXa148d362.Builder.() -> Unit): InlineWebhookIssuesLockedIssueUserXa148d362 = InlineWebhookIssuesLockedIssueUserXa148d362.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLockedIssueUserXa148d362 is missing required property '" + name + "'")
