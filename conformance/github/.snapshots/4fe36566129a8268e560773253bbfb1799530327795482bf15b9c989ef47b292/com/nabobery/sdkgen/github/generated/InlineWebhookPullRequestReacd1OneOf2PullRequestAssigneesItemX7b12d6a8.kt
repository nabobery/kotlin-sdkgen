 ...
 * request/properties/assignees/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-request-removed/oneOf/1/properties/pull_
 * request/properties/assignees/items
 */
@Serializable(with = InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8.Serializer::class)
public class InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemTypeXd0d25a7a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemTypeXd0d25a7a? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8 must be a JSON object")
      ...
      return InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemTypeXd0d25a7a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8")
...
public fun inlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8(block: InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8.Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8 = InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneesItemX7b12d6a8 is missing required property '" + name + "'")
