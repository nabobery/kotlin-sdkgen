 ...
 * rties/reactions
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871.Serializer::class)
public class InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871 {
      ...
      return InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871")
...
public fun inlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871(block: InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871 = InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedCommentReactionsX28551871 is missing required property '" + name + "'")
