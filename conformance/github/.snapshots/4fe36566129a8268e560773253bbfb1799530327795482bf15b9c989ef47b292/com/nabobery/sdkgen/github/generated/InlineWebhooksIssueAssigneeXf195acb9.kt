...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue/properties/assignee.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue/properties/assignee
 */
@Serializable(with = InlineWebhooksIssueAssigneeXf195acb9.Serializer::class)
public class InlineWebhooksIssueAssigneeXf195acb9(
  public val id: Int,
  ...
  public val type: InlineWebhooksIssueAssigneeTypeXe0b94e15? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksIssueAssigneeTypeXe0b94e15? = null
    ...
    public fun build(): InlineWebhooksIssueAssigneeXf195acb9 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksIssueAssigneeXf195acb9(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssueAssigneeXf195acb9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssueAssigneeXf195acb9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssueAssigneeXf195acb9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssueAssigneeXf195acb9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssueAssigneeXf195acb9 must be a JSON object")
      ...
      return InlineWebhooksIssueAssigneeXf195acb9(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksIssueAssigneeTypeXe0b94e15>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssueAssigneeXf195acb9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssueAssigneeXf195acb9")
...
public fun inlineWebhooksIssueAssigneeXf195acb9(block: InlineWebhooksIssueAssigneeXf195acb9.Builder.() -> Unit): InlineWebhooksIssueAssigneeXf195acb9 = InlineWebhooksIssueAssigneeXf195acb9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssueAssigneeXf195acb9 is missing required property '" + name + "'")
