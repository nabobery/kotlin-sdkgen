 ...
 * License Simple
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-license-simple
 */
@Serializable(with = NullableLicenseSimple.Serializer::class)
public class NullableLicenseSimple internal constructor(
  ...
  public class Builder {
    ...
    public fun build(): NullableLicenseSimple {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): NullableLicenseSimple = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<NullableLicenseSimple> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): NullableLicenseSimple {
      val jsonDecoder = decoder.requireJsonDecoder("NullableLicenseSimple")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("NullableLicenseSimple must be a JSON object")
      val key = json.decodeRequired<String>(rawObject, "key")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("spdx_id")) {
        throw SerializationException("NullableLicenseSimple is missing required property 'spdx_id'")
      }
      ...
      if (!rawObject.containsKey("url")) {
        throw SerializationException("NullableLicenseSimple is missing required property 'url'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: NullableLicenseSimple) {
      val jsonEncoder = encoder.requireJsonEncoder("NullableLicenseSimple")
...
public fun nullableLicenseSimple(block: NullableLicenseSimple.Builder.() -> Unit): NullableLicenseSimple = NullableLicenseSimple.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NullableLicenseSimple is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("NullableLicenseSimple property '" + name + "' is not nullable")
