 ...
 * e/properties/user
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestDequeuedPullRequestBaseUserTypeX5aa10e2a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestDequeuedPullRequestBaseUserTypeX5aa10e2a? = null
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf must be a JSON object")
      ...
      return InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestBaseUserTypeX5aa10e2a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf")
...
public fun inlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf(block: InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf = InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseUserX4eb523cf is missing required property '" + name + "'")
