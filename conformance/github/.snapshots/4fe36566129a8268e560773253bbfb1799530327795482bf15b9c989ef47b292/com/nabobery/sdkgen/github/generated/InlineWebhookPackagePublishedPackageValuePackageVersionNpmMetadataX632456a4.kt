 ...
 * ion/properties/npm_metadata.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-package-published/properties/package/properties/package_vers
 * ion/properties/npm_metadata
 */
@Serializable(with = InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4.Serializer::class)
public class InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4(
  public val author: JsonObject? = null,
  public val bin: JsonObject? = null,
  public val bugs: JsonObject? = null,
  public val commitOid: String? = null,
  contributors: List<JsonObject>? = null,
  ...
  public val directories: JsonObject? = null,
  public val dist: JsonObject? = null,
  ...
  maintainers: List<JsonObject>? = null,
  ...
  public val repository: JsonObject? = null,
  public val scripts: JsonObject? = null,
  public val version: String? = null,
) {
  public val contributors: List<JsonObject>? =
      contributors?.let { collection0 -> collection0.toList() }
  ...
  public val maintainers: List<JsonObject>? =
      maintainers?.let { collection0 -> collection0.toList() }

  public val os: List<String>? = os?.let { collection0 -> collection0.toList() }

  public class Builder {
    public var author: JsonObject? = null

    public var bin: JsonObject? = null

    public var bugs: JsonObject? = null

    public var commitOid: String? = null

    private var contributorsValue: List<JsonObject>? = null

    public var contributors: List<JsonObject>?
    ...
    public var directories: JsonObject? = null

    public var dist: JsonObject? = null
    ...
    private var maintainersValue: List<JsonObject>? = null

    public var maintainers: List<JsonObject>?
    ...
    public var repository: JsonObject? = null

    public var scripts: JsonObject? = null

    public var version: String? = null

    public fun build(): InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4 = InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4(
      author = author,
      bin = bin,
      bugs = bugs,
      commitOid = commitOid,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4 must be a JSON object")
      return InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4(
        author = rawObject["author"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<JsonObject?>(element) },
        bin = rawObject["bin"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
        bugs = rawObject["bugs"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<JsonObject?>(element) },
        commitOid = rawObject["commit_oid"]?.let { json.decodeFromJsonElement<String>(it) },
        contributors = rawObject["contributors"]?.let { json.decodeFromJsonElement<List<JsonObject>>(it) },
        ...
        directories = rawObject["directories"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<JsonObject?>(element) },
        dist = rawObject["dist"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<JsonObject?>(element) },
        ...
        maintainers = rawObject["maintainers"]?.let { json.decodeFromJsonElement<List<JsonObject>>(it) },
        ...
        repository = rawObject["repository"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<JsonObject?>(element) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4")
...
public fun inlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4(block: InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4.Builder.() -> Unit): InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4 = InlineWebhookPackagePublishedPackageValuePackageVersionNpmMetadataX632456a4.build(block)
