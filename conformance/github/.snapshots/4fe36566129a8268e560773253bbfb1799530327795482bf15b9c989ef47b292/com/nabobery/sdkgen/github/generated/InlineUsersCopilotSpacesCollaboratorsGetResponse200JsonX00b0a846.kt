...
public class InlineUsersCopilotSpacesCollaboratorsGetResponse200JsonX00b0a846(
  ...
  public class Builder {
    ...
    public var collaborators: List<CopilotSpaceCollaborator>
      get() = requireNotNull(collaboratorsValue) { "collaborators is required" }.toList()
      set(`value`) {
        collaboratorsValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<InlineUsersCopilotSpacesCollaboratorsGetResponse200JsonX00b0a846> {
