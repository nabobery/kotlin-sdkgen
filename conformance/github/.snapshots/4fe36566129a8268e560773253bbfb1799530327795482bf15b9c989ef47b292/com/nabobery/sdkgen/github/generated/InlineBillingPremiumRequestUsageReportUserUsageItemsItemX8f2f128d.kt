...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/billing-premium-request-usage-report-user/properties/usageItems/item
 * s.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/billing-premium-request-usage-report-user/properties/usageItems/item
 * s
 */
@Serializable(with = InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d.Serializer::class)
public class InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d {
      ...
      return InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d")
...
public fun inlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d(block: InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d.Builder.() -> Unit): InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d = InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineBillingPremiumRequestUsageReportUserUsageItemsItemX8f2f128d is missing required property '" + name + "'")
