...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-pinned/properties/issue/allOf/0/properties/rea
 * ctions.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-pinned/properties/issue/allOf/0/properties/rea
 * ctions
 */
@Serializable(with = InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6.Serializer::class)
public class InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6 {
      ...
      return InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6")
...
public fun inlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6(block: InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6.Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6 = InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1ReactionsXe9fec4d6 is missing required property '" + name + "'")
