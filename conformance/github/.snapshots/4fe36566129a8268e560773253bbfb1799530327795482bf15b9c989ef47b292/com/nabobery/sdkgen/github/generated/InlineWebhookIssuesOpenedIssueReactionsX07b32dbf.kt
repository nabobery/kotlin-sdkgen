...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-opened/properties/issue/properties/reactions.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-opened/properties/issue/properties/reactions
 */
@Serializable(with = InlineWebhookIssuesOpenedIssueReactionsX07b32dbf.Serializer::class)
public class InlineWebhookIssuesOpenedIssueReactionsX07b32dbf(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssuesOpenedIssueReactionsX07b32dbf {
      ...
      return InlineWebhookIssuesOpenedIssueReactionsX07b32dbf(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedIssueReactionsX07b32dbf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedIssueReactionsX07b32dbf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedIssueReactionsX07b32dbf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedIssueReactionsX07b32dbf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedIssueReactionsX07b32dbf must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedIssueReactionsX07b32dbf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedIssueReactionsX07b32dbf")
...
public fun inlineWebhookIssuesOpenedIssueReactionsX07b32dbf(block: InlineWebhookIssuesOpenedIssueReactionsX07b32dbf.Builder.() -> Unit): InlineWebhookIssuesOpenedIssueReactionsX07b32dbf = InlineWebhookIssuesOpenedIssueReactionsX07b32dbf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedIssueReactionsX07b32dbf is missing required property '" + name + "'")
