 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_release_1
 */
@Serializable(with = WebhooksRelease1.Serializer::class)
public class WebhooksRelease1 internal constructor(
  assets: List<InlineWebhooksRelease1AssetsItemXf2dba3dc?>,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val assetsUrl: String,
  public val author: InlineWebhooksRelease1AuthorXe6dab8b6?,
  ...
  private val reactionsState: FieldState<InlineWebhooksRelease1ReactionsXf7f8ef63>,
) {
  public val assets: List<InlineWebhooksRelease1AssetsItemXf2dba3dc?> = assets.toList()
  ...
  public val reactions: InlineWebhooksRelease1ReactionsXf7f8ef63?
    get() = reactionsState.valueOrNull()

  public constructor(
    assets: List<InlineWebhooksRelease1AssetsItemXf2dba3dc?>,
    assetsUrl: String,
    author: InlineWebhooksRelease1AuthorXe6dab8b6?,
    body: String?,
    createdAt: String?,
    draft: Boolean,
    htmlUrl: String,
  ...
  public class Builder {
    private var assetsValue: List<InlineWebhooksRelease1AssetsItemXf2dba3dc?>? = null

    public var assets: List<InlineWebhooksRelease1AssetsItemXf2dba3dc?>
    ...
    private var authorState: FieldState<InlineWebhooksRelease1AuthorXe6dab8b6?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var author: InlineWebhooksRelease1AuthorXe6dab8b6?
    ...
    private var reactionsState: FieldState<InlineWebhooksRelease1ReactionsXf7f8ef63> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var reactions: InlineWebhooksRelease1ReactionsXf7f8ef63?
      get() = reactionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): WebhooksRelease1 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhooksRelease1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhooksRelease1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhooksRelease1 {
      val jsonDecoder = decoder.requireJsonDecoder("WebhooksRelease1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhooksRelease1 must be a JSON object")
      val assets = json.decodeRequired<List<InlineWebhooksRelease1AssetsItemXf2dba3dc?>>(rawObject, "assets")
      ...
      if (!rawObject.containsKey("author")) {
        throw SerializationException("WebhooksRelease1 is missing required property 'author'")
      }
      val author = rawObject["author"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksRelease1AuthorXe6dab8b6?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("WebhooksRelease1 is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("WebhooksRelease1 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("name")) {
        throw SerializationException("WebhooksRelease1 is missing required property 'name'")
      }
      ...
      if (!rawObject.containsKey("published_at")) {
        throw SerializationException("WebhooksRelease1 is missing required property 'published_at'")
      }
      ...
      if (!rawObject.containsKey("tarball_url")) {
        throw SerializationException("WebhooksRelease1 is missing required property 'tarball_url'")
      }
      ...
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("WebhooksRelease1 is missing required property 'updated_at'")
      }
      ...
      if (!rawObject.containsKey("zipball_url")) {
        throw SerializationException("WebhooksRelease1 is missing required property 'zipball_url'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: WebhooksRelease1) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhooksRelease1")
...
public fun webhooksRelease1(block: WebhooksRelease1.Builder.() -> Unit): WebhooksRelease1 = WebhooksRelease1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhooksRelease1 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("WebhooksRelease1 property '" + name + "' is not nullable")
