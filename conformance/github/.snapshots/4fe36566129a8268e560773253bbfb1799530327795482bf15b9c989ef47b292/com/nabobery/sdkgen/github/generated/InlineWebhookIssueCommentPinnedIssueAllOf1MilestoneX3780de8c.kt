 ...
 * estone
 */
@Serializable(with = InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c.Serializer::class)
public class InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c(
  /**
  ...
  public val creator: InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580?,
   ...
   */
  public val state: InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneStateXe84ae1c3,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneStateXe84ae1c3? =
        null

    public var state: InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneStateXe84ae1c3
    ...
    private var creatorState:
        FieldState<InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580?
    ...
    public fun build(): InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c {
      ...
      return InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneStateXe84ae1c3>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c")
...
public fun inlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c(block: InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c.Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c = InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneX3780de8c property '" + name + "' is not nullable")
