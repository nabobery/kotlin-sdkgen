 ...
 * e/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestUnlockedPullRequestBaseRepoCreatedAtX94f3ac11,
  /**
  ...
  public val license: InlineWebhookPullRequestUnlockedPullRequestBaseRepoLicenseX2878e588?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestUnlockedPullRequestBaseRepoPushedAtXe7e8af82?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestUnlockedPullRequestBaseRepoVisibilityX2f1b9c19,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessageX5d394d4c>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitleX17cde9ff>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestUnlockedPullRequestBaseRepoPermissionsX5db4189f>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestUnc059PullRequestBasePullRequestCreationP824dX3abd97bb>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUnc059PullRequestBaseSquashMergeCommitMessageX0109eb6b>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUnc059PullRequestBaseRepoSquashMergeCommitTitleX132f8b4d>,
  ...
  public val permissions: InlineWebhookPullRequestUnlockedPullRequestBaseRepoPermissionsX5db4189f?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestUnlockedPullRequestBaseRepoCreatedAtX94f3ac11,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestUnlockedPullRequestBaseRepoLicenseX2878e588?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestUnlockedPullRequestBaseRepoPushedAtXe7e8af82?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestUnlockedPullRequestBaseRepoVisibilityX2f1b9c19,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestUnlockedPullRequestBaseRepoCreatedAtX94f3ac11? = null

    public var createdAt: InlineWebhookPullRequestUnlockedPullRequestBaseRepoCreatedAtX94f3ac11
    ...
    private var visibilityValue:
        InlineWebhookPullRequestUnlockedPullRequestBaseRepoVisibilityX2f1b9c19? = null

    public var visibility: InlineWebhookPullRequestUnlockedPullRequestBaseRepoVisibilityX2f1b9c19
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestUnlockedPullRequestBaseRepoLicenseX2878e588?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestUnlockedPullRequestBaseRepoLicenseX2878e588?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestUnlockedPullRequestBaseRepoPushedAtXe7e8af82?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestUnlockedPullRequestBaseRepoPushedAtXe7e8af82?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestUnlockedPullRequestBaseRepoPermissionsX5db4189f?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 {
      ...
      return InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestUnlockedPullRequestBaseRepoCreatedAtX94f3ac11>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestUnlockedPullRequestBaseRepoVisibilityX2f1b9c19>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestBaseRepoLicenseX2878e588?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestBaseRepoPushedAtXe7e8af82?>(requireNotNull(element)) }
      return InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224")
...
public fun inlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224(block: InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 = InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoX49b61224 property '" + name + "' is not nullable")
