 ...
 * rties/creator
 */
@Serializable(with = InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b.Serializer::class)
public class InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b(
  public val id: Int,
  ...
  public val type: InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorTypeX631bcf72? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorTypeX631bcf72? =
        null
    ...
    public fun build(): InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b must be a JSON object")
      ...
      return InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorTypeX631bcf72>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b")
...
public fun inlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b(block: InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b.Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b = InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentStatusCreatorX8248454b is missing required property '" + name + "'")
