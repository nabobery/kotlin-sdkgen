...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_membership/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_membership/properties/user
 */
@Serializable(with = InlineWebhooksMembershipUserXdc90daf6.Serializer::class)
public class InlineWebhooksMembershipUserXdc90daf6(
  public val id: Long,
  ...
  public val type: InlineWebhooksMembershipUserTypeX98a33378? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksMembershipUserTypeX98a33378? = null
    ...
    public fun build(): InlineWebhooksMembershipUserXdc90daf6 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksMembershipUserXdc90daf6(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksMembershipUserXdc90daf6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksMembershipUserXdc90daf6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksMembershipUserXdc90daf6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksMembershipUserXdc90daf6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksMembershipUserXdc90daf6 must be a JSON object")
      ...
      return InlineWebhooksMembershipUserXdc90daf6(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksMembershipUserTypeX98a33378>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksMembershipUserXdc90daf6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksMembershipUserXdc90daf6")
...
public fun inlineWebhooksMembershipUserXdc90daf6(block: InlineWebhooksMembershipUserXdc90daf6.Builder.() -> Unit): InlineWebhooksMembershipUserXdc90daf6 = InlineWebhooksMembershipUserXdc90daf6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksMembershipUserXdc90daf6 is missing required property '" + name + "'")
