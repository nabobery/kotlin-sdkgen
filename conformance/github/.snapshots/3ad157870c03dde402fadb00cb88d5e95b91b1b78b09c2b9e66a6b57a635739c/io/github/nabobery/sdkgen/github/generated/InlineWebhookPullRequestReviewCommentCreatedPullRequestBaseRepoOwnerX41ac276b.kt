 ...
 * properties/base/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-created/properties/pull_request/
 * properties/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b.Serializer::class)
public class InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe0d91PullRequestBaseRepoOwnerTypeX1bda017f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe0d91PullRequestBaseRepoOwnerTypeX1bda017f? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe0d91PullRequestBaseRepoOwnerTypeX1bda017f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b")
...
public fun inlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b(block: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b = InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b is missing required property '" + name + "'")
