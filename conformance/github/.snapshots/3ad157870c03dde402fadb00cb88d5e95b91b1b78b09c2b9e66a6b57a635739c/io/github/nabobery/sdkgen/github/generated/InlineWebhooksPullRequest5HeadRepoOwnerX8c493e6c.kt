 ...
 * wner
 */
@Serializable(with = InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c.Serializer::class)
public class InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c(
  public val id: Int,
  ...
  public val type: InlineWebhooksPullRequest5HeadRepoOwnerTypeX7b307600? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksPullRequest5HeadRepoOwnerTypeX7b307600? = null
    ...
    public fun build(): InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c must be a JSON object")
      ...
      return InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksPullRequest5HeadRepoOwnerTypeX7b307600>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c")
...
public fun inlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c(block: InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c.Builder.() -> Unit): InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c = InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5HeadRepoOwnerX8c493e6c is missing required property '" + name + "'")
