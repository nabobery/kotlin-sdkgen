...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_team/properties/parent.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_team/properties/parent
 */
@Serializable(with = InlineWebhooksTeamParentX23cdb17a.Serializer::class)
public class InlineWebhooksTeamParentX23cdb17a internal constructor(
  /**
   ...
   */
  public val notificationSetting: InlineWebhooksTeamParentNotificationSettingX543b17c4,
  /**
   * Permission that the team will have for its repositories
   */
  public val permission: String,
  public val privacy: InlineWebhooksTeamParentPrivacyXb491fa22,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
   ...
   */
  public val type: InlineWebhooksTeamParentTypeX4638967e,
  /**
   * URL for the team
   *
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    notificationSetting: InlineWebhooksTeamParentNotificationSettingX543b17c4,
    permission: String,
    privacy: InlineWebhooksTeamParentPrivacyXb491fa22,
    repositoriesUrl: String,
    slug: String,
    type: InlineWebhooksTeamParentTypeX4638967e,
    url: String,
  ...
  public class Builder {
    ...
    private var notificationSettingValue: InlineWebhooksTeamParentNotificationSettingX543b17c4? =
        null

    public var notificationSetting: InlineWebhooksTeamParentNotificationSettingX543b17c4
    ...
    private var privacyValue: InlineWebhooksTeamParentPrivacyXb491fa22? = null

    public var privacy: InlineWebhooksTeamParentPrivacyXb491fa22
    ...
    private var typeValue: InlineWebhooksTeamParentTypeX4638967e? = null

    public var type: InlineWebhooksTeamParentTypeX4638967e
    ...
    public fun build(): InlineWebhooksTeamParentX23cdb17a {
      ...
      return InlineWebhooksTeamParentX23cdb17a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksTeamParentX23cdb17a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksTeamParentX23cdb17a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksTeamParentX23cdb17a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksTeamParentX23cdb17a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksTeamParentX23cdb17a must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val id = json.decodeRequired<Int>(rawObject, "id")
      val membersUrl = json.decodeRequired<String>(rawObject, "members_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      val notificationSetting = json.decodeRequired<InlineWebhooksTeamParentNotificationSettingX543b17c4>(rawObject, "notification_setting")
      val permission = json.decodeRequired<String>(rawObject, "permission")
      val privacy = json.decodeRequired<InlineWebhooksTeamParentPrivacyXb491fa22>(rawObject, "privacy")
      ...
      val type = json.decodeRequired<InlineWebhooksTeamParentTypeX4638967e>(rawObject, "type")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhooksTeamParentX23cdb17a is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksTeamParentX23cdb17a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksTeamParentX23cdb17a")
...
public fun inlineWebhooksTeamParentX23cdb17a(block: InlineWebhooksTeamParentX23cdb17a.Builder.() -> Unit): InlineWebhooksTeamParentX23cdb17a = InlineWebhooksTeamParentX23cdb17a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksTeamParentX23cdb17a is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhooksTeamParentX23cdb17a property '" + name + "' is not nullable")
