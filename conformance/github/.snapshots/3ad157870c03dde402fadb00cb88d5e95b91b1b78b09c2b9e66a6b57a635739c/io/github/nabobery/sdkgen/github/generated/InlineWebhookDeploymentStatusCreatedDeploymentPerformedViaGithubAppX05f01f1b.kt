 ...
 * erformed_via_github_app
 */
@Serializable(with = InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b.Serializer::class)
public class InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b internal constructor(
  /**
  ...
  public val owner: InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppEventsItemX9c49ecb0>>,
  private val permissionsState:
      FieldState<InlineWebhookDeploymentSta5240DeploymentPermissionsX56f1b97f>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppEventsItemX9c49ecb0>>
   ...
   */
  public val events:
      List<InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppEventsItemX9c49ecb0>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookDeploymentSta5240DeploymentPermissionsX56f1b97f?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73?
    ...
    private var permissionsState:
        FieldState<InlineWebhookDeploymentSta5240DeploymentPermissionsX56f1b97f> = FieldState.Absent

    /**
     * The set of permissions for the GitHub app
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookDeploymentSta5240DeploymentPermissionsX56f1b97f?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b {
      ...
      return InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b")
...
public fun inlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b(block: InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b.Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b = InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppX05f01f1b property '" + name + "' is not nullable")
