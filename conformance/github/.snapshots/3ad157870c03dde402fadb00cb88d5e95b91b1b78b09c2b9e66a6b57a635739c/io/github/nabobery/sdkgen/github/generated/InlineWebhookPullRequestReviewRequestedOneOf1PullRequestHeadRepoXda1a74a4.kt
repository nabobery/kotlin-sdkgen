 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoCreatedAtX43418fbc,
  /**
  ...
  public val license:
      InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoLicenseXa3db5b5c?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoPushedAtX3bd22a6a?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoVisibilityX019fe866,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestHeadMergeCommitMessageXd81c64a6>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoMergeCommitTitleX3eee2f65>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoPermissionsXa2775d59>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestPullRequestCreationP824dXff4584f2>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestSquashMergeCommitMessageX7d11cb42>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestSquashMergeCommitTitleX97012f4e>,
  ...
  public val mergeCommitTitle:
      InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoMergeCommitTitleX3eee2f65?
  ...
  public val permissions:
      InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoPermissionsXa2775d59?
  ...
  public val squashMergeCommitTitle:
      InlineWebhookPullRequestReffb1OneOf1PullRequestSquashMergeCommitTitleX97012f4e?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoCreatedAtX43418fbc,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoLicenseXa3db5b5c?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoPushedAtX3bd22a6a?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoVisibilityX019fe866,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoCreatedAtX43418fbc? = null

    public var createdAt: InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoCreatedAtX43418fbc
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoVisibilityX019fe866? = null

    public var visibility:
        InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoVisibilityX019fe866
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoLicenseXa3db5b5c?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9?>
        = FieldState.Absent
     ...
     */
    public var owner:
        InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoPushedAtX3bd22a6a?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoPushedAtX3bd22a6a?
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 {
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoCreatedAtX43418fbc>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoVisibilityX019fe866>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoLicenseXa3db5b5c?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoPushedAtX3bd22a6a?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4(block: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 = InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoXda1a74a4 property '" + name + "' is not nullable")
