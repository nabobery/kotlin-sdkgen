 ...
 * ion/properties/author.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-package-published/properties/package/properties/package_vers
 * ion/properties/author
 */
@Serializable(with = InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4.Serializer::class)
public class InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPackagePublishedPackageValuePackageVersionAuthorTypeXfb41a235? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPackagePublishedPackageValuePackageVersionAuthorTypeXfb41a235? =
        null
    ...
    public fun build(): InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4 must be a JSON object")
      ...
      return InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPackagePublishedPackageValuePackageVersionAuthorTypeXfb41a235>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4")
...
public fun inlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4(block: InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4.Builder.() -> Unit): InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4 = InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPackagePublishedPackageValuePackageVersionAuthorX195921f4 is missing required property '" + name + "'")
