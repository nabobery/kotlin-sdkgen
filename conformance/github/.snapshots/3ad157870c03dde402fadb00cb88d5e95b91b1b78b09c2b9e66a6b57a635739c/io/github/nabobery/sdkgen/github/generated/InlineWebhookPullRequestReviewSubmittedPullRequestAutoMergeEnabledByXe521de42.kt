 ...
 * ties/auto_merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-submitted/properties/pull_request/proper
 * ties/auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42.Serializer::class)
public class InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe5d81PullRequestAutoMergeEnabledByTypeXfc8460fd? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe5d81PullRequestAutoMergeEnabledByTypeXfc8460fd? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe5d81PullRequestAutoMergeEnabledByTypeXfc8460fd>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42")
...
public fun inlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42(block: InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42.Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42 = InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByXe521de42 is missing required property '" + name + "'")
