 ...
 * r
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestDequeuedPullRequestUserTypeXb68a8165? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestDequeuedPullRequestUserTypeXb68a8165? = null
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5 must be a JSON object")
      ...
      return InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestUserTypeXb68a8165>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5")
...
public fun inlineWebhookPullRequestDequeuedPullRequestUserX66a255e5(block: InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5 = InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestUserX66a255e5 is missing required property '" + name + "'")
