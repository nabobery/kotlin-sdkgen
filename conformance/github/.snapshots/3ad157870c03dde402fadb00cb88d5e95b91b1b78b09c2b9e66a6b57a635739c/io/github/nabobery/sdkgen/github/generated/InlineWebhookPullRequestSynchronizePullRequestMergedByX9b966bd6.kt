 ...
 * merged_by
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestSynchronizePullRequestMergedByTypeX31c874aa? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestSynchronizePullRequestMergedByTypeX31c874aa? = null
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6 must be a JSON object")
      ...
      return InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestMergedByTypeX31c874aa>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6")
...
public fun inlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6(block: InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6 = InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestMergedByX9b966bd6 is missing required property '" + name + "'")
