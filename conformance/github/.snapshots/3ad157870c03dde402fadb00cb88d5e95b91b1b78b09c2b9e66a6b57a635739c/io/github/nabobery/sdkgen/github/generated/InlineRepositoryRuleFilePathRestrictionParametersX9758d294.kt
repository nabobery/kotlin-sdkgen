...
public class InlineRepositoryRuleFilePathRestrictionParametersX9758d294(
  ...
  public class Builder {
    ...
    public var restrictedFilePaths: List<String>
      get() = requireNotNull(restrictedFilePathsValue) { "restrictedFilePaths is required" }.toList()
      set(`value`) {
        restrictedFilePathsValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<InlineRepositoryRuleFilePathRestrictionParametersX9758d294> {
