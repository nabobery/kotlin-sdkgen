...
public class InlineUserCodespacesPatchRequestJsonXe8797cb4 internal constructor(
  ...
  recentFoldersState: FieldState<List<String>>,
) {
  private val recentFoldersState: FieldState<List<String>> =
      recentFoldersState.copyValue { fieldValue -> fieldValue.toList() }
  ...
  public class Builder {
    ...
    public var recentFolders: List<String>?
      get() = recentFoldersState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        val present = requireNotNull(value) { "recentFolders is not nullable; call unsetRecentFolders() to omit it" }
        recentFoldersState = FieldState.Value(present.toList())
      }
  ...
  internal object Serializer : KSerializer<InlineUserCodespacesPatchRequestJsonXe8797cb4> {
