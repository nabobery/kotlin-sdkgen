 ...
 * e/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerTypeX7c5b4774? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerTypeX7c5b4774? = null
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99 must be a JSON object")
      ...
      return InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerTypeX7c5b4774>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99")
...
public fun inlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99(block: InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99 = InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99 is missing required property '" + name + "'")
