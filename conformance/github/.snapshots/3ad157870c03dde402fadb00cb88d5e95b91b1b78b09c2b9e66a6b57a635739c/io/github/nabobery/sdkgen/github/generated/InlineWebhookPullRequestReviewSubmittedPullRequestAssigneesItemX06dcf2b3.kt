 ...
 * ties/assignees/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-submitted/properties/pull_request/proper
 * ties/assignees/items
 */
@Serializable(with = InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3.Serializer::class)
public class InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemTypeX90da9fef? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemTypeX90da9fef? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemTypeX90da9fef>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3")
...
public fun inlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3(block: InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3.Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3 = InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3 is missing required property '" + name + "'")
