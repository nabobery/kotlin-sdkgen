 ...
 * o_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByTypeX873897ff? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByTypeX873897ff? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2 must be a JSON object")
      ...
      return InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByTypeX873897ff>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2")
...
public fun inlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2(block: InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2 = InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestAutoMergeEnabledByX4a01e2c2 is missing required property '" + name + "'")
