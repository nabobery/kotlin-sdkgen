 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-code-scanning-alert-created/properties/alert
 */
@Serializable(with = InlineWebhookCodeScanningAlertCreatedAlertXdbeae464.Serializer::class)
public class InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 internal constructor(
  /**
  ...
  public val rule: InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f,
  /**
   ...
   */
  public val state: InlineWebhookCodeScanningAlertCreatedAlertStateXa597c82b?,
  public val tool: InlineWebhookCodeScanningAlertCreatedAlertToolXa6b33f2a?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val mostRecentInstanceState:
      FieldState<InlineWebhookCodeScanningAlertCreatedAlertMostRecentInstanceXc67cad0c?>,
  ...
  public val mostRecentInstance:
      InlineWebhookCodeScanningAlertCreatedAlertMostRecentInstanceXc67cad0c?
  ...
  public constructor(
    ...
    htmlUrl: String,
    number: Int,
    rule: InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f,
    state: InlineWebhookCodeScanningAlertCreatedAlertStateXa597c82b?,
    tool: InlineWebhookCodeScanningAlertCreatedAlertToolXa6b33f2a?,
    url: String,
  ...
  public class Builder {
    ...
    private var ruleValue: InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f? = null

    public var rule: InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f
    ...
    private var stateState: FieldState<InlineWebhookCodeScanningAlertCreatedAlertStateXa597c82b?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var state: InlineWebhookCodeScanningAlertCreatedAlertStateXa597c82b?
      get() = stateState.valueOrNull()
      set(`value`) {
        stateState = value.toNullableFieldState()
      }

    private var toolState: FieldState<InlineWebhookCodeScanningAlertCreatedAlertToolXa6b33f2a?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var tool: InlineWebhookCodeScanningAlertCreatedAlertToolXa6b33f2a?
      get() = toolState.valueOrNull()
      set(`value`) {
        toolState = value.toNullableFieldState()
      }
    ...
    public fun build(): InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 {
      ...
      check(toolState !== FieldState.Absent) { "tool is required, even when null" }
      return InlineWebhookCodeScanningAlertCreatedAlertXdbeae464(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCodeScanningAlertCreatedAlertXdbeae464> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCodeScanningAlertCreatedAlertXdbeae464")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val number = json.decodeRequired<Int>(rawObject, "number")
      val rule = json.decodeRequired<InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f>(rawObject, "rule")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("dismissed_at")) {
        throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 is missing required property 'dismissed_at'")
      }
      ...
      if (!rawObject.containsKey("dismissed_by")) {
        throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 is missing required property 'dismissed_by'")
      }
      ...
      if (!rawObject.containsKey("dismissed_reason")) {
        throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 is missing required property 'dismissed_reason'")
      }
      ...
      if (!rawObject.containsKey("state")) {
        throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 is missing required property 'state'")
      }
      val state = rawObject["state"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCodeScanningAlertCreatedAlertStateXa597c82b?>(requireNotNull(element)) }
      if (!rawObject.containsKey("tool")) {
        throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 is missing required property 'tool'")
      }
      val tool = rawObject["tool"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCodeScanningAlertCreatedAlertToolXa6b33f2a?>(requireNotNull(element)) }
      return InlineWebhookCodeScanningAlertCreatedAlertXdbeae464(
        createdAt = createdAt,
        dismissedAt = dismissedAt,
        dismissedBy = dismissedBy,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookCodeScanningAlertCreatedAlertXdbeae464) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCodeScanningAlertCreatedAlertXdbeae464")
      ...
      val raw = buildJsonObject {
        ...
        put("tool", value.tool?.let { json.encodeToJsonElement(it) } ?: JsonNull)
        put("url", value.url)
...
public fun inlineWebhookCodeScanningAlertCreatedAlertXdbeae464(block: InlineWebhookCodeScanningAlertCreatedAlertXdbeae464.Builder.() -> Unit): InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 = InlineWebhookCodeScanningAlertCreatedAlertXdbeae464.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertXdbeae464 property '" + name + "' is not nullable")
