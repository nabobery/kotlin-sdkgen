...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-untyped.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-untyped
 */
@Serializable(with = WebhookIssuesUntyped.Serializer::class)
public class WebhookIssuesUntyped internal constructor(
  public val action: InlineWebhookIssuesUntypedActionX75e245c1,
  ...
  public constructor(
    action: InlineWebhookIssuesUntypedActionX75e245c1,
    issue: WebhooksIssue,
  ...
  public class Builder {
    private var actionValue: InlineWebhookIssuesUntypedActionX75e245c1? = null

    public var action: InlineWebhookIssuesUntypedActionX75e245c1
    ...
    public fun build(): WebhookIssuesUntyped {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhookIssuesUntyped = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhookIssuesUntyped> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhookIssuesUntyped {
      val jsonDecoder = decoder.requireJsonDecoder("WebhookIssuesUntyped")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhookIssuesUntyped must be a JSON object")
      val action = json.decodeRequired<InlineWebhookIssuesUntypedActionX75e245c1>(rawObject, "action")
      val issue = json.decodeRequired<WebhooksIssue>(rawObject, "issue")
      val repository = json.decodeRequired<RepositoryWebhooks>(rawObject, "repository")
      val sender = json.decodeRequired<SimpleUser>(rawObject, "sender")
      if (!rawObject.containsKey("type")) {
        throw SerializationException("WebhookIssuesUntyped is missing required property 'type'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: WebhookIssuesUntyped) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhookIssuesUntyped")
...
public fun webhookIssuesUntyped(block: WebhookIssuesUntyped.Builder.() -> Unit): WebhookIssuesUntyped = WebhookIssuesUntyped.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhookIssuesUntyped is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("WebhookIssuesUntyped property '" + name + "' is not nullable")
