 ...
 * signee
 */
@Serializable(with = InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e.Serializer::class)
public class InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeTypeX789794db? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeTypeX789794db? = null
    ...
    public fun build(): InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e must be a JSON object")
      ...
      return InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeTypeX789794db>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e")
...
public fun inlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e(block: InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e.Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e = InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e is missing required property '" + name + "'")
