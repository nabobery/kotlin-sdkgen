...
public class GistSimple(
  ...
  public val files: Map<String, InlineGistSimpleFilesAdditionalValueX30d0d80a?>? =
      files?.let { collection0 -> collection0.toMap() }

  public val forks: List<InlineGistSimpleForksItemXe5a796ed>? =
      forks?.let { collection0 -> collection0.toList() }

  public val history: List<GistHistory>? = history?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    private var filesValue: Map<String, InlineGistSimpleFilesAdditionalValueX30d0d80a?>? = null

    public var files: Map<String, InlineGistSimpleFilesAdditionalValueX30d0d80a?>?
      get() = filesValue?.let { collection0 -> collection0.toMap() }
      set(`value`) {
        filesValue = value?.let { collection0 -> collection0.toMap() }
      }
    ...
    private var forksValue: List<InlineGistSimpleForksItemXe5a796ed>? = null

    public var forks: List<InlineGistSimpleForksItemXe5a796ed>?
      get() = forksValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        forksValue = value?.let { collection0 -> collection0.toList() }
      }
    ...
    private var historyValue: List<GistHistory>? = null

    public var history: List<GistHistory>?
      get() = historyValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        historyValue = value?.let { collection0 -> collection0.toList() }
      }
  ...
  internal object Serializer : KSerializer<GistSimple> {
