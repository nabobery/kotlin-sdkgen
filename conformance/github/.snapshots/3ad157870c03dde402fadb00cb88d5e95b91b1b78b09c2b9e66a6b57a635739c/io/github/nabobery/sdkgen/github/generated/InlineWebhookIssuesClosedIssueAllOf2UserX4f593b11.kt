...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-closed/properties/issue/allOf/1/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-closed/properties/issue/allOf/1/properties/user
 */
@Serializable(with = InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11.Serializer::class)
public class InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11 = InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11 must be a JSON object")
      return InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11")
...
public fun inlineWebhookIssuesClosedIssueAllOf2UserX4f593b11(block: InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11.Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11 = InlineWebhookIssuesClosedIssueAllOf2UserX4f593b11.build(block)
