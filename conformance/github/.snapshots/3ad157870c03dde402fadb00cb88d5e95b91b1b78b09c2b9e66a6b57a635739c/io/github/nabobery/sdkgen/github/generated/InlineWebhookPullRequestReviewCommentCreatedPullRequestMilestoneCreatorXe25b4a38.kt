 ...
 * properties/milestone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-created/properties/pull_request/
 * properties/milestone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38.Serializer::class)
public class InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe0d91PullRequestMilestoneCreatorTypeX8376e87b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe0d91PullRequestMilestoneCreatorTypeX8376e87b? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe0d91PullRequestMilestoneCreatorTypeX8376e87b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38")
...
public fun inlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38(block: InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38 = InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorXe25b4a38 is missing required property '" + name + "'")
