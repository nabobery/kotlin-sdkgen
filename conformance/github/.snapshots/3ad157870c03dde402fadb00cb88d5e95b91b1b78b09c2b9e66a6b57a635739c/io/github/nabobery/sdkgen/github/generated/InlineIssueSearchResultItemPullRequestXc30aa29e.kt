...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/issue-search-result-item/properties/pull_request.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/issue-search-result-item/properties/pull_request
 */
@Serializable(with = InlineIssueSearchResultItemPullRequestXc30aa29e.Serializer::class)
public class InlineIssueSearchResultItemPullRequestXc30aa29e internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineIssueSearchResultItemPullRequestXc30aa29e {
      ...
      return InlineIssueSearchResultItemPullRequestXc30aa29e(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineIssueSearchResultItemPullRequestXc30aa29e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineIssueSearchResultItemPullRequestXc30aa29e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineIssueSearchResultItemPullRequestXc30aa29e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineIssueSearchResultItemPullRequestXc30aa29e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineIssueSearchResultItemPullRequestXc30aa29e must be a JSON object")
      if (!rawObject.containsKey("diff_url")) {
        throw SerializationException("InlineIssueSearchResultItemPullRequestXc30aa29e is missing required property 'diff_url'")
      }
      ...
      if (!rawObject.containsKey("html_url")) {
        throw SerializationException("InlineIssueSearchResultItemPullRequestXc30aa29e is missing required property 'html_url'")
      }
      ...
      if (!rawObject.containsKey("patch_url")) {
        throw SerializationException("InlineIssueSearchResultItemPullRequestXc30aa29e is missing required property 'patch_url'")
      }
      ...
      if (!rawObject.containsKey("url")) {
        throw SerializationException("InlineIssueSearchResultItemPullRequestXc30aa29e is missing required property 'url'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineIssueSearchResultItemPullRequestXc30aa29e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineIssueSearchResultItemPullRequestXc30aa29e")
...
public fun inlineIssueSearchResultItemPullRequestXc30aa29e(block: InlineIssueSearchResultItemPullRequestXc30aa29e.Builder.() -> Unit): InlineIssueSearchResultItemPullRequestXc30aa29e = InlineIssueSearchResultItemPullRequestXc30aa29e.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineIssueSearchResultItemPullRequestXc30aa29e property '" + name + "' is not nullable")
