 ...
 * ties/base/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-dismissed/properties/pull_request/proper
 * ties/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e.Serializer::class)
public class InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerTypeXdb294992? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerTypeXdb294992? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerTypeXdb294992>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e")
...
public fun inlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e(block: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e.Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e = InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e is missing required property '" + name + "'")
