 ...
 */
@Serializable(with = InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971.Serializer::class)
public class InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971(
  /**
  ...
  public val creator: InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d?,
   ...
   */
  public val state: InlineWebhookIssuesClosedIssueAllOf1MilestoneStateXca2a563b,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssuesClosedIssueAllOf1MilestoneStateXca2a563b? = null

    public var state: InlineWebhookIssuesClosedIssueAllOf1MilestoneStateXca2a563b
    ...
    private var creatorState:
        FieldState<InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d?
    ...
    public fun build(): InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971 {
      ...
      return InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssuesClosedIssueAllOf1MilestoneStateXca2a563b>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971")
...
public fun inlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971(block: InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971.Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971 = InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971 property '" + name + "' is not nullable")
