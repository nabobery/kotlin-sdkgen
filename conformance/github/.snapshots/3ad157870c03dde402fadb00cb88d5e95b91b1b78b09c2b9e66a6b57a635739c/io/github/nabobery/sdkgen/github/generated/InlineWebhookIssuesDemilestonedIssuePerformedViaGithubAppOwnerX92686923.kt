 ...
 * a_github_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-demilestoned/properties/issue/properties/performed_vi
 * a_github_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923.Serializer::class)
public class InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerTypeXf4da95f5? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerTypeXf4da95f5? =
        null
    ...
    public fun build(): InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923 must be a JSON object")
      ...
      return InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerTypeXf4da95f5>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923")
...
public fun inlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923(block: InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923.Builder.() -> Unit): InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923 = InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923 is missing required property '" + name + "'")
