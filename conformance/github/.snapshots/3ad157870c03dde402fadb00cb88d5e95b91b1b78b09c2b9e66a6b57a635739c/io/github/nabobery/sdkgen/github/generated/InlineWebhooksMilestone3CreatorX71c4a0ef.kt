...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_milestone_3/properties/creator.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_milestone_3/properties/creator
 */
@Serializable(with = InlineWebhooksMilestone3CreatorX71c4a0ef.Serializer::class)
public class InlineWebhooksMilestone3CreatorX71c4a0ef(
  public val id: Int,
  ...
  public val type: InlineWebhooksMilestone3CreatorTypeXa7c11e5a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksMilestone3CreatorTypeXa7c11e5a? = null
    ...
    public fun build(): InlineWebhooksMilestone3CreatorX71c4a0ef {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksMilestone3CreatorX71c4a0ef(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksMilestone3CreatorX71c4a0ef = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksMilestone3CreatorX71c4a0ef> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksMilestone3CreatorX71c4a0ef {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksMilestone3CreatorX71c4a0ef")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksMilestone3CreatorX71c4a0ef must be a JSON object")
      ...
      return InlineWebhooksMilestone3CreatorX71c4a0ef(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksMilestone3CreatorTypeXa7c11e5a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksMilestone3CreatorX71c4a0ef) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksMilestone3CreatorX71c4a0ef")
...
public fun inlineWebhooksMilestone3CreatorX71c4a0ef(block: InlineWebhooksMilestone3CreatorX71c4a0ef.Builder.() -> Unit): InlineWebhooksMilestone3CreatorX71c4a0ef = InlineWebhooksMilestone3CreatorX71c4a0ef.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksMilestone3CreatorX71c4a0ef is missing required property '" + name + "'")
