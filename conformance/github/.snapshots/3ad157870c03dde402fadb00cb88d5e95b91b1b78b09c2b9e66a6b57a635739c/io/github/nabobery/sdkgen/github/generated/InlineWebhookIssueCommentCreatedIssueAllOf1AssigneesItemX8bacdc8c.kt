 ...
 * signees/items
 */
@Serializable(with = InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c.Serializer::class)
public class InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemTypeX173683ec? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemTypeX173683ec? = null
    ...
    public fun build(): InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c must be a JSON object")
      ...
      return InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemTypeX173683ec>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c")
...
public fun inlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c(block: InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c.Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c = InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c is missing required property '" + name + "'")
