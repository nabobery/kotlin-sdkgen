...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-created/properties/issue/allOf/0/properties/us
 * er.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-created/properties/issue/allOf/0/properties/us
 * er
 */
@Serializable(with = InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f.Serializer::class)
public class InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f(
  public val id: Long,
  ...
  public val type: InlineWebhookIssueCommentCreatedIssueAllOf1UserTypeXb3d06fc7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentCreatedIssueAllOf1UserTypeXb3d06fc7? = null
    ...
    public fun build(): InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f must be a JSON object")
      ...
      return InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedIssueAllOf1UserTypeXb3d06fc7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f")
...
public fun inlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f(block: InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f.Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f = InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f is missing required property '" + name + "'")
