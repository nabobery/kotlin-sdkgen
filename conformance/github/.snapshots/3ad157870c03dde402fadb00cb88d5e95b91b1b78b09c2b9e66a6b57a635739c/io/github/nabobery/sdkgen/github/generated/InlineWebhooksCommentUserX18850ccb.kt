...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_comment/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_comment/properties/user
 */
@Serializable(with = InlineWebhooksCommentUserX18850ccb.Serializer::class)
public class InlineWebhooksCommentUserX18850ccb(
  public val id: Long,
  ...
  public val type: InlineWebhooksCommentUserTypeX4f3017de? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksCommentUserTypeX4f3017de? = null
    ...
    public fun build(): InlineWebhooksCommentUserX18850ccb {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksCommentUserX18850ccb(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksCommentUserX18850ccb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksCommentUserX18850ccb> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksCommentUserX18850ccb {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksCommentUserX18850ccb")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksCommentUserX18850ccb must be a JSON object")
      ...
      return InlineWebhooksCommentUserX18850ccb(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksCommentUserTypeX4f3017de>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksCommentUserX18850ccb) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksCommentUserX18850ccb")
...
public fun inlineWebhooksCommentUserX18850ccb(block: InlineWebhooksCommentUserX18850ccb.Builder.() -> Unit): InlineWebhooksCommentUserX18850ccb = InlineWebhooksCommentUserX18850ccb.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksCommentUserX18850ccb is missing required property '" + name + "'")
