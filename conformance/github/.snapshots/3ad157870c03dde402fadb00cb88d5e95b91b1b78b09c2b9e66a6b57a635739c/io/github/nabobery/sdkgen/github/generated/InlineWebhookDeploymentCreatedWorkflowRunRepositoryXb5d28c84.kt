 ...
 * tory
 */
@Serializable(with = InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84.Serializer::class)
public class InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84(
  ...
  public val owner: InlineWebhookDeploymentCreatedWorkflowRunRepositoryOwnerX5ce80a9c? = null,
  ...
  public class Builder {
    ...
    public var owner: InlineWebhookDeploymentCreatedWorkflowRunRepositoryOwnerX5ce80a9c? = null
    ...
    public fun build(): InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84 = InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84 must be a JSON object")
      return InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84(
        ...
        owner = rawObject["owner"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentCreatedWorkflowRunRepositoryOwnerX5ce80a9c>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84")
...
public fun inlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84(block: InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84.Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84 = InlineWebhookDeploymentCreatedWorkflowRunRepositoryXb5d28c84.build(block)
