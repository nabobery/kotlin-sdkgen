 ...
 * request/properties/requested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-request-removed/oneOf/0/properties/pull_
 * request/properties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7.Serializer::class)
public class InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersTypeX0abf9224? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersTypeX0abf9224?
        = null
    ...
    public fun build(): InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7 must be a JSON object")
      ...
      return InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersTypeX0abf9224>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7")
...
public fun inlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7(block: InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7.Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7 = InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedReviewersOneOf1X3dc28ce7 is missing required property '" + name + "'")
