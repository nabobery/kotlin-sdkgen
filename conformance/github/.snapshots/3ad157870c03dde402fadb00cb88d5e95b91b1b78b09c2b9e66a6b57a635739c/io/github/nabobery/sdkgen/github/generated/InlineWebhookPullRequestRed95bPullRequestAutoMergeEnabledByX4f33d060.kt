 ...
 * roperties/auto_merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-edited/properties/pull_request/p
 * roperties/auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060.Serializer::class)
public class InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByTypeX803f9a45? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByTypeX803f9a45? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060 must be a JSON object")
      ...
      return InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByTypeX803f9a45>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060")
...
public fun inlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060(block: InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060.Builder.() -> Unit): InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060 = InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRed95bPullRequestAutoMergeEnabledByX4f33d060 is missing required property '" + name + "'")
