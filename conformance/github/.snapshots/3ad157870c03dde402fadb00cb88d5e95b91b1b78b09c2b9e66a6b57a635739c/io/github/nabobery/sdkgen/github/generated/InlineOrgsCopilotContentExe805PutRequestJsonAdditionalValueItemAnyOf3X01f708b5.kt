...
public class InlineOrgsCopilotContentExe805PutRequestJsonAdditionalValueItemAnyOf3X01f708b5(
  ...
  public class Builder {
    ...
    public var ifNoneMatch: List<String>
      get() = requireNotNull(ifNoneMatchValue) { "ifNoneMatch is required" }.toList()
      set(`value`) {
        ifNoneMatchValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<InlineOrgsCopilotContentExe805PutRequestJsonAdditionalValueItemAnyOf3X01f708b5> {
