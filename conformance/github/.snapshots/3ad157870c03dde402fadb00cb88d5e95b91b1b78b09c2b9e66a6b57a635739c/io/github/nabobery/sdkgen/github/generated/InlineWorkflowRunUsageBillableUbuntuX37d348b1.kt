...
public class InlineWorkflowRunUsageBillableUbuntuX37d348b1(
  ...
  jobRuns: List<InlineWorkflowRunUsageBillableUbuntuJobRunsItemX304343e3>? = null,
) {
  public val jobRuns: List<InlineWorkflowRunUsageBillableUbuntuJobRunsItemX304343e3>? =
  ...
  public class Builder {
    ...
    private var jobRunsValue: List<InlineWorkflowRunUsageBillableUbuntuJobRunsItemX304343e3>? = null

    public var jobRuns: List<InlineWorkflowRunUsageBillableUbuntuJobRunsItemX304343e3>?
  ...
  internal object Serializer : KSerializer<InlineWorkflowRunUsageBillableUbuntuX37d348b1> {
