 ...
 * pository/properties/owner
 */
@Serializable(with = InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f.Serializer::class)
public class InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f(
  public val id: Int,
  ...
  public val type: InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerTypeXd7dbe77a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerTypeXd7dbe77a? =
        null
    ...
    public fun build(): InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f must be a JSON object")
      ...
      return InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerTypeXd7dbe77a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f")
...
public fun inlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f(block: InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f.Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f = InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f is missing required property '" + name + "'")
