 ...
 * es/creator
 */
@Serializable(with = InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb.Serializer::class)
public class InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesOpenedIssueMilestoneCreatorTypeXd74dc15a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesOpenedIssueMilestoneCreatorTypeXd74dc15a? = null
    ...
    public fun build(): InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb must be a JSON object")
      ...
      return InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesOpenedIssueMilestoneCreatorTypeXd74dc15a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb")
...
public fun inlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb(block: InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb.Builder.() -> Unit): InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb = InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb is missing required property '" + name + "'")
