 ...
 * tone
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96(
  /**
  ...
  public val creator: InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89?,
   ...
   */
  public val state: InlineWebhookPullRequestLockedPullRequestMilestoneStateX3b7a0e44,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookPullRequestLockedPullRequestMilestoneStateX3b7a0e44? = null

    public var state: InlineWebhookPullRequestLockedPullRequestMilestoneStateX3b7a0e44
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89?
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96 {
      ...
      return InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestLockedPullRequestMilestoneStateX3b7a0e44>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96")
...
public fun inlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96(block: InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96 = InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestLockedPullRequestMilestoneXd0f6dd96 property '" + name + "' is not nullable")
