 ...
 * wner
 */
@Serializable(with = InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a.Serializer::class)
public class InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a(
  public val id: Int,
  ...
  public val type: InlineWebhooksPullRequest5BaseRepoOwnerTypeX2656ca95? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksPullRequest5BaseRepoOwnerTypeX2656ca95? = null
    ...
    public fun build(): InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a must be a JSON object")
      ...
      return InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksPullRequest5BaseRepoOwnerTypeX2656ca95>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a")
...
public fun inlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a(block: InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a.Builder.() -> Unit): InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a = InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5BaseRepoOwnerX48fcaa0a is missing required property '" + name + "'")
