 ...
 * t/properties/auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2.Serializer::class)
public class InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByTypeXde002230? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByTypeXde002230? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2 must be a JSON object")
      ...
      return InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByTypeXde002230>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2")
...
public fun inlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2(block: InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2.Builder.() -> Unit): InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2 = InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe5e87PullRequestAutoMergeEnabledByX62a384a2 is missing required property '" + name + "'")
