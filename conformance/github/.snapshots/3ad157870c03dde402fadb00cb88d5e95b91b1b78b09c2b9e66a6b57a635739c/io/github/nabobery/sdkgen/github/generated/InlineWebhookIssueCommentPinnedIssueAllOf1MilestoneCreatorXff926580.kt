 ...
 * estone/properties/creator
 */
@Serializable(with = InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580.Serializer::class)
public class InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorTypeX4892a8b5? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorTypeX4892a8b5? = null
    ...
    public fun build(): InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580 must be a JSON object")
      ...
      return InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorTypeX4892a8b5>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580")
...
public fun inlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580(block: InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580.Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580 = InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1MilestoneCreatorXff926580 is missing required property '" + name + "'")
