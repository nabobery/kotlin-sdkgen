 ...
 * A git repository
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-push/properties/repository
 */
@Serializable(with = InlineWebhookPushRepositoryXe37d7d2d.Serializer::class)
public class InlineWebhookPushRepositoryXe37d7d2d internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPushRepositoryCreatedAtX3f1f1ae2,
  /**
  ...
  public val license: InlineWebhookPushRepositoryLicenseX7dda1e6e?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPushRepositoryOwnerX679ba505?,
  /**
  ...
  public val pushedAt: InlineWebhookPushRepositoryPushedAtX6596fb3c?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPushRepositoryVisibilityX1686edcd,
  ...
  private val permissionsState: FieldState<InlineWebhookPushRepositoryPermissionsXf2e0de30>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPushRepositoryPullRequestCreationPolicyXcf779631>,
  ...
  public val permissions: InlineWebhookPushRepositoryPermissionsXf2e0de30?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPushRepositoryCreatedAtX3f1f1ae2,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPushRepositoryLicenseX7dda1e6e?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPushRepositoryOwnerX679ba505?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPushRepositoryPushedAtX6596fb3c?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPushRepositoryVisibilityX1686edcd,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookPushRepositoryCreatedAtX3f1f1ae2? = null

    public var createdAt: InlineWebhookPushRepositoryCreatedAtX3f1f1ae2
    ...
    private var visibilityValue: InlineWebhookPushRepositoryVisibilityX1686edcd? = null

    public var visibility: InlineWebhookPushRepositoryVisibilityX1686edcd
    ...
    private var licenseState: FieldState<InlineWebhookPushRepositoryLicenseX7dda1e6e?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPushRepositoryLicenseX7dda1e6e?
    ...
    private var ownerState: FieldState<InlineWebhookPushRepositoryOwnerX679ba505?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPushRepositoryOwnerX679ba505?
      get() = ownerState.valueOrNull()
      set(`value`) {
        ownerState = value.toNullableFieldState()
      }

    private var pushedAtState: FieldState<InlineWebhookPushRepositoryPushedAtX6596fb3c?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPushRepositoryPushedAtX6596fb3c?
    ...
    private var permissionsState: FieldState<InlineWebhookPushRepositoryPermissionsXf2e0de30> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPushRepositoryPermissionsXf2e0de30?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPushRepositoryXe37d7d2d {
      ...
      return InlineWebhookPushRepositoryXe37d7d2d(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPushRepositoryXe37d7d2d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPushRepositoryXe37d7d2d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPushRepositoryXe37d7d2d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPushRepositoryXe37d7d2d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPushRepositoryXe37d7d2d must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPushRepositoryCreatedAtX3f1f1ae2>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPushRepositoryVisibilityX1686edcd>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPushRepositoryXe37d7d2d is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPushRepositoryXe37d7d2d is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPushRepositoryXe37d7d2d is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPushRepositoryXe37d7d2d is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPushRepositoryLicenseX7dda1e6e?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPushRepositoryXe37d7d2d is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPushRepositoryXe37d7d2d is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPushRepositoryOwnerX679ba505?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPushRepositoryXe37d7d2d is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPushRepositoryPushedAtX6596fb3c?>(requireNotNull(element)) }
      return InlineWebhookPushRepositoryXe37d7d2d(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPushRepositoryXe37d7d2d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPushRepositoryXe37d7d2d")
...
public fun inlineWebhookPushRepositoryXe37d7d2d(block: InlineWebhookPushRepositoryXe37d7d2d.Builder.() -> Unit): InlineWebhookPushRepositoryXe37d7d2d = InlineWebhookPushRepositoryXe37d7d2d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPushRepositoryXe37d7d2d is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPushRepositoryXe37d7d2d property '" + name + "' is not nullable")
