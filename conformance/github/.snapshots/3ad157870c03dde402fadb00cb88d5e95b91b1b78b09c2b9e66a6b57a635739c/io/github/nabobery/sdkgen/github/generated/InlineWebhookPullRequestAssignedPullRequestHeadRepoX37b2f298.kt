 ...
 * d/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestAssignedPullRequestHeadRepoCreatedAtX270e2e37,
  /**
  ...
  public val license: InlineWebhookPullRequestAssignedPullRequestHeadRepoLicenseX10ec8a4d?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestAssignedPullRequestHeadRepoPushedAtX6b3cfed2?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestAssignedPullRequestHeadRepoVisibilityX469c779c,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessageX4558f619>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitleX4abcf564>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestAssignedPullRequestHeadRepoPermissionsX107a8613>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestAsbb98PullRequestHeadPullRequestCreationP824dXb1840b82>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestAsbb98PullRequestHeadSquashMergeCommitMessageX710f8a2b>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestAsbb98PullRequestHeadRepoSquashMergeCommitTitleX21df56dd>,
  ...
  public val permissions: InlineWebhookPullRequestAssignedPullRequestHeadRepoPermissionsX107a8613?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestAssignedPullRequestHeadRepoCreatedAtX270e2e37,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestAssignedPullRequestHeadRepoLicenseX10ec8a4d?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestAssignedPullRequestHeadRepoPushedAtX6b3cfed2?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestAssignedPullRequestHeadRepoVisibilityX469c779c,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestAssignedPullRequestHeadRepoCreatedAtX270e2e37? = null

    public var createdAt: InlineWebhookPullRequestAssignedPullRequestHeadRepoCreatedAtX270e2e37
    ...
    private var visibilityValue:
        InlineWebhookPullRequestAssignedPullRequestHeadRepoVisibilityX469c779c? = null

    public var visibility: InlineWebhookPullRequestAssignedPullRequestHeadRepoVisibilityX469c779c
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestAssignedPullRequestHeadRepoLicenseX10ec8a4d?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestAssignedPullRequestHeadRepoLicenseX10ec8a4d?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestAssignedPullRequestHeadRepoPushedAtX6b3cfed2?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestAssignedPullRequestHeadRepoPushedAtX6b3cfed2?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestAssignedPullRequestHeadRepoPermissionsX107a8613?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 {
      ...
      return InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestAssignedPullRequestHeadRepoCreatedAtX270e2e37>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestAssignedPullRequestHeadRepoVisibilityX469c779c>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestHeadRepoLicenseX10ec8a4d?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestHeadRepoPushedAtX6b3cfed2?>(requireNotNull(element)) }
      return InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298")
...
public fun inlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298(block: InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 = InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoX37b2f298 property '" + name + "' is not nullable")
