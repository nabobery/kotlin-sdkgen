...
public class RuleSuite(
  ...
  ruleEvaluations: List<InlineRuleSuiteRuleEvaluationsItemX419ab29d>? = null,
) {
  /**
   * Details on the evaluated rules.
   */
  public val ruleEvaluations: List<InlineRuleSuiteRuleEvaluationsItemX419ab29d>? =
      ruleEvaluations?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    private var ruleEvaluationsValue: List<InlineRuleSuiteRuleEvaluationsItemX419ab29d>? = null

    /**
     * Details on the evaluated rules.
     */
    public var ruleEvaluations: List<InlineRuleSuiteRuleEvaluationsItemX419ab29d>?
      get() = ruleEvaluationsValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        ruleEvaluationsValue = value?.let { collection0 -> collection0.toList() }
      }
  ...
  internal object Serializer : KSerializer<RuleSuite> {
