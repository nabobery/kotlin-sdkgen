 ...
 * properties/repo
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestLockedPullRequestHeadRepoCreatedAtX0c88c7d3,
  /**
  ...
  public val license: InlineWebhookPullRequestLockedPullRequestHeadRepoLicenseXc3ec22c0?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestLockedPullRequestHeadRepoPushedAtX16da6887?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestLockedPullRequestHeadRepoVisibilityX32040539,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessageXc5fb991d>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitleXb12fd0b8>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestLockedPullRequestHeadRepoPermissionsX427f5d6f>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestLockedPullRequestHeadPullRequestCreationP824dX3d968f30>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestLockedPullRequestHeadSquashMergeCommitMessageX759159b0>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitleX08706ec0>,
  ...
  public val permissions: InlineWebhookPullRequestLockedPullRequestHeadRepoPermissionsX427f5d6f?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestLockedPullRequestHeadRepoCreatedAtX0c88c7d3,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestLockedPullRequestHeadRepoLicenseXc3ec22c0?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestLockedPullRequestHeadRepoPushedAtX16da6887?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestLockedPullRequestHeadRepoVisibilityX32040539,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookPullRequestLockedPullRequestHeadRepoCreatedAtX0c88c7d3?
        = null

    public var createdAt: InlineWebhookPullRequestLockedPullRequestHeadRepoCreatedAtX0c88c7d3
    ...
    private var visibilityValue:
        InlineWebhookPullRequestLockedPullRequestHeadRepoVisibilityX32040539? = null

    public var visibility: InlineWebhookPullRequestLockedPullRequestHeadRepoVisibilityX32040539
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestLockedPullRequestHeadRepoLicenseXc3ec22c0?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestLockedPullRequestHeadRepoLicenseXc3ec22c0?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestLockedPullRequestHeadRepoPushedAtX16da6887?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestLockedPullRequestHeadRepoPushedAtX16da6887?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestLockedPullRequestHeadRepoPermissionsX427f5d6f?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 {
      ...
      return InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestLockedPullRequestHeadRepoCreatedAtX0c88c7d3>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestLockedPullRequestHeadRepoVisibilityX32040539>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestHeadRepoLicenseXc3ec22c0?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestHeadRepoPushedAtX16da6887?>(requireNotNull(element)) }
      return InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60")
...
public fun inlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60(block: InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 = InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoX3d92ac60 property '" + name + "' is not nullable")
