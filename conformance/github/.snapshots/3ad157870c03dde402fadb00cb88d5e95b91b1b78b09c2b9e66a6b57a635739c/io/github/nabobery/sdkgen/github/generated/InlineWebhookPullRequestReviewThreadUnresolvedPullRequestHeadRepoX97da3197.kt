 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197.Serializer::class)
public class InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestRe5e87PullRequestHeadRepoCreatedAtX9e57c4ee,
  /**
  ...
  public val license: InlineWebhookPullRequestRe5e87PullRequestHeadRepoLicenseX57c57a5b?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner:
      InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestRe5e87PullRequestHeadRepoPushedAtXc275d343?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestRe5e87PullRequestHeadRepoVisibilityX63ec17d1,
  ...
  private val permissionsState:
      FieldState<InlineWebhookPullRequestRe5e87PullRequestHeadRepoPermissionsX83cec082>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe5e87PullRequestHeadPullRequestCreationP824dX181af473>,
  ...
  public val permissions: InlineWebhookPullRequestRe5e87PullRequestHeadRepoPermissionsX83cec082?
  ...
  public val pullRequestCreationPolicy:
      InlineWebhookPullRequestRe5e87PullRequestHeadPullRequestCreationP824dX181af473?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestRe5e87PullRequestHeadRepoCreatedAtX9e57c4ee,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestRe5e87PullRequestHeadRepoLicenseX57c57a5b?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestRe5e87PullRequestHeadRepoPushedAtXc275d343?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestRe5e87PullRequestHeadRepoVisibilityX63ec17d1,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookPullRequestRe5e87PullRequestHeadRepoCreatedAtX9e57c4ee?
        = null

    public var createdAt: InlineWebhookPullRequestRe5e87PullRequestHeadRepoCreatedAtX9e57c4ee
    ...
    private var visibilityValue:
        InlineWebhookPullRequestRe5e87PullRequestHeadRepoVisibilityX63ec17d1? = null

    public var visibility: InlineWebhookPullRequestRe5e87PullRequestHeadRepoVisibilityX63ec17d1
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestRe5e87PullRequestHeadRepoLicenseX57c57a5b?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestRe5e87PullRequestHeadRepoLicenseX57c57a5b?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a?>
        = FieldState.Absent
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestRe5e87PullRequestHeadRepoPushedAtXc275d343?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestRe5e87PullRequestHeadRepoPushedAtXc275d343?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestRe5e87PullRequestHeadRepoPermissionsX83cec082?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 {
      ...
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestRe5e87PullRequestHeadRepoCreatedAtX9e57c4ee>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestRe5e87PullRequestHeadRepoVisibilityX63ec17d1>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestRe5e87PullRequestHeadRepoLicenseX57c57a5b?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestRe5e87PullRequestHeadRepoPushedAtXc275d343?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197")
...
public fun inlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197(block: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoX97da3197 property '" + name + "' is not nullable")
