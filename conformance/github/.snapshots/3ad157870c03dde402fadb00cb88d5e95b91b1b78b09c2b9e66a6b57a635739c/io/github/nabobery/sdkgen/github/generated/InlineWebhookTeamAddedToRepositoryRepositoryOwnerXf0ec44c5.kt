 ...
 * ner
 */
@Serializable(with = InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5.Serializer::class)
public class InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5(
  public val id: Int,
  ...
  public val type: InlineWebhookTeamAddedToRepositoryRepositoryOwnerTypeXe56695d2? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookTeamAddedToRepositoryRepositoryOwnerTypeXe56695d2? = null
    ...
    public fun build(): InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5 must be a JSON object")
      ...
      return InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookTeamAddedToRepositoryRepositoryOwnerTypeXe56695d2>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5")
...
public fun inlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5(block: InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5.Builder.() -> Unit): InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5 = InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookTeamAddedToRepositoryRepositoryOwnerXf0ec44c5 is missing required property '" + name + "'")
