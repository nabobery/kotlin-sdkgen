 ...
 * ication~1json/schema/allOf/0
 */
@Serializable(with = InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1.Serializer::class)
public class InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1 {
      check(createdAtValue != null) { "createdAt is required" }
      check(idValue != null) { "id is required" }
      check(stateValue != null) { "state is required" }
      return InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1(
        createdAt = createdAt,
        id = id,
        state = state,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1")
...
public fun inlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1(block: InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1.Builder.() -> Unit): InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1 = InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineAgentsReposTasksGetResponse200JsonAllOf1X299121c1 is missing required property '" + name + "'")
