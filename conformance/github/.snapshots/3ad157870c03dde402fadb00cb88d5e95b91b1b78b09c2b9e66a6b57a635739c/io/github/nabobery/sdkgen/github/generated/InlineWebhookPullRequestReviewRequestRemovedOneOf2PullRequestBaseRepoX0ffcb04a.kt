 ...
 * request/properties/base/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoCreatedAtX28760596,
  /**
  ...
  public val license: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoLicenseXb02049ff?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoPushedAtXe9b2cd19?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoVisibilityX782eee0a,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseMergeCommitMessageXe4987985>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoMergeCommitTitleX93724b50>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoPermissionsXa93943b5>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestPullRequestCreationP824dXf55f5124>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestSquashMergeCommitMessageXd8c851f3>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestSquashMergeCommitTitleXfe878ee6>,
  ...
  public val mergeCommitMessage:
      InlineWebhookPullRequestReacd1OneOf2PullRequestBaseMergeCommitMessageXe4987985?
  ...
  public val mergeCommitTitle:
      InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoMergeCommitTitleX93724b50?
  ...
  public val permissions:
      InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoPermissionsXa93943b5?
  ...
  public val squashMergeCommitMessage:
      InlineWebhookPullRequestReacd1OneOf2PullRequestSquashMergeCommitMessageXd8c851f3?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoCreatedAtX28760596,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoLicenseXb02049ff?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoPushedAtXe9b2cd19?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoVisibilityX782eee0a,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoCreatedAtX28760596? = null

    public var createdAt: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoCreatedAtX28760596
    ...
    public var topics: List<String>
      get() = requireNotNull(topicsValue) { "topics is required" }.toList()
      set(`value`) {
        topicsValue = value.toList()
      }
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoVisibilityX782eee0a? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoLicenseXb02049ff?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoLicenseXb02049ff?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoPushedAtXe9b2cd19?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoPushedAtXe9b2cd19?
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a {
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoCreatedAtX28760596>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoVisibilityX782eee0a>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoLicenseXb02049ff?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoPushedAtXe9b2cd19?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a(block: InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a = InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestBaseRepoX0ffcb04a property '" + name + "' is not nullable")
