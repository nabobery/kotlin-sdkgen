 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_2/properties/performed_via_github_app
 */
@Serializable(with = InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68.Serializer::class)
public class InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 internal constructor(
  /**
  ...
  public val owner: InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhooksIssue2PerformedViaGithubAppEventsItemX0f2ae4be>>,
  private val permissionsState:
      FieldState<InlineWebhooksIssue2PerformedViaGithubAppPermissionsX2ec8aa34>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhooksIssue2PerformedViaGithubAppEventsItemX0f2ae4be>> =
      eventsState.copyValue { fieldValue -> fieldValue.toList() }

  /**
   * The list of events for the GitHub app
   */
  public val events: List<InlineWebhooksIssue2PerformedViaGithubAppEventsItemX0f2ae4be>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhooksIssue2PerformedViaGithubAppPermissionsX2ec8aa34?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState: FieldState<InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091?
     ...
     */
    public var events: List<InlineWebhooksIssue2PerformedViaGithubAppEventsItemX0f2ae4be>?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhooksIssue2PerformedViaGithubAppPermissionsX2ec8aa34?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 {
      ...
      return InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68")
...
public fun inlineWebhooksIssue2PerformedViaGithubAppXc6b77f68(block: InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68.Builder.() -> Unit): InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 = InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68 property '" + name + "' is not nullable")
