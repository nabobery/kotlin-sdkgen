...
@Serializable
public data class BlockingAddedIssueEventView(
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/blocking-added-issue-event
 */
@Serializable(with = BlockingAddedIssueEvent.Serializer::class)
public class BlockingAddedIssueEvent(
  public val actor: SimpleUser,
  public val blocking: NullableIssueReference?,
  public val commitId: String?,
  public val commitUrl: String?,
  ...
  public class Builder {
    ...
    public fun build(): BlockingAddedIssueEvent {
      ...
      return BlockingAddedIssueEvent(
        actor = actor,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BlockingAddedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BlockingAddedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): BlockingAddedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("BlockingAddedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BlockingAddedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("blocking")) {
        throw SerializationException("BlockingAddedIssueEvent is missing required property 'blocking'")
      }
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("BlockingAddedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("BlockingAddedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("BlockingAddedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: BlockingAddedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("BlockingAddedIssueEvent")
...
public fun blockingAddedIssueEvent(block: BlockingAddedIssueEvent.Builder.() -> Unit): BlockingAddedIssueEvent = BlockingAddedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BlockingAddedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("BlockingAddedIssueEvent property '" + name + "' is not nullable")
