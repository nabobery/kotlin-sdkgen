...
public class InlineGpgKeySubkeysItemX34dfab1f(
  ...
  emails: List<InlineGpgKeySubkeysItemEmailsItemX74c93dc0>? = null,
  ...
  subkeys: List<JsonElement>? = null,
) {
  public val emails: List<InlineGpgKeySubkeysItemEmailsItemX74c93dc0>? =
      emails?.let { collection0 -> collection0.toList() }

  public val subkeys: List<JsonElement>? = subkeys?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    private var emailsValue: List<InlineGpgKeySubkeysItemEmailsItemX74c93dc0>? = null

    public var emails: List<InlineGpgKeySubkeysItemEmailsItemX74c93dc0>?
      get() = emailsValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        emailsValue = value?.let { collection0 -> collection0.toList() }
      }
    ...
    private var subkeysValue: List<JsonElement>? = null

    public var subkeys: List<JsonElement>?
      get() = subkeysValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        subkeysValue = value?.let { collection0 -> collection0.toList() }
      }
  ...
  internal object Serializer : KSerializer<InlineGpgKeySubkeysItemX34dfab1f> {
