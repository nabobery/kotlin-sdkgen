 ...
 */
@Serializable(with = InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3.Serializer::class)
public class InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3 internal constructor(
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemParentXf381a43d?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent: InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemParentXf381a43d?
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemPrivacyX0c2e2e3e? = null
     ...
     */
    public var parent:
        InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemParentXf381a43d?
      get() = parentState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3 must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemPrivacyX0c2e2e3e>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3 is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3")
...
public fun inlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3(block: InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3.Builder.() -> Unit): InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3 = InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf2X698527c3 property '" + name + "' is not nullable")
