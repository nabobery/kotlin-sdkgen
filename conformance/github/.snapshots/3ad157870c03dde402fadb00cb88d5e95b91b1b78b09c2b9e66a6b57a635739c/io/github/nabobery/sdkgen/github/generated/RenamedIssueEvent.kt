...
@Serializable
public data class RenamedIssueEventView(
  ...
  public val rename: InlineRenamedIssueEventRenameX9143a408,
 ...
 * Renamed Issue Event
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/renamed-issue-event
 */
@Serializable(with = RenamedIssueEvent.Serializer::class)
public class RenamedIssueEvent(
  ...
  public class Builder {
    ...
    private var renameValue: InlineRenamedIssueEventRenameX9143a408? = null

    public var rename: InlineRenamedIssueEventRenameX9143a408
      get() = requireNotNull(renameValue) { "rename is required" }
      set(`value`) {
        renameValue = value
      }
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): RenamedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<RenamedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): RenamedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("RenamedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RenamedIssueEvent must be a JSON object")
      ...
      val rename = json.decodeRequired<InlineRenamedIssueEventRenameX9143a408>(rawObject, "rename")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("RenamedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("RenamedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("RenamedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: RenamedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("RenamedIssueEvent")
      ...
      val raw = buildJsonObject {
        ...
        put("rename", json.encodeToJsonElement(value.rename))
        put("url", value.url)
      }
...
public fun renamedIssueEvent(block: RenamedIssueEvent.Builder.() -> Unit): RenamedIssueEvent = RenamedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("RenamedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("RenamedIssueEvent property '" + name + "' is not nullable")
