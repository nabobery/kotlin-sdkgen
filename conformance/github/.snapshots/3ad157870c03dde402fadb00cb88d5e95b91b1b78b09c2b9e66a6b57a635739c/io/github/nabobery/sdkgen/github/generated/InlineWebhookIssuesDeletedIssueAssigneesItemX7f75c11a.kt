...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-deleted/properties/issue/properties/assignees/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-deleted/properties/issue/properties/assignees/items
 */
@Serializable(with = InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a.Serializer::class)
public class InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesDeletedIssueAssigneesItemTypeX86459a68? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesDeletedIssueAssigneesItemTypeX86459a68? = null
    ...
    public fun build(): InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a must be a JSON object")
      ...
      return InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesDeletedIssueAssigneesItemTypeX86459a68>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a")
...
public fun inlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a(block: InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a.Builder.() -> Unit): InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a = InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a is missing required property '" + name + "'")
