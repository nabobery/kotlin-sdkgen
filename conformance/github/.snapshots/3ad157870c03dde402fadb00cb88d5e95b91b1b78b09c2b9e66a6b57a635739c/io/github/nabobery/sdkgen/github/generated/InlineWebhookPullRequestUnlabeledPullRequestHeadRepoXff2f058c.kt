 ...
 * ad/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoCreatedAtX5429b70b,
  /**
  ...
  public val license: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoLicenseXfd4d954f?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoPushedAtX1ff4053e?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoVisibilityXfe005075,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoMergeCommitMessageX7f94d42d>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoMergeCommitTitleXdf17876a>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoPermissionsXbcd329b7>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestUn950ePullRequestHeadPullRequestCreationP824dX0a031cd5>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUn950ePullRequestHeadSquashMergeCommitMessageX2596cd8e>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUn950ePullRequestHeadRepoSquashMergeCommitTitleX1e3edfa2>,
  ...
  public val permissions: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoPermissionsXbcd329b7?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoCreatedAtX5429b70b,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoLicenseXfd4d954f?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoPushedAtX1ff4053e?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoVisibilityXfe005075,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestUnlabeledPullRequestHeadRepoCreatedAtX5429b70b? = null

    public var createdAt: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoCreatedAtX5429b70b
    ...
    private var visibilityValue:
        InlineWebhookPullRequestUnlabeledPullRequestHeadRepoVisibilityXfe005075? = null

    public var visibility: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoVisibilityXfe005075
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoLicenseXfd4d954f?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoLicenseXfd4d954f?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoPushedAtX1ff4053e?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoPushedAtX1ff4053e?
    ...
    public var permissions:
        InlineWebhookPullRequestUnlabeledPullRequestHeadRepoPermissionsXbcd329b7?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c {
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoCreatedAtX5429b70b>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoVisibilityXfe005075>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoLicenseXfd4d954f?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoPushedAtX1ff4053e?>(requireNotNull(element)) }
      return InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c(block: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c = InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoXff2f058c property '" + name + "' is not nullable")
