 ...
 * items
 */
@Serializable(with = InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7.Serializer::class)
public class InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesClosedIssueAllOf1AssigneesItemTypeX2cc280b7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesClosedIssueAllOf1AssigneesItemTypeX2cc280b7? = null
    ...
    public fun build(): InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7 must be a JSON object")
      ...
      return InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesClosedIssueAllOf1AssigneesItemTypeX2cc280b7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7")
...
public fun inlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7(block: InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7.Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7 = InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7 is missing required property '" + name + "'")
