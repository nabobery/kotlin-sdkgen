 ...
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-labeled/properties/pull_request/properties/user
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestUserX0075eccc.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestUserX0075eccc(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestLabeledPullRequestUserTypeX1500b6e1? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLabeledPullRequestUserTypeX1500b6e1? = null
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestUserX0075eccc {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLabeledPullRequestUserX0075eccc(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestUserX0075eccc = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestUserX0075eccc> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestUserX0075eccc {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestUserX0075eccc")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestUserX0075eccc must be a JSON object")
      ...
      return InlineWebhookPullRequestLabeledPullRequestUserX0075eccc(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestUserTypeX1500b6e1>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestUserX0075eccc) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestUserX0075eccc")
...
public fun inlineWebhookPullRequestLabeledPullRequestUserX0075eccc(block: InlineWebhookPullRequestLabeledPullRequestUserX0075eccc.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestUserX0075eccc = InlineWebhookPullRequestLabeledPullRequestUserX0075eccc.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestUserX0075eccc is missing required property '" + name + "'")
