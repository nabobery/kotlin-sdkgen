 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoCreatedAtXb3c52b46,
  /**
  ...
  public val license: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoLicenseXf7fc8923?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoPushedAtX70ff153f?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoVisibilityX66feb0c0,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadMergeCommitMessageX1ee0ca45>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoMergeCommitTitleX52524a19>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoPermissionsX9e4567c2>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestPullRequestCreationP824dX3448c981>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestSquashMergeCommitMessageXc4f48891>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestSquashMergeCommitTitleXb6635115>,
  ...
  public val mergeCommitMessage:
      InlineWebhookPullRequestReacd1OneOf1PullRequestHeadMergeCommitMessageX1ee0ca45?
  ...
  public val permissions:
      InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoPermissionsX9e4567c2?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoCreatedAtXb3c52b46,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoLicenseXf7fc8923?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoPushedAtX70ff153f?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoVisibilityX66feb0c0,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoCreatedAtXb3c52b46? = null

    public var createdAt: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoCreatedAtXb3c52b46
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoVisibilityX66feb0c0? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoLicenseXf7fc8923?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoLicenseXf7fc8923?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoPushedAtX70ff153f?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoPushedAtX70ff153f?
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c {
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoCreatedAtXb3c52b46>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoVisibilityX66feb0c0>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoLicenseXf7fc8923?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoPushedAtX70ff153f?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c(block: InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c = InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadRepoX6858c00c property '" + name + "' is not nullable")
