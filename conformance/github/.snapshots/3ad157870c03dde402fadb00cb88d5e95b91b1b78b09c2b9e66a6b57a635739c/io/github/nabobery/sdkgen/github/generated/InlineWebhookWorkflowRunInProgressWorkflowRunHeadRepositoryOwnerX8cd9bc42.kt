 ...
 * head_repository/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-workflow-run-in-progress/properties/workflow_run/properties/
 * head_repository/properties/owner
 */
@Serializable(with = InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42.Serializer::class)
public class InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42(
  public val id: Int,
  ...
  public val type:
      InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerTypeX7707b5f3? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerTypeX7707b5f3?
        = null
    ...
    public fun build(): InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42 must be a JSON object")
      ...
      return InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerTypeX7707b5f3>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42")
...
public fun inlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42(block: InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42.Builder.() -> Unit): InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42 = InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerX8cd9bc42 is missing required property '" + name + "'")
