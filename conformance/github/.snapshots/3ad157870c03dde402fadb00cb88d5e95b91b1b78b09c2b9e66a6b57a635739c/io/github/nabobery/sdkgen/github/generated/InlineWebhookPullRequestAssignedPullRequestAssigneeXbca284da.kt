 ...
 * ignee
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestAssignedPullRequestAssigneeTypeX623e5bcb? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAssignedPullRequestAssigneeTypeX623e5bcb? = null
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da must be a JSON object")
      ...
      return InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestAssigneeTypeX623e5bcb>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da")
...
public fun inlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da(block: InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da = InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestAssigneeXbca284da is missing required property '" + name + "'")
