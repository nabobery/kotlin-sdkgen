 ...
 * properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerTypeX9c4ff7c9? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerTypeX9c4ff7c9? = null
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d must be a JSON object")
      ...
      return InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerTypeX9c4ff7c9>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d")
...
public fun inlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d(block: InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d = InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadRepoOwnerXe0cf6e9d is missing required property '" + name + "'")
