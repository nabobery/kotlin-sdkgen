...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_release/properties/assets/items/properties/uploader.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_release/properties/assets/items/properties/uploader
 */
@Serializable(with = InlineWebhooksReleaseAssetsItemUploaderX5de938af.Serializer::class)
public class InlineWebhooksReleaseAssetsItemUploaderX5de938af(
  public val id: Int,
  ...
  public val type: InlineWebhooksReleaseAssetsItemUploaderTypeXdc29e5a3? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksReleaseAssetsItemUploaderTypeXdc29e5a3? = null
    ...
    public fun build(): InlineWebhooksReleaseAssetsItemUploaderX5de938af {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksReleaseAssetsItemUploaderX5de938af(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksReleaseAssetsItemUploaderX5de938af = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksReleaseAssetsItemUploaderX5de938af> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksReleaseAssetsItemUploaderX5de938af {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksReleaseAssetsItemUploaderX5de938af")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksReleaseAssetsItemUploaderX5de938af must be a JSON object")
      ...
      return InlineWebhooksReleaseAssetsItemUploaderX5de938af(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksReleaseAssetsItemUploaderTypeXdc29e5a3>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksReleaseAssetsItemUploaderX5de938af) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksReleaseAssetsItemUploaderX5de938af")
...
public fun inlineWebhooksReleaseAssetsItemUploaderX5de938af(block: InlineWebhooksReleaseAssetsItemUploaderX5de938af.Builder.() -> Unit): InlineWebhooksReleaseAssetsItemUploaderX5de938af = InlineWebhooksReleaseAssetsItemUploaderX5de938af.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksReleaseAssetsItemUploaderX5de938af is missing required property '" + name + "'")
