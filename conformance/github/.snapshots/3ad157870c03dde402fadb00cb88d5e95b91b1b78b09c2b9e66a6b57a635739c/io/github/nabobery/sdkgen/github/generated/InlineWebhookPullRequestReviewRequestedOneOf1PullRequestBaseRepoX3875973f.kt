 ...
 * t/properties/base/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoCreatedAtX29f0f93c,
  /**
  ...
  public val license:
      InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoLicenseX07c69325?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoPushedAtX05ca3c25?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoVisibilityX84305434,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestBaseMergeCommitMessageXd5871cf4>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoMergeCommitTitleX8739b73b>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoPermissionsXa262f90e>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestPullRequestCreationP824dX65bc3988>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestSquashMergeCommitMessageXa8cd4852>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestSquashMergeCommitTitleX3e892128>,
  ...
  public val permissions:
      InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoPermissionsXa262f90e?
  ...
  public val squashMergeCommitMessage:
      InlineWebhookPullRequestReffb1OneOf1PullRequestSquashMergeCommitMessageXa8cd4852?
  ...
  public val squashMergeCommitTitle:
      InlineWebhookPullRequestReffb1OneOf1PullRequestSquashMergeCommitTitleX3e892128?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoCreatedAtX29f0f93c,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoLicenseX07c69325?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoPushedAtX05ca3c25?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoVisibilityX84305434,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoCreatedAtX29f0f93c? = null

    public var createdAt: InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoCreatedAtX29f0f93c
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoVisibilityX84305434? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoLicenseX07c69325?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581?>
        = FieldState.Absent
     ...
     */
    public var owner:
        InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoPushedAtX05ca3c25?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoPushedAtX05ca3c25?
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f {
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoCreatedAtX29f0f93c>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoVisibilityX84305434>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoLicenseX07c69325?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoPushedAtX05ca3c25?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f(block: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f = InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoX3875973f property '" + name + "' is not nullable")
