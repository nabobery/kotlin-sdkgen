...
public class InlineReposSecretScanningCustomPatternsPostResponse422JsonX7bc7a534(
  ...
  validationErrors: Map<String, InlineReposSecretScanningCe66fPostResponse422JsonAdditionalValueX2b539d63>? = null,
) {
  /**
  ...
  public val validationErrors:
      ...
      validationErrors?.let { collection0 -> collection0.toMap() }
  ...
  public class Builder {
    ...
    private var validationErrorsValue:
        Map<String, InlineReposSecretScanningCe66fPostResponse422JsonAdditionalValueX2b539d63>? =
        null
    ...
    public var validationErrors:
        Map<String, InlineReposSecretScanningCe66fPostResponse422JsonAdditionalValueX2b539d63>?
      get() = validationErrorsValue?.let { collection0 -> collection0.toMap() }
      set(`value`) {
        validationErrorsValue = value?.let { collection0 -> collection0.toMap() }
      }
  ...
  internal object Serializer : KSerializer<InlineReposSecretScanningCustomPatternsPostResponse422JsonX7bc7a534> {
