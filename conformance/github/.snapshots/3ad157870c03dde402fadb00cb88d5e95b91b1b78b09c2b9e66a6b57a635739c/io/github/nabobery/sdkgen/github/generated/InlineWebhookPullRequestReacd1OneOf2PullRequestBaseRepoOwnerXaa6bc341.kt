 ...
 * request/properties/base/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-request-removed/oneOf/1/properties/pull_
 * request/properties/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341.Serializer::class)
public class InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerTypeXa1d378ec? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerTypeXa1d378ec? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341 must be a JSON object")
      ...
      return InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerTypeXa1d378ec>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341")
...
public fun inlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341(block: InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341.Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341 = InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestBaseRepoOwnerXaa6bc341 is missing required property '" + name + "'")
