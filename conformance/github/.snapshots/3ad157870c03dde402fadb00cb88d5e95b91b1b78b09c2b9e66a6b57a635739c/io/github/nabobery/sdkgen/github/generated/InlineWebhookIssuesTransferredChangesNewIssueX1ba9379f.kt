 ...
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-transferred/properties/changes/properties/new_issue
 */
@Serializable(with = InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f.Serializer::class)
public class InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f internal constructor(
  public val activeLockReason:
      InlineWebhookIssuesTransferredChangesNewIssueActiveLockReasonX21b8a737?,
  assignees: List<InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a?>,
  /**
   ...
   */
  public val milestone: InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhookIssuesTransferredChangesNewIssueReactionsXd82f9a27,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e?,
  private val assigneeState:
      FieldState<InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282?>,
  ...
  labelsState: FieldState<List<InlineWebhookIssuesTransferredChangesNewIssueLabelsItemX14a27d2a>>,
  private val lockedState: FieldState<Boolean>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27?>,
  private val pinnedCommentState: FieldState<NullableIssueComment?>,
  private val pullRequestState:
      FieldState<InlineWebhookIssuesTransferredChangesNewIssuePullRequestXa8922813>,
  private val stateState: FieldState<InlineWebhookIssuesTransferredChangesNewIssueStateX1abf2980>,
  ...
  public val assignees: List<InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a?> =
      assignees.toList()
  ...
  private val labelsState:
      FieldState<List<InlineWebhookIssuesTransferredChangesNewIssueLabelsItemX14a27d2a>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282?
  ...
  public val labels: List<InlineWebhookIssuesTransferredChangesNewIssueLabelsItemX14a27d2a>?
  ...
  public val performedViaGithubApp:
      InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27?
  ...
  public val pullRequest: InlineWebhookIssuesTransferredChangesNewIssuePullRequestXa8922813?
    get() = pullRequestState.valueOrNull()

  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssuesTransferredChangesNewIssueStateX1abf2980?
  ...
  public constructor(
    activeLockReason: InlineWebhookIssuesTransferredChangesNewIssueActiveLockReasonX21b8a737?,
    assignees: List<InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a?>,
    authorAssociation: InlineWebhookIssuesTransferredChangesNewIssueAuthorAssociationX605535fd,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    id: Long,
    labelsUrl: String,
    milestone: InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhookIssuesTransferredChangesNewIssueReactionsXd82f9a27,
    repositoryUrl: String,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e?,
  ...
  public class Builder {
    private var assigneesValue:
        List<InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a?>? = null

    public var assignees: List<InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a?>
    ...
    private var authorAssociationValue:
        InlineWebhookIssuesTransferredChangesNewIssueAuthorAssociationX605535fd? = null
    ...
    private var reactionsValue: InlineWebhookIssuesTransferredChangesNewIssueReactionsXd82f9a27? =
        null

    public var reactions: InlineWebhookIssuesTransferredChangesNewIssueReactionsXd82f9a27
    ...
    private var activeLockReasonState:
        FieldState<InlineWebhookIssuesTransferredChangesNewIssueActiveLockReasonX21b8a737?> =
        FieldState.Absent
    ...
    private var milestoneState:
        FieldState<InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e?
     ...
     */
    public var assignee: InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282?
      get() = assigneeState.valueOrNull()
      set(`value`) {
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhookIssuesTransferredChangesNewIssueLabelsItemX14a27d2a>?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhookIssuesTransferredChangesNewIssuePullRequestXa8922813?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssuesTransferredChangesNewIssueStateX1abf2980>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var state: InlineWebhookIssuesTransferredChangesNewIssueStateX1abf2980?
      get() = stateState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f {
      ...
      return InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhookIssuesTransferredChangesNewIssueAuthorAssociationX605535fd>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhookIssuesTransferredChangesNewIssueReactionsXd82f9a27>(rawObject, "reactions")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesTransferredChangesNewIssueActiveLockReasonX21b8a737?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e?>(requireNotNull(element)) }
      return InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f")
...
public fun inlineWebhookIssuesTransferredChangesNewIssueX1ba9379f(block: InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f.Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f = InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueX1ba9379f property '" + name + "' is not nullable")
