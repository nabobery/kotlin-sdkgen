 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/repository-advisory/properties/publisher
 */
@Serializable(with = InlineRepositoryAdvisoryPublisherXdcfad729.Serializer::class)
public class InlineRepositoryAdvisoryPublisherXdcfad729 internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineRepositoryAdvisoryPublisherXdcfad729 {
      ...
      return InlineRepositoryAdvisoryPublisherXdcfad729(
        avatarUrl = avatarUrl,
        eventsUrl = eventsUrl,
        followersUrl = followersUrl,
        followingUrl = followingUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineRepositoryAdvisoryPublisherXdcfad729 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineRepositoryAdvisoryPublisherXdcfad729> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineRepositoryAdvisoryPublisherXdcfad729 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineRepositoryAdvisoryPublisherXdcfad729")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineRepositoryAdvisoryPublisherXdcfad729 must be a JSON object")
      ...
      if (!rawObject.containsKey("gravatar_id")) {
        throw SerializationException("InlineRepositoryAdvisoryPublisherXdcfad729 is missing required property 'gravatar_id'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineRepositoryAdvisoryPublisherXdcfad729) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineRepositoryAdvisoryPublisherXdcfad729")
...
public fun inlineRepositoryAdvisoryPublisherXdcfad729(block: InlineRepositoryAdvisoryPublisherXdcfad729.Builder.() -> Unit): InlineRepositoryAdvisoryPublisherXdcfad729 = InlineRepositoryAdvisoryPublisherXdcfad729.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineRepositoryAdvisoryPublisherXdcfad729 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineRepositoryAdvisoryPublisherXdcfad729 property '" + name + "' is not nullable")
