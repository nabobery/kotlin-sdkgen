...
public class InlineOrgsMigrationsPostRequestJsonX5797c146(
  ...
  exclude: List<InlineOrgsMigrationsPostRequestJsonExcludeItemX46b27445>? = null,
  /**
   ...
   */
  public val exclude: List<InlineOrgsMigrationsPostRequestJsonExcludeItemX46b27445>? =
  ...
  public class Builder {
    ...
    private var excludeValue: List<InlineOrgsMigrationsPostRequestJsonExcludeItemX46b27445>? = null

    /**
     * Exclude related items from being returned in the response in order to improve performance of the request.
     */
    public var exclude: List<InlineOrgsMigrationsPostRequestJsonExcludeItemX46b27445>?
  ...
  internal object Serializer : KSerializer<InlineOrgsMigrationsPostRequestJsonX5797c146> {
