 ...
 * merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-locked/properties/pull_request/properties/auto_
 * merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByTypeX4ecf083e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByTypeX4ecf083e? =
        null
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30 must be a JSON object")
      ...
      return InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByTypeX4ecf083e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30")
...
public fun inlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30(block: InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30 = InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestAutoMergeEnabledByX3c8bae30 is missing required property '" + name + "'")
