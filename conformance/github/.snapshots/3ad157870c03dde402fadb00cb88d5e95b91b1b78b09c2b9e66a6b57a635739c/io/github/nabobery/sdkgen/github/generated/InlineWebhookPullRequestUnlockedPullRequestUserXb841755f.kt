 ...
 * r
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestUserXb841755f.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestUserXb841755f(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestUnlockedPullRequestUserTypeX4148630c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlockedPullRequestUserTypeX4148630c? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestUserXb841755f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlockedPullRequestUserXb841755f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestUserXb841755f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestUserXb841755f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestUserXb841755f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestUserXb841755f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestUserXb841755f must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlockedPullRequestUserXb841755f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestUserTypeX4148630c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestUserXb841755f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestUserXb841755f")
...
public fun inlineWebhookPullRequestUnlockedPullRequestUserXb841755f(block: InlineWebhookPullRequestUnlockedPullRequestUserXb841755f.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestUserXb841755f = InlineWebhookPullRequestUnlockedPullRequestUserXb841755f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestUserXb841755f is missing required property '" + name + "'")
