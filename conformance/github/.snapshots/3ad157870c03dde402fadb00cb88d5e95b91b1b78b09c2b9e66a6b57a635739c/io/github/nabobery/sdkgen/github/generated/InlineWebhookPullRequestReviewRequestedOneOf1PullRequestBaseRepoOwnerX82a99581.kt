 ...
 * t/properties/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoOwnerTypeXdc46f382? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoOwnerTypeXdc46f382? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf1PullRequestBaseRepoOwnerTypeXdc46f382>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581(block: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581 = InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestBaseRepoOwnerX82a99581 is missing required property '" + name + "'")
