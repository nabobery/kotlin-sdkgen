...
public class Feed(
  ...
  currentUserOrganizationUrls: List<String>? = null,
  ...
  public val currentUserOrganizationUrls: List<String>? =
      currentUserOrganizationUrls?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    private var currentUserOrganizationUrlsValue: List<String>? = null

    public var currentUserOrganizationUrls: List<String>?
      get() = currentUserOrganizationUrlsValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        currentUserOrganizationUrlsValue = value?.let { collection0 -> collection0.toList() }
      }
  ...
  internal object Serializer : KSerializer<Feed> {
