 ...
 * /triggering_actor
 */
@Serializable(with = InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84.Serializer::class)
public class InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84(
  public val id: Int,
  ...
  public val type:
      InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorTypeXeed32a19? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorTypeXeed32a19? =
        null
    ...
    public fun build(): InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84 must be a JSON object")
      ...
      return InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorTypeXeed32a19>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84")
...
public fun inlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84(block: InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84.Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84 = InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84 is missing required property '" + name + "'")
