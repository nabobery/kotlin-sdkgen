 ...
 * Of/0
 */
@Serializable(with = InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e.Serializer::class)
public class InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e {
      check(createdAtValue != null) { "createdAt is required" }
      check(idValue != null) { "id is required" }
      check(stateValue != null) { "state is required" }
      return InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e(
        createdAt = createdAt,
        id = id,
        state = state,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e")
...
public fun inlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e(block: InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e.Builder.() -> Unit): InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e = InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineAgentsTasksGetResponse200JsonAllOf1Xbd46f97e is missing required property '" + name + "'")
