 ...
 * milestone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-synchronize/properties/pull_request/properties/
 * milestone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorTypeX8439723e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorTypeX8439723e? =
        null
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0 must be a JSON object")
      ...
      return InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorTypeX8439723e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0")
...
public fun inlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0(block: InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0 = InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0 is missing required property '" + name + "'")
