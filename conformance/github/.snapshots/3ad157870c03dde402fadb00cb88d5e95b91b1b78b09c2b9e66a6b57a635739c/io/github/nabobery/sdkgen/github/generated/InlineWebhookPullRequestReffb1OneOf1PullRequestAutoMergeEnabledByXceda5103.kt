 ...
 * t/properties/auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103.Serializer::class)
public class InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByTypeX8a59a9ea? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByTypeX8a59a9ea?
        = null
    ...
    public fun build(): InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103 must be a JSON object")
      ...
      return InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByTypeX8a59a9ea>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103")
...
public fun inlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103(block: InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103.Builder.() -> Unit): InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103 = InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReffb1OneOf1PullRequestAutoMergeEnabledByXceda5103 is missing required property '" + name + "'")
