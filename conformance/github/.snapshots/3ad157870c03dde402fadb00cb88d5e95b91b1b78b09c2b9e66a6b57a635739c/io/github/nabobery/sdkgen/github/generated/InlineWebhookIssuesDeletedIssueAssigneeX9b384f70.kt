...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-deleted/properties/issue/properties/assignee.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-deleted/properties/issue/properties/assignee
 */
@Serializable(with = InlineWebhookIssuesDeletedIssueAssigneeX9b384f70.Serializer::class)
public class InlineWebhookIssuesDeletedIssueAssigneeX9b384f70(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesDeletedIssueAssigneeTypeX55d562ec? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesDeletedIssueAssigneeTypeX55d562ec? = null
    ...
    public fun build(): InlineWebhookIssuesDeletedIssueAssigneeX9b384f70 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesDeletedIssueAssigneeX9b384f70(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDeletedIssueAssigneeX9b384f70 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDeletedIssueAssigneeX9b384f70> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDeletedIssueAssigneeX9b384f70 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDeletedIssueAssigneeX9b384f70")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDeletedIssueAssigneeX9b384f70 must be a JSON object")
      ...
      return InlineWebhookIssuesDeletedIssueAssigneeX9b384f70(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesDeletedIssueAssigneeTypeX55d562ec>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDeletedIssueAssigneeX9b384f70) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDeletedIssueAssigneeX9b384f70")
...
public fun inlineWebhookIssuesDeletedIssueAssigneeX9b384f70(block: InlineWebhookIssuesDeletedIssueAssigneeX9b384f70.Builder.() -> Unit): InlineWebhookIssuesDeletedIssueAssigneeX9b384f70 = InlineWebhookIssuesDeletedIssueAssigneeX9b384f70.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDeletedIssueAssigneeX9b384f70 is missing required property '" + name + "'")
