...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-pinned/properties/issue/allOf/1/properties/use
 * r.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-pinned/properties/issue/allOf/1/properties/use
 * r
 */
@Serializable(with = InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523.Serializer::class)
public class InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523 = InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523 must be a JSON object")
      return InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523")
...
public fun inlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523(block: InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523.Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523 = InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523.build(block)
