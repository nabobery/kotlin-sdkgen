 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48.Serializer::class)
public class InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestRe8fbbPullRequestHeadRepoCreatedAtX0abf9648,
  /**
  ...
  public val license:
      InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoLicenseXae85c9e9?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f?,
  /**
  ...
  public val pushedAt:
      InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoPushedAtXc895aba9?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestRe8fbbPullRequestHeadRepoVisibilityXc4c43f38,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestHeadRepoMergeCommitMessageX0319ef11>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestHeadRepoMergeCommitTitleXc8766868>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestHeadRepoPermissionsXeab916ad>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestHeadPullRequestCreationP824dX3ebac8bc>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestHeadSquashMergeCommitMessageX5c385394>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestHeadRepoSquashMergeCommitTitleX37d0ee34>,
  ...
  public val permissions: InlineWebhookPullRequestRe8fbbPullRequestHeadRepoPermissionsXeab916ad?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestRe8fbbPullRequestHeadRepoCreatedAtX0abf9648,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoLicenseXae85c9e9?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoPushedAtXc895aba9?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestRe8fbbPullRequestHeadRepoVisibilityXc4c43f38,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookPullRequestRe8fbbPullRequestHeadRepoCreatedAtX0abf9648?
        = null

    public var createdAt: InlineWebhookPullRequestRe8fbbPullRequestHeadRepoCreatedAtX0abf9648
    ...
    private var visibilityValue:
        InlineWebhookPullRequestRe8fbbPullRequestHeadRepoVisibilityXc4c43f38? = null

    public var visibility: InlineWebhookPullRequestRe8fbbPullRequestHeadRepoVisibilityXc4c43f38
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoLicenseXae85c9e9?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoPushedAtXc895aba9?>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestRe8fbbPullRequestHeadRepoPermissionsXeab916ad?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 {
      ...
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestRe8fbbPullRequestHeadRepoCreatedAtX0abf9648>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestRe8fbbPullRequestHeadRepoVisibilityXc4c43f38>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoLicenseXae85c9e9?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerX6eab0e7f?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoPushedAtXc895aba9?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48")
...
public fun inlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48(block: InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 = InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestHeadRepoX89815e48 property '" + name + "' is not nullable")
