 ...
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-opened/properties/changes/properties/old_repository
 */
@Serializable(with = InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce.Serializer::class)
public class InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookIssuesOpenedChangesOldRepositoryCreatedAtX869e923e,
  /**
  ...
  public val license: InlineWebhookIssuesOpenedChangesOldRepositoryLicenseX9dfc8c78?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7?,
  /**
  ...
  public val pushedAt: InlineWebhookIssuesOpenedChangesOldRepositoryPushedAtX54cab54a?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookIssuesOpenedChangesOldRepositoryVisibilityXc070a084,
  ...
  private val permissionsState:
      FieldState<InlineWebhookIssuesOpenedChangesOldRepositoryPermissionsXdc712eff>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookIssuesOpenedChangesOldRepositoryPullRequestCreationPolicyX2ecbaff9>,
  ...
  public val permissions: InlineWebhookIssuesOpenedChangesOldRepositoryPermissionsXdc712eff?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookIssuesOpenedChangesOldRepositoryCreatedAtX869e923e,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookIssuesOpenedChangesOldRepositoryLicenseX9dfc8c78?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookIssuesOpenedChangesOldRepositoryPushedAtX54cab54a?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookIssuesOpenedChangesOldRepositoryVisibilityXc070a084,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookIssuesOpenedChangesOldRepositoryCreatedAtX869e923e? =
        null

    public var createdAt: InlineWebhookIssuesOpenedChangesOldRepositoryCreatedAtX869e923e
    ...
    private var visibilityValue: InlineWebhookIssuesOpenedChangesOldRepositoryVisibilityXc070a084? =
        null

    public var visibility: InlineWebhookIssuesOpenedChangesOldRepositoryVisibilityXc070a084
    ...
    private var licenseState:
        FieldState<InlineWebhookIssuesOpenedChangesOldRepositoryLicenseX9dfc8c78?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookIssuesOpenedChangesOldRepositoryLicenseX9dfc8c78?
    ...
    private var ownerState: FieldState<InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7?>
        = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookIssuesOpenedChangesOldRepositoryPushedAtX54cab54a?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookIssuesOpenedChangesOldRepositoryPushedAtX54cab54a?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookIssuesOpenedChangesOldRepositoryPermissionsXdc712eff?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce {
      ...
      return InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookIssuesOpenedChangesOldRepositoryCreatedAtX869e923e>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookIssuesOpenedChangesOldRepositoryVisibilityXc070a084>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesOpenedChangesOldRepositoryLicenseX9dfc8c78?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesOpenedChangesOldRepositoryPushedAtX54cab54a?>(requireNotNull(element)) }
      return InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce")
...
public fun inlineWebhookIssuesOpenedChangesOldRepositoryX986609ce(block: InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce.Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce = InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryX986609ce property '" + name + "' is not nullable")
