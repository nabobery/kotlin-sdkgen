 ...
 * s/owner
 */
@Serializable(with = InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215.Serializer::class)
public class InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215(
  public val id: Int,
  ...
  public val type: InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerTypeX147535d5? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerTypeX147535d5? = null
    ...
    public fun build(): InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215 must be a JSON object")
      ...
      return InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerTypeX147535d5>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215")
...
public fun inlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215(block: InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215.Builder.() -> Unit): InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215 = InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookTeamRemovedFromRepositoryRepositoryOwnerX27355215 is missing required property '" + name + "'")
