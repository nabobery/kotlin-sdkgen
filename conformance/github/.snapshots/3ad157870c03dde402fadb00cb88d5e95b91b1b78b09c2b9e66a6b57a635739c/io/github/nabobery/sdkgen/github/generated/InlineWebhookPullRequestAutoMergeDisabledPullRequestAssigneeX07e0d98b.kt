 ...
 * perties/assignee
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b.Serializer::class)
public class InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeTypeX6358a5e2? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeTypeX6358a5e2? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeTypeX6358a5e2>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b")
...
public fun inlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b(block: InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b = InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneeX07e0d98b is missing required property '" + name + "'")
