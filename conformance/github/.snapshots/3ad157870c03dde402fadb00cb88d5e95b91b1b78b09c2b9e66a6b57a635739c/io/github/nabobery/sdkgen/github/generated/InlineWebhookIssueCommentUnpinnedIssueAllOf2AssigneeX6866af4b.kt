 ...
 * ssignee
 */
@Serializable(with = InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b.Serializer::class)
public class InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeTypeX4e76b569? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeTypeX4e76b569? = null
    ...
    public fun build(): InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b must be a JSON object")
      ...
      return InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeTypeX4e76b569>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b")
...
public fun inlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b(block: InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b.Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b = InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b is missing required property '" + name + "'")
