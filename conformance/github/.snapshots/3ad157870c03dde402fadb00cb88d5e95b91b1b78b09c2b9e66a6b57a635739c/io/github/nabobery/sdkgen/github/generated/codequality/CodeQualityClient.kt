package io.github.nabobery.sdkgen.github.generated.codequality
...
import io.github.nabobery.sdkgen.github.generated.CodeQualityFinding
import io.github.nabobery.sdkgen.github.generated.CodeQualitySetup
import io.github.nabobery.sdkgen.github.generated.CodeQualitySetupUpdate
import io.github.nabobery.sdkgen.github.generated.CodeQualitySetupUpdateResponse
import io.github.nabobery.sdkgen.github.generated.InlineDirectionParameterX3053723f
import io.github.nabobery.sdkgen.github.generated.InlineReposCodeQualityFindingsGetParameterXcc6159d8
...
internal object CodeQualityCodecs {
  internal const val CODEQUALITYGETFINDING_RESPONSE_CODEC_ID: String =
  ...
  internal val codeQualityGetFindingResponseCodecAlternative0Registry:
  ...
  internal val codeQualityGetFindingResponseCodecAlternative1Registry:
  ...
  internal val codeQualityGetFindingResponseCodecAlternative2Registry:
      MediaTypeCodecRegistry<BasicError> =
  ...
  internal val codeQualityGetFindingResponseCodecAlternative3Registry:
  ...
  internal val codeQualityGetFindingRequestCodecRegistry: MediaTypeCodecRegistry<Unit> =
      MediaTypeCodecRegistry.of()

  internal val codeQualityGetFindingResponseCodecRegistry:
      MediaTypeCodecRegistry<CodeQualityFinding> =
      MediaTypeCodecRegistry.of(codeQualityGetFindingResponseCodec)

  internal const val CODEQUALITYGETSETUP_RESPONSE_CODEC_ID: String =
      "code-quality/get-setup.response"
  ...
  internal val codeQualityGetSetupResponseCodecAlternative0Registry:
  ...
  internal val codeQualityGetSetupResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<BasicError> =
  ...
  internal val codeQualityGetSetupResponseCodecAlternative2Registry:
      MediaTypeCodecRegistry<BasicError> =
  ...
  internal val codeQualityGetSetupResponseCodecAlternative3Registry:
      MediaTypeCodecRegistry<InlineServiceUnavailableResponseJsonX4cf316d5> =
      MediaTypeCodecRegistry.of(codeQualityGetSetupResponseCodecAlternative3Codec)

  internal val codeQualityGetSetupRequestCodecRegistry: MediaTypeCodecRegistry<Unit> =
      MediaTypeCodecRegistry.of()

  internal val codeQualityGetSetupResponseCodecRegistry: MediaTypeCodecRegistry<CodeQualitySetup> =
      MediaTypeCodecRegistry.of(codeQualityGetSetupResponseCodec)

  internal const val CODEQUALITYLISTFINDINGSFORREPO_RESPONSE_CODEC_ID: String =
  ...
  internal val codeQualityListFindingsForRepoResponseCodecAlternative0Registry:
  ...
  internal val codeQualityListFindingsForRepoResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<BasicError> =
  ...
  internal val codeQualityListFindingsForRepoResponseCodecAlternative2Registry:
      MediaTypeCodecRegistry<BasicError> =
  ...
  internal val codeQualityListFindingsForRepoResponseCodecAlternative3Registry:
      MediaTypeCodecRegistry<InlineServiceUnavailableResponseJsonX4cf316d5> =
      MediaTypeCodecRegistry.of(codeQualityListFindingsForRepoResponseCodecAlternative3Codec)

  internal val codeQualityListFindingsForRepoRequestCodecRegistry: MediaTypeCodecRegistry<Unit> =
      MediaTypeCodecRegistry.of()

  internal val codeQualityListFindingsForRepoResponseCodecRegistry:
      MediaTypeCodecRegistry<List<CodeQualityFinding>> =
      MediaTypeCodecRegistry.of(codeQualityListFindingsForRepoResponseCodec)

  internal const val CODEQUALITYUPDATESETUP_REQUEST_CODEC_ID: String =
  ...
  internal val codeQualityUpdateSetupResponseCodecAlternative0Registry:
  ...
  internal val codeQualityUpdateSetupResponseCodecAlternative1Registry:
  ...
  internal val codeQualityUpdateSetupResponseCodecAlternative2Registry:
      MediaTypeCodecRegistry<BasicError> =
  ...
  internal val codeQualityUpdateSetupResponseCodecAlternative3Registry:
      MediaTypeCodecRegistry<BasicError> =
  ...
  internal val codeQualityUpdateSetupResponseCodecAlternative4Registry:
      MediaTypeCodecRegistry<BasicError> =
  ...
  internal val codeQualityUpdateSetupResponseCodecAlternative5Registry:
      MediaTypeCodecRegistry<BasicError> =
  ...
  internal val codeQualityUpdateSetupResponseCodecAlternative6Registry:
      MediaTypeCodecRegistry<InlineServiceUnavailableResponseJsonX4cf316d5> =
      MediaTypeCodecRegistry.of(codeQualityUpdateSetupResponseCodecAlternative6Codec)

  internal val codeQualityUpdateSetupRequestCodecRegistry:
...
public class CodeQualityClient(
   ...
   *
   * @param findingNumber The number that identifies a finding.
   ...
   * API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api)."
   * @param state If specified, only code quality findings with this state will be returned.
   * @param options Execution options.
   * @return Buffered response body.
  ...
  public companion object {
    internal val codeQualityGetFindingMetadata: OperationMetadata by
    ...
    internal val codeQualityGetSetupMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val codeQualityListFindingsForRepoMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val codeQualityUpdateSetupMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
