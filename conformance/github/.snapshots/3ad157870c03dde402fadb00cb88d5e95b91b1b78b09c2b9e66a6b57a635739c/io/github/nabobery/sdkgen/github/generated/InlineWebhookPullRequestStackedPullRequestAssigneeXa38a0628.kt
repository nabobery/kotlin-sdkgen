 ...
 * gnee
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestStackedPullRequestAssigneeTypeX20e430ef? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestStackedPullRequestAssigneeTypeX20e430ef? = null
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628 must be a JSON object")
      ...
      return InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestStackedPullRequestAssigneeTypeX20e430ef>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628")
...
public fun inlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628(block: InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628 = InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestAssigneeXa38a0628 is missing required property '" + name + "'")
