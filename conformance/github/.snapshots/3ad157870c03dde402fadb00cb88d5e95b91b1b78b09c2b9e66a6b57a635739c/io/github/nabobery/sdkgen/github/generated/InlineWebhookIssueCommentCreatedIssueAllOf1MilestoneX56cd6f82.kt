 ...
 * lestone
 */
@Serializable(with = InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82.Serializer::class)
public class InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82(
  /**
  ...
  public val creator: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa?,
   ...
   */
  public val state: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneStateX7a7cc6d8,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneStateX7a7cc6d8? =
        null

    public var state: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneStateX7a7cc6d8
    ...
    private var creatorState:
        FieldState<InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa?
    ...
    public fun build(): InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82 {
      ...
      return InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneStateX7a7cc6d8>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82")
...
public fun inlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82(block: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82.Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82 = InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82 property '" + name + "' is not nullable")
