 ...
 * s/base/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-edited/properties/pull_request/propertie
 * s/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3.Serializer::class)
public class InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerTypeXcf8a6311? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerTypeXcf8a6311? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerTypeXcf8a6311>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3")
...
public fun inlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3(block: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3.Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3 = InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3 is missing required property '" + name + "'")
