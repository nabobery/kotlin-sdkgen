 ...
 * thub_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4.Serializer::class)
public class InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerTypeX91775bb6? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerTypeX91775bb6? = null
    ...
    public fun build(): InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4 must be a JSON object")
      ...
      return InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerTypeX91775bb6>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4")
...
public fun inlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4(block: InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4.Builder.() -> Unit): InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4 = InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4 is missing required property '" + name + "'")
