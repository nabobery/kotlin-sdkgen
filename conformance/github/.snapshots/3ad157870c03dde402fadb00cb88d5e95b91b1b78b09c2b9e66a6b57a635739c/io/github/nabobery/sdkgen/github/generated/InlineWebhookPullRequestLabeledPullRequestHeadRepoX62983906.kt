 ...
 * /properties/repo
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestLabeledPullRequestHeadRepoCreatedAtX0d696ea8,
  /**
  ...
  public val license: InlineWebhookPullRequestLabeledPullRequestHeadRepoLicenseX49f6816f?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestLabeledPullRequestHeadRepoPushedAtXf3e39639?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestLabeledPullRequestHeadRepoVisibilityX6bc05294,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestLabeledPullRequestHeadRepoMergeCommitMessageX50ec32d2>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestLabeledPullRequestHeadRepoMergeCommitTitleX8c903812>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestLabeledPullRequestHeadRepoPermissionsX3418e1d9>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestLa835fPullRequestHeadPullRequestCreationP824dXc5dc38d2>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestLa835fPullRequestHeadSquashMergeCommitMessageXe7eaa8f2>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestLa835fPullRequestHeadRepoSquashMergeCommitTitleX8b2d209a>,
  ...
  public val permissions: InlineWebhookPullRequestLabeledPullRequestHeadRepoPermissionsX3418e1d9?
  ...
  public val squashMergeCommitMessage:
      InlineWebhookPullRequestLa835fPullRequestHeadSquashMergeCommitMessageXe7eaa8f2?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestLabeledPullRequestHeadRepoCreatedAtX0d696ea8,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestLabeledPullRequestHeadRepoLicenseX49f6816f?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestLabeledPullRequestHeadRepoPushedAtXf3e39639?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestLabeledPullRequestHeadRepoVisibilityX6bc05294,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestLabeledPullRequestHeadRepoCreatedAtX0d696ea8? = null

    public var createdAt: InlineWebhookPullRequestLabeledPullRequestHeadRepoCreatedAtX0d696ea8
    ...
    private var visibilityValue:
        InlineWebhookPullRequestLabeledPullRequestHeadRepoVisibilityX6bc05294? = null

    public var visibility: InlineWebhookPullRequestLabeledPullRequestHeadRepoVisibilityX6bc05294
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestLabeledPullRequestHeadRepoLicenseX49f6816f?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestLabeledPullRequestHeadRepoLicenseX49f6816f?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestLabeledPullRequestHeadRepoPushedAtXf3e39639?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestLabeledPullRequestHeadRepoPushedAtXf3e39639?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestLabeledPullRequestHeadRepoPermissionsX3418e1d9?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 {
      ...
      return InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestLabeledPullRequestHeadRepoCreatedAtX0d696ea8>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestLabeledPullRequestHeadRepoVisibilityX6bc05294>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestHeadRepoLicenseX49f6816f?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestHeadRepoOwnerX632336ef?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestHeadRepoPushedAtXf3e39639?>(requireNotNull(element)) }
      return InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906")
...
public fun inlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906(block: InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 = InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestLabeledPullRequestHeadRepoX62983906 property '" + name + "' is not nullable")
