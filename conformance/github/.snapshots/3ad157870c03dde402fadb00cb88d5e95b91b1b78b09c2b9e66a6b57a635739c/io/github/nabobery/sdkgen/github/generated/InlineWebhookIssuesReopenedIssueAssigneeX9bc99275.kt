...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-reopened/properties/issue/properties/assignee.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-reopened/properties/issue/properties/assignee
 */
@Serializable(with = InlineWebhookIssuesReopenedIssueAssigneeX9bc99275.Serializer::class)
public class InlineWebhookIssuesReopenedIssueAssigneeX9bc99275(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesReopenedIssueAssigneeTypeX578f7213? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesReopenedIssueAssigneeTypeX578f7213? = null
    ...
    public fun build(): InlineWebhookIssuesReopenedIssueAssigneeX9bc99275 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesReopenedIssueAssigneeX9bc99275(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesReopenedIssueAssigneeX9bc99275 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesReopenedIssueAssigneeX9bc99275> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesReopenedIssueAssigneeX9bc99275 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesReopenedIssueAssigneeX9bc99275")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesReopenedIssueAssigneeX9bc99275 must be a JSON object")
      ...
      return InlineWebhookIssuesReopenedIssueAssigneeX9bc99275(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesReopenedIssueAssigneeTypeX578f7213>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesReopenedIssueAssigneeX9bc99275) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesReopenedIssueAssigneeX9bc99275")
...
public fun inlineWebhookIssuesReopenedIssueAssigneeX9bc99275(block: InlineWebhookIssuesReopenedIssueAssigneeX9bc99275.Builder.() -> Unit): InlineWebhookIssuesReopenedIssueAssigneeX9bc99275 = InlineWebhookIssuesReopenedIssueAssigneeX9bc99275.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesReopenedIssueAssigneeX9bc99275 is missing required property '" + name + "'")
