 ...
 * d/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestDequeuedPullRequestHeadRepoCreatedAtXb249c128,
  /**
  ...
  public val license: InlineWebhookPullRequestDequeuedPullRequestHeadRepoLicenseXaf1a05ed?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestDequeuedPullRequestHeadRepoPushedAtXe02dba36?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestDequeuedPullRequestHeadRepoVisibilityX50edda87,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessageX5a00700b>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitleXfb6b6cc0>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestDequeuedPullRequestHeadRepoPermissionsX71e55f80>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestDea21dPullRequestHeadPullRequestCreationP824dX4ac1a251>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestDea21dPullRequestHeadSquashMergeCommitMessageX5b52d0d8>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestDea21dPullRequestHeadRepoSquashMergeCommitTitleXc60f828b>,
  ...
  public val permissions: InlineWebhookPullRequestDequeuedPullRequestHeadRepoPermissionsX71e55f80?
  ...
  public val squashMergeCommitTitle:
      InlineWebhookPullRequestDea21dPullRequestHeadRepoSquashMergeCommitTitleXc60f828b?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestDequeuedPullRequestHeadRepoCreatedAtXb249c128,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestDequeuedPullRequestHeadRepoLicenseXaf1a05ed?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestDequeuedPullRequestHeadRepoPushedAtXe02dba36?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestDequeuedPullRequestHeadRepoVisibilityX50edda87,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestDequeuedPullRequestHeadRepoCreatedAtXb249c128? = null

    public var createdAt: InlineWebhookPullRequestDequeuedPullRequestHeadRepoCreatedAtXb249c128
    ...
    private var visibilityValue:
        InlineWebhookPullRequestDequeuedPullRequestHeadRepoVisibilityX50edda87? = null

    public var visibility: InlineWebhookPullRequestDequeuedPullRequestHeadRepoVisibilityX50edda87
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestDequeuedPullRequestHeadRepoLicenseXaf1a05ed?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestDequeuedPullRequestHeadRepoLicenseXaf1a05ed?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestDequeuedPullRequestHeadRepoPushedAtXe02dba36?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestDequeuedPullRequestHeadRepoPushedAtXe02dba36?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestDequeuedPullRequestHeadRepoPermissionsX71e55f80?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 {
      ...
      return InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestDequeuedPullRequestHeadRepoCreatedAtXb249c128>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestDequeuedPullRequestHeadRepoVisibilityX50edda87>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestHeadRepoLicenseXaf1a05ed?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestHeadRepoOwnerX832b9cce?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestHeadRepoPushedAtXe02dba36?>(requireNotNull(element)) }
      return InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5")
...
public fun inlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5(block: InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 = InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadRepoX383f27a5 property '" + name + "' is not nullable")
