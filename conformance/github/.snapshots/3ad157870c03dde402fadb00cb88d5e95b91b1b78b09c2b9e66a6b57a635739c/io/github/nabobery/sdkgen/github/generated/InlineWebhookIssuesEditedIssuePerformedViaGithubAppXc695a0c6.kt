 ...
 * ub_app
 */
@Serializable(with = InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6.Serializer::class)
public class InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssuesEditedIssuePerformedViaGithubAppEventsItemXdb41e3cf>>,
  private val permissionsState:
      FieldState<InlineWebhookIssuesEditedIssuePerformedViaGithubAppPermissionsXdc1caa2f>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssuesEditedIssuePerformedViaGithubAppEventsItemXdb41e3cf>> =
      eventsState.copyValue { fieldValue -> fieldValue.toList() }

  /**
   * The list of events for the GitHub app
   */
  public val events: List<InlineWebhookIssuesEditedIssuePerformedViaGithubAppEventsItemXdb41e3cf>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssuesEditedIssuePerformedViaGithubAppPermissionsXdc1caa2f?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8?
     ...
     */
    public var events: List<InlineWebhookIssuesEditedIssuePerformedViaGithubAppEventsItemXdb41e3cf>?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookIssuesEditedIssuePerformedViaGithubAppPermissionsXdc1caa2f?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 {
      ...
      return InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesEditedIssuePerformedViaGithubAppOwnerX3eec0bf8?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6")
...
public fun inlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6(block: InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6.Builder.() -> Unit): InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 = InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesEditedIssuePerformedViaGithubAppXc695a0c6 property '" + name + "' is not nullable")
