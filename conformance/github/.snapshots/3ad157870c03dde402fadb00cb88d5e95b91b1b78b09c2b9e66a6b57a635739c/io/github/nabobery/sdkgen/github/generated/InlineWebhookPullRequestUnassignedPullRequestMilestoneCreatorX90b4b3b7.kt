 ...
 * ilestone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unassigned/properties/pull_request/properties/m
 * ilestone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorTypeXce370fda? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorTypeXce370fda? =
        null
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorTypeXce370fda>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7")
...
public fun inlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7(block: InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7 = InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7 is missing required property '" + name + "'")
