 ...
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-created/properties/deployment/properties/creator
 */
@Serializable(with = InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7.Serializer::class)
public class InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7(
  public val id: Int,
  ...
  public val type: InlineWebhookDeploymentCreatedDeploymentCreatorTypeX39517fd4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentCreatedDeploymentCreatorTypeX39517fd4? = null
    ...
    public fun build(): InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7 must be a JSON object")
      ...
      return InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentCreatedDeploymentCreatorTypeX39517fd4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7")
...
public fun inlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7(block: InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7.Builder.() -> Unit): InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7 = InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentCreatedDeploymentCreatorX69458bd7 is missing required property '" + name + "'")
