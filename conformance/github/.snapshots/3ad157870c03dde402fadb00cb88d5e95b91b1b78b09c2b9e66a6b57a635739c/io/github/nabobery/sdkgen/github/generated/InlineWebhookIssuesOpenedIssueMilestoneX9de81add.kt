 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-opened/properties/issue/properties/milestone
 */
@Serializable(with = InlineWebhookIssuesOpenedIssueMilestoneX9de81add.Serializer::class)
public class InlineWebhookIssuesOpenedIssueMilestoneX9de81add(
  /**
  ...
  public val creator: InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb?,
   ...
   */
  public val state: InlineWebhookIssuesOpenedIssueMilestoneStateX2d51789c,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssuesOpenedIssueMilestoneStateX2d51789c? = null

    public var state: InlineWebhookIssuesOpenedIssueMilestoneStateX2d51789c
    ...
    private var creatorState: FieldState<InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb?
    ...
    public fun build(): InlineWebhookIssuesOpenedIssueMilestoneX9de81add {
      ...
      return InlineWebhookIssuesOpenedIssueMilestoneX9de81add(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedIssueMilestoneX9de81add = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedIssueMilestoneX9de81add> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedIssueMilestoneX9de81add {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedIssueMilestoneX9de81add")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedIssueMilestoneX9de81add must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssuesOpenedIssueMilestoneStateX2d51789c>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesOpenedIssueMilestoneX9de81add is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssuesOpenedIssueMilestoneX9de81add is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesOpenedIssueMilestoneCreatorX375413cb?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesOpenedIssueMilestoneX9de81add is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssuesOpenedIssueMilestoneX9de81add is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedIssueMilestoneX9de81add) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedIssueMilestoneX9de81add")
...
public fun inlineWebhookIssuesOpenedIssueMilestoneX9de81add(block: InlineWebhookIssuesOpenedIssueMilestoneX9de81add.Builder.() -> Unit): InlineWebhookIssuesOpenedIssueMilestoneX9de81add = InlineWebhookIssuesOpenedIssueMilestoneX9de81add.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedIssueMilestoneX9de81add is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesOpenedIssueMilestoneX9de81add property '" + name + "' is not nullable")
