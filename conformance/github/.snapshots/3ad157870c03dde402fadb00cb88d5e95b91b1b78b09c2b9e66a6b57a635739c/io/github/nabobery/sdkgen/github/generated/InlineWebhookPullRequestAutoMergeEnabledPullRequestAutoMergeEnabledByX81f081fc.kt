 ...
 * erties/auto_merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-enabled/properties/pull_request/prop
 * erties/auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc.Serializer::class)
public class InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestAu6055PullRequestAutoMergeEnabledByTypeX6c9c225a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAu6055PullRequestAutoMergeEnabledByTypeX6c9c225a? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAu6055PullRequestAutoMergeEnabledByTypeX6c9c225a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc")
...
public fun inlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc(block: InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc = InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByX81f081fc is missing required property '" + name + "'")
