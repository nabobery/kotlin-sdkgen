 ...
 * o_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByTypeXafd28b59? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByTypeXafd28b59? =
        null
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37 must be a JSON object")
      ...
      return InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByTypeXafd28b59>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37")
...
public fun inlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37(block: InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37 = InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestAutoMergeEnabledByX62c45b37 is missing required property '" + name + "'")
