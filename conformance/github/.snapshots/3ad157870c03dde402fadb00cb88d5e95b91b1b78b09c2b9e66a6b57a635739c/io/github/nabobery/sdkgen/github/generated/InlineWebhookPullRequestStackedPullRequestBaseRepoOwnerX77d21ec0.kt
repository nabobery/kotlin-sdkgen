 ...
 * /properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-stacked/properties/pull_request/properties/base
 * /properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerTypeXa7c0f5e9? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerTypeXa7c0f5e9? = null
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0 must be a JSON object")
      ...
      return InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerTypeXa7c0f5e9>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0")
...
public fun inlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0(block: InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0 = InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestBaseRepoOwnerX77d21ec0 is missing required property '" + name + "'")
