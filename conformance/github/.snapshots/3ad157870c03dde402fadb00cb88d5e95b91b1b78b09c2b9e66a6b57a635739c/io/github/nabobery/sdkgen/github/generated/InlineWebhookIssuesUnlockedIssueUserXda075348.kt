...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-unlocked/properties/issue/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-unlocked/properties/issue/properties/user
 */
@Serializable(with = InlineWebhookIssuesUnlockedIssueUserXda075348.Serializer::class)
public class InlineWebhookIssuesUnlockedIssueUserXda075348(
  public val id: Long,
  ...
  public val type: InlineWebhookIssuesUnlockedIssueUserTypeXac343142? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesUnlockedIssueUserTypeXac343142? = null
    ...
    public fun build(): InlineWebhookIssuesUnlockedIssueUserXda075348 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesUnlockedIssueUserXda075348(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesUnlockedIssueUserXda075348 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesUnlockedIssueUserXda075348> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesUnlockedIssueUserXda075348 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesUnlockedIssueUserXda075348")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesUnlockedIssueUserXda075348 must be a JSON object")
      ...
      return InlineWebhookIssuesUnlockedIssueUserXda075348(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesUnlockedIssueUserTypeXac343142>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesUnlockedIssueUserXda075348) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesUnlockedIssueUserXda075348")
...
public fun inlineWebhookIssuesUnlockedIssueUserXda075348(block: InlineWebhookIssuesUnlockedIssueUserXda075348.Builder.() -> Unit): InlineWebhookIssuesUnlockedIssueUserXda075348 = InlineWebhookIssuesUnlockedIssueUserXda075348.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesUnlockedIssueUserXda075348 is missing required property '" + name + "'")
