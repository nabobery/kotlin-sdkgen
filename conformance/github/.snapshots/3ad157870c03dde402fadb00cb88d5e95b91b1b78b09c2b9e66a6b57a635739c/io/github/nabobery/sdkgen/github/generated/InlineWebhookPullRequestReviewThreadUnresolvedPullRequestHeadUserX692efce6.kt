 ...
 * t/properties/head/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6.Serializer::class)
public class InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6(
  public val id: Long,
  ...
  public val type:
      InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserTypeX92183fe7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserTypeX92183fe7?
        = null
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserTypeX92183fe7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6")
...
public fun inlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6(block: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6 = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadUserX692efce6 is missing required property '" + name + "'")
