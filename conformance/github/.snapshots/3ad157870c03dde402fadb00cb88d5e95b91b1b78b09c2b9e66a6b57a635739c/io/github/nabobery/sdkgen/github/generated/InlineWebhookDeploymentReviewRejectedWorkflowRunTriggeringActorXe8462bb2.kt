 ...
 * s/triggering_actor
 */
@Serializable(with = InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2.Serializer::class)
public class InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2(
  public val id: Int,
  ...
  public val type:
      InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorTypeX99a67327? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorTypeX99a67327? =
        null
    ...
    public fun build(): InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2 must be a JSON object")
      ...
      return InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorTypeX99a67327>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2")
...
public fun inlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2(block: InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2.Builder.() -> Unit): InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2 = InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentReviewRejectedWorkflowRunTriggeringActorXe8462bb2 is missing required property '" + name + "'")
