...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_release/properties/reactions.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_release/properties/reactions
 */
@Serializable(with = InlineWebhooksReleaseReactionsXb76673db.Serializer::class)
public class InlineWebhooksReleaseReactionsXb76673db(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhooksReleaseReactionsXb76673db {
      ...
      return InlineWebhooksReleaseReactionsXb76673db(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksReleaseReactionsXb76673db = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksReleaseReactionsXb76673db> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksReleaseReactionsXb76673db {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksReleaseReactionsXb76673db")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksReleaseReactionsXb76673db must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksReleaseReactionsXb76673db) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksReleaseReactionsXb76673db")
...
public fun inlineWebhooksReleaseReactionsXb76673db(block: InlineWebhooksReleaseReactionsXb76673db.Builder.() -> Unit): InlineWebhooksReleaseReactionsXb76673db = InlineWebhooksReleaseReactionsXb76673db.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksReleaseReactionsXb76673db is missing required property '" + name + "'")
