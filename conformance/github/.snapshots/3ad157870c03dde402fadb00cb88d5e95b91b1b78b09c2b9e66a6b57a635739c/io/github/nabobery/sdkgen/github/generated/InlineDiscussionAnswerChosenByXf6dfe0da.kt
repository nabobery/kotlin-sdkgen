...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/discussion/properties/answer_chosen_by.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/discussion/properties/answer_chosen_by
 */
@Serializable(with = InlineDiscussionAnswerChosenByXf6dfe0da.Serializer::class)
public class InlineDiscussionAnswerChosenByXf6dfe0da(
  public val id: Int,
  ...
  public val type: InlineDiscussionAnswerChosenByTypeXf3706e59? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineDiscussionAnswerChosenByTypeXf3706e59? = null
    ...
    public fun build(): InlineDiscussionAnswerChosenByXf6dfe0da {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineDiscussionAnswerChosenByXf6dfe0da(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineDiscussionAnswerChosenByXf6dfe0da = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineDiscussionAnswerChosenByXf6dfe0da> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineDiscussionAnswerChosenByXf6dfe0da {
      val jsonDecoder = decoder.requireJsonDecoder("InlineDiscussionAnswerChosenByXf6dfe0da")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineDiscussionAnswerChosenByXf6dfe0da must be a JSON object")
      ...
      return InlineDiscussionAnswerChosenByXf6dfe0da(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineDiscussionAnswerChosenByTypeXf3706e59>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineDiscussionAnswerChosenByXf6dfe0da) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineDiscussionAnswerChosenByXf6dfe0da")
...
public fun inlineDiscussionAnswerChosenByXf6dfe0da(block: InlineDiscussionAnswerChosenByXf6dfe0da.Builder.() -> Unit): InlineDiscussionAnswerChosenByXf6dfe0da = InlineDiscussionAnswerChosenByXf6dfe0da.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineDiscussionAnswerChosenByXf6dfe0da is missing required property '" + name + "'")
