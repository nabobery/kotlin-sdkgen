 ...
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce internal constructor(
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestAsbb98PullRequestRequestedReviewersItemParentXc35cade7?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent: InlineWebhookPullRequestAsbb98PullRequestRequestedReviewersItemParentXc35cade7?
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestAsbb98PullRequestRequestedReviewersItemPrivacyXd4490efb? = null
     ...
     */
    public var parent:
        InlineWebhookPullRequestAsbb98PullRequestRequestedReviewersItemParentXc35cade7?
      get() = parentState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestAsbb98PullRequestRequestedReviewersItemPrivacyXd4490efb>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce")
...
public fun inlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce(block: InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce = InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf2Xccd19bce property '" + name + "' is not nullable")
