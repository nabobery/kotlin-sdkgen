 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-organization-simple
 */
@Serializable(with = NullableOrganizationSimple.Serializer::class)
public class NullableOrganizationSimple(
  ...
  public class Builder {
    ...
    public fun build(): NullableOrganizationSimple {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): NullableOrganizationSimple = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<NullableOrganizationSimple> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): NullableOrganizationSimple {
      val jsonDecoder = decoder.requireJsonDecoder("NullableOrganizationSimple")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("NullableOrganizationSimple must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("NullableOrganizationSimple is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: NullableOrganizationSimple) {
      val jsonEncoder = encoder.requireJsonEncoder("NullableOrganizationSimple")
...
public fun nullableOrganizationSimple(block: NullableOrganizationSimple.Builder.() -> Unit): NullableOrganizationSimple = NullableOrganizationSimple.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NullableOrganizationSimple is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("NullableOrganizationSimple property '" + name + "' is not nullable")
