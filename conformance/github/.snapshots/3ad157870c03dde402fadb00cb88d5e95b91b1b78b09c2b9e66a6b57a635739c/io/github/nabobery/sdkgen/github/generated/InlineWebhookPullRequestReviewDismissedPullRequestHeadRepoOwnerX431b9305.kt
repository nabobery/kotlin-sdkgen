 ...
 * ties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305.Serializer::class)
public class InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerTypeX12eae7f6? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerTypeX12eae7f6? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerTypeX12eae7f6>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305")
...
public fun inlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305(block: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305.Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305 = InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305 is missing required property '" + name + "'")
