...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_release_1/properties/assets/items/properties/uploader.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_release_1/properties/assets/items/properties/uploader
 */
@Serializable(with = InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d.Serializer::class)
public class InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d(
  public val id: Int,
  ...
  public val type: InlineWebhooksRelease1AssetsItemUploaderTypeX1b75ffa8? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksRelease1AssetsItemUploaderTypeX1b75ffa8? = null
    ...
    public fun build(): InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d must be a JSON object")
      ...
      return InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksRelease1AssetsItemUploaderTypeX1b75ffa8>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d")
...
public fun inlineWebhooksRelease1AssetsItemUploaderX5e0ef77d(block: InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d.Builder.() -> Unit): InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d = InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d is missing required property '" + name + "'")
