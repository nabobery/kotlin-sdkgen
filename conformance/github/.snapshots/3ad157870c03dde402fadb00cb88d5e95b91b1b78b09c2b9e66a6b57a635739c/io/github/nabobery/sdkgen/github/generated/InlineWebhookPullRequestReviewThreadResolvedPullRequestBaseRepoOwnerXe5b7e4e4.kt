 ...
 * properties/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4.Serializer::class)
public class InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe0df9PullRequestBaseRepoOwnerTypeX9008b089? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe0df9PullRequestBaseRepoOwnerTypeX9008b089? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe0df9PullRequestBaseRepoOwnerTypeX9008b089>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4")
...
public fun inlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4(block: InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4 = InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4 is missing required property '" + name + "'")
