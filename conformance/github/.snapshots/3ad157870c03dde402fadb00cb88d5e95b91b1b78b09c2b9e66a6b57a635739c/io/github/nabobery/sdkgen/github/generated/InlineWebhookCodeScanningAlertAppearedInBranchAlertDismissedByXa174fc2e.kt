 ...
 * erties/dismissed_by
 */
@Serializable(with = InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e.Serializer::class)
public class InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e(
  public val id: Int,
  ...
  public val type:
      InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByTypeXa6770840? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByTypeXa6770840? =
        null
    ...
    public fun build(): InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e must be a JSON object")
      ...
      return InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByTypeXa6770840>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e")
...
public fun inlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e(block: InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e.Builder.() -> Unit): InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e = InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e is missing required property '" + name + "'")
