 ...
 * request/properties/head/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-request-removed/oneOf/0/properties/pull_
 * request/properties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96.Serializer::class)
public class InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerTypeXead1bd62? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerTypeXead1bd62? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96 must be a JSON object")
      ...
      return InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerTypeXead1bd62>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96")
...
public fun inlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96(block: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96.Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96 = InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestHeadRepoOwnerXc4139f96 is missing required property '" + name + "'")
