...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_milestone/properties/creator.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_milestone/properties/creator
 */
@Serializable(with = InlineWebhooksMilestoneCreatorX97e15615.Serializer::class)
public class InlineWebhooksMilestoneCreatorX97e15615(
  public val id: Int,
  ...
  public val type: InlineWebhooksMilestoneCreatorTypeX20c04496? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksMilestoneCreatorTypeX20c04496? = null
    ...
    public fun build(): InlineWebhooksMilestoneCreatorX97e15615 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksMilestoneCreatorX97e15615(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksMilestoneCreatorX97e15615 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksMilestoneCreatorX97e15615> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksMilestoneCreatorX97e15615 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksMilestoneCreatorX97e15615")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksMilestoneCreatorX97e15615 must be a JSON object")
      ...
      return InlineWebhooksMilestoneCreatorX97e15615(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksMilestoneCreatorTypeX20c04496>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksMilestoneCreatorX97e15615) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksMilestoneCreatorX97e15615")
...
public fun inlineWebhooksMilestoneCreatorX97e15615(block: InlineWebhooksMilestoneCreatorX97e15615.Builder.() -> Unit): InlineWebhooksMilestoneCreatorX97e15615 = InlineWebhooksMilestoneCreatorX97e15615.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksMilestoneCreatorX97e15615 is missing required property '" + name + "'")
