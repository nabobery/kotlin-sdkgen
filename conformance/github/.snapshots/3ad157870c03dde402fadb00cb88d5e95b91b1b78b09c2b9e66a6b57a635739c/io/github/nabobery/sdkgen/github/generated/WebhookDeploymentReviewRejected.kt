...
public class WebhookDeploymentReviewRejected internal constructor(
  ...
  workflowJobRunsState: FieldState<List<InlineWebhookDeploymentReviewRejectedWorkflowJobRunsItemXe09667bf>>,
) {
  ...
  internal object Serializer : KSerializer<WebhookDeploymentReviewRejected> {
