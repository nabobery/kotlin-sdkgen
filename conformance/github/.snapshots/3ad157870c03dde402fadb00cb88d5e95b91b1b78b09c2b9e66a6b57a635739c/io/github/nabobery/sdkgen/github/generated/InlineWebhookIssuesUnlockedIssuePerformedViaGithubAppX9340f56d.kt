 ...
 * thub_app
 */
@Serializable(with = InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d.Serializer::class)
public class InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppEventsItemXb26a8c16>>,
  private val permissionsState:
      FieldState<InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppPermissionsXe6745a29>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppEventsItemXb26a8c16>> =
      eventsState.copyValue { fieldValue -> fieldValue.toList() }

  /**
   * The list of events for the GitHub app
   */
  public val events: List<InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppEventsItemXb26a8c16>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppPermissionsXe6745a29?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4?
     ...
     */
    public var events:
        List<InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppEventsItemXb26a8c16>?
    ...
    public var permissions:
        InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppPermissionsXe6745a29?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d {
      ...
      return InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerXe40cf2c4?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d")
...
public fun inlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d(block: InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d.Builder.() -> Unit): InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d = InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesUnlockedIssuePerformedViaGithubAppX9340f56d property '" + name + "' is not nullable")
