 ...
 * base/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestSynchronizePullRequestBaseRepoCreatedAtX4da2810d,
  /**
  ...
  public val license: InlineWebhookPullRequestSynchronizePullRequestBaseRepoLicenseXb4f3d520?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestSynchronizePullRequestBaseRepoPushedAtX3b3f0fd5?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestSynchronizePullRequestBaseRepoVisibilityX246704f3,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestSy92fbPullRequestBaseRepoMergeCommitMessageX45c95d8a>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitTitleX67bf78c5>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestSynchronizePullRequestBaseRepoPermissionsX5b5b7228>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestSy92fbPullRequestBasePullRequestCreationP824dX188165ad>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestSy92fbPullRequestBaseSquashMergeCommitMessageXf55f2d0c>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestSy92fbPullRequestBaseRepoSquashMergeCommitTitleX8912b817>,
  ...
  public val mergeCommitTitle:
      InlineWebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitTitleX67bf78c5?
  ...
  public val permissions:
      InlineWebhookPullRequestSynchronizePullRequestBaseRepoPermissionsX5b5b7228?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestSynchronizePullRequestBaseRepoCreatedAtX4da2810d,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestSynchronizePullRequestBaseRepoLicenseXb4f3d520?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestSynchronizePullRequestBaseRepoPushedAtX3b3f0fd5?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestSynchronizePullRequestBaseRepoVisibilityX246704f3,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestSynchronizePullRequestBaseRepoCreatedAtX4da2810d? = null

    public var createdAt: InlineWebhookPullRequestSynchronizePullRequestBaseRepoCreatedAtX4da2810d
    ...
    private var visibilityValue:
        InlineWebhookPullRequestSynchronizePullRequestBaseRepoVisibilityX246704f3? = null

    public var visibility: InlineWebhookPullRequestSynchronizePullRequestBaseRepoVisibilityX246704f3
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestSynchronizePullRequestBaseRepoLicenseXb4f3d520?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestSynchronizePullRequestBaseRepoLicenseXb4f3d520?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestSynchronizePullRequestBaseRepoPushedAtX3b3f0fd5?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestSynchronizePullRequestBaseRepoPushedAtX3b3f0fd5?
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a {
      ...
      return InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestSynchronizePullRequestBaseRepoCreatedAtX4da2810d>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestSynchronizePullRequestBaseRepoVisibilityX246704f3>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestBaseRepoLicenseXb4f3d520?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestBaseRepoPushedAtX3b3f0fd5?>(requireNotNull(element)) }
      return InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a")
...
public fun inlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a(block: InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a = InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoX84e39e1a property '" + name + "' is not nullable")
