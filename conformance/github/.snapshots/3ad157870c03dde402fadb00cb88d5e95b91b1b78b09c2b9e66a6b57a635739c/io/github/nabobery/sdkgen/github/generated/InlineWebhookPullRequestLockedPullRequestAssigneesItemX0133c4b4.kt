 ...
 * nees/items
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLockedPullRequestAssigneesItemTypeX2c766114? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLockedPullRequestAssigneesItemTypeX2c766114? = null
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4 must be a JSON object")
      ...
      return InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestAssigneesItemTypeX2c766114>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4")
...
public fun inlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4(block: InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4 = InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestAssigneesItemX0133c4b4 is missing required property '" + name + "'")
