...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_review/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_review/properties/user
 */
@Serializable(with = InlineWebhooksReviewUserX9e6f3586.Serializer::class)
public class InlineWebhooksReviewUserX9e6f3586(
  public val id: Long,
  ...
  public val type: InlineWebhooksReviewUserTypeX8eadd193? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksReviewUserTypeX8eadd193? = null
    ...
    public fun build(): InlineWebhooksReviewUserX9e6f3586 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksReviewUserX9e6f3586(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksReviewUserX9e6f3586 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksReviewUserX9e6f3586> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksReviewUserX9e6f3586 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksReviewUserX9e6f3586")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksReviewUserX9e6f3586 must be a JSON object")
      ...
      return InlineWebhooksReviewUserX9e6f3586(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksReviewUserTypeX8eadd193>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksReviewUserX9e6f3586) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksReviewUserX9e6f3586")
...
public fun inlineWebhooksReviewUserX9e6f3586(block: InlineWebhooksReviewUserX9e6f3586.Builder.() -> Unit): InlineWebhooksReviewUserX9e6f3586 = InlineWebhooksReviewUserX9e6f3586.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksReviewUserX9e6f3586 is missing required property '" + name + "'")
