 ...
 * ties/reactions
 */
@Serializable(with = InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01.Serializer::class)
public class InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01 {
      ...
      return InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01")
...
public fun inlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01(block: InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01.Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01 = InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueReactionsXe25bab01 is missing required property '" + name + "'")
