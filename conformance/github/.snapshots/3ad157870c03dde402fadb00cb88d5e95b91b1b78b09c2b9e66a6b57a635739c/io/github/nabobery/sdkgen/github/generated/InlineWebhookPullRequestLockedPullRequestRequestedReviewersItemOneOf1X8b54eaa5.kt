 ...
 * sted_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-locked/properties/pull_request/properties/reque
 * sted_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemTypeX89cbdacd? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemTypeX89cbdacd? =
        null
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5 must be a JSON object")
      ...
      return InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemTypeX89cbdacd>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5")
...
public fun inlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5(block: InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5 = InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf1X8b54eaa5 is missing required property '" + name + "'")
