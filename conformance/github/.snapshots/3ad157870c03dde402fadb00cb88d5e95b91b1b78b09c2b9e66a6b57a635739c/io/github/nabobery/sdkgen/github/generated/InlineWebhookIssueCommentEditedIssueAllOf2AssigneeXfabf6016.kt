 ...
 * ignee
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentEditedIssueAllOf2AssigneeTypeXbe2eeea1? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentEditedIssueAllOf2AssigneeTypeXbe2eeea1? = null
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016 must be a JSON object")
      ...
      return InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentEditedIssueAllOf2AssigneeTypeXbe2eeea1>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016(block: InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016 = InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016 is missing required property '" + name + "'")
