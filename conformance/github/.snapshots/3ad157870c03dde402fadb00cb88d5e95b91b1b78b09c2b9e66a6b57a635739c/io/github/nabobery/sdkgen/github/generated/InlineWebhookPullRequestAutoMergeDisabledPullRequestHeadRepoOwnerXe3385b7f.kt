 ...
 * perties/head/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-disabled/properties/pull_request/pro
 * perties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f.Serializer::class)
public class InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerTypeXc08e4963? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerTypeXc08e4963?
        = null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerTypeXc08e4963>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f")
...
public fun inlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f(block: InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f = InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwnerXe3385b7f is missing required property '" + name + "'")
