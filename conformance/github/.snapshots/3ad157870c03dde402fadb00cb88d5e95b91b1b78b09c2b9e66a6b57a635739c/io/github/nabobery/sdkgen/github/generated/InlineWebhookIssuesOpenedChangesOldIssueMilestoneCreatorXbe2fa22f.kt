 ...
 * ties/milestone/properties/creator
 */
@Serializable(with = InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f.Serializer::class)
public class InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorTypeXb173e919? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorTypeXb173e919? = null
    ...
    public fun build(): InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f must be a JSON object")
      ...
      return InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorTypeXb173e919>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f")
...
public fun inlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f(block: InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f.Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f = InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueMilestoneCreatorXbe2fa22f is missing required property '" + name + "'")
