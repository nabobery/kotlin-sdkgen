 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-push/properties/commits/items/properties/committer
 */
@Serializable(with = InlineWebhookPushCommitsItemCommitterXf5654f5b.Serializer::class)
public class InlineWebhookPushCommitsItemCommitterXf5654f5b internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPushCommitsItemCommitterXf5654f5b {
      check(nameValue != null) { "name is required" }
      check(emailState !== FieldState.Absent) { "email is required, even when null" }
      return InlineWebhookPushCommitsItemCommitterXf5654f5b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPushCommitsItemCommitterXf5654f5b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPushCommitsItemCommitterXf5654f5b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPushCommitsItemCommitterXf5654f5b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPushCommitsItemCommitterXf5654f5b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPushCommitsItemCommitterXf5654f5b must be a JSON object")
      val name = json.decodeRequired<String>(rawObject, "name")
      if (!rawObject.containsKey("email")) {
        throw SerializationException("InlineWebhookPushCommitsItemCommitterXf5654f5b is missing required property 'email'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPushCommitsItemCommitterXf5654f5b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPushCommitsItemCommitterXf5654f5b")
...
public fun inlineWebhookPushCommitsItemCommitterXf5654f5b(block: InlineWebhookPushCommitsItemCommitterXf5654f5b.Builder.() -> Unit): InlineWebhookPushCommitsItemCommitterXf5654f5b = InlineWebhookPushCommitsItemCommitterXf5654f5b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPushCommitsItemCommitterXf5654f5b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPushCommitsItemCommitterXf5654f5b property '" + name + "' is not nullable")
