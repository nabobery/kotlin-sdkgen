 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-unpinned/properties/issue/allOf/0
 */
@Serializable(with = InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1.Serializer::class)
public class InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 internal constructor(
  ...
  public val user: InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4?,
  private val assigneeState:
      FieldState<InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f?>,
  private val draftState: FieldState<Boolean>,
  private val issueDependenciesSummaryState: FieldState<IssueDependenciesSummary>,
  labelsState: FieldState<List<InlineWebhookIssueCommentUnpinnedIssueAllOf1LabelsItemXd6df32dd>>,
  ...
  private val stateState: FieldState<InlineWebhookIssueCommentUnpinnedIssueAllOf1StateX277707b8>,
  ...
  private val labelsState:
      FieldState<List<InlineWebhookIssueCommentUnpinnedIssueAllOf1LabelsItemXd6df32dd>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f?
  ...
  public constructor(
    ...
    updatedAt: String,
    url: String,
    user: InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4?,
  ...
  public class Builder {
    ...
    private var userState: FieldState<InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4?
     ...
     */
    public var assignee: InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f?
      get() = assigneeState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssueCommentUnpinnedIssueAllOf1StateX277707b8> =
        FieldState.Absent
    ...
    public fun build(): InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 {
      ...
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 must be a JSON object")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 is missing required property 'active_lock_reason'")
      }
      ...
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 is missing required property 'milestone'")
      }
      ...
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4?>(requireNotNull(element)) }
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1")
...
public fun inlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1(block: InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1.Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 = InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1Xc6ca15f1 property '" + name + "' is not nullable")
