...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/assignees/items.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/assignees/items
 */
@Serializable(with = InlineWebhooksPullRequest5AssigneesItemX6f42e01c.Serializer::class)
public class InlineWebhooksPullRequest5AssigneesItemX6f42e01c(
  public val id: Int,
  ...
  public val type: InlineWebhooksPullRequest5AssigneesItemTypeX2f60c077? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksPullRequest5AssigneesItemTypeX2f60c077? = null
    ...
    public fun build(): InlineWebhooksPullRequest5AssigneesItemX6f42e01c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksPullRequest5AssigneesItemX6f42e01c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5AssigneesItemX6f42e01c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5AssigneesItemX6f42e01c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5AssigneesItemX6f42e01c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5AssigneesItemX6f42e01c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5AssigneesItemX6f42e01c must be a JSON object")
      ...
      return InlineWebhooksPullRequest5AssigneesItemX6f42e01c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksPullRequest5AssigneesItemTypeX2f60c077>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5AssigneesItemX6f42e01c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5AssigneesItemX6f42e01c")
...
public fun inlineWebhooksPullRequest5AssigneesItemX6f42e01c(block: InlineWebhooksPullRequest5AssigneesItemX6f42e01c.Builder.() -> Unit): InlineWebhooksPullRequest5AssigneesItemX6f42e01c = InlineWebhooksPullRequest5AssigneesItemX6f42e01c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5AssigneesItemX6f42e01c is missing required property '" + name + "'")
