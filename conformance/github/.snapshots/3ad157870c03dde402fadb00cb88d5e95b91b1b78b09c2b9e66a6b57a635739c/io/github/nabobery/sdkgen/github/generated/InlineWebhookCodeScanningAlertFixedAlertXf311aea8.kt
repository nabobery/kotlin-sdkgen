 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-code-scanning-alert-fixed/properties/alert
 */
@Serializable(with = InlineWebhookCodeScanningAlertFixedAlertXf311aea8.Serializer::class)
public class InlineWebhookCodeScanningAlertFixedAlertXf311aea8 internal constructor(
  /**
  ...
  public val dismissedBy: InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1?,
  /**
   * The reason for dismissing or closing the alert.
   */
  public val dismissedReason: InlineWebhookCodeScanningAlertFixedAlertDismissedReasonXece79ab1?,
  /**
  ...
  public val rule: InlineWebhookCodeScanningAlertFixedAlertRuleX56f0c43f,
  /**
   ...
   */
  public val state: InlineWebhookCodeScanningAlertFixedAlertStateX2bcd5b28?,
  public val tool: InlineWebhookCodeScanningAlertFixedAlertToolX69b66b7b,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val mostRecentInstanceState:
      FieldState<InlineWebhookCodeScanningAlertFixedAlertMostRecentInstanceXd8d94b89?>,
) {
  ...
  public val mostRecentInstance:
      InlineWebhookCodeScanningAlertFixedAlertMostRecentInstanceXd8d94b89?
    get() = mostRecentInstanceState.valueOrNull()

  public constructor(
    createdAt: String,
    dismissedAt: String?,
    dismissedBy: InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1?,
    dismissedReason: InlineWebhookCodeScanningAlertFixedAlertDismissedReasonXece79ab1?,
    htmlUrl: String,
    number: Int,
    rule: InlineWebhookCodeScanningAlertFixedAlertRuleX56f0c43f,
    state: InlineWebhookCodeScanningAlertFixedAlertStateX2bcd5b28?,
    tool: InlineWebhookCodeScanningAlertFixedAlertToolX69b66b7b,
    url: String,
  ...
  public class Builder {
    ...
    private var ruleValue: InlineWebhookCodeScanningAlertFixedAlertRuleX56f0c43f? = null

    public var rule: InlineWebhookCodeScanningAlertFixedAlertRuleX56f0c43f
      get() = requireNotNull(ruleValue) { "rule is required" }
      set(`value`) {
        ruleValue = value
      }

    private var toolValue: InlineWebhookCodeScanningAlertFixedAlertToolX69b66b7b? = null

    public var tool: InlineWebhookCodeScanningAlertFixedAlertToolX69b66b7b
    ...
    private var dismissedByState:
        FieldState<InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var dismissedBy: InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1?
    ...
    private var dismissedReasonState:
        FieldState<InlineWebhookCodeScanningAlertFixedAlertDismissedReasonXece79ab1?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var dismissedReason: InlineWebhookCodeScanningAlertFixedAlertDismissedReasonXece79ab1?
      get() = dismissedReasonState.valueOrNull()
      set(`value`) {
        dismissedReasonState = value.toNullableFieldState()
      }

    private var stateState: FieldState<InlineWebhookCodeScanningAlertFixedAlertStateX2bcd5b28?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var state: InlineWebhookCodeScanningAlertFixedAlertStateX2bcd5b28?
    ...
    public fun build(): InlineWebhookCodeScanningAlertFixedAlertXf311aea8 {
      ...
      return InlineWebhookCodeScanningAlertFixedAlertXf311aea8(
        createdAt = createdAt,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCodeScanningAlertFixedAlertXf311aea8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCodeScanningAlertFixedAlertXf311aea8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCodeScanningAlertFixedAlertXf311aea8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCodeScanningAlertFixedAlertXf311aea8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCodeScanningAlertFixedAlertXf311aea8 must be a JSON object")
      val createdAt = json.decodeRequired<String>(rawObject, "created_at")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val number = json.decodeRequired<Int>(rawObject, "number")
      val rule = json.decodeRequired<InlineWebhookCodeScanningAlertFixedAlertRuleX56f0c43f>(rawObject, "rule")
      val tool = json.decodeRequired<InlineWebhookCodeScanningAlertFixedAlertToolX69b66b7b>(rawObject, "tool")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("dismissed_at")) {
        throw SerializationException("InlineWebhookCodeScanningAlertFixedAlertXf311aea8 is missing required property 'dismissed_at'")
      }
      ...
      if (!rawObject.containsKey("dismissed_by")) {
        throw SerializationException("InlineWebhookCodeScanningAlertFixedAlertXf311aea8 is missing required property 'dismissed_by'")
      }
      val dismissedBy = rawObject["dismissed_by"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1?>(requireNotNull(element)) }
      if (!rawObject.containsKey("dismissed_reason")) {
        throw SerializationException("InlineWebhookCodeScanningAlertFixedAlertXf311aea8 is missing required property 'dismissed_reason'")
      }
      val dismissedReason = rawObject["dismissed_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCodeScanningAlertFixedAlertDismissedReasonXece79ab1?>(requireNotNull(element)) }
      if (!rawObject.containsKey("state")) {
        throw SerializationException("InlineWebhookCodeScanningAlertFixedAlertXf311aea8 is missing required property 'state'")
      }
      val state = rawObject["state"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCodeScanningAlertFixedAlertStateX2bcd5b28?>(requireNotNull(element)) }
      return InlineWebhookCodeScanningAlertFixedAlertXf311aea8(
        createdAt = createdAt,
        dismissedAt = dismissedAt,
        dismissedBy = dismissedBy,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookCodeScanningAlertFixedAlertXf311aea8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCodeScanningAlertFixedAlertXf311aea8")
...
public fun inlineWebhookCodeScanningAlertFixedAlertXf311aea8(block: InlineWebhookCodeScanningAlertFixedAlertXf311aea8.Builder.() -> Unit): InlineWebhookCodeScanningAlertFixedAlertXf311aea8 = InlineWebhookCodeScanningAlertFixedAlertXf311aea8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCodeScanningAlertFixedAlertXf311aea8 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookCodeScanningAlertFixedAlertXf311aea8 property '" + name + "' is not nullable")
