 ...
 * e/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoCreatedAtXd808649b,
  /**
  ...
  public val license: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoLicenseXefde002e?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoPushedAtX3ea23165?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoVisibilityXca3a4a46,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoMergeCommitMessageX3b11304d>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoMergeCommitTitleXcd1bcfdb>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoPermissionsXea6df9dc>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestEnd765PullRequestBasePullRequestCreationP824dX4f45e821>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestEnd765PullRequestBaseSquashMergeCommitMessageX19e6a069>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestEnd765PullRequestBaseRepoSquashMergeCommitTitleX3787915c>,
  ...
  public val mergeCommitTitle:
      InlineWebhookPullRequestEnqueuedPullRequestBaseRepoMergeCommitTitleXcd1bcfdb?
    get() = mergeCommitTitleState.valueOrNull()

  public val organization: String?
    get() = organizationState.valueOrNull()

  public val permissions: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoPermissionsXea6df9dc?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoCreatedAtXd808649b,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoLicenseXefde002e?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoPushedAtX3ea23165?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoVisibilityXca3a4a46,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestEnqueuedPullRequestBaseRepoCreatedAtXd808649b? = null

    public var createdAt: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoCreatedAtXd808649b
    ...
    private var visibilityValue:
        InlineWebhookPullRequestEnqueuedPullRequestBaseRepoVisibilityXca3a4a46? = null

    public var visibility: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoVisibilityXca3a4a46
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoLicenseXefde002e?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoLicenseXefde002e?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoPushedAtX3ea23165?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoPushedAtX3ea23165?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoPermissionsXea6df9dc?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b {
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoCreatedAtXd808649b>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoVisibilityXca3a4a46>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoLicenseXefde002e?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoPushedAtX3ea23165?>(requireNotNull(element)) }
      return InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b(block: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b = InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoX628bdb0b property '" + name + "' is not nullable")
