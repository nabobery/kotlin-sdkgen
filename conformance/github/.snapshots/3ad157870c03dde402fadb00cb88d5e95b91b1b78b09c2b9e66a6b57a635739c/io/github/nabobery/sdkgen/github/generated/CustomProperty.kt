...
public class CustomProperty internal constructor(
  ...
  allowedValuesState: FieldState<List<String>?>,
  ...
  private val allowedValuesState: FieldState<List<String>?> =
      allowedValuesState.copyValue { fieldValue -> fieldValue?.let { collection0 -> collection0.toList() } }
  ...
  public class Builder {
    ...
    public var allowedValues: List<String>?
      get() = allowedValuesState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        allowedValuesState = value?.let { collection0 -> collection0.toList() }.toNullableFieldState()
      }
  ...
  internal object Serializer : KSerializer<CustomProperty> {
