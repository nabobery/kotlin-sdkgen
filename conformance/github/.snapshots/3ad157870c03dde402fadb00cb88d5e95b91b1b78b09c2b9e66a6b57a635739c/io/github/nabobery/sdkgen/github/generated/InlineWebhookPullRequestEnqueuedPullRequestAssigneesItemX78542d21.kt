 ...
 * ignees/items
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemTypeX93f9771f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemTypeX93f9771f? = null
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21 must be a JSON object")
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemTypeX93f9771f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21(block: InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21 = InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestAssigneesItemX78542d21 is missing required property '" + name + "'")
