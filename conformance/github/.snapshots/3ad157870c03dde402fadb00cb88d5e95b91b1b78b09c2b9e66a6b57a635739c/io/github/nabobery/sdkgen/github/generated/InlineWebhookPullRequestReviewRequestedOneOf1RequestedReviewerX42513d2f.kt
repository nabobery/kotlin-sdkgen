...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-requested/oneOf/0/properties/requested_r
 * eviewer.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-requested/oneOf/0/properties/requested_r
 * eviewer
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerTypeXbfb402b5? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerTypeXbfb402b5? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerTypeXbfb402b5>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f(block: InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f = InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1RequestedReviewerX42513d2f is missing required property '" + name + "'")
