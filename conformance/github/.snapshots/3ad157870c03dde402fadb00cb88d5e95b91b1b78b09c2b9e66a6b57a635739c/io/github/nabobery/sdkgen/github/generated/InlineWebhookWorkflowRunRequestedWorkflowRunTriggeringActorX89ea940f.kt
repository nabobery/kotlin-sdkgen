 ...
 * iggering_actor
 */
@Serializable(with = InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f.Serializer::class)
public class InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f(
  public val id: Int,
  ...
  public val type: InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorTypeX0b36580b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorTypeX0b36580b? =
        null
    ...
    public fun build(): InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f must be a JSON object")
      ...
      return InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorTypeX0b36580b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f")
...
public fun inlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f(block: InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f.Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f = InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunTriggeringActorX89ea940f is missing required property '" + name + "'")
