...
public class Import internal constructor(
  ...
  projectChoicesState: FieldState<List<InlineImportProjectChoicesItemX77a49ad4>>,
  ...
  private val projectChoicesState: FieldState<List<InlineImportProjectChoicesItemX77a49ad4>> =
      projectChoicesState.copyValue { fieldValue -> fieldValue.toList() }
  ...
  public class Builder {
    ...
    public var projectChoices: List<InlineImportProjectChoicesItemX77a49ad4>?
      get() = projectChoicesState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        val present = requireNotNull(value) { "projectChoices is not nullable; call unsetProjectChoices() to omit it" }
        projectChoicesState = FieldState.Value(present.toList())
      }
  ...
  internal object Serializer : KSerializer<Import> {
