 ...
 * properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerTypeXd43d4fb0? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerTypeXd43d4fb0? = null
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f must be a JSON object")
      ...
      return InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerTypeXd43d4fb0>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f")
...
public fun inlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f(block: InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f = InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestBaseRepoOwnerX372f860f is missing required property '" + name + "'")
