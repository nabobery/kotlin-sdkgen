 ...
 * e/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestAssignedPullRequestBaseRepoCreatedAtX0fc810a0,
  /**
  ...
  public val license: InlineWebhookPullRequestAssignedPullRequestBaseRepoLicenseX3ce8b034?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestAssignedPullRequestBaseRepoPushedAtXf7f3c59d?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestAssignedPullRequestBaseRepoVisibilityXa9c3c1be,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestAssignedPullRequestBaseRepoMergeCommitMessageX09b44246>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestAssignedPullRequestBaseRepoMergeCommitTitleXf64399ce>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestAssignedPullRequestBaseRepoPermissionsX5652862b>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestAsbb98PullRequestBasePullRequestCreationP824dXcb29f654>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestAsbb98PullRequestBaseSquashMergeCommitMessageX370ed878>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestAsbb98PullRequestBaseRepoSquashMergeCommitTitleXfe13c1ec>,
  ...
  public val permissions: InlineWebhookPullRequestAssignedPullRequestBaseRepoPermissionsX5652862b?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestAssignedPullRequestBaseRepoCreatedAtX0fc810a0,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestAssignedPullRequestBaseRepoLicenseX3ce8b034?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestAssignedPullRequestBaseRepoPushedAtXf7f3c59d?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestAssignedPullRequestBaseRepoVisibilityXa9c3c1be,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestAssignedPullRequestBaseRepoCreatedAtX0fc810a0? = null

    public var createdAt: InlineWebhookPullRequestAssignedPullRequestBaseRepoCreatedAtX0fc810a0
    ...
    private var visibilityValue:
        InlineWebhookPullRequestAssignedPullRequestBaseRepoVisibilityXa9c3c1be? = null

    public var visibility: InlineWebhookPullRequestAssignedPullRequestBaseRepoVisibilityXa9c3c1be
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestAssignedPullRequestBaseRepoLicenseX3ce8b034?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestAssignedPullRequestBaseRepoLicenseX3ce8b034?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestAssignedPullRequestBaseRepoPushedAtXf7f3c59d?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestAssignedPullRequestBaseRepoPushedAtXf7f3c59d?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestAssignedPullRequestBaseRepoPermissionsX5652862b?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a {
      ...
      return InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestAssignedPullRequestBaseRepoCreatedAtX0fc810a0>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestAssignedPullRequestBaseRepoVisibilityXa9c3c1be>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestBaseRepoLicenseX3ce8b034?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestBaseRepoOwnerXf38d5a99?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestBaseRepoPushedAtXf7f3c59d?>(requireNotNull(element)) }
      return InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a")
...
public fun inlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a(block: InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a = InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseRepoX09d4050a property '" + name + "' is not nullable")
