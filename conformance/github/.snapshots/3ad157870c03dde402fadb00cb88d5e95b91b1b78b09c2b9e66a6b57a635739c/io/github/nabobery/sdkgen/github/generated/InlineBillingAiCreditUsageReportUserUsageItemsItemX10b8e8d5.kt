...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/billing-ai-credit-usage-report-user/properties/usageItems/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/billing-ai-credit-usage-report-user/properties/usageItems/items
 */
@Serializable(with = InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5.Serializer::class)
public class InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5 {
      ...
      return InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5")
...
public fun inlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5(block: InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5.Builder.() -> Unit): InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5 = InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineBillingAiCreditUsageReportUserUsageItemsItemX10b8e8d5 is missing required property '" + name + "'")
