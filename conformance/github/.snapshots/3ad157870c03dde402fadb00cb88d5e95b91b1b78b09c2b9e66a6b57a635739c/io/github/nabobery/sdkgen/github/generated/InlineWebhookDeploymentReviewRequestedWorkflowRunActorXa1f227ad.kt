 ...
 * es/actor
 */
@Serializable(with = InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad.Serializer::class)
public class InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad(
  public val id: Int,
  ...
  public val type: InlineWebhookDeploymentReviewRequestedWorkflowRunActorTypeX143b81f3? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentReviewRequestedWorkflowRunActorTypeX143b81f3? = null
    ...
    public fun build(): InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad must be a JSON object")
      ...
      return InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewRequestedWorkflowRunActorTypeX143b81f3>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad")
...
public fun inlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad(block: InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad.Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad = InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad is missing required property '" + name + "'")
