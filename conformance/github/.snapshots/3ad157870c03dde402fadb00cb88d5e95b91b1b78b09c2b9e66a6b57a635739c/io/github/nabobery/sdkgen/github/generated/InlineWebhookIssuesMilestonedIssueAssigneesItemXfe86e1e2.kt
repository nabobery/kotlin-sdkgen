 ...
 * s
 */
@Serializable(with = InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2.Serializer::class)
public class InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesMilestonedIssueAssigneesItemTypeX9c75f183? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesMilestonedIssueAssigneesItemTypeX9c75f183? = null
    ...
    public fun build(): InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2 must be a JSON object")
      ...
      return InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesMilestonedIssueAssigneesItemTypeX9c75f183>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2")
...
public fun inlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2(block: InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2.Builder.() -> Unit): InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2 = InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2 is missing required property '" + name + "'")
