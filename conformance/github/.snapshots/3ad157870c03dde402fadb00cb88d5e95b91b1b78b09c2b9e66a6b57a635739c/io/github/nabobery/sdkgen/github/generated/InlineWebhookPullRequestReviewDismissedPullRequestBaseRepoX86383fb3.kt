 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3.Serializer::class)
public class InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 internal constructor(
  /**
  ...
  public val createdAt:
      InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoCreatedAtXbfcb1ac3,
  /**
  ...
  public val license: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoLicenseXeecb9d34?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoPushedAtX56e30b3f?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe8581PullRequestBaseRepoMergeCommitMessageX53919df2>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe8581PullRequestBaseRepoMergeCommitTitleXb3e37c62>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoPermissionsX8bb96d29>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe8581PullRequestBasePullRequestCreationP824dXf17f86f6>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe8581PullRequestBaseSquashMergeCommitMessageX33b52b5e>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe8581PullRequestBaseRepoSquashMergeCommitTitleXe85cea37>,
  ...
  public val mergeCommitMessage:
      InlineWebhookPullRequestRe8581PullRequestBaseRepoMergeCommitMessageX53919df2?
  ...
  public val permissions:
      InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoPermissionsX8bb96d29?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoCreatedAtXbfcb1ac3,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoLicenseXeecb9d34?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoPushedAtX56e30b3f?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoVisibilityX37977939,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoCreatedAtXbfcb1ac3? = null
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoVisibilityX37977939? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoLicenseXeecb9d34?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoLicenseXeecb9d34?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoPushedAtX56e30b3f?> =
        FieldState.Absent
     ...
     */
    public var pushedAt:
        InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoPushedAtX56e30b3f?
    ...
    public fun build(): InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 {
      ...
      return InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoCreatedAtXbfcb1ac3>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoVisibilityX37977939>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoLicenseXeecb9d34?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoOwnerXd510365e?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoPushedAtX56e30b3f?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3")
...
public fun inlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3(block: InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3.Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 = InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseRepoX86383fb3 property '" + name + "' is not nullable")
