...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue/properties/milestone/properties/creator.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue/properties/milestone/properties/creator
 */
@Serializable(with = InlineWebhooksIssueMilestoneCreatorXc00aa031.Serializer::class)
public class InlineWebhooksIssueMilestoneCreatorXc00aa031(
  public val id: Int,
  ...
  public val type: InlineWebhooksIssueMilestoneCreatorTypeXabbcdfaa? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksIssueMilestoneCreatorTypeXabbcdfaa? = null
    ...
    public fun build(): InlineWebhooksIssueMilestoneCreatorXc00aa031 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksIssueMilestoneCreatorXc00aa031(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssueMilestoneCreatorXc00aa031 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssueMilestoneCreatorXc00aa031> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssueMilestoneCreatorXc00aa031 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssueMilestoneCreatorXc00aa031")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssueMilestoneCreatorXc00aa031 must be a JSON object")
      ...
      return InlineWebhooksIssueMilestoneCreatorXc00aa031(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksIssueMilestoneCreatorTypeXabbcdfaa>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssueMilestoneCreatorXc00aa031) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssueMilestoneCreatorXc00aa031")
...
public fun inlineWebhooksIssueMilestoneCreatorXc00aa031(block: InlineWebhooksIssueMilestoneCreatorXc00aa031.Builder.() -> Unit): InlineWebhooksIssueMilestoneCreatorXc00aa031 = InlineWebhooksIssueMilestoneCreatorXc00aa031.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssueMilestoneCreatorXc00aa031 is missing required property '" + name + "'")
