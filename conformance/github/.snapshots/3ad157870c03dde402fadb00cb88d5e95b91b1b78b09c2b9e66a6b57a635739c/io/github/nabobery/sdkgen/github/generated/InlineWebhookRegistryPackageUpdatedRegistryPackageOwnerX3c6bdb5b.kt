 ...
 * ies/owner
 */
@Serializable(with = InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b.Serializer::class)
public class InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b {
      ...
      return InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b(
        avatarUrl = avatarUrl,
        eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b")
...
public fun inlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b(block: InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b.Builder.() -> Unit): InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b = InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookRegistryPackageUpdatedRegistryPackageOwnerX3c6bdb5b is missing required property '" + name + "'")
