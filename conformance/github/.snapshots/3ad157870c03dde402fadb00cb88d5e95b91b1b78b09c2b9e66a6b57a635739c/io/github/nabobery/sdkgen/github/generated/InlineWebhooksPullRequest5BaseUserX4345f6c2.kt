...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/base/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/base/properties/user
 */
@Serializable(with = InlineWebhooksPullRequest5BaseUserX4345f6c2.Serializer::class)
public class InlineWebhooksPullRequest5BaseUserX4345f6c2(
  public val id: Long,
  ...
  public val type: InlineWebhooksPullRequest5BaseUserTypeXd9dd5270? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksPullRequest5BaseUserTypeXd9dd5270? = null
    ...
    public fun build(): InlineWebhooksPullRequest5BaseUserX4345f6c2 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksPullRequest5BaseUserX4345f6c2(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5BaseUserX4345f6c2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5BaseUserX4345f6c2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5BaseUserX4345f6c2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5BaseUserX4345f6c2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5BaseUserX4345f6c2 must be a JSON object")
      ...
      return InlineWebhooksPullRequest5BaseUserX4345f6c2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksPullRequest5BaseUserTypeXd9dd5270>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5BaseUserX4345f6c2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5BaseUserX4345f6c2")
...
public fun inlineWebhooksPullRequest5BaseUserX4345f6c2(block: InlineWebhooksPullRequest5BaseUserX4345f6c2.Builder.() -> Unit): InlineWebhooksPullRequest5BaseUserX4345f6c2 = InlineWebhooksPullRequest5BaseUserX4345f6c2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5BaseUserX4345f6c2 is missing required property '" + name + "'")
