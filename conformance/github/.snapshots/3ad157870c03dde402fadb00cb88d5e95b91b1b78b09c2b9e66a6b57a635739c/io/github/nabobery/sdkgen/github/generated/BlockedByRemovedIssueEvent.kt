...
@Serializable
public data class BlockedByRemovedIssueEventView(
  public val actor: SimpleUser,
  @SerialName("blocked_by")
  public val blockedBy: NullableIssueReference?,
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/blocked-by-removed-issue-event
 */
@Serializable(with = BlockedByRemovedIssueEvent.Serializer::class)
public class BlockedByRemovedIssueEvent(
  public val actor: SimpleUser,
  public val blockedBy: NullableIssueReference?,
  public val commitId: String?,
  public val commitUrl: String?,
  ...
  public class Builder {
    ...
    private var blockedByState: FieldState<NullableIssueReference?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var blockedBy: NullableIssueReference?
      get() = blockedByState.valueOrNull()
      set(`value`) {
        blockedByState = value.toNullableFieldState()
      }
    ...
    public fun build(): BlockedByRemovedIssueEvent {
      ...
      check(blockedByState !== FieldState.Absent) { "blockedBy is required, even when null" }
      ...
      return BlockedByRemovedIssueEvent(
        actor = actor,
        blockedBy = blockedByState.valueOrNull(),
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BlockedByRemovedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BlockedByRemovedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): BlockedByRemovedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("BlockedByRemovedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BlockedByRemovedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("blocked_by")) {
        throw SerializationException("BlockedByRemovedIssueEvent is missing required property 'blocked_by'")
      }
      val blockedBy = rawObject["blocked_by"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<NullableIssueReference?>(requireNotNull(element)) }
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("BlockedByRemovedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("BlockedByRemovedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("BlockedByRemovedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: BlockedByRemovedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("BlockedByRemovedIssueEvent")
      val json = jsonEncoder.json
      val raw = buildJsonObject {
        put("actor", json.encodeToJsonElement(value.actor))
        put("blocked_by", value.blockedBy?.let { json.encodeToJsonElement(it) } ?: JsonNull)
...
public fun blockedByRemovedIssueEvent(block: BlockedByRemovedIssueEvent.Builder.() -> Unit): BlockedByRemovedIssueEvent = BlockedByRemovedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BlockedByRemovedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("BlockedByRemovedIssueEvent property '" + name + "' is not nullable")
