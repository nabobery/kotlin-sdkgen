 ...
 * t/properties/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoOwnerTypeX1f55b811? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoOwnerTypeX1f55b811? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoOwnerTypeX1f55b811>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e(block: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e is missing required property '" + name + "'")
