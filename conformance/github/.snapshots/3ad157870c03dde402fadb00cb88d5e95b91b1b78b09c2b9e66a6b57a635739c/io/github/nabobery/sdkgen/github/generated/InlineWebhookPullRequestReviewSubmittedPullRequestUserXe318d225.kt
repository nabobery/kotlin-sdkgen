 ...
 * ties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225.Serializer::class)
public class InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestReviewSubmittedPullRequestUserTypeX89bd093c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewSubmittedPullRequestUserTypeX89bd093c? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestUserTypeX89bd093c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225")
...
public fun inlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225(block: InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225.Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225 = InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225 is missing required property '" + name + "'")
