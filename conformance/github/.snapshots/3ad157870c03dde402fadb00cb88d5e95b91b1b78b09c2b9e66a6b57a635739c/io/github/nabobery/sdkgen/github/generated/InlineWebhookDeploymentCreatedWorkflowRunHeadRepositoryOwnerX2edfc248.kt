 ...
 * epository/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-created/properties/workflow_run/properties/head_r
 * epository/properties/owner
 */
@Serializable(with = InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248.Serializer::class)
public class InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248 = InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248 must be a JSON object")
      return InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248")
...
public fun inlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248(block: InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248.Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248 = InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248.build(block)
