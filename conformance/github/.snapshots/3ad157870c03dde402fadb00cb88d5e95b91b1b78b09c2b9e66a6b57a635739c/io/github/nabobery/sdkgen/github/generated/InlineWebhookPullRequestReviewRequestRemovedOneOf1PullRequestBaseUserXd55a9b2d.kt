 ...
 * request/properties/base/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseUserTypeX28e0fd18? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseUserTypeX28e0fd18? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseUserTypeX28e0fd18>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d(block: InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d = InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseUserXd55a9b2d is missing required property '" + name + "'")
