 ...
 * s/triggering_actor
 */
@Serializable(with = InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450.Serializer::class)
public class InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450(
  public val id: Int,
  ...
  public val type:
      InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorTypeX00671c7d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorTypeX00671c7d? =
        null
    ...
    public fun build(): InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450 must be a JSON object")
      ...
      return InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorTypeX00671c7d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450")
...
public fun inlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450(block: InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450.Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450 = InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentReviewApprovedWorkflowRunTriggeringActorXac0a0450 is missing required property '" + name + "'")
