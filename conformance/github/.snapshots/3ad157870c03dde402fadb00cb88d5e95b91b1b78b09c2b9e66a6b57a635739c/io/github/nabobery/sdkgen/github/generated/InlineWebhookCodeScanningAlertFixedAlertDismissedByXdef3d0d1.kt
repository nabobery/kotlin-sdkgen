 ...
 * sed_by
 */
@Serializable(with = InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1.Serializer::class)
public class InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1(
  public val id: Int,
  ...
  public val type: InlineWebhookCodeScanningAlertFixedAlertDismissedByTypeX56006c01? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookCodeScanningAlertFixedAlertDismissedByTypeX56006c01? = null
    ...
    public fun build(): InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1 must be a JSON object")
      ...
      return InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookCodeScanningAlertFixedAlertDismissedByTypeX56006c01>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1")
...
public fun inlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1(block: InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1.Builder.() -> Unit): InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1 = InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCodeScanningAlertFixedAlertDismissedByXdef3d0d1 is missing required property '" + name + "'")
