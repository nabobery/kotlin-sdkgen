 ...
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue/properties/performed_via_github_app/properties/owner
 */
@Serializable(with = InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65.Serializer::class)
public class InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65(
  public val id: Int,
  ...
  public val type: InlineWebhooksIssuePerformedViaGithubAppOwnerTypeXc2a24b0a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksIssuePerformedViaGithubAppOwnerTypeXc2a24b0a? = null
    ...
    public fun build(): InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65 must be a JSON object")
      ...
      return InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksIssuePerformedViaGithubAppOwnerTypeXc2a24b0a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65")
...
public fun inlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65(block: InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65.Builder.() -> Unit): InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65 = InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65 is missing required property '" + name + "'")
