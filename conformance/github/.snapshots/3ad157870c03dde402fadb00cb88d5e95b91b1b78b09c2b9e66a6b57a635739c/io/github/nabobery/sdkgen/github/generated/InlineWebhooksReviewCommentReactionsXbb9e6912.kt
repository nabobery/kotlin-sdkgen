...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_review_comment/properties/reactions.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_review_comment/properties/reactions
 */
@Serializable(with = InlineWebhooksReviewCommentReactionsXbb9e6912.Serializer::class)
public class InlineWebhooksReviewCommentReactionsXbb9e6912(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhooksReviewCommentReactionsXbb9e6912 {
      ...
      return InlineWebhooksReviewCommentReactionsXbb9e6912(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksReviewCommentReactionsXbb9e6912 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksReviewCommentReactionsXbb9e6912> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksReviewCommentReactionsXbb9e6912 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksReviewCommentReactionsXbb9e6912")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksReviewCommentReactionsXbb9e6912 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksReviewCommentReactionsXbb9e6912) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksReviewCommentReactionsXbb9e6912")
...
public fun inlineWebhooksReviewCommentReactionsXbb9e6912(block: InlineWebhooksReviewCommentReactionsXbb9e6912.Builder.() -> Unit): InlineWebhooksReviewCommentReactionsXbb9e6912 = InlineWebhooksReviewCommentReactionsXbb9e6912.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksReviewCommentReactionsXbb9e6912 is missing required property '" + name + "'")
