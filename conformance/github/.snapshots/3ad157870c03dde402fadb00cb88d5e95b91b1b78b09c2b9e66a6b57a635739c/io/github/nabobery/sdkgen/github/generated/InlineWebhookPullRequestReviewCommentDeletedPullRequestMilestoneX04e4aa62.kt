 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62.Serializer::class)
public class InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62(
  /**
  ...
  public val creator:
      InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31?,
   ...
   */
  public val state: InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneStateXe444112e,
  /**
  ...
  public class Builder {
    ...
    private var stateValue:
        InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneStateXe444112e? = null

    public var state: InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneStateXe444112e
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31?>
        = FieldState.Absent
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62 {
      ...
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneStateXe444112e>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62")
...
public fun inlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62(block: InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62 = InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneX04e4aa62 property '" + name + "' is not nullable")
