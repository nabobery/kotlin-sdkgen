...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-push/properties/repository/properties/owner.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-push/properties/repository/properties/owner
 */
@Serializable(with = InlineWebhookPushRepositoryOwnerX679ba505.Serializer::class)
public class InlineWebhookPushRepositoryOwnerX679ba505(
  public val id: Int,
  ...
  public val type: InlineWebhookPushRepositoryOwnerTypeX2ac2a17b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPushRepositoryOwnerTypeX2ac2a17b? = null
    ...
    public fun build(): InlineWebhookPushRepositoryOwnerX679ba505 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPushRepositoryOwnerX679ba505(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPushRepositoryOwnerX679ba505 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPushRepositoryOwnerX679ba505> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPushRepositoryOwnerX679ba505 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPushRepositoryOwnerX679ba505")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPushRepositoryOwnerX679ba505 must be a JSON object")
      ...
      return InlineWebhookPushRepositoryOwnerX679ba505(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPushRepositoryOwnerTypeX2ac2a17b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPushRepositoryOwnerX679ba505) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPushRepositoryOwnerX679ba505")
...
public fun inlineWebhookPushRepositoryOwnerX679ba505(block: InlineWebhookPushRepositoryOwnerX679ba505.Builder.() -> Unit): InlineWebhookPushRepositoryOwnerX679ba505 = InlineWebhookPushRepositoryOwnerX679ba505.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPushRepositoryOwnerX679ba505 is missing required property '" + name + "'")
