...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-closed/properties/issue/allOf/0/properties/assignee.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-closed/properties/issue/allOf/0/properties/assignee
 */
@Serializable(with = InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207.Serializer::class)
public class InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesClosedIssueAllOf1AssigneeTypeXf0cc2f31? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesClosedIssueAllOf1AssigneeTypeXf0cc2f31? = null
    ...
    public fun build(): InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207 must be a JSON object")
      ...
      return InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesClosedIssueAllOf1AssigneeTypeXf0cc2f31>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207")
...
public fun inlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207(block: InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207.Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207 = InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207 is missing required property '" + name + "'")
