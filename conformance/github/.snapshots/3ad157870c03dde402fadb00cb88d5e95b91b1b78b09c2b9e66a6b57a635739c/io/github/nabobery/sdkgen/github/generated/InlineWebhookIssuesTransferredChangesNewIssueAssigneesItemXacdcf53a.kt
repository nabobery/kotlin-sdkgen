 ...
 * roperties/assignees/items
 */
@Serializable(with = InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a.Serializer::class)
public class InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemTypeXa26abcdd? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemTypeXa26abcdd? = null
    ...
    public fun build(): InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a must be a JSON object")
      ...
      return InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemTypeXa26abcdd>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a")
...
public fun inlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a(block: InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a.Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a = InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueAssigneesItemXacdcf53a is missing required property '" + name + "'")
