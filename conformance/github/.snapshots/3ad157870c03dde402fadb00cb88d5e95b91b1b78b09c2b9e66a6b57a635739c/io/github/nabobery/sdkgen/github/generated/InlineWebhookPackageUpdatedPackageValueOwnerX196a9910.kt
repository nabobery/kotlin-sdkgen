...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-package-updated/properties/package/properties/owner.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-package-updated/properties/package/properties/owner
 */
@Serializable(with = InlineWebhookPackageUpdatedPackageValueOwnerX196a9910.Serializer::class)
public class InlineWebhookPackageUpdatedPackageValueOwnerX196a9910(
  public val id: Int,
  ...
  public val type: InlineWebhookPackageUpdatedPackageValueOwnerTypeX58c001bc? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPackageUpdatedPackageValueOwnerTypeX58c001bc? = null
    ...
    public fun build(): InlineWebhookPackageUpdatedPackageValueOwnerX196a9910 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPackageUpdatedPackageValueOwnerX196a9910(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPackageUpdatedPackageValueOwnerX196a9910 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPackageUpdatedPackageValueOwnerX196a9910> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPackageUpdatedPackageValueOwnerX196a9910 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPackageUpdatedPackageValueOwnerX196a9910")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPackageUpdatedPackageValueOwnerX196a9910 must be a JSON object")
      ...
      return InlineWebhookPackageUpdatedPackageValueOwnerX196a9910(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPackageUpdatedPackageValueOwnerTypeX58c001bc>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPackageUpdatedPackageValueOwnerX196a9910) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPackageUpdatedPackageValueOwnerX196a9910")
...
public fun inlineWebhookPackageUpdatedPackageValueOwnerX196a9910(block: InlineWebhookPackageUpdatedPackageValueOwnerX196a9910.Builder.() -> Unit): InlineWebhookPackageUpdatedPackageValueOwnerX196a9910 = InlineWebhookPackageUpdatedPackageValueOwnerX196a9910.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPackageUpdatedPackageValueOwnerX196a9910 is missing required property '" + name + "'")
