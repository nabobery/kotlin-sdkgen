 ...
 * estone/properties/creator
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorTypeX5cf726d9? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorTypeX5cf726d9? = null
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536 must be a JSON object")
      ...
      return InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorTypeX5cf726d9>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536(block: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536 = InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536 is missing required property '" + name + "'")
