 ...
 * erties/base/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-enabled/properties/pull_request/prop
 * erties/base/properties/user
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69.Serializer::class)
public class InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserTypeX3d4b7073? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserTypeX3d4b7073? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69 must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserTypeX3d4b7073>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69")
...
public fun inlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69(block: InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69 = InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestBaseUserX5d388d69 is missing required property '" + name + "'")
