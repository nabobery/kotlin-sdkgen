 ...
 * request/properties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c.Serializer::class)
public class InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerTypeXc5ff2a80? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerTypeXc5ff2a80? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c must be a JSON object")
      ...
      return InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerTypeXc5ff2a80>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c")
...
public fun inlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c(block: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c.Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c = InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestHeadRepoOwnerX69ff612c is missing required property '" + name + "'")
