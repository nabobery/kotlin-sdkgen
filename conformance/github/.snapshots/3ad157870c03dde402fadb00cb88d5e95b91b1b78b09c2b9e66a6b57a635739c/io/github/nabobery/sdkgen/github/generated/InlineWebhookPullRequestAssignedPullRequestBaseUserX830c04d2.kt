 ...
 * e/properties/user
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestAssignedPullRequestBaseUserTypeX91dc944b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAssignedPullRequestBaseUserTypeX91dc944b? = null
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2 must be a JSON object")
      ...
      return InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestBaseUserTypeX91dc944b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2")
...
public fun inlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2(block: InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2 = InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestBaseUserX830c04d2 is missing required property '" + name + "'")
