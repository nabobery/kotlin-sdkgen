...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-fork/properties/forkee/allOf/1/properties/owner.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-fork/properties/forkee/allOf/1/properties/owner
 */
@Serializable(with = InlineWebhookForkForkeeAllOf2OwnerX9c8ea267.Serializer::class)
public class InlineWebhookForkForkeeAllOf2OwnerX9c8ea267(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookForkForkeeAllOf2OwnerX9c8ea267 = InlineWebhookForkForkeeAllOf2OwnerX9c8ea267(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookForkForkeeAllOf2OwnerX9c8ea267 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookForkForkeeAllOf2OwnerX9c8ea267> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookForkForkeeAllOf2OwnerX9c8ea267 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookForkForkeeAllOf2OwnerX9c8ea267")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookForkForkeeAllOf2OwnerX9c8ea267 must be a JSON object")
      return InlineWebhookForkForkeeAllOf2OwnerX9c8ea267(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookForkForkeeAllOf2OwnerX9c8ea267) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookForkForkeeAllOf2OwnerX9c8ea267")
...
public fun inlineWebhookForkForkeeAllOf2OwnerX9c8ea267(block: InlineWebhookForkForkeeAllOf2OwnerX9c8ea267.Builder.() -> Unit): InlineWebhookForkForkeeAllOf2OwnerX9c8ea267 = InlineWebhookForkForkeeAllOf2OwnerX9c8ea267.build(block)
