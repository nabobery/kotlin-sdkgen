 ...
 * ies/package_version/properties/release/properties/author.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-registry-package-updated/properties/registry_package/propert
 * ies/package_version/properties/release/properties/author
 */
@Serializable(with = InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e.Serializer::class)
public class InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e {
      ...
      return InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e(
        avatarUrl = avatarUrl,
        eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e")
...
public fun inlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e(block: InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e.Builder.() -> Unit): InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e = InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookRegistryPacka3525RegistryPackagePackageVersionAuthorX2c8b4d1e is missing required property '" + name + "'")
