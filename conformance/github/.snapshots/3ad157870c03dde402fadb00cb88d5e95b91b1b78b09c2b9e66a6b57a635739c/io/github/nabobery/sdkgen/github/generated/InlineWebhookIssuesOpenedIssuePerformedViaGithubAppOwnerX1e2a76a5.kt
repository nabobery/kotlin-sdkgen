 ...
 * ub_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5.Serializer::class)
public class InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerTypeX100ad208? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerTypeX100ad208? = null
    ...
    public fun build(): InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5 must be a JSON object")
      ...
      return InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerTypeX100ad208>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5")
...
public fun inlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5(block: InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5.Builder.() -> Unit): InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5 = InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5 is missing required property '" + name + "'")
