 ...
 * es/repository
 */
@Serializable(with = InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126.Serializer::class)
public class InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126(
  ...
  public val owner:
      InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0? = null,
  ...
  public class Builder {
    ...
    public var owner: InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0? =
        null
    ...
    public fun build(): InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126 = InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126 must be a JSON object")
      return InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126(
        ...
        owner = rawObject["owner"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126")
...
public fun inlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126(block: InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126.Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126 = InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126.build(block)
