...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/copilot-space-collaborator/anyOf/0.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/copilot-space-collaborator/anyOf/0
 */
@Serializable(with = InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912.Serializer::class)
public class InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912 internal constructor(
  /**
  ...
  public constructor(
    actorType: InlineCopilotSpaceCollaboratorAnyOf1AllOf2ActorTypeXeaf570b4,
    avatarUrl: String,
    eventsUrl: String,
    followersUrl: String,
    followingUrl: String,
    ...
    reposUrl: String,
    role: InlineCopilotSpaceCollaboratorAnyOf1AllOf2RoleXcf063803,
    siteAdmin: Boolean,
    starredUrl: String,
  ...
  public class Builder {
    ...
    public fun build(): InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912 {
      ...
      return InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912(
        actorType = actorType,
        avatarUrl = avatarUrl,
        eventsUrl = eventsUrl,
        followersUrl = followersUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912 must be a JSON object")
      ...
      if (!rawObject.containsKey("gravatar_id")) {
        throw SerializationException("InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912 is missing required property 'gravatar_id'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912")
...
public fun inlineCopilotSpaceCollaboratorAnyOf1Xec8d9912(block: InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912.Builder.() -> Unit): InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912 = InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineCopilotSpaceCollaboratorAnyOf1Xec8d9912 property '" + name + "' is not nullable")
