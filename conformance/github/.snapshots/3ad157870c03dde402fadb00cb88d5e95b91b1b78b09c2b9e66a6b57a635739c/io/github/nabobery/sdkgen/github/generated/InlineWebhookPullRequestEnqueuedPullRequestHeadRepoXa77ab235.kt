 ...
 * d/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoCreatedAtX6b0cc8f0,
  /**
  ...
  public val license: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoLicenseX0c436853?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoPushedAtX663bd36f?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoVisibilityXb1a51ea4,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoMergeCommitMessageXa0df8836>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoMergeCommitTitleX31f74304>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoPermissionsXd235cac9>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestEnd765PullRequestHeadPullRequestCreationP824dXd3f9e17e>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestEnd765PullRequestHeadSquashMergeCommitMessageX9f62ab64>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestEnd765PullRequestHeadRepoSquashMergeCommitTitleXfa1b0181>,
  ...
  public val permissions: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoPermissionsXd235cac9?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoCreatedAtX6b0cc8f0,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoLicenseX0c436853?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoPushedAtX663bd36f?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoVisibilityXb1a51ea4,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestEnqueuedPullRequestHeadRepoCreatedAtX6b0cc8f0? = null

    public var createdAt: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoCreatedAtX6b0cc8f0
    ...
    private var visibilityValue:
        InlineWebhookPullRequestEnqueuedPullRequestHeadRepoVisibilityXb1a51ea4? = null

    public var visibility: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoVisibilityXb1a51ea4
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoLicenseX0c436853?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoLicenseX0c436853?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoPushedAtX663bd36f?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoPushedAtX663bd36f?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoPermissionsXd235cac9?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 {
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoCreatedAtX6b0cc8f0>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoVisibilityXb1a51ea4>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoLicenseX0c436853?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoPushedAtX663bd36f?>(requireNotNull(element)) }
      return InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235(block: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 = InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoXa77ab235 property '" + name + "' is not nullable")
