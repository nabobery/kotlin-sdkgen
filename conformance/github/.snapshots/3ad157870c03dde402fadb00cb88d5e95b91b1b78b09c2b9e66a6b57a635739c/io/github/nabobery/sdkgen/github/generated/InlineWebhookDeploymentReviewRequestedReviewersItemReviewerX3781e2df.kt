 ...
 * rties/reviewer
 */
@Serializable(with = InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df.Serializer::class)
public class InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df(
  public val id: Int,
  /**
  ...
  public val type: InlineWebhookDeploymentReviewRequestedReviewersItemReviewerTypeXbbdd5023? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentReviewRequestedReviewersItemReviewerTypeXbbdd5023? =
        null
    ...
    public fun build(): InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df {
      check(idValue != null) { "id is required" }
      return InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df(
        id = id,
        avatarUrl = avatarUrl,
        deleted = deleted,
        email = email,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df must be a JSON object")
      ...
      return InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewRequestedReviewersItemReviewerTypeXbbdd5023>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df")
...
public fun inlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df(block: InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df.Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df = InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedReviewersItemReviewerX3781e2df is missing required property '" + name + "'")
