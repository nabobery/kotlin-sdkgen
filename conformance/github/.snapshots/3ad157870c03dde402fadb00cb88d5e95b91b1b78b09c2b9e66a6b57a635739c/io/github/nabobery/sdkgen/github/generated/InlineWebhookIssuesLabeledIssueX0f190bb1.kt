 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-labeled/properties/issue
 */
@Serializable(with = InlineWebhookIssuesLabeledIssueX0f190bb1.Serializer::class)
public class InlineWebhookIssuesLabeledIssueX0f190bb1 internal constructor(
  public val activeLockReason: InlineWebhookIssuesLabeledIssueActiveLockReasonX1c4bfaf6?,
  assignees: List<InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724?>,
  /**
   * How the author is associated with the repository.
   */
  public val authorAssociation: InlineWebhookIssuesLabeledIssueAuthorAssociationX0d83cc07,
  /**
   ...
   */
  public val milestone: InlineWebhookIssuesLabeledIssueMilestoneXd5790e20?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhookIssuesLabeledIssueReactionsXdeb4fd9b,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhookIssuesLabeledIssueUserX5187f2e0?,
  private val assigneeState: FieldState<InlineWebhookIssuesLabeledIssueAssigneeX32a06287?>,
  ...
  labelsState: FieldState<List<InlineWebhookIssuesLabeledIssueLabelsItemXeaad11cb>>,
  private val lockedState: FieldState<Boolean>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384?>,
  private val pinnedCommentState: FieldState<NullableIssueComment?>,
  private val pullRequestState: FieldState<InlineWebhookIssuesLabeledIssuePullRequestX34e18e8e>,
  private val stateState: FieldState<InlineWebhookIssuesLabeledIssueStateXf76602dd>,
  ...
  public val assignees: List<InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724?> =
      assignees.toList()
  ...
  private val labelsState: FieldState<List<InlineWebhookIssuesLabeledIssueLabelsItemXeaad11cb>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssuesLabeledIssueAssigneeX32a06287?
  ...
  public val labels: List<InlineWebhookIssuesLabeledIssueLabelsItemXeaad11cb>?
   ...
   */
  public val performedViaGithubApp: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384?
  ...
  public val pullRequest: InlineWebhookIssuesLabeledIssuePullRequestX34e18e8e?
    get() = pullRequestState.valueOrNull()

  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssuesLabeledIssueStateXf76602dd?
  ...
  public constructor(
    activeLockReason: InlineWebhookIssuesLabeledIssueActiveLockReasonX1c4bfaf6?,
    assignees: List<InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724?>,
    authorAssociation: InlineWebhookIssuesLabeledIssueAuthorAssociationX0d83cc07,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    id: Long,
    labelsUrl: String,
    milestone: InlineWebhookIssuesLabeledIssueMilestoneXd5790e20?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhookIssuesLabeledIssueReactionsXdeb4fd9b,
    repositoryUrl: String,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhookIssuesLabeledIssueUserX5187f2e0?,
  ...
  public class Builder {
    private var assigneesValue: List<InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724?>? = null

    public var assignees: List<InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724?>
      get() = requireNotNull(assigneesValue) { "assignees is required" }.toList()
      set(`value`) {
        assigneesValue = value.toList()
      }

    private var authorAssociationValue: InlineWebhookIssuesLabeledIssueAuthorAssociationX0d83cc07? =
        null

    public var authorAssociation: InlineWebhookIssuesLabeledIssueAuthorAssociationX0d83cc07
    ...
    private var reactionsValue: InlineWebhookIssuesLabeledIssueReactionsXdeb4fd9b? = null

    public var reactions: InlineWebhookIssuesLabeledIssueReactionsXdeb4fd9b
    ...
    private var activeLockReasonState:
        FieldState<InlineWebhookIssuesLabeledIssueActiveLockReasonX1c4bfaf6?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var activeLockReason: InlineWebhookIssuesLabeledIssueActiveLockReasonX1c4bfaf6?
    ...
    private var milestoneState: FieldState<InlineWebhookIssuesLabeledIssueMilestoneXd5790e20?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhookIssuesLabeledIssueMilestoneXd5790e20?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhookIssuesLabeledIssueUserX5187f2e0?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssuesLabeledIssueUserX5187f2e0?
      get() = userState.valueOrNull()
      set(`value`) {
        userState = value.toNullableFieldState()
      }

    private var assigneeState: FieldState<InlineWebhookIssuesLabeledIssueAssigneeX32a06287?> =
        FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var assignee: InlineWebhookIssuesLabeledIssueAssigneeX32a06287?
      get() = assigneeState.valueOrNull()
      set(`value`) {
    ...
    private var labelsState: FieldState<List<InlineWebhookIssuesLabeledIssueLabelsItemXeaad11cb>> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhookIssuesLabeledIssueLabelsItemXeaad11cb>?
     ...
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var performedViaGithubApp: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384?
      get() = performedViaGithubAppState.valueOrNull()
      set(`value`) {
    ...
    private var pullRequestState: FieldState<InlineWebhookIssuesLabeledIssuePullRequestX34e18e8e> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhookIssuesLabeledIssuePullRequestX34e18e8e?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssuesLabeledIssueStateXf76602dd> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var state: InlineWebhookIssuesLabeledIssueStateXf76602dd?
      get() = stateState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesLabeledIssueX0f190bb1 {
      ...
      return InlineWebhookIssuesLabeledIssueX0f190bb1(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLabeledIssueX0f190bb1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLabeledIssueX0f190bb1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLabeledIssueX0f190bb1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLabeledIssueX0f190bb1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLabeledIssueX0f190bb1 must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhookIssuesLabeledIssueAuthorAssociationX0d83cc07>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhookIssuesLabeledIssueReactionsXdeb4fd9b>(rawObject, "reactions")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssueX0f190bb1 is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesLabeledIssueActiveLockReasonX1c4bfaf6?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssueX0f190bb1 is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssueX0f190bb1 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssueX0f190bb1 is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesLabeledIssueMilestoneXd5790e20?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssueX0f190bb1 is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesLabeledIssueUserX5187f2e0?>(requireNotNull(element)) }
      return InlineWebhookIssuesLabeledIssueX0f190bb1(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLabeledIssueX0f190bb1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLabeledIssueX0f190bb1")
...
public fun inlineWebhookIssuesLabeledIssueX0f190bb1(block: InlineWebhookIssuesLabeledIssueX0f190bb1.Builder.() -> Unit): InlineWebhookIssuesLabeledIssueX0f190bb1 = InlineWebhookIssuesLabeledIssueX0f190bb1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLabeledIssueX0f190bb1 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesLabeledIssueX0f190bb1 property '" + name + "' is not nullable")
