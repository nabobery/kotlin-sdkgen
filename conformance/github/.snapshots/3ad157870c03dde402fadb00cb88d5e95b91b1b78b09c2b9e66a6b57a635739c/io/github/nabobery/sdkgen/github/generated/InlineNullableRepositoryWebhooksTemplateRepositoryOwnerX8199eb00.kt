 ...
 * es/owner
 */
@Serializable(with = InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00.Serializer::class)
public class InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00(
  ...
  public class Builder {
    ...
    public fun build(): InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00 = InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00 must be a JSON object")
      return InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00")
...
public fun inlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00(block: InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00.Builder.() -> Unit): InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00 = InlineNullableRepositoryWebhooksTemplateRepositoryOwnerX8199eb00.build(block)
