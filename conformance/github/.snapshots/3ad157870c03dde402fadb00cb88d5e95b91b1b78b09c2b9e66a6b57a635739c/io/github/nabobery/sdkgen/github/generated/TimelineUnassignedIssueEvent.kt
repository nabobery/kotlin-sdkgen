 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/timeline-unassigned-issue-event
 */
@Serializable(with = TimelineUnassignedIssueEvent.Serializer::class)
public class TimelineUnassignedIssueEvent(
  ...
  public class Builder {
    ...
    public fun build(): TimelineUnassignedIssueEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TimelineUnassignedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TimelineUnassignedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): TimelineUnassignedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("TimelineUnassignedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TimelineUnassignedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("TimelineUnassignedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("TimelineUnassignedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("TimelineUnassignedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: TimelineUnassignedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("TimelineUnassignedIssueEvent")
...
public fun timelineUnassignedIssueEvent(block: TimelineUnassignedIssueEvent.Builder.() -> Unit): TimelineUnassignedIssueEvent = TimelineUnassignedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TimelineUnassignedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("TimelineUnassignedIssueEvent property '" + name + "' is not nullable")
