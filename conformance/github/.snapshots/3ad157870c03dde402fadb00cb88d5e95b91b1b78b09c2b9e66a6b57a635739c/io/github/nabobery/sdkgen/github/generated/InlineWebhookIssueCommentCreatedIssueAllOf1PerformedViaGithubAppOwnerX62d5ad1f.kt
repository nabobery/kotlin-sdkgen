 ...
 * rformed_via_github_app/properties/owner
 */
@Serializable(with = InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f.Serializer::class)
public class InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssueCommentC396cIssueAllOf1PerformedViaGithubAppOwnerTypeXcd12a89f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f must be a JSON object")
      ...
      return InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentC396cIssueAllOf1PerformedViaGithubAppOwnerTypeXcd12a89f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f")
...
public fun inlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f(block: InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f.Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f = InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f is missing required property '" + name + "'")
