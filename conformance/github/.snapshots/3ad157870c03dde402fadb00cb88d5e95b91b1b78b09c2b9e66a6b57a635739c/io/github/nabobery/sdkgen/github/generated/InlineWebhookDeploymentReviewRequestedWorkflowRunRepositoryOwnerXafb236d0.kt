 ...
 * es/repository/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-review-requested/properties/workflow_run/properti
 * es/repository/properties/owner
 */
@Serializable(with = InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0.Serializer::class)
public class InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0 = InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0 must be a JSON object")
      return InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0")
...
public fun inlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0(block: InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0.Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0 = InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryOwnerXafb236d0.build(block)
