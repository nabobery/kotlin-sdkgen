 ...
 * /properties/user
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestStackedPullRequestBaseUserTypeXea1719a2? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestStackedPullRequestBaseUserTypeXea1719a2? = null
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36 must be a JSON object")
      ...
      return InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestStackedPullRequestBaseUserTypeXea1719a2>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36")
...
public fun inlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36(block: InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36 = InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestBaseUserXf42c6b36 is missing required property '" + name + "'")
