...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-labeled/properties/issue/properties/assignee.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-labeled/properties/issue/properties/assignee
 */
@Serializable(with = InlineWebhookIssuesLabeledIssueAssigneeX32a06287.Serializer::class)
public class InlineWebhookIssuesLabeledIssueAssigneeX32a06287(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesLabeledIssueAssigneeTypeXca189e37? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesLabeledIssueAssigneeTypeXca189e37? = null
    ...
    public fun build(): InlineWebhookIssuesLabeledIssueAssigneeX32a06287 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesLabeledIssueAssigneeX32a06287(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLabeledIssueAssigneeX32a06287 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLabeledIssueAssigneeX32a06287> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLabeledIssueAssigneeX32a06287 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLabeledIssueAssigneeX32a06287")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLabeledIssueAssigneeX32a06287 must be a JSON object")
      ...
      return InlineWebhookIssuesLabeledIssueAssigneeX32a06287(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesLabeledIssueAssigneeTypeXca189e37>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLabeledIssueAssigneeX32a06287) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLabeledIssueAssigneeX32a06287")
...
public fun inlineWebhookIssuesLabeledIssueAssigneeX32a06287(block: InlineWebhookIssuesLabeledIssueAssigneeX32a06287.Builder.() -> Unit): InlineWebhookIssuesLabeledIssueAssigneeX32a06287 = InlineWebhookIssuesLabeledIssueAssigneeX32a06287.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLabeledIssueAssigneeX32a06287 is missing required property '" + name + "'")
