...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_sponsorship/properties/sponsor.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_sponsorship/properties/sponsor
 */
@Serializable(with = InlineWebhooksSponsorshipSponsorX08503003.Serializer::class)
public class InlineWebhooksSponsorshipSponsorX08503003(
  public val id: Int,
  ...
  public val type: InlineWebhooksSponsorshipSponsorTypeXba2396bd? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksSponsorshipSponsorTypeXba2396bd? = null
    ...
    public fun build(): InlineWebhooksSponsorshipSponsorX08503003 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksSponsorshipSponsorX08503003(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksSponsorshipSponsorX08503003 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksSponsorshipSponsorX08503003> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksSponsorshipSponsorX08503003 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksSponsorshipSponsorX08503003")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksSponsorshipSponsorX08503003 must be a JSON object")
      ...
      return InlineWebhooksSponsorshipSponsorX08503003(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksSponsorshipSponsorTypeXba2396bd>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksSponsorshipSponsorX08503003) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksSponsorshipSponsorX08503003")
...
public fun inlineWebhooksSponsorshipSponsorX08503003(block: InlineWebhooksSponsorshipSponsorX08503003.Builder.() -> Unit): InlineWebhooksSponsorshipSponsorX08503003 = InlineWebhooksSponsorshipSponsorX08503003.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksSponsorshipSponsorX08503003 is missing required property '" + name + "'")
