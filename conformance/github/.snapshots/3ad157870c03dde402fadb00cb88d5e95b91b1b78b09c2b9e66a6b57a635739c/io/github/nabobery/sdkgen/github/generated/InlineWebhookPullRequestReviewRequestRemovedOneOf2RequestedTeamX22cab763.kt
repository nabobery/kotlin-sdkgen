 ...
 * sted_team
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763 internal constructor(
  /**
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamParentX64e754f0?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent: InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamParentX64e754f0?
  ...
  public constructor(
    ...
    nodeId: String,
    permission: String,
    privacy: InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamPrivacyX2d8afe91,
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamPrivacyX2d8afe91? = null
     ...
     */
    public var parent:
        InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamParentX64e754f0?
      get() = parentState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763 {
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763 must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamPrivacyX2d8afe91>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763 is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763(block: InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763 = InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2RequestedTeamX22cab763 property '" + name + "' is not nullable")
