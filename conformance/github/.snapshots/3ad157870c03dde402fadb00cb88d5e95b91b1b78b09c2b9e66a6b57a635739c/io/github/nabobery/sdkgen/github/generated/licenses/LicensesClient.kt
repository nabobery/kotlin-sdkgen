package io.github.nabobery.sdkgen.github.generated.licenses
...
import io.github.nabobery.sdkgen.github.generated.License
import io.github.nabobery.sdkgen.github.generated.LicenseContent
import io.github.nabobery.sdkgen.github.generated.LicenseSimple
...
internal object LicensesCodecs {
  internal const val LICENSESGET_RESPONSE_CODEC_ID: String = "licenses/get.response"
  ...
  internal val licensesGetResponseCodecAlternative0Registry: MediaTypeCodecRegistry<License> =
  ...
  internal val licensesGetResponseCodecAlternative2Registry: MediaTypeCodecRegistry<BasicError> =
  ...
  internal val licensesGetResponseCodecAlternative3Registry: MediaTypeCodecRegistry<BasicError> =
      MediaTypeCodecRegistry.of(licensesGetResponseCodecAlternative3Codec)

  internal val licensesGetRequestCodecRegistry: MediaTypeCodecRegistry<Unit> =
      MediaTypeCodecRegistry.of()

  internal val licensesGetResponseCodecRegistry: MediaTypeCodecRegistry<License> =
      MediaTypeCodecRegistry.of(licensesGetResponseCodec)

  internal const val LICENSESGETALLCOMMONLYUSED_RESPONSE_CODEC_ID: String =
  ...
  internal val licensesGetAllCommonlyUsedResponseCodecAlternative0Registry:
  ...
  internal val licensesGetAllCommonlyUsedRequestCodecRegistry: MediaTypeCodecRegistry<Unit> =
      MediaTypeCodecRegistry.of()

  internal val licensesGetAllCommonlyUsedResponseCodecRegistry:
      MediaTypeCodecRegistry<List<LicenseSimple>> =
      MediaTypeCodecRegistry.of(licensesGetAllCommonlyUsedResponseCodec)

  internal const val LICENSESGETFORREPO_RESPONSE_CODEC_ID: String = "licenses/get-for-repo.response"
  ...
  internal val licensesGetForRepoResponseCodecAlternative0Registry:
  ...
  internal val licensesGetForRepoResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<BasicError> =
      MediaTypeCodecRegistry.of(licensesGetForRepoResponseCodecAlternative1Codec)

  internal val licensesGetForRepoRequestCodecRegistry: MediaTypeCodecRegistry<Unit> =
      MediaTypeCodecRegistry.of()

  internal val licensesGetForRepoResponseCodecRegistry: MediaTypeCodecRegistry<LicenseContent> =
...
public class LicensesClient(
  ...
  public companion object {
    internal val licensesGetMetadata: OperationMetadata by
    ...
    internal val licensesGetAllCommonlyUsedMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val licensesGetForRepoMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
