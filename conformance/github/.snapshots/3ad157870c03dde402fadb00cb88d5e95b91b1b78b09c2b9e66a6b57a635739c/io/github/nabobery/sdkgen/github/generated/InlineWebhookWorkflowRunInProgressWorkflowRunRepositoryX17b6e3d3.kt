 ...
 * repository
 */
@Serializable(with = InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3.Serializer::class)
public class InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3(
  /**
  ...
  public val owner: InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerXbdd9307d?,
  /**
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerXbdd9307d?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerXbdd9307d?
      get() = ownerState.valueOrNull()
      set(`value`) {
        ownerState = value.toNullableFieldState()
      }

    public fun build(): InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3 {
      ...
      return InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3 must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerXbdd9307d?>(requireNotNull(element)) }
      return InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3(
        archiveUrl = archiveUrl,
        assigneesUrl = assigneesUrl,
        blobsUrl = blobsUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3")
...
public fun inlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3(block: InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3.Builder.() -> Unit): InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3 = InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookWorkflowRunInProgressWorkflowRunRepositoryX17b6e3d3 property '" + name + "' is not nullable")
