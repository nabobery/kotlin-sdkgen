 ...
 * roperties/base/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9.Serializer::class)
public class InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 internal constructor(
  /**
  ...
  public val createdAt:
      InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoCreatedAtXab28efbc,
  /**
  ...
  public val owner: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212?,
  /**
  ...
  public val pushedAt:
      InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoPushedAtXba3b6fcd?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestRed95bPullRequestBaseRepoVisibilityX5a48cdff,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestBaseRepoMergeCommitMessageX1983e323>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestBaseRepoMergeCommitTitleX0faf1b3e>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestBaseRepoPermissionsX60229eb2>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestBasePullRequestCreationP824dX5359fe9d>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestBaseSquashMergeCommitMessageXcd6f18e2>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestBaseRepoSquashMergeCommitTitleXc2cf9511>,
  ...
  public val mergeCommitMessage:
      InlineWebhookPullRequestRed95bPullRequestBaseRepoMergeCommitMessageX1983e323?
  ...
  public val permissions: InlineWebhookPullRequestRed95bPullRequestBaseRepoPermissionsX60229eb2?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoCreatedAtXab28efbc,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoLicenseX0434545f?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoPushedAtXba3b6fcd?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestRed95bPullRequestBaseRepoVisibilityX5a48cdff,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoCreatedAtXab28efbc? = null
    ...
    private var visibilityValue:
        InlineWebhookPullRequestRed95bPullRequestBaseRepoVisibilityX5a48cdff? = null

    public var visibility: InlineWebhookPullRequestRed95bPullRequestBaseRepoVisibilityX5a48cdff
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoLicenseX0434545f?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoPushedAtXba3b6fcd?>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestRed95bPullRequestBaseRepoPermissionsX60229eb2?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 {
      ...
      return InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoCreatedAtXab28efbc>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestRed95bPullRequestBaseRepoVisibilityX5a48cdff>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoLicenseX0434545f?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwnerXb1004212?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoPushedAtXba3b6fcd?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9")
...
public fun inlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9(block: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 = InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseRepoXf9a968c9 property '" + name + "' is not nullable")
