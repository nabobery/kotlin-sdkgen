 ...
 * t/properties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoOwnerTypeX86a2a5b3? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoOwnerTypeX86a2a5b3? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoOwnerTypeX86a2a5b3>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8(block: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8 = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8 is missing required property '" + name + "'")
