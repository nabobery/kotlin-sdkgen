 ...
 * perties/requested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-disabled/properties/pull_request/pro
 * perties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28.Serializer::class)
public class InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemTypeX8637a0c5? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemTypeX8637a0c5? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28 must be a JSON object")
      ...
      return InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemTypeX8637a0c5>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28")
...
public fun inlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28(block: InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28.Builder.() -> Unit): InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28 = InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf1Xdf150d28 is missing required property '" + name + "'")
