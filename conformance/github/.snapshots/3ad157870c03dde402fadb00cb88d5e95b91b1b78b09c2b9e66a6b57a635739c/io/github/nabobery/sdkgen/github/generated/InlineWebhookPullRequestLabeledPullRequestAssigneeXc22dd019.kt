 ...
 * gnee
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLabeledPullRequestAssigneeTypeX304e5066? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLabeledPullRequestAssigneeTypeX304e5066? = null
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019 must be a JSON object")
      ...
      return InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestAssigneeTypeX304e5066>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019")
...
public fun inlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019(block: InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019 = InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestAssigneeXc22dd019 is missing required property '" + name + "'")
