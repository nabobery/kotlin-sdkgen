 ...
 * quested_reviewers/items/oneOf/1
 */
@Serializable(with = InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb.Serializer::class)
public class InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb internal constructor(
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemParentX090404d9?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent: InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemParentX090404d9?
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemPrivacyX6efb95da? = null
     ...
     */
    public var parent:
        InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemParentX090404d9?
      get() = parentState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemPrivacyX6efb95da>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb")
...
public fun inlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb(block: InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb.Builder.() -> Unit): InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb = InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf2X588efccb property '" + name + "' is not nullable")
