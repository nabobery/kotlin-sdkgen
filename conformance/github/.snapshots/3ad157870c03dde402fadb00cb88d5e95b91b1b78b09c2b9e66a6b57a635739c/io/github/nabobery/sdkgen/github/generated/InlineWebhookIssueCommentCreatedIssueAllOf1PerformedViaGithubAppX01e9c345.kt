 ...
 */
@Serializable(with = InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345.Serializer::class)
public class InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssueCommentC396cIssueAllOf1PerformedViaGithubAppItemXc6d98664>>,
  private val permissionsState:
      FieldState<InlineWebhookIssueCommentC396cIssueAllOf1PermissionsX6e5c4c41>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssueCommentC396cIssueAllOf1PerformedViaGithubAppItemXc6d98664>>
   ...
   */
  public val events:
      List<InlineWebhookIssueCommentC396cIssueAllOf1PerformedViaGithubAppItemXc6d98664>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssueCommentC396cIssueAllOf1PermissionsX6e5c4c41?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f?>
        = FieldState.Absent
     ...
     */
    public var owner:
        InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookIssueCommentC396cIssueAllOf1PermissionsX6e5c4c41?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 {
      ...
      return InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppOwnerX62d5ad1f?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345")
...
public fun inlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345(block: InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345.Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 = InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345 property '" + name + "' is not nullable")
