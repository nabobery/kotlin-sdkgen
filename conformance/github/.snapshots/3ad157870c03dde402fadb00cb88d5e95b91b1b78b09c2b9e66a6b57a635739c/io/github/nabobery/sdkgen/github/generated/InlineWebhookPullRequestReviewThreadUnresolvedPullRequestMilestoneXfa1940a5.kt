 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5.Serializer::class)
public class InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5(
  /**
  ...
  public val creator: InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d?,
  ...
  public class Builder {
    ...
    private var stateValue:
        InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneStateX15eba71c? = null
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d?
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5 {
      ...
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneStateX15eba71c>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5")
...
public fun inlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5(block: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5 = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestMilestoneXfa1940a5 property '" + name + "' is not nullable")
