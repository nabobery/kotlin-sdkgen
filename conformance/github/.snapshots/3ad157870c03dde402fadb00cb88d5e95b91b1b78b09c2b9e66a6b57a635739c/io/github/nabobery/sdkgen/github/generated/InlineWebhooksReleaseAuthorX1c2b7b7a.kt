...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_release/properties/author.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_release/properties/author
 */
@Serializable(with = InlineWebhooksReleaseAuthorX1c2b7b7a.Serializer::class)
public class InlineWebhooksReleaseAuthorX1c2b7b7a(
  public val id: Int,
  ...
  public val type: InlineWebhooksReleaseAuthorTypeXf3fdd82a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksReleaseAuthorTypeXf3fdd82a? = null
    ...
    public fun build(): InlineWebhooksReleaseAuthorX1c2b7b7a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksReleaseAuthorX1c2b7b7a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksReleaseAuthorX1c2b7b7a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksReleaseAuthorX1c2b7b7a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksReleaseAuthorX1c2b7b7a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksReleaseAuthorX1c2b7b7a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksReleaseAuthorX1c2b7b7a must be a JSON object")
      ...
      return InlineWebhooksReleaseAuthorX1c2b7b7a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksReleaseAuthorTypeXf3fdd82a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksReleaseAuthorX1c2b7b7a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksReleaseAuthorX1c2b7b7a")
...
public fun inlineWebhooksReleaseAuthorX1c2b7b7a(block: InlineWebhooksReleaseAuthorX1c2b7b7a.Builder.() -> Unit): InlineWebhooksReleaseAuthorX1c2b7b7a = InlineWebhooksReleaseAuthorX1c2b7b7a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksReleaseAuthorX1c2b7b7a is missing required property '" + name + "'")
