 ...
 * roperties/assignee
 */
@Serializable(with = InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282.Serializer::class)
public class InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesTransferredChangesNewIssueAssigneeTypeX990b4787? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesTransferredChangesNewIssueAssigneeTypeX990b4787? = null
    ...
    public fun build(): InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282 must be a JSON object")
      ...
      return InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesTransferredChangesNewIssueAssigneeTypeX990b4787>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282")
...
public fun inlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282(block: InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282.Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282 = InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueAssigneeX95657282 is missing required property '" + name + "'")
