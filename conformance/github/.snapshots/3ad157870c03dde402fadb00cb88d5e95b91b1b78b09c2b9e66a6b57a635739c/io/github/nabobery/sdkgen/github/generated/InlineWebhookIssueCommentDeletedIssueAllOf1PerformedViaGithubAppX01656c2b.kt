 ...
 * rformed_via_github_app
 */
@Serializable(with = InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b.Serializer::class)
public class InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssueCommentD1026IssueAllOf1PerformedViaGithubAppItemXc8b2380c>>,
  private val permissionsState:
      FieldState<InlineWebhookIssueCommentD1026IssueAllOf1PermissionsXe59c6d8b>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssueCommentD1026IssueAllOf1PerformedViaGithubAppItemXc8b2380c>>
   ...
   */
  public val events:
      List<InlineWebhookIssueCommentD1026IssueAllOf1PerformedViaGithubAppItemXc8b2380c>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssueCommentD1026IssueAllOf1PermissionsXe59c6d8b?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0?>
        = FieldState.Absent
     ...
     */
    public var owner:
        InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookIssueCommentD1026IssueAllOf1PermissionsXe59c6d8b?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b {
      ...
      return InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b")
...
public fun inlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b(block: InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b.Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b = InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppX01656c2b property '" + name + "' is not nullable")
