...
@Serializable
public data class SubIssueAddedIssueEventView(
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/sub-issue-added-issue-event
 */
@Serializable(with = SubIssueAddedIssueEvent.Serializer::class)
public class SubIssueAddedIssueEvent(
  public val actor: SimpleUser,
  public val commitId: String?,
  public val commitUrl: String?,
  public val createdAt: String,
  ...
  public class Builder {
    ...
    public fun build(): SubIssueAddedIssueEvent {
      ...
      return SubIssueAddedIssueEvent(
        actor = actor,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): SubIssueAddedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<SubIssueAddedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): SubIssueAddedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("SubIssueAddedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SubIssueAddedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("SubIssueAddedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("SubIssueAddedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("SubIssueAddedIssueEvent is missing required property 'performed_via_github_app'")
      }
      ...
      if (!rawObject.containsKey("sub_issue")) {
        throw SerializationException("SubIssueAddedIssueEvent is missing required property 'sub_issue'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: SubIssueAddedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("SubIssueAddedIssueEvent")
...
public fun subIssueAddedIssueEvent(block: SubIssueAddedIssueEvent.Builder.() -> Unit): SubIssueAddedIssueEvent = SubIssueAddedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("SubIssueAddedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("SubIssueAddedIssueEvent property '" + name + "' is not nullable")
