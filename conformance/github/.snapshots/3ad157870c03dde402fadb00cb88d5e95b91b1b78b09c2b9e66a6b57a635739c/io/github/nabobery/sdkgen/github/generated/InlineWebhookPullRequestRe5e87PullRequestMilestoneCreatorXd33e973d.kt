 ...
 * t/properties/milestone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d.Serializer::class)
public class InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorTypeXf26cf756? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorTypeXf26cf756? = null
    ...
    public fun build(): InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d must be a JSON object")
      ...
      return InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorTypeXf26cf756>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d")
...
public fun inlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d(block: InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d.Builder.() -> Unit): InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d = InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe5e87PullRequestMilestoneCreatorXd33e973d is missing required property '" + name + "'")
