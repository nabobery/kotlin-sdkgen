 ...
 * d_via_github_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-created/properties/deployment/properties/performe
 * d_via_github_app/properties/owner
 */
@Serializable(with = InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3.Serializer::class)
public class InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3(
  public val id: Int,
  ...
  public val type:
      InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerTypeXb9763580? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3 must be a JSON object")
      ...
      return InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerTypeXb9763580>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3")
...
public fun inlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3(block: InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3.Builder.() -> Unit): InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3 = InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerXa2a3ffa3 is missing required property '" + name + "'")
