 ...
 * ad/properties/user
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestUnlabeledPullRequestHeadUserTypeX5c169124? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlabeledPullRequestHeadUserTypeX5c169124? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestHeadUserTypeX5c169124>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e(block: InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e = InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadUserX1360256e is missing required property '" + name + "'")
