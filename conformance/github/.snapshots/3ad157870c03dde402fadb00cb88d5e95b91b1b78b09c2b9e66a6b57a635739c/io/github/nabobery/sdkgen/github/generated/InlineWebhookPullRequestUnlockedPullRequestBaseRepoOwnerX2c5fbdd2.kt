 ...
 * e/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unlocked/properties/pull_request/properties/bas
 * e/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerTypeXca8c8452? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerTypeXca8c8452? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerTypeXca8c8452>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2")
...
public fun inlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2(block: InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2 = InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseRepoOwnerX2c5fbdd2 is missing required property '" + name + "'")
