 ...
 * ilestone
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259(
  /**
  ...
  public val creator: InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7?,
   ...
   */
  public val state: InlineWebhookPullRequestUnassignedPullRequestMilestoneStateX2b78073b,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookPullRequestUnassignedPullRequestMilestoneStateX2b78073b? =
        null

    public var state: InlineWebhookPullRequestUnassignedPullRequestMilestoneStateX2b78073b
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7?
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259 {
      ...
      return InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestUnassignedPullRequestMilestoneStateX2b78073b>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestMilestoneCreatorX90b4b3b7?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259")
...
public fun inlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259(block: InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259 = InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestMilestoneXabe14259 property '" + name + "' is not nullable")
