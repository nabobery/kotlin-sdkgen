 ...
 * properties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3.Serializer::class)
public class InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemTypeXc2ab5f38? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemTypeXc2ab5f38? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3 must be a JSON object")
      ...
      return InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemTypeXc2ab5f38>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3")
...
public fun inlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3(block: InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3.Builder.() -> Unit): InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3 = InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe8fbbPullRequestRequestedReviewersItemOneOf1Xf6e682f3 is missing required property '" + name + "'")
