 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-milestone
 */
@Serializable(with = NullableMilestone.Serializer::class)
public class NullableMilestone(
   ...
   */
  public val state: InlineNullableMilestoneStateXc7465c01,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineNullableMilestoneStateXc7465c01? = null

    public var state: InlineNullableMilestoneStateXc7465c01
    ...
    public fun build(): NullableMilestone {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): NullableMilestone = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<NullableMilestone> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): NullableMilestone {
      val jsonDecoder = decoder.requireJsonDecoder("NullableMilestone")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("NullableMilestone must be a JSON object")
      ...
      val state = json.decodeRequired<InlineNullableMilestoneStateXc7465c01>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("NullableMilestone is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("NullableMilestone is missing required property 'creator'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("NullableMilestone is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("NullableMilestone is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: NullableMilestone) {
      val jsonEncoder = encoder.requireJsonEncoder("NullableMilestone")
...
public fun nullableMilestone(block: NullableMilestone.Builder.() -> Unit): NullableMilestone = NullableMilestone.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NullableMilestone is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("NullableMilestone property '" + name + "' is not nullable")
