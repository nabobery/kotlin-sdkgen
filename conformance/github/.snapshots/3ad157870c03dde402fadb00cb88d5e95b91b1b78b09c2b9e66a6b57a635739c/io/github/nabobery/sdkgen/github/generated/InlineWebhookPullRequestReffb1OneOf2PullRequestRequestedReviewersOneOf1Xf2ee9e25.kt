 ...
 * t/properties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25.Serializer::class)
public class InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersTypeX7cf53144? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersTypeX7cf53144?
        = null
    ...
    public fun build(): InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25 must be a JSON object")
      ...
      return InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersTypeX7cf53144>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25")
...
public fun inlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25(block: InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25.Builder.() -> Unit): InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25 = InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReffb1OneOf2PullRequestRequestedReviewersOneOf1Xf2ee9e25 is missing required property '" + name + "'")
