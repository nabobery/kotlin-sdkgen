 ...
 * erties/head/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-enabled/properties/pull_request/prop
 * erties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0.Serializer::class)
public class InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerTypeXa11ca469? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerTypeXa11ca469?
        = null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0 must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerTypeXa11ca469>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0")
...
public fun inlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0(block: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0 = InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0 is missing required property '" + name + "'")
