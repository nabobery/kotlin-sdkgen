 ...
 * rformed_via_github_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-deleted/properties/issue/allOf/0/properties/pe
 * rformed_via_github_app/properties/owner
 */
@Serializable(with = InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0.Serializer::class)
public class InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssueCommentD1026IssueAllOf1PerformedViaGithubAppOwnerTypeX4ca4d475? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0 must be a JSON object")
      ...
      return InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentD1026IssueAllOf1PerformedViaGithubAppOwnerTypeX4ca4d475>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0")
...
public fun inlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0(block: InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0.Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0 = InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1PerformedViaGithubAppOwnerX3203b2f0 is missing required property '" + name + "'")
