 ...
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-locked/properties/pull_request/properties/user
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestUserX53cf83a8.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestUserX53cf83a8(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestLockedPullRequestUserTypeXbe64a761? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLockedPullRequestUserTypeXbe64a761? = null
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestUserX53cf83a8 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLockedPullRequestUserX53cf83a8(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestUserX53cf83a8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestUserX53cf83a8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestUserX53cf83a8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestUserX53cf83a8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestUserX53cf83a8 must be a JSON object")
      ...
      return InlineWebhookPullRequestLockedPullRequestUserX53cf83a8(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestUserTypeXbe64a761>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestUserX53cf83a8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestUserX53cf83a8")
...
public fun inlineWebhookPullRequestLockedPullRequestUserX53cf83a8(block: InlineWebhookPullRequestLockedPullRequestUserX53cf83a8.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestUserX53cf83a8 = InlineWebhookPullRequestLockedPullRequestUserX53cf83a8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestUserX53cf83a8 is missing required property '" + name + "'")
