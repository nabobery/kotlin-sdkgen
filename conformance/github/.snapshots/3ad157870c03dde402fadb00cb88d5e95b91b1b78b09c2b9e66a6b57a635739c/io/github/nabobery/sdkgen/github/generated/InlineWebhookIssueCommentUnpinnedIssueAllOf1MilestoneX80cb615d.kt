 ...
 * ilestone
 */
@Serializable(with = InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d.Serializer::class)
public class InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d(
  /**
  ...
  public val creator: InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197?,
   ...
   */
  public val state: InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneStateX8431aac5,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneStateX8431aac5? =
        null

    public var state: InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneStateX8431aac5
    ...
    private var creatorState:
        FieldState<InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197?
    ...
    public fun build(): InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d {
      ...
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneStateX8431aac5>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d")
...
public fun inlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d(block: InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d.Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d = InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneX80cb615d property '" + name + "' is not nullable")
