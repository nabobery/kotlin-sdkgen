...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_comment/properties/reactions.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_comment/properties/reactions
 */
@Serializable(with = InlineWebhooksCommentReactionsX0f705a6e.Serializer::class)
public class InlineWebhooksCommentReactionsX0f705a6e(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhooksCommentReactionsX0f705a6e {
      ...
      return InlineWebhooksCommentReactionsX0f705a6e(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksCommentReactionsX0f705a6e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksCommentReactionsX0f705a6e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksCommentReactionsX0f705a6e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksCommentReactionsX0f705a6e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksCommentReactionsX0f705a6e must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksCommentReactionsX0f705a6e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksCommentReactionsX0f705a6e")
...
public fun inlineWebhooksCommentReactionsX0f705a6e(block: InlineWebhooksCommentReactionsX0f705a6e.Builder.() -> Unit): InlineWebhooksCommentReactionsX0f705a6e = InlineWebhooksCommentReactionsX0f705a6e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksCommentReactionsX0f705a6e is missing required property '" + name + "'")
