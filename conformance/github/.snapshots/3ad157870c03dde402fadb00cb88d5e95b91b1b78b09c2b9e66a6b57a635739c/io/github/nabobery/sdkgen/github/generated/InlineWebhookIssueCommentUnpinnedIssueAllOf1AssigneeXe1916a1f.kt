 ...
 * ssignee
 */
@Serializable(with = InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f.Serializer::class)
public class InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeTypeX620c6eb2? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeTypeX620c6eb2? = null
    ...
    public fun build(): InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f must be a JSON object")
      ...
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeTypeX620c6eb2>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f")
...
public fun inlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f(block: InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f.Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f = InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1AssigneeXe1916a1f is missing required property '" + name + "'")
