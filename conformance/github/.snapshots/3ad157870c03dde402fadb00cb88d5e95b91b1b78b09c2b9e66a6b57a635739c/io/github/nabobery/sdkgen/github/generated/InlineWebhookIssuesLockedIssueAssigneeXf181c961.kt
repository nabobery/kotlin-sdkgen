...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-locked/properties/issue/properties/assignee.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-locked/properties/issue/properties/assignee
 */
@Serializable(with = InlineWebhookIssuesLockedIssueAssigneeXf181c961.Serializer::class)
public class InlineWebhookIssuesLockedIssueAssigneeXf181c961(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesLockedIssueAssigneeTypeX864a4116? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesLockedIssueAssigneeTypeX864a4116? = null
    ...
    public fun build(): InlineWebhookIssuesLockedIssueAssigneeXf181c961 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesLockedIssueAssigneeXf181c961(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLockedIssueAssigneeXf181c961 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLockedIssueAssigneeXf181c961> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLockedIssueAssigneeXf181c961 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLockedIssueAssigneeXf181c961")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLockedIssueAssigneeXf181c961 must be a JSON object")
      ...
      return InlineWebhookIssuesLockedIssueAssigneeXf181c961(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesLockedIssueAssigneeTypeX864a4116>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLockedIssueAssigneeXf181c961) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLockedIssueAssigneeXf181c961")
...
public fun inlineWebhookIssuesLockedIssueAssigneeXf181c961(block: InlineWebhookIssuesLockedIssueAssigneeXf181c961.Builder.() -> Unit): InlineWebhookIssuesLockedIssueAssigneeXf181c961 = InlineWebhookIssuesLockedIssueAssigneeXf181c961.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLockedIssueAssigneeXf181c961 is missing required property '" + name + "'")
