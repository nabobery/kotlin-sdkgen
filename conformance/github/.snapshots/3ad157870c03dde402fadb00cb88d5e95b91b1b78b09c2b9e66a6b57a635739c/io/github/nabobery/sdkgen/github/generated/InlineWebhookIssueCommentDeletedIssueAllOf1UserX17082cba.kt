 ...
 * er
 */
@Serializable(with = InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba.Serializer::class)
public class InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba(
  public val id: Long,
  ...
  public val type: InlineWebhookIssueCommentDeletedIssueAllOf1UserTypeX43aa191c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentDeletedIssueAllOf1UserTypeX43aa191c? = null
    ...
    public fun build(): InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba must be a JSON object")
      ...
      return InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentDeletedIssueAllOf1UserTypeX43aa191c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba")
...
public fun inlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba(block: InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba.Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba = InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba is missing required property '" + name + "'")
