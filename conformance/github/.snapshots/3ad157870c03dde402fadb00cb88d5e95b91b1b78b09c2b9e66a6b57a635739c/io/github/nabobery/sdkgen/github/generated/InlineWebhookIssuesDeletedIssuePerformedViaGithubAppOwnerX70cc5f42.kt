 ...
 * hub_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-deleted/properties/issue/properties/performed_via_git
 * hub_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42.Serializer::class)
public class InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerTypeXf72d40b3? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerTypeXf72d40b3? = null
    ...
    public fun build(): InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42 must be a JSON object")
      ...
      return InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerTypeXf72d40b3>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42")
...
public fun inlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42(block: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42.Builder.() -> Unit): InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42 = InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42 is missing required property '" + name + "'")
