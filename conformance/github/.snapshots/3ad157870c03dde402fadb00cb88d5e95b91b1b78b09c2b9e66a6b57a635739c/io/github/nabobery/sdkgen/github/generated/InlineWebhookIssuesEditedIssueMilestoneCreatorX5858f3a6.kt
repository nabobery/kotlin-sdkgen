 ...
 * es/creator
 */
@Serializable(with = InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6.Serializer::class)
public class InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesEditedIssueMilestoneCreatorTypeX5e7d2efa? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesEditedIssueMilestoneCreatorTypeX5e7d2efa? = null
    ...
    public fun build(): InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6 must be a JSON object")
      ...
      return InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesEditedIssueMilestoneCreatorTypeX5e7d2efa>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6")
...
public fun inlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6(block: InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6.Builder.() -> Unit): InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6 = InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6 is missing required property '" + name + "'")
