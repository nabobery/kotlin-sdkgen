 ...
 * estone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorTypeXd0fcb7bb? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorTypeXd0fcb7bb? =
        null
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee must be a JSON object")
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorTypeXd0fcb7bb>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee(block: InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee = InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee is missing required property '" + name + "'")
