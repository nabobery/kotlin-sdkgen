 ...
 * signee
 */
@Serializable(with = InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87.Serializer::class)
public class InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeTypeX78de4452? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeTypeX78de4452? = null
    ...
    public fun build(): InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87 must be a JSON object")
      ...
      return InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeTypeX78de4452>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87")
...
public fun inlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87(block: InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87.Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87 = InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87 is missing required property '" + name + "'")
