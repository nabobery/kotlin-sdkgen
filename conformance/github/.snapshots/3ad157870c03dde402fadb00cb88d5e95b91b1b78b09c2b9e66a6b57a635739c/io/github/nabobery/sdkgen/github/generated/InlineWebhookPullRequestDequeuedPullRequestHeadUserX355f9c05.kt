 ...
 * d/properties/user
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestDequeuedPullRequestHeadUserTypeXee0b8db3? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestDequeuedPullRequestHeadUserTypeXee0b8db3? = null
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05 must be a JSON object")
      ...
      return InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestHeadUserTypeXee0b8db3>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05")
...
public fun inlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05(block: InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05 = InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestHeadUserX355f9c05 is missing required property '" + name + "'")
