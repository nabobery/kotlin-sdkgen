 ...
 * t/properties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688.Serializer::class)
public class InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemTypeX395c5e9c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemTypeX395c5e9c? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688 must be a JSON object")
      ...
      return InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemTypeX395c5e9c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688")
...
public fun inlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688(block: InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688.Builder.() -> Unit): InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688 = InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe5e87PullRequestRequestedReviewersItemOneOf1X0fee8688 is missing required property '" + name + "'")
