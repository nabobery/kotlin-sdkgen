 ...
 * ms/properties/uploader.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-release-prereleased/properties/release/properties/assets/ite
 * ms/properties/uploader
 */
@Serializable(with = InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499.Serializer::class)
public class InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499(
  public val id: Int,
  ...
  public val type: InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderTypeX610edeaa? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderTypeX610edeaa? = null
    ...
    public fun build(): InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499 must be a JSON object")
      ...
      return InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderTypeX610edeaa>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499")
...
public fun inlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499(block: InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499.Builder.() -> Unit): InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499 = InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookReleasePrereleasedReleaseAssetsItemUploaderXbf6ea499 is missing required property '" + name + "'")
