...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-opened/properties/issue/properties/assignee.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-opened/properties/issue/properties/assignee
 */
@Serializable(with = InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9.Serializer::class)
public class InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesOpenedIssueAssigneeTypeX57074f1b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesOpenedIssueAssigneeTypeX57074f1b? = null
    ...
    public fun build(): InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9 must be a JSON object")
      ...
      return InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesOpenedIssueAssigneeTypeX57074f1b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9")
...
public fun inlineWebhookIssuesOpenedIssueAssigneeX1e0487c9(block: InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9.Builder.() -> Unit): InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9 = InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedIssueAssigneeX1e0487c9 is missing required property '" + name + "'")
