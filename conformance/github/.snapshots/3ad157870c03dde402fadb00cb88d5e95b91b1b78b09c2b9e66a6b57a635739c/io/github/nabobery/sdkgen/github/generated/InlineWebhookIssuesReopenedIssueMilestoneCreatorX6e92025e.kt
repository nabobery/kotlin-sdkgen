 ...
 * ties/creator
 */
@Serializable(with = InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e.Serializer::class)
public class InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesReopenedIssueMilestoneCreatorTypeX6864d35f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesReopenedIssueMilestoneCreatorTypeX6864d35f? = null
    ...
    public fun build(): InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e must be a JSON object")
      ...
      return InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesReopenedIssueMilestoneCreatorTypeX6864d35f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e")
...
public fun inlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e(block: InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e.Builder.() -> Unit): InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e = InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e is missing required property '" + name + "'")
