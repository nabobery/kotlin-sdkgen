 ...
 * t/properties/head/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-thread-unresolved/properties/pull_reques
 * t/properties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a.Serializer::class)
public class InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe5e87PullRequestHeadRepoOwnerTypeXcd63383d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe5e87PullRequestHeadRepoOwnerTypeXcd63383d? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe5e87PullRequestHeadRepoOwnerTypeXcd63383d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a")
...
public fun inlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a(block: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerXfdf15e3a is missing required property '" + name + "'")
