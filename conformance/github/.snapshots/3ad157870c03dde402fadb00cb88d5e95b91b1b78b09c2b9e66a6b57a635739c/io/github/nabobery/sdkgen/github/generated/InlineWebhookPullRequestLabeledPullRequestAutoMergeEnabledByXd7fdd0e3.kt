 ...
 * _merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByTypeXe4a01f3f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByTypeXe4a01f3f? =
        null
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3 must be a JSON object")
      ...
      return InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByTypeXe4a01f3f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3")
...
public fun inlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3(block: InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3 = InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestAutoMergeEnabledByXd7fdd0e3 is missing required property '" + name + "'")
