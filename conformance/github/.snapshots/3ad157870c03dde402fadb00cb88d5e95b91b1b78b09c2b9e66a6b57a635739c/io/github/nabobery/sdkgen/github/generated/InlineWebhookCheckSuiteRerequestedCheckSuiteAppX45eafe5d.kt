 ...
 * p
 */
@Serializable(with = InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d.Serializer::class)
public class InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d internal constructor(
  /**
  ...
  public val owner: InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  private val clientIdState: FieldState<String?>,
  eventsState: FieldState<List<InlineWebhookCheckSuiteRerequestedCheckSuiteAppEventsItemX7027c088>>,
  private val permissionsState:
      FieldState<InlineWebhookCheckSuiteRerequestedCheckSuiteAppPermissionsX9a2037df>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookCheckSuiteRerequestedCheckSuiteAppEventsItemX7027c088>> =
   ...
   */
  public val events: List<InlineWebhookCheckSuiteRerequestedCheckSuiteAppEventsItemX7027c088>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookCheckSuiteRerequestedCheckSuiteAppPermissionsX9a2037df?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17?
    ...
    public var clientId: String?
      get() = clientIdState.valueOrNull()
      set(`value`) {
        clientIdState = value.toNullableFieldState()
      }
     ...
     */
    public var events: List<InlineWebhookCheckSuiteRerequestedCheckSuiteAppEventsItemX7027c088>?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookCheckSuiteRerequestedCheckSuiteAppPermissionsX9a2037df?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d {
      ...
      return InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d is missing required property 'updated_at'")
      }
      ...
      return InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d(
        ...
        owner = owner,
        updatedAt = updatedAt,
        clientIdState = json.decodeOptional(rawObject, "client_id", nullable = true),
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d")
...
public fun inlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d(block: InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d.Builder.() -> Unit): InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d = InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookCheckSuiteRerequestedCheckSuiteAppX45eafe5d property '" + name + "' is not nullable")
