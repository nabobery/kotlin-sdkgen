 ...
 * estone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-assigned/properties/pull_request/properties/mil
 * estone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorTypeXe8b9d179? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorTypeXe8b9d179? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88 must be a JSON object")
      ...
      return InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorTypeXe8b9d179>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88")
...
public fun inlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88(block: InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88 = InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestMilestoneCreatorXa948cb88 is missing required property '" + name + "'")
