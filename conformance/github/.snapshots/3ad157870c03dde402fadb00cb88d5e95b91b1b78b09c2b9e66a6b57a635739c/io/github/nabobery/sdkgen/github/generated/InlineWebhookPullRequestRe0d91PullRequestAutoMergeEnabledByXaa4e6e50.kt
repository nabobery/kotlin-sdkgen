 ...
 * properties/auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50.Serializer::class)
public class InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByTypeX93b05c5d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByTypeX93b05c5d? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50 must be a JSON object")
      ...
      return InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByTypeX93b05c5d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50")
...
public fun inlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50(block: InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50.Builder.() -> Unit): InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50 = InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe0d91PullRequestAutoMergeEnabledByXaa4e6e50 is missing required property '" + name + "'")
