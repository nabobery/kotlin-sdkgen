 ...
 * t/properties/requested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-requested/oneOf/0/properties/pull_reques
 * t/properties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f.Serializer::class)
public class InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersTypeXfd93ee7e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersTypeXfd93ee7e?
        = null
    ...
    public fun build(): InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f must be a JSON object")
      ...
      return InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersTypeXfd93ee7e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f")
...
public fun inlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f(block: InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f.Builder.() -> Unit): InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f = InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReffb1OneOf1PullRequestRequestedReviewersOneOf1Xe69e842f is missing required property '" + name + "'")
