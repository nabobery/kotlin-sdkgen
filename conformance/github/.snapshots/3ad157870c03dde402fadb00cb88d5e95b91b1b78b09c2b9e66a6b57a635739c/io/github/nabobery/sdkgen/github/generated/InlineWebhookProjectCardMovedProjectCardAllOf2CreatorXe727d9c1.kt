...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-project-card-moved/properties/project_card/allOf/1/propertie
 * s/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-project-card-moved/properties/project_card/allOf/1/propertie
 * s/creator
 */
@Serializable(with = InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1.Serializer::class)
public class InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1 = InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1 must be a JSON object")
      return InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1")
...
public fun inlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1(block: InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1.Builder.() -> Unit): InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1 = InlineWebhookProjectCardMovedProjectCardAllOf2CreatorXe727d9c1.build(block)
