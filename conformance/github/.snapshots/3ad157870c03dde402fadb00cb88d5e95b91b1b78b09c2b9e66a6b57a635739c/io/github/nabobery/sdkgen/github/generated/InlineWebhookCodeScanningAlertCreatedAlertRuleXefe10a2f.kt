 ...
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-code-scanning-alert-created/properties/alert/properties/rule
 */
@Serializable(with = InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f.Serializer::class)
public class InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f internal constructor(
  /**
   ...
   */
  public val severity: InlineWebhookCodeScanningAlertCreatedAlertRuleSeverityXe7a889d4?,
  ...
  public constructor(
    description: String,
    id: String,
    severity: InlineWebhookCodeScanningAlertCreatedAlertRuleSeverityXe7a889d4?,
  ...
  public class Builder {
    ...
    private var severityState:
        FieldState<InlineWebhookCodeScanningAlertCreatedAlertRuleSeverityXe7a889d4?> =
        FieldState.Absent
     ...
     */
    public var severity: InlineWebhookCodeScanningAlertCreatedAlertRuleSeverityXe7a889d4?
    ...
    public fun build(): InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f {
      ...
      return InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f must be a JSON object")
      val description = json.decodeRequired<String>(rawObject, "description")
      val id = json.decodeRequired<String>(rawObject, "id")
      if (!rawObject.containsKey("severity")) {
        throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f is missing required property 'severity'")
      }
      val severity = rawObject["severity"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCodeScanningAlertCreatedAlertRuleSeverityXe7a889d4?>(requireNotNull(element)) }
      return InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f(
        description = description,
        id = id,
        severity = severity,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f")
...
public fun inlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f(block: InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f.Builder.() -> Unit): InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f = InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookCodeScanningAlertCreatedAlertRuleXefe10a2f property '" + name + "' is not nullable")
