 ...
 * properties/owner
 */
@Serializable(with = InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21.Serializer::class)
public class InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21(
  public val id: Int,
  ...
  public val type: InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerTypeXac1f2199? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerTypeXac1f2199? = null
    ...
    public fun build(): InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21 must be a JSON object")
      ...
      return InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerTypeXac1f2199>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21")
...
public fun inlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21(block: InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21.Builder.() -> Unit): InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21 = InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21 is missing required property '" + name + "'")
