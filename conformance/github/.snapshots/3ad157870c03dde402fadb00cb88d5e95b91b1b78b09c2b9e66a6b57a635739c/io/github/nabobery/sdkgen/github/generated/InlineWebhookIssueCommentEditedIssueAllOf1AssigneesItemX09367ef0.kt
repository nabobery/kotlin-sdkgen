 ...
 * ignees/items
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemTypeX75ffc8cf? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemTypeX75ffc8cf? = null
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0 must be a JSON object")
      ...
      return InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemTypeX75ffc8cf>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0(block: InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0 = InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1AssigneesItemX09367ef0 is missing required property '" + name + "'")
