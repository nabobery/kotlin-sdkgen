 ...
 * erties/head/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925.Serializer::class)
public class InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 internal constructor(
  /**
  ...
  public val createdAt:
      InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoCreatedAtX37e62bfa,
  /**
  ...
  public val license: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoLicenseXd22f7722?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0?,
  /**
  ...
  public val pushedAt:
      InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoPushedAtX83735611?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestAu6055PullRequestHeadRepoMergeCommitMessageX30f2ff45>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestAu6055PullRequestHeadRepoMergeCommitTitleX2086fa39>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoPermissionsXa2ffe44b>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestAu6055PullRequestHeadPullRequestCreationP824dX2a76c970>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestAu6055PullRequestHeadSquashMergeCommitMessageX0b966f7f>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestAu6055PullRequestHeadRepoSquashMergeCommitTitleX52b0994c>,
  ...
  public val permissions:
      InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoPermissionsXa2ffe44b?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoCreatedAtX37e62bfa,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoLicenseXd22f7722?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoPushedAtX83735611?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoVisibilityX82746233,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoCreatedAtX37e62bfa? = null
    ...
    private var visibilityValue:
        InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoVisibilityX82746233? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoLicenseXd22f7722?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoLicenseXd22f7722?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoPushedAtX83735611?> =
        FieldState.Absent
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 {
      ...
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoCreatedAtX37e62bfa>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoVisibilityX82746233>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoLicenseXd22f7722?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerX4b33f6b0?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoPushedAtX83735611?>(requireNotNull(element)) }
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925")
...
public fun inlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925(block: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 = InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadRepoXaf5eb925 property '" + name + "' is not nullable")
