...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_user
 */
@Serializable(with = WebhooksUser.Serializer::class)
public class WebhooksUser(
  ...
  public val type: InlineWebhooksUserTypeX8c61ddb4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksUserTypeX8c61ddb4? = null
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhooksUser = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhooksUser> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhooksUser {
      val jsonDecoder = decoder.requireJsonDecoder("WebhooksUser")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhooksUser must be a JSON object")
      ...
      return WebhooksUser(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksUserTypeX8c61ddb4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: WebhooksUser) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhooksUser")
...
public fun webhooksUser(block: WebhooksUser.Builder.() -> Unit): WebhooksUser = WebhooksUser.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhooksUser is missing required property '" + name + "'")
