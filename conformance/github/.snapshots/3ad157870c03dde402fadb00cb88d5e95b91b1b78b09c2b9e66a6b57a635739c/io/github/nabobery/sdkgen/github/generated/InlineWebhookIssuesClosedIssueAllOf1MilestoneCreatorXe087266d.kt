 ...
 * properties/creator
 */
@Serializable(with = InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d.Serializer::class)
public class InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorTypeX9873ab5b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorTypeX9873ab5b? = null
    ...
    public fun build(): InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d must be a JSON object")
      ...
      return InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorTypeX9873ab5b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d")
...
public fun inlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d(block: InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d.Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d = InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1MilestoneCreatorXe087266d is missing required property '" + name + "'")
