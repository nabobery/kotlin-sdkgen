 ...
 * pository/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-workflow-run-completed/properties/workflow_run/properties/re
 * pository/properties/owner
 */
@Serializable(with = InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a.Serializer::class)
public class InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a(
  public val id: Int,
  ...
  public val type: InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerTypeX32a2c8a3? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerTypeX32a2c8a3? =
        null
    ...
    public fun build(): InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a must be a JSON object")
      ...
      return InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerTypeX32a2c8a3>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a")
...
public fun inlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a(block: InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a.Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a = InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a is missing required property '" + name + "'")
