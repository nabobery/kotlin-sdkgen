 ...
 * p/properties/owner
 */
@Serializable(with = InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17.Serializer::class)
public class InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17(
  public val id: Int,
  ...
  public val type: InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerTypeX6c63664d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerTypeX6c63664d? = null
    ...
    public fun build(): InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17 must be a JSON object")
      ...
      return InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerTypeX6c63664d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17")
...
public fun inlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17(block: InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17.Builder.() -> Unit): InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17 = InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCheckSuiteRerequestedCheckSuiteAppOwnerXc705ef17 is missing required property '" + name + "'")
