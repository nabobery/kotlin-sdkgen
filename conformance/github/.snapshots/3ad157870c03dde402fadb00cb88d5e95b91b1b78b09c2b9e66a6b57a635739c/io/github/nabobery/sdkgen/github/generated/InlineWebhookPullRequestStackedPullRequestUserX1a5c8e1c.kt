 ...
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-stacked/properties/pull_request/properties/user
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestStackedPullRequestUserTypeX611546d7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestStackedPullRequestUserTypeX611546d7? = null
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c must be a JSON object")
      ...
      return InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestStackedPullRequestUserTypeX611546d7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c")
...
public fun inlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c(block: InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c = InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestUserX1a5c8e1c is missing required property '" + name + "'")
