 ...
 */
@Serializable(with = InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3.Serializer::class)
public class InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3 internal constructor(
  /**
  ...
  public val privacy: InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsPrivacyXd5006315,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemParentXf53135f4?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent:
      InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemParentXf53135f4?
  ...
  public constructor(
    ...
    nodeId: String,
    permission: String,
    privacy: InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsPrivacyXd5006315,
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsPrivacyXd5006315? = null

    public var privacy:
        InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsPrivacyXd5006315
    ...
    public fun build(): InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3 {
      ...
      return InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3 must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsPrivacyXd5006315>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3 is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3")
...
public fun inlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3(block: InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3.Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3 = InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedTeamsItemX145531f3 property '" + name + "' is not nullable")
