...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/code-scanning-alert.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/code-scanning-alert
 */
@Serializable(with = CodeScanningAlert.Serializer::class)
public class CodeScanningAlert internal constructor(
  /**
  ...
  public class Builder {
    ...
    private var ruleValue: CodeScanningAlertRule? = null
    ...
    public fun build(): CodeScanningAlert {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): CodeScanningAlert = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<CodeScanningAlert> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): CodeScanningAlert {
      val jsonDecoder = decoder.requireJsonDecoder("CodeScanningAlert")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CodeScanningAlert must be a JSON object")
      ...
      val rule = json.decodeRequired<CodeScanningAlertRule>(rawObject, "rule")
      val tool = json.decodeRequired<CodeScanningAnalysisTool>(rawObject, "tool")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("dismissed_at")) {
        throw SerializationException("CodeScanningAlert is missing required property 'dismissed_at'")
      }
      ...
      if (!rawObject.containsKey("dismissed_by")) {
        throw SerializationException("CodeScanningAlert is missing required property 'dismissed_by'")
      }
      ...
      if (!rawObject.containsKey("dismissed_reason")) {
        throw SerializationException("CodeScanningAlert is missing required property 'dismissed_reason'")
      }
      ...
      if (!rawObject.containsKey("state")) {
        throw SerializationException("CodeScanningAlert is missing required property 'state'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: CodeScanningAlert) {
      val jsonEncoder = encoder.requireJsonEncoder("CodeScanningAlert")
...
public fun codeScanningAlert(block: CodeScanningAlert.Builder.() -> Unit): CodeScanningAlert = CodeScanningAlert.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("CodeScanningAlert is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("CodeScanningAlert property '" + name + "' is not nullable")
