...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue/properties/user
 */
@Serializable(with = InlineWebhooksIssueUserXb40fe13e.Serializer::class)
public class InlineWebhooksIssueUserXb40fe13e(
  public val id: Long,
  ...
  public val type: InlineWebhooksIssueUserTypeX056191ef? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksIssueUserTypeX056191ef? = null
    ...
    public fun build(): InlineWebhooksIssueUserXb40fe13e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksIssueUserXb40fe13e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssueUserXb40fe13e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssueUserXb40fe13e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssueUserXb40fe13e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssueUserXb40fe13e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssueUserXb40fe13e must be a JSON object")
      ...
      return InlineWebhooksIssueUserXb40fe13e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksIssueUserTypeX056191ef>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssueUserXb40fe13e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssueUserXb40fe13e")
...
public fun inlineWebhooksIssueUserXb40fe13e(block: InlineWebhooksIssueUserXb40fe13e.Builder.() -> Unit): InlineWebhooksIssueUserXb40fe13e = InlineWebhooksIssueUserXb40fe13e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssueUserXb40fe13e is missing required property '" + name + "'")
