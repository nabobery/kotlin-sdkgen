 ...
 * erties/milestone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-enabled/properties/pull_request/prop
 * erties/milestone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c.Serializer::class)
public class InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorTypeX2d948a7d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorTypeX2d948a7d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c")
...
public fun inlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c(block: InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c = InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorX4221c42c is missing required property '" + name + "'")
