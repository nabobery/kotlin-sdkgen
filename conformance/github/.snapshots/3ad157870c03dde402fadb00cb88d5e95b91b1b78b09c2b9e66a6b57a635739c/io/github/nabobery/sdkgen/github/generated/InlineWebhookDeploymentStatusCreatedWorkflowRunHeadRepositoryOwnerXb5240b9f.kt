 ...
 * /head_repository/properties/owner
 */
@Serializable(with = InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f.Serializer::class)
public class InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f = InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f must be a JSON object")
      return InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f")
...
public fun inlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f(block: InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f.Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f = InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f.build(block)
