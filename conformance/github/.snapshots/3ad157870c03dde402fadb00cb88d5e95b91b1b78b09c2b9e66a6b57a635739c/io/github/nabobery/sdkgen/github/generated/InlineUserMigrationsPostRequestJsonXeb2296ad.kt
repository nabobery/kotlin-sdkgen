...
public class InlineUserMigrationsPostRequestJsonXeb2296ad(
  ...
  exclude: List<InlineUserMigrationsPostRequestJsonExcludeItemX571d7366>? = null,
  /**
   ...
   */
  public val exclude: List<InlineUserMigrationsPostRequestJsonExcludeItemX571d7366>? =
  ...
  public class Builder {
    ...
    private var excludeValue: List<InlineUserMigrationsPostRequestJsonExcludeItemX571d7366>? = null

    /**
     * Exclude attributes from the API response to improve performance
     */
    public var exclude: List<InlineUserMigrationsPostRequestJsonExcludeItemX571d7366>?
  ...
  internal object Serializer : KSerializer<InlineUserMigrationsPostRequestJsonXeb2296ad> {
