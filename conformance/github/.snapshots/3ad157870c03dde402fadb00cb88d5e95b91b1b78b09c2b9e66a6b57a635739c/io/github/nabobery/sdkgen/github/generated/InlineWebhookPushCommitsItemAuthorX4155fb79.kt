 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-push/properties/commits/items/properties/author
 */
@Serializable(with = InlineWebhookPushCommitsItemAuthorX4155fb79.Serializer::class)
public class InlineWebhookPushCommitsItemAuthorX4155fb79 internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPushCommitsItemAuthorX4155fb79 {
      check(nameValue != null) { "name is required" }
      check(emailState !== FieldState.Absent) { "email is required, even when null" }
      return InlineWebhookPushCommitsItemAuthorX4155fb79(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPushCommitsItemAuthorX4155fb79 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPushCommitsItemAuthorX4155fb79> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPushCommitsItemAuthorX4155fb79 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPushCommitsItemAuthorX4155fb79")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPushCommitsItemAuthorX4155fb79 must be a JSON object")
      val name = json.decodeRequired<String>(rawObject, "name")
      if (!rawObject.containsKey("email")) {
        throw SerializationException("InlineWebhookPushCommitsItemAuthorX4155fb79 is missing required property 'email'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPushCommitsItemAuthorX4155fb79) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPushCommitsItemAuthorX4155fb79")
...
public fun inlineWebhookPushCommitsItemAuthorX4155fb79(block: InlineWebhookPushCommitsItemAuthorX4155fb79.Builder.() -> Unit): InlineWebhookPushCommitsItemAuthorX4155fb79 = InlineWebhookPushCommitsItemAuthorX4155fb79.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPushCommitsItemAuthorX4155fb79 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPushCommitsItemAuthorX4155fb79 property '" + name + "' is not nullable")
