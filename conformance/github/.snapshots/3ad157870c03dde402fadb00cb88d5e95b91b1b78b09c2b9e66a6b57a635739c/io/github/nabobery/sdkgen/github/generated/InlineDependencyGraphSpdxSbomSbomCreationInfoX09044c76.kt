...
public class InlineDependencyGraphSpdxSbomSbomCreationInfoX09044c76(
  ...
  public class Builder {
    ...
    public var creators: List<String>
      get() = requireNotNull(creatorsValue) { "creators is required" }.toList()
      set(`value`) {
        creatorsValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<InlineDependencyGraphSpdxSbomSbomCreationInfoX09044c76> {
