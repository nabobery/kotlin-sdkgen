 ...
 * ignees/items
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnlockedPullRequestAssigneesItemTypeXcd16d418? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlockedPullRequestAssigneesItemTypeXcd16d418? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestAssigneesItemTypeXcd16d418>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828")
...
public fun inlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828(block: InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828 = InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestAssigneesItemX1c67e828 is missing required property '" + name + "'")
