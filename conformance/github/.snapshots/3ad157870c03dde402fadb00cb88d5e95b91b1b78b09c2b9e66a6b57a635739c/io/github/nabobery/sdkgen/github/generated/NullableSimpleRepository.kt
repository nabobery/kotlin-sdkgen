 ...
 * A GitHub repository.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-simple-repository
 */
@Serializable(with = NullableSimpleRepository.Serializer::class)
public class NullableSimpleRepository(
  ...
  public class Builder {
    ...
    public fun build(): NullableSimpleRepository {
      ...
      return NullableSimpleRepository(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): NullableSimpleRepository = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<NullableSimpleRepository> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): NullableSimpleRepository {
      val jsonDecoder = decoder.requireJsonDecoder("NullableSimpleRepository")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("NullableSimpleRepository must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("NullableSimpleRepository is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: NullableSimpleRepository) {
      val jsonEncoder = encoder.requireJsonEncoder("NullableSimpleRepository")
...
public fun nullableSimpleRepository(block: NullableSimpleRepository.Builder.() -> Unit): NullableSimpleRepository = NullableSimpleRepository.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NullableSimpleRepository is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("NullableSimpleRepository property '" + name + "' is not nullable")
