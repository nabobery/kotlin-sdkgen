 ...
 * s/milestone
 */
@Serializable(with = InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82.Serializer::class)
public class InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82(
  /**
  ...
  public val creator: InlineWebhookPullRequestReviewEditedPullRequestMilestoneCreatorX6d8e2efe?,
   ...
   */
  public val state: InlineWebhookPullRequestReviewEditedPullRequestMilestoneStateX9a5a3d72,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookPullRequestReviewEditedPullRequestMilestoneStateX9a5a3d72?
        = null

    public var state: InlineWebhookPullRequestReviewEditedPullRequestMilestoneStateX9a5a3d72
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestReviewEditedPullRequestMilestoneCreatorX6d8e2efe?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestReviewEditedPullRequestMilestoneCreatorX6d8e2efe?
    ...
    public fun build(): InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82 {
      ...
      return InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestReviewEditedPullRequestMilestoneStateX9a5a3d72>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestMilestoneCreatorX6d8e2efe?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82")
...
public fun inlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82(block: InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82.Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82 = InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestMilestoneXdb467e82 property '" + name + "' is not nullable")
