 ...
 * request/properties/merged_by
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestReacd1OneOf1PullRequestMergedByTypeX06f90e4a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf1PullRequestMergedByTypeX06f90e4a? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestMergedByTypeX06f90e4a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0(block: InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0 = InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestMergedByXe2fb71e0 is missing required property '" + name + "'")
