 ...
 * uested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-enqueued/properties/pull_request/properties/req
 * uested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestEnd765PullRequestRequestedReviewersItemTypeX8995c73e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestEnd765PullRequestRequestedReviewersItemTypeX8995c73e? =
        null
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c must be a JSON object")
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestEnd765PullRequestRequestedReviewersItemTypeX8995c73e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c(block: InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c = InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestRequestedReviewersItemOneOf1X1de2446c is missing required property '" + name + "'")
