 ...
 * stone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorTypeXcdbf7ef6? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorTypeXcdbf7ef6? = null
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf must be a JSON object")
      ...
      return InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorTypeXcdbf7ef6>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf")
...
public fun inlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf(block: InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf = InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf is missing required property '" + name + "'")
