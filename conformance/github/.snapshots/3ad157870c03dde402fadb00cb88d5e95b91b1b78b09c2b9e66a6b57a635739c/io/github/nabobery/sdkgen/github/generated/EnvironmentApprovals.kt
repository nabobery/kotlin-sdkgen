...
public class EnvironmentApprovals(
  ...
  public class Builder {
    ...
    public var environments: List<InlineEnvironmentApprovalsEnvironmentsItemXd4c2c31a>
      get() = requireNotNull(environmentsValue) { "environments is required" }.toList()
      set(`value`) {
        environmentsValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<EnvironmentApprovals> {
