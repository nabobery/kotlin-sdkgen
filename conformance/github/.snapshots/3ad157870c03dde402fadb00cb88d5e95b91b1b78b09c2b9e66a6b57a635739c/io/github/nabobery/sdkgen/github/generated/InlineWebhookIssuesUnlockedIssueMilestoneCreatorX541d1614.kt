 ...
 * ties/creator
 */
@Serializable(with = InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614.Serializer::class)
public class InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesUnlockedIssueMilestoneCreatorTypeX826a17bc? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesUnlockedIssueMilestoneCreatorTypeX826a17bc? = null
    ...
    public fun build(): InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614 must be a JSON object")
      ...
      return InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesUnlockedIssueMilestoneCreatorTypeX826a17bc>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614")
...
public fun inlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614(block: InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614.Builder.() -> Unit): InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614 = InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614 is missing required property '" + name + "'")
