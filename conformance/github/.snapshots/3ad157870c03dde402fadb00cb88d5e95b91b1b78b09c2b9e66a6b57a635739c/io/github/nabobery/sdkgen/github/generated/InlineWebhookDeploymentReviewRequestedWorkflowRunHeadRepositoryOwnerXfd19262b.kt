 ...
 * es/head_repository/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-review-requested/properties/workflow_run/properti
 * es/head_repository/properties/owner
 */
@Serializable(with = InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b.Serializer::class)
public class InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b = InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b must be a JSON object")
      return InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b")
...
public fun inlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b(block: InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b.Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b = InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b.build(block)
