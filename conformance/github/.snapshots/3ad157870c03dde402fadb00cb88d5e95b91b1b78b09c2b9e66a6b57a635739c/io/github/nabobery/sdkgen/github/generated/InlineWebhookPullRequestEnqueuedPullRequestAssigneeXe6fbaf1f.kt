 ...
 * ignee
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestEnqueuedPullRequestAssigneeTypeXe45cb041? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestEnqueuedPullRequestAssigneeTypeXe45cb041? = null
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f must be a JSON object")
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestAssigneeTypeXe45cb041>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f(block: InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f = InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestAssigneeXe6fbaf1f is missing required property '" + name + "'")
