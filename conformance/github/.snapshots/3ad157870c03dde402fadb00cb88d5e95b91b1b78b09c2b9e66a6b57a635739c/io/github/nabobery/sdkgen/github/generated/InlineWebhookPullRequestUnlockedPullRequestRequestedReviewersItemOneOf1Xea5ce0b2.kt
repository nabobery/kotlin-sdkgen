 ...
 * uested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestUnc059PullRequestRequestedReviewersItemTypeX9669c17f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnc059PullRequestRequestedReviewersItemTypeX9669c17f? =
        null
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnc059PullRequestRequestedReviewersItemTypeX9669c17f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2")
...
public fun inlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2(block: InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2 = InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestRequestedReviewersItemOneOf1Xea5ce0b2 is missing required property '" + name + "'")
