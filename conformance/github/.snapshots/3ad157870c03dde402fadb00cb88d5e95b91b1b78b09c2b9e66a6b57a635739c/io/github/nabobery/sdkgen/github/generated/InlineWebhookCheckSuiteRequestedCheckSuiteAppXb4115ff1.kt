 ...
 */
@Serializable(with = InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1.Serializer::class)
public class InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 internal constructor(
  /**
  ...
  public val owner: InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  private val clientIdState: FieldState<String?>,
  eventsState: FieldState<List<InlineWebhookCheckSuiteRequestedCheckSuiteAppEventsItemXbabfab22>>,
  private val permissionsState:
      FieldState<InlineWebhookCheckSuiteRequestedCheckSuiteAppPermissionsX49164511>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookCheckSuiteRequestedCheckSuiteAppEventsItemXbabfab22>> =
   ...
   */
  public val events: List<InlineWebhookCheckSuiteRequestedCheckSuiteAppEventsItemXbabfab22>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookCheckSuiteRequestedCheckSuiteAppPermissionsX49164511?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState: FieldState<InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74?>
        = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74?
     ...
     */
    public var events: List<InlineWebhookCheckSuiteRequestedCheckSuiteAppEventsItemXbabfab22>?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookCheckSuiteRequestedCheckSuiteAppPermissionsX49164511?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 {
      ...
      return InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1")
...
public fun inlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1(block: InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1.Builder.() -> Unit): InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 = InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookCheckSuiteRequestedCheckSuiteAppXb4115ff1 property '" + name + "' is not nullable")
