 ...
 * rties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8.Serializer::class)
public class InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestReviewCommentCreatedCommentUserTypeX90763e89? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewCommentCreatedCommentUserTypeX90763e89? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentCreatedCommentUserTypeX90763e89>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8")
...
public fun inlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8(block: InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8 = InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedCommentUserXc4eda8e8 is missing required property '" + name + "'")
