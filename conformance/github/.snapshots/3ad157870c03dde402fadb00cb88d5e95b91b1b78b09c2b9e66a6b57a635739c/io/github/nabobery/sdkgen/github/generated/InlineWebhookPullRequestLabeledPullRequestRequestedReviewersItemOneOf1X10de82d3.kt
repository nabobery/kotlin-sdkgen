 ...
 * ested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-labeled/properties/pull_request/properties/requ
 * ested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestLa835fPullRequestRequestedReviewersItemTypeX53cc4b6e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLa835fPullRequestRequestedReviewersItemTypeX53cc4b6e? =
        null
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3 must be a JSON object")
      ...
      return InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLa835fPullRequestRequestedReviewersItemTypeX53cc4b6e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3")
...
public fun inlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3(block: InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3 = InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf1X10de82d3 is missing required property '" + name + "'")
