 ...
 * ged_by
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestEnqueuedPullRequestMergedByTypeXe0bbdf2f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestEnqueuedPullRequestMergedByTypeXe0bbdf2f? = null
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c must be a JSON object")
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestMergedByTypeXe0bbdf2f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c(block: InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c = InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestMergedByXfb44803c is missing required property '" + name + "'")
