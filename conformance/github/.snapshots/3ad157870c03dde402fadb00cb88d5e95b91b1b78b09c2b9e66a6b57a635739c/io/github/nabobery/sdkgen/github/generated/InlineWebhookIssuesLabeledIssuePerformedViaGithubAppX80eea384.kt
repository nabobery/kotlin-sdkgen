 ...
 * hub_app
 */
@Serializable(with = InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384.Serializer::class)
public class InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssuesLabeledIssuePerformedViaGithubAppEventsItemX60f5307b>>,
  private val permissionsState:
      FieldState<InlineWebhookIssuesLabeledIssuePerformedViaGithubAppPermissionsX16c4d96f>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssuesLabeledIssuePerformedViaGithubAppEventsItemX60f5307b>> =
      eventsState.copyValue { fieldValue -> fieldValue.toList() }

  /**
   * The list of events for the GitHub app
   */
  public val events: List<InlineWebhookIssuesLabeledIssuePerformedViaGithubAppEventsItemX60f5307b>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppPermissionsX16c4d96f?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918?
     ...
     */
    public var events:
        List<InlineWebhookIssuesLabeledIssuePerformedViaGithubAppEventsItemX60f5307b>?
    ...
    public fun build(): InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 {
      ...
      return InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384")
...
public fun inlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384(block: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384.Builder.() -> Unit): InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 = InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppX80eea384 property '" + name + "' is not nullable")
