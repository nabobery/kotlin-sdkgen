 ...
 * hub_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918.Serializer::class)
public class InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerTypeX5202c0cc? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerTypeX5202c0cc? = null
    ...
    public fun build(): InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918 must be a JSON object")
      ...
      return InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerTypeX5202c0cc>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918")
...
public fun inlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918(block: InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918.Builder.() -> Unit): InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918 = InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLabeledIssuePerformedViaGithubAppOwnerXe81ad918 is missing required property '" + name + "'")
