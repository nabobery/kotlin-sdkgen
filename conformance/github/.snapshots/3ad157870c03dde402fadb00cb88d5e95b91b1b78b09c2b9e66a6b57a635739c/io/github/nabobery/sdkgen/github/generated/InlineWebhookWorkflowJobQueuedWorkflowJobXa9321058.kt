...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-workflow-job-queued/properties/workflow_job.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-workflow-job-queued/properties/workflow_job
 */
@Serializable(with = InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058.Serializer::class)
public class InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058(
  /**
  ...
  public val status: InlineWebhookWorkflowJobQueuedWorkflowJobStatusX07e4ac74,
  steps: List<InlineWebhookWorkflowJobQueuedWorkflowJobStepsItemXcb808823>,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val steps: List<InlineWebhookWorkflowJobQueuedWorkflowJobStepsItemXcb808823> =
      steps.toList()
  ...
  public class Builder {
    ...
    private var statusValue: InlineWebhookWorkflowJobQueuedWorkflowJobStatusX07e4ac74? = null

    public var status: InlineWebhookWorkflowJobQueuedWorkflowJobStatusX07e4ac74
      get() = requireNotNull(statusValue) { "status is required" }
      set(`value`) {
        statusValue = value
      }

    private var stepsValue: List<InlineWebhookWorkflowJobQueuedWorkflowJobStepsItemXcb808823>? =
        null

    public var steps: List<InlineWebhookWorkflowJobQueuedWorkflowJobStepsItemXcb808823>
    ...
    public fun build(): InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 {
      ...
      return InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 must be a JSON object")
      ...
      val status = json.decodeRequired<InlineWebhookWorkflowJobQueuedWorkflowJobStatusX07e4ac74>(rawObject, "status")
      val steps = json.decodeRequired<List<InlineWebhookWorkflowJobQueuedWorkflowJobStepsItemXcb808823>>(rawObject, "steps")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("completed_at")) {
        throw SerializationException("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 is missing required property 'completed_at'")
      }
      ...
      if (!rawObject.containsKey("conclusion")) {
        throw SerializationException("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 is missing required property 'conclusion'")
      }
      ...
      if (!rawObject.containsKey("head_branch")) {
        throw SerializationException("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 is missing required property 'head_branch'")
      }
      ...
      if (!rawObject.containsKey("runner_group_id")) {
        throw SerializationException("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 is missing required property 'runner_group_id'")
      }
      ...
      if (!rawObject.containsKey("runner_group_name")) {
        throw SerializationException("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 is missing required property 'runner_group_name'")
      }
      ...
      if (!rawObject.containsKey("runner_id")) {
        throw SerializationException("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 is missing required property 'runner_id'")
      }
      ...
      if (!rawObject.containsKey("runner_name")) {
        throw SerializationException("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 is missing required property 'runner_name'")
      }
      ...
      if (!rawObject.containsKey("workflow_name")) {
        throw SerializationException("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 is missing required property 'workflow_name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058")
...
public fun inlineWebhookWorkflowJobQueuedWorkflowJobXa9321058(block: InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058.Builder.() -> Unit): InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 = InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookWorkflowJobQueuedWorkflowJobXa9321058 property '" + name + "' is not nullable")
