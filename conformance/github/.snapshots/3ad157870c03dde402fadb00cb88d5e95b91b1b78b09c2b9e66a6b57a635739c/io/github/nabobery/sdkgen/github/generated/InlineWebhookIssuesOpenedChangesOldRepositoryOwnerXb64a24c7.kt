 ...
 * roperties/owner
 */
@Serializable(with = InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7.Serializer::class)
public class InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesOpenedChangesOldRepositoryOwnerTypeX5297275b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesOpenedChangesOldRepositoryOwnerTypeX5297275b? = null
    ...
    public fun build(): InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7 must be a JSON object")
      ...
      return InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesOpenedChangesOldRepositoryOwnerTypeX5297275b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7")
...
public fun inlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7(block: InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7.Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7 = InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldRepositoryOwnerXb64a24c7 is missing required property '" + name + "'")
