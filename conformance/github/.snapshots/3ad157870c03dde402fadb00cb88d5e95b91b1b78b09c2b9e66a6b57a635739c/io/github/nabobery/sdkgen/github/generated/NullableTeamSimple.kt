 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-team-simple
 */
@Serializable(with = NullableTeamSimple.Serializer::class)
public class NullableTeamSimple internal constructor(
  /**
   ...
   */
  public val type: InlineNullableTeamSimpleTypeX5d0e9585,
  /**
   * URL for the team
   *
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
  ...
  public constructor(
    ...
    slug: String,
    type: InlineNullableTeamSimpleTypeX5d0e9585,
    url: String,
  ...
  public class Builder {
    ...
    private var typeValue: InlineNullableTeamSimpleTypeX5d0e9585? = null

    public var type: InlineNullableTeamSimpleTypeX5d0e9585
    ...
    public fun build(): NullableTeamSimple {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): NullableTeamSimple = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<NullableTeamSimple> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): NullableTeamSimple {
      val jsonDecoder = decoder.requireJsonDecoder("NullableTeamSimple")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("NullableTeamSimple must be a JSON object")
      ...
      val type = json.decodeRequired<InlineNullableTeamSimpleTypeX5d0e9585>(rawObject, "type")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("description")) {
        throw SerializationException("NullableTeamSimple is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: NullableTeamSimple) {
      val jsonEncoder = encoder.requireJsonEncoder("NullableTeamSimple")
...
public fun nullableTeamSimple(block: NullableTeamSimple.Builder.() -> Unit): NullableTeamSimple = NullableTeamSimple.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NullableTeamSimple is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("NullableTeamSimple property '" + name + "' is not nullable")
