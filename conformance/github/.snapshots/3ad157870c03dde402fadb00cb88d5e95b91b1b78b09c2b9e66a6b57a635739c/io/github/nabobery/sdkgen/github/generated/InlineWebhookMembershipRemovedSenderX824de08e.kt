...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhook-membership-removed/properties/sender.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-membership-removed/properties/sender
 */
@Serializable(with = InlineWebhookMembershipRemovedSenderX824de08e.Serializer::class)
public class InlineWebhookMembershipRemovedSenderX824de08e(
  public val id: Int,
  ...
  public val type: InlineWebhookMembershipRemovedSenderTypeXcdc86398? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookMembershipRemovedSenderTypeXcdc86398? = null
    ...
    public fun build(): InlineWebhookMembershipRemovedSenderX824de08e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookMembershipRemovedSenderX824de08e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookMembershipRemovedSenderX824de08e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookMembershipRemovedSenderX824de08e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookMembershipRemovedSenderX824de08e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookMembershipRemovedSenderX824de08e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookMembershipRemovedSenderX824de08e must be a JSON object")
      ...
      return InlineWebhookMembershipRemovedSenderX824de08e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookMembershipRemovedSenderTypeXcdc86398>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookMembershipRemovedSenderX824de08e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookMembershipRemovedSenderX824de08e")
...
public fun inlineWebhookMembershipRemovedSenderX824de08e(block: InlineWebhookMembershipRemovedSenderX824de08e.Builder.() -> Unit): InlineWebhookMembershipRemovedSenderX824de08e = InlineWebhookMembershipRemovedSenderX824de08e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookMembershipRemovedSenderX824de08e is missing required property '" + name + "'")
