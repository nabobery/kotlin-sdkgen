 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5.Serializer::class)
public class InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestRe0df9PullRequestBaseRepoCreatedAtX961512d5,
  /**
  ...
  public val license:
      InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoLicenseX28a25e12?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4?,
  /**
  ...
  public val pushedAt:
      InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoPushedAtXbaef078a?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestRe0df9PullRequestBaseRepoVisibilityX387d7b1c,
  ...
  private val permissionsState:
      FieldState<InlineWebhookPullRequestRe0df9PullRequestBaseRepoPermissionsXc52fdd78>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe0df9PullRequestBasePullRequestCreationP824dX1dd56a44>,
  ...
  public val permissions: InlineWebhookPullRequestRe0df9PullRequestBaseRepoPermissionsXc52fdd78?
  ...
  public val pullRequestCreationPolicy:
      InlineWebhookPullRequestRe0df9PullRequestBasePullRequestCreationP824dX1dd56a44?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestRe0df9PullRequestBaseRepoCreatedAtX961512d5,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoLicenseX28a25e12?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoPushedAtXbaef078a?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestRe0df9PullRequestBaseRepoVisibilityX387d7b1c,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookPullRequestRe0df9PullRequestBaseRepoCreatedAtX961512d5?
        = null

    public var createdAt: InlineWebhookPullRequestRe0df9PullRequestBaseRepoCreatedAtX961512d5
    ...
    private var visibilityValue:
        InlineWebhookPullRequestRe0df9PullRequestBaseRepoVisibilityX387d7b1c? = null

    public var visibility: InlineWebhookPullRequestRe0df9PullRequestBaseRepoVisibilityX387d7b1c
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoLicenseX28a25e12?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoPushedAtXbaef078a?>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestRe0df9PullRequestBaseRepoPermissionsXc52fdd78?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 {
      ...
      return InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestRe0df9PullRequestBaseRepoCreatedAtX961512d5>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestRe0df9PullRequestBaseRepoVisibilityX387d7b1c>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoLicenseX28a25e12?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerXe5b7e4e4?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoPushedAtXbaef078a?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5")
...
public fun inlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5(block: InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 = InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestBaseRepoX7cbcb8b5 property '" + name + "' is not nullable")
