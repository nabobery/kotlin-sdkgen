...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-status/properties/commit/properties/author.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-status/properties/commit/properties/author
 */
@Serializable(with = InlineWebhookStatusCommitAuthorX74d59945.Serializer::class)
public class InlineWebhookStatusCommitAuthorX74d59945(
  /**
  ...
  public val type: InlineWebhookStatusCommitAuthorTypeXa694fe82? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookStatusCommitAuthorTypeXa694fe82? = null
    ...
    public fun build(): InlineWebhookStatusCommitAuthorX74d59945 = InlineWebhookStatusCommitAuthorX74d59945(
      avatarUrl = avatarUrl,
      deleted = deleted,
      email = email,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookStatusCommitAuthorX74d59945 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookStatusCommitAuthorX74d59945> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookStatusCommitAuthorX74d59945 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookStatusCommitAuthorX74d59945")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookStatusCommitAuthorX74d59945 must be a JSON object")
      return InlineWebhookStatusCommitAuthorX74d59945(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookStatusCommitAuthorTypeXa694fe82>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookStatusCommitAuthorX74d59945) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookStatusCommitAuthorX74d59945")
...
public fun inlineWebhookStatusCommitAuthorX74d59945(block: InlineWebhookStatusCommitAuthorX74d59945.Builder.() -> Unit): InlineWebhookStatusCommitAuthorX74d59945 = InlineWebhookStatusCommitAuthorX74d59945.build(block)
