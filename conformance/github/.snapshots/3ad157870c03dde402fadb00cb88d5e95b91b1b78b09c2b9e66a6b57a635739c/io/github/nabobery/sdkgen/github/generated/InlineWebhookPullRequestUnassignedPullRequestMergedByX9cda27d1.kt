 ...
 * erged_by
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnassignedPullRequestMergedByTypeXa4d13806? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnassignedPullRequestMergedByTypeXa4d13806? = null
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestMergedByTypeXa4d13806>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1")
...
public fun inlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1(block: InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1 = InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestMergedByX9cda27d1 is missing required property '" + name + "'")
