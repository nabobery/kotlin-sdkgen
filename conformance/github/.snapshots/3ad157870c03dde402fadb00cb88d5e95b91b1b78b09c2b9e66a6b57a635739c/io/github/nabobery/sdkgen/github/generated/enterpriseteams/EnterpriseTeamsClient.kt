package io.github.nabobery.sdkgen.github.generated.enterpriseteams
...
import io.github.nabobery.sdkgen.github.generated.EnterpriseTeam
import io.github.nabobery.sdkgen.github.generated.InlineEnterprisesTeamsPatchRequestJsonXe1ba10dc
import io.github.nabobery.sdkgen.github.generated.InlineEnterprisesTeamsPostRequestJsonX7cfbf060
...
internal object EnterpriseTeamsCodecs {
  internal const val ENTERPRISETEAMSCREATE_REQUEST_CODEC_ID: String =
  ...
  internal const val ENTERPRISETEAMSCREATE_RESPONSE_CODEC_ID: String =
  ...
  internal val enterpriseTeamsCreateResponseCodecAlternative0Registry:
      MediaTypeCodecRegistry<EnterpriseTeam> =
      MediaTypeCodecRegistry.of(enterpriseTeamsCreateResponseCodecAlternative0Codec)

  internal val enterpriseTeamsCreateRequestCodecRegistry:
  ...
  internal val enterpriseTeamsCreateResponseCodecRegistry: MediaTypeCodecRegistry<EnterpriseTeam> =
  ...
  internal val enterpriseTeamsDeleteResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<BasicError> =
      MediaTypeCodecRegistry.of(enterpriseTeamsDeleteResponseCodecAlternative1Codec)

  internal val enterpriseTeamsDeleteRequestCodecRegistry: MediaTypeCodecRegistry<Unit> =
      MediaTypeCodecRegistry.of()

  internal val enterpriseTeamsDeleteResponseCodecRegistry: MediaTypeCodecRegistry<Unit> =
      MediaTypeCodecRegistry.of()

  internal const val ENTERPRISETEAMSGET_RESPONSE_CODEC_ID: String = "enterprise-teams/get.response"
  ...
  internal val enterpriseTeamsGetResponseCodecAlternative0Registry:
      MediaTypeCodecRegistry<EnterpriseTeam> =
  ...
  internal val enterpriseTeamsGetResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<BasicError> =
      MediaTypeCodecRegistry.of(enterpriseTeamsGetResponseCodecAlternative1Codec)

  internal val enterpriseTeamsGetRequestCodecRegistry: MediaTypeCodecRegistry<Unit> =
      MediaTypeCodecRegistry.of()

  internal val enterpriseTeamsGetResponseCodecRegistry: MediaTypeCodecRegistry<EnterpriseTeam> =
      MediaTypeCodecRegistry.of(enterpriseTeamsGetResponseCodec)

  internal const val ENTERPRISETEAMSLIST_RESPONSE_CODEC_ID: String =
      "enterprise-teams/list.response"
  ...
  internal val enterpriseTeamsListResponseCodecAlternative0Registry:
  ...
  internal val enterpriseTeamsListResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<BasicError> =
      MediaTypeCodecRegistry.of(enterpriseTeamsListResponseCodecAlternative1Codec)

  internal val enterpriseTeamsListRequestCodecRegistry: MediaTypeCodecRegistry<Unit> =
      MediaTypeCodecRegistry.of()

  internal val enterpriseTeamsListResponseCodecRegistry:
      MediaTypeCodecRegistry<List<EnterpriseTeam>> =
      MediaTypeCodecRegistry.of(enterpriseTeamsListResponseCodec)

  internal const val ENTERPRISETEAMSUPDATE_REQUEST_CODEC_ID: String =
  ...
  internal const val ENTERPRISETEAMSUPDATE_RESPONSE_CODEC_ID: String =
  ...
  internal val enterpriseTeamsUpdateResponseCodecAlternative0Registry:
      MediaTypeCodecRegistry<EnterpriseTeam> =
  ...
  internal val enterpriseTeamsUpdateResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<BasicError> =
      MediaTypeCodecRegistry.of(enterpriseTeamsUpdateResponseCodecAlternative1Codec)

  internal val enterpriseTeamsUpdateRequestCodecRegistry:
  ...
  internal val enterpriseTeamsUpdateResponseCodecRegistry: MediaTypeCodecRegistry<EnterpriseTeam> =
...
public class EnterpriseTeamsClient(
  ...
  public companion object {
    internal val enterpriseTeamsCreateMetadata: OperationMetadata by
    ...
    internal val enterpriseTeamsDeleteMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val enterpriseTeamsGetMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val enterpriseTeamsListMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val enterpriseTeamsUpdateMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
