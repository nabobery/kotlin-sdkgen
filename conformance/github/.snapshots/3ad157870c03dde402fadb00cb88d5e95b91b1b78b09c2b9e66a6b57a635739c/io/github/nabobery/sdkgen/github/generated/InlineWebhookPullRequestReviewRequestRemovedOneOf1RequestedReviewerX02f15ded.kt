 ...
 * sted_reviewer
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerTypeX0af8d9b7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerTypeX0af8d9b7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded(block: InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded = InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1RequestedReviewerX02f15ded is missing required property '" + name + "'")
