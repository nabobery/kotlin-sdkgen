 ...
 */
@Serializable(with = InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6.Serializer::class)
public class InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssueCommentP58c8IssueAllOf1PerformedViaGithubAppItemX2e31fb37>>,
  private val permissionsState:
      FieldState<InlineWebhookIssueCommentP58c8IssueAllOf1PermissionsXdeb67073>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssueCommentP58c8IssueAllOf1PerformedViaGithubAppItemX2e31fb37>>
   ...
   */
  public val events:
      List<InlineWebhookIssueCommentP58c8IssueAllOf1PerformedViaGithubAppItemX2e31fb37>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssueCommentP58c8IssueAllOf1PermissionsXdeb67073?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookIssueCommentP58c8IssueAllOf1PermissionsXdeb67073?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 {
      ...
      return InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6")
...
public fun inlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6(block: InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6.Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 = InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppX33edacc6 property '" + name + "' is not nullable")
