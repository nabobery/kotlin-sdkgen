 ...
 * github_app
 */
@Serializable(with = InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4.Serializer::class)
public class InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppEventsItemX32804ba7>>,
  private val permissionsState:
      FieldState<InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppPermissionsX7a898f2c>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppEventsItemX32804ba7>> =
   ...
   */
  public val events:
      List<InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppEventsItemX32804ba7>?
  ...
  public val permissions:
      InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppPermissionsX7a898f2c?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226?
    ...
    public fun build(): InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 {
      ...
      return InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4")
...
public fun inlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4(block: InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4.Builder.() -> Unit): InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 = InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4 property '" + name + "' is not nullable")
