 ...
 * A git repository
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-team-edited/properties/repository
 */
@Serializable(with = InlineWebhookTeamEditedRepositoryX5cdb77da.Serializer::class)
public class InlineWebhookTeamEditedRepositoryX5cdb77da internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookTeamEditedRepositoryCreatedAtX2c420ca4,
  /**
  ...
  public val license: InlineWebhookTeamEditedRepositoryLicenseX7f3bf918?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookTeamEditedRepositoryOwnerX87f220a9?,
  /**
  ...
  public val pushedAt: InlineWebhookTeamEditedRepositoryPushedAtXa29e469f?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookTeamEditedRepositoryVisibilityXfab0ae44,
  ...
  private val permissionsState: FieldState<InlineWebhookTeamEditedRepositoryPermissionsX12580478>,
  ...
  public val permissions: InlineWebhookTeamEditedRepositoryPermissionsX12580478?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookTeamEditedRepositoryCreatedAtX2c420ca4,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookTeamEditedRepositoryLicenseX7f3bf918?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookTeamEditedRepositoryOwnerX87f220a9?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookTeamEditedRepositoryPushedAtXa29e469f?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookTeamEditedRepositoryVisibilityXfab0ae44,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookTeamEditedRepositoryCreatedAtX2c420ca4? = null

    public var createdAt: InlineWebhookTeamEditedRepositoryCreatedAtX2c420ca4
    ...
    private var visibilityValue: InlineWebhookTeamEditedRepositoryVisibilityXfab0ae44? = null

    public var visibility: InlineWebhookTeamEditedRepositoryVisibilityXfab0ae44
    ...
    private var licenseState: FieldState<InlineWebhookTeamEditedRepositoryLicenseX7f3bf918?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookTeamEditedRepositoryLicenseX7f3bf918?
    ...
    private var ownerState: FieldState<InlineWebhookTeamEditedRepositoryOwnerX87f220a9?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookTeamEditedRepositoryOwnerX87f220a9?
      get() = ownerState.valueOrNull()
      set(`value`) {
        ownerState = value.toNullableFieldState()
      }

    private var pushedAtState: FieldState<InlineWebhookTeamEditedRepositoryPushedAtXa29e469f?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookTeamEditedRepositoryPushedAtXa29e469f?
    ...
    private var permissionsState: FieldState<InlineWebhookTeamEditedRepositoryPermissionsX12580478>
        = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookTeamEditedRepositoryPermissionsX12580478?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookTeamEditedRepositoryX5cdb77da {
      ...
      return InlineWebhookTeamEditedRepositoryX5cdb77da(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookTeamEditedRepositoryX5cdb77da = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookTeamEditedRepositoryX5cdb77da> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookTeamEditedRepositoryX5cdb77da {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookTeamEditedRepositoryX5cdb77da")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookTeamEditedRepositoryX5cdb77da must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookTeamEditedRepositoryCreatedAtX2c420ca4>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookTeamEditedRepositoryVisibilityXfab0ae44>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookTeamEditedRepositoryX5cdb77da is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookTeamEditedRepositoryX5cdb77da is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookTeamEditedRepositoryX5cdb77da is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookTeamEditedRepositoryX5cdb77da is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamEditedRepositoryLicenseX7f3bf918?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookTeamEditedRepositoryX5cdb77da is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookTeamEditedRepositoryX5cdb77da is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamEditedRepositoryOwnerX87f220a9?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookTeamEditedRepositoryX5cdb77da is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamEditedRepositoryPushedAtXa29e469f?>(requireNotNull(element)) }
      return InlineWebhookTeamEditedRepositoryX5cdb77da(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookTeamEditedRepositoryX5cdb77da) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookTeamEditedRepositoryX5cdb77da")
...
public fun inlineWebhookTeamEditedRepositoryX5cdb77da(block: InlineWebhookTeamEditedRepositoryX5cdb77da.Builder.() -> Unit): InlineWebhookTeamEditedRepositoryX5cdb77da = InlineWebhookTeamEditedRepositoryX5cdb77da.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookTeamEditedRepositoryX5cdb77da is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookTeamEditedRepositoryX5cdb77da property '" + name + "' is not nullable")
