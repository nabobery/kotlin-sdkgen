 ...
 * erties/requested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-enabled/properties/pull_request/prop
 * erties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0.Serializer::class)
public class InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemTypeXb610cb33? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemTypeXb610cb33? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0 must be a JSON object")
      ...
      return InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemTypeXb610cb33>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0")
...
public fun inlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0(block: InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0.Builder.() -> Unit): InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0 = InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAu6055PullRequestRequestedReviewersItemOneOf1Xf648eaa0 is missing required property '" + name + "'")
