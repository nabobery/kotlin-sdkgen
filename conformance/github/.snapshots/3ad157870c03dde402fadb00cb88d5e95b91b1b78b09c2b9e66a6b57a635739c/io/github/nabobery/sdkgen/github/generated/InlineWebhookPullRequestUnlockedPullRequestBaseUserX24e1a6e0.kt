 ...
 * e/properties/user
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestUnlockedPullRequestBaseUserTypeX6613c32c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlockedPullRequestBaseUserTypeX6613c32c? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestBaseUserTypeX6613c32c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0")
...
public fun inlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0(block: InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0 = InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestBaseUserX24e1a6e0 is missing required property '" + name + "'")
