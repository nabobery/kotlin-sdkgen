 ...
 * /actor
 */
@Serializable(with = InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248.Serializer::class)
public class InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248(
  public val id: Int,
  ...
  public val type: InlineWebhookDeploymentStatusCreatedWorkflowRunActorTypeX75643039? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentStatusCreatedWorkflowRunActorTypeX75643039? = null
    ...
    public fun build(): InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248 must be a JSON object")
      ...
      return InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentStatusCreatedWorkflowRunActorTypeX75643039>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248")
...
public fun inlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248(block: InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248.Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248 = InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248 is missing required property '" + name + "'")
