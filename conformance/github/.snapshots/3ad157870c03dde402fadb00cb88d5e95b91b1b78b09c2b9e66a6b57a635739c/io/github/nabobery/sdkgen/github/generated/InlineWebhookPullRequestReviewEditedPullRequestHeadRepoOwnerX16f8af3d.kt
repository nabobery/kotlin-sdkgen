 ...
 * s/head/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-edited/properties/pull_request/propertie
 * s/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d.Serializer::class)
public class InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerTypeX74dba768? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerTypeX74dba768? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerTypeX74dba768>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d")
...
public fun inlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d(block: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d.Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d = InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d is missing required property '" + name + "'")
