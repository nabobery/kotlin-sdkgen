 ...
 * properties/user
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestLockedPullRequestHeadUserTypeX00da870d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLockedPullRequestHeadUserTypeX00da870d? = null
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1 must be a JSON object")
      ...
      return InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestHeadUserTypeX00da870d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1")
...
public fun inlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1(block: InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1 = InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestHeadUserX57d922c1 is missing required property '" + name + "'")
