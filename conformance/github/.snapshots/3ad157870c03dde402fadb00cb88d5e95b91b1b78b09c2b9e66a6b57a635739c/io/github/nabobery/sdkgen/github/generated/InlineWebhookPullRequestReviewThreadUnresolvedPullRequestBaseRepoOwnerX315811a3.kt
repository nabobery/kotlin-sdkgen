 ...
 * t/properties/base/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-thread-unresolved/properties/pull_reques
 * t/properties/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3.Serializer::class)
public class InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe5e87PullRequestBaseRepoOwnerTypeX3a609908? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe5e87PullRequestBaseRepoOwnerTypeX3a609908? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe5e87PullRequestBaseRepoOwnerTypeX3a609908>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3")
...
public fun inlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3(block: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3 = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3 is missing required property '" + name + "'")
