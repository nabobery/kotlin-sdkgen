 ...
 * perties/base/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-disabled/properties/pull_request/pro
 * perties/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065.Serializer::class)
public class InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerTypeX4da8641d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerTypeX4da8641d?
        = null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065 must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerTypeX4da8641d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065")
...
public fun inlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065(block: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065 = InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065 is missing required property '" + name + "'")
