 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/repository-advisory/properties/author
 */
@Serializable(with = InlineRepositoryAdvisoryAuthorX5138f947.Serializer::class)
public class InlineRepositoryAdvisoryAuthorX5138f947 internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineRepositoryAdvisoryAuthorX5138f947 {
      ...
      return InlineRepositoryAdvisoryAuthorX5138f947(
        avatarUrl = avatarUrl,
        eventsUrl = eventsUrl,
        followersUrl = followersUrl,
        followingUrl = followingUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineRepositoryAdvisoryAuthorX5138f947 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineRepositoryAdvisoryAuthorX5138f947> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineRepositoryAdvisoryAuthorX5138f947 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineRepositoryAdvisoryAuthorX5138f947")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineRepositoryAdvisoryAuthorX5138f947 must be a JSON object")
      ...
      if (!rawObject.containsKey("gravatar_id")) {
        throw SerializationException("InlineRepositoryAdvisoryAuthorX5138f947 is missing required property 'gravatar_id'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineRepositoryAdvisoryAuthorX5138f947) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineRepositoryAdvisoryAuthorX5138f947")
...
public fun inlineRepositoryAdvisoryAuthorX5138f947(block: InlineRepositoryAdvisoryAuthorX5138f947.Builder.() -> Unit): InlineRepositoryAdvisoryAuthorX5138f947 = InlineRepositoryAdvisoryAuthorX5138f947.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineRepositoryAdvisoryAuthorX5138f947 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineRepositoryAdvisoryAuthorX5138f947 property '" + name + "' is not nullable")
