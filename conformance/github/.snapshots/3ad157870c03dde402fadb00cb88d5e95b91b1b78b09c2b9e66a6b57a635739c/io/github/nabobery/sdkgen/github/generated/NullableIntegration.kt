 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-integration
 */
@Serializable(with = NullableIntegration.Serializer::class)
public class NullableIntegration internal constructor(
  /**
  ...
  public val owner: InlineNullableIntegrationOwnerXab362aa5,
  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineNullableIntegrationPermissionsX8c58ac3b,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineNullableIntegrationOwnerXab362aa5,
    permissions: InlineNullableIntegrationPermissionsX8c58ac3b,
    updatedAt: String,
  ...
  public class Builder {
    ...
    private var ownerValue: InlineNullableIntegrationOwnerXab362aa5? = null

    public var owner: InlineNullableIntegrationOwnerXab362aa5
      get() = requireNotNull(ownerValue) { "owner is required" }
      set(`value`) {
        ownerValue = value
      }

    private var permissionsValue: InlineNullableIntegrationPermissionsX8c58ac3b? = null

    public var permissions: InlineNullableIntegrationPermissionsX8c58ac3b
    ...
    public fun build(): NullableIntegration {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): NullableIntegration = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<NullableIntegration> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): NullableIntegration {
      val jsonDecoder = decoder.requireJsonDecoder("NullableIntegration")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("NullableIntegration must be a JSON object")
      ...
      val owner = json.decodeRequired<InlineNullableIntegrationOwnerXab362aa5>(rawObject, "owner")
      val permissions = json.decodeRequired<InlineNullableIntegrationPermissionsX8c58ac3b>(rawObject, "permissions")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      if (!rawObject.containsKey("description")) {
        throw SerializationException("NullableIntegration is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: NullableIntegration) {
      val jsonEncoder = encoder.requireJsonEncoder("NullableIntegration")
...
public fun nullableIntegration(block: NullableIntegration.Builder.() -> Unit): NullableIntegration = NullableIntegration.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NullableIntegration is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("NullableIntegration property '" + name + "' is not nullable")
