 ...
 * properties/owner
 */
@Serializable(with = InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74.Serializer::class)
public class InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74(
  public val id: Int,
  ...
  public val type: InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerTypeX2dbbe558? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerTypeX2dbbe558? = null
    ...
    public fun build(): InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74 must be a JSON object")
      ...
      return InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerTypeX2dbbe558>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74")
...
public fun inlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74(block: InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74.Builder.() -> Unit): InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74 = InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCheckSuiteRequestedCheckSuiteAppOwnerX7540cd74 is missing required property '" + name + "'")
