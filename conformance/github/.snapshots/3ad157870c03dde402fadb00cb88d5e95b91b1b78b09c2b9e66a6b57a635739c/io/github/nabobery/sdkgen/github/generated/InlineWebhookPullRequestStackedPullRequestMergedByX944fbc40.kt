 ...
 * ed_by
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestStackedPullRequestMergedByTypeX2a6fc616? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestStackedPullRequestMergedByTypeX2a6fc616? = null
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40 must be a JSON object")
      ...
      return InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestStackedPullRequestMergedByTypeX2a6fc616>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40")
...
public fun inlineWebhookPullRequestStackedPullRequestMergedByX944fbc40(block: InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40 = InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestMergedByX944fbc40 is missing required property '" + name + "'")
