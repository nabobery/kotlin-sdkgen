...
@Serializable
public data class AssignedIssueEventView(
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/assigned-issue-event
 */
@Serializable(with = AssignedIssueEvent.Serializer::class)
public class AssignedIssueEvent(
  ...
  public class Builder {
    ...
    public fun build(): AssignedIssueEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): AssignedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<AssignedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): AssignedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("AssignedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AssignedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("AssignedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("AssignedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("AssignedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: AssignedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("AssignedIssueEvent")
...
public fun assignedIssueEvent(block: AssignedIssueEvent.Builder.() -> Unit): AssignedIssueEvent = AssignedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AssignedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("AssignedIssueEvent property '" + name + "' is not nullable")
