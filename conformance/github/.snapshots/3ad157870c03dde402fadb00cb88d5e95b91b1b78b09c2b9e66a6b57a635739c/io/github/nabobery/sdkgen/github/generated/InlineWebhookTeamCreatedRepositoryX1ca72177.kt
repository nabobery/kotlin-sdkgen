 ...
 * A git repository
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-team-created/properties/repository
 */
@Serializable(with = InlineWebhookTeamCreatedRepositoryX1ca72177.Serializer::class)
public class InlineWebhookTeamCreatedRepositoryX1ca72177 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookTeamCreatedRepositoryCreatedAtX13f705af,
  /**
  ...
  public val license: InlineWebhookTeamCreatedRepositoryLicenseX56787c5c?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924?,
  /**
  ...
  public val pushedAt: InlineWebhookTeamCreatedRepositoryPushedAtX7ac9c1a7?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookTeamCreatedRepositoryVisibilityX1711b492,
  ...
  private val permissionsState: FieldState<InlineWebhookTeamCreatedRepositoryPermissionsXaf100deb>,
  ...
  public val permissions: InlineWebhookTeamCreatedRepositoryPermissionsXaf100deb?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookTeamCreatedRepositoryCreatedAtX13f705af,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookTeamCreatedRepositoryLicenseX56787c5c?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookTeamCreatedRepositoryPushedAtX7ac9c1a7?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookTeamCreatedRepositoryVisibilityX1711b492,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookTeamCreatedRepositoryCreatedAtX13f705af? = null

    public var createdAt: InlineWebhookTeamCreatedRepositoryCreatedAtX13f705af
    ...
    private var visibilityValue: InlineWebhookTeamCreatedRepositoryVisibilityX1711b492? = null

    public var visibility: InlineWebhookTeamCreatedRepositoryVisibilityX1711b492
    ...
    private var licenseState: FieldState<InlineWebhookTeamCreatedRepositoryLicenseX56787c5c?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookTeamCreatedRepositoryLicenseX56787c5c?
    ...
    private var ownerState: FieldState<InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924?
      get() = ownerState.valueOrNull()
      set(`value`) {
        ownerState = value.toNullableFieldState()
      }

    private var pushedAtState: FieldState<InlineWebhookTeamCreatedRepositoryPushedAtX7ac9c1a7?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookTeamCreatedRepositoryPushedAtX7ac9c1a7?
    ...
    private var permissionsState: FieldState<InlineWebhookTeamCreatedRepositoryPermissionsXaf100deb>
        = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookTeamCreatedRepositoryPermissionsXaf100deb?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookTeamCreatedRepositoryX1ca72177 {
      ...
      return InlineWebhookTeamCreatedRepositoryX1ca72177(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookTeamCreatedRepositoryX1ca72177 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookTeamCreatedRepositoryX1ca72177> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookTeamCreatedRepositoryX1ca72177 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookTeamCreatedRepositoryX1ca72177")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookTeamCreatedRepositoryX1ca72177 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookTeamCreatedRepositoryCreatedAtX13f705af>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookTeamCreatedRepositoryVisibilityX1711b492>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookTeamCreatedRepositoryX1ca72177 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookTeamCreatedRepositoryX1ca72177 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookTeamCreatedRepositoryX1ca72177 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookTeamCreatedRepositoryX1ca72177 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamCreatedRepositoryLicenseX56787c5c?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookTeamCreatedRepositoryX1ca72177 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookTeamCreatedRepositoryX1ca72177 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamCreatedRepositoryOwnerXbfdc2924?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookTeamCreatedRepositoryX1ca72177 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamCreatedRepositoryPushedAtX7ac9c1a7?>(requireNotNull(element)) }
      return InlineWebhookTeamCreatedRepositoryX1ca72177(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookTeamCreatedRepositoryX1ca72177) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookTeamCreatedRepositoryX1ca72177")
...
public fun inlineWebhookTeamCreatedRepositoryX1ca72177(block: InlineWebhookTeamCreatedRepositoryX1ca72177.Builder.() -> Unit): InlineWebhookTeamCreatedRepositoryX1ca72177 = InlineWebhookTeamCreatedRepositoryX1ca72177.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookTeamCreatedRepositoryX1ca72177 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookTeamCreatedRepositoryX1ca72177 property '" + name + "' is not nullable")
