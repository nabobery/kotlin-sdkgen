 ...
 * iggering_actor
 */
@Serializable(with = InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4.Serializer::class)
public class InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4(
  public val id: Int,
  ...
  public val type: InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorTypeX67f32384? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorTypeX67f32384? =
        null
    ...
    public fun build(): InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4 must be a JSON object")
      ...
      return InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorTypeX67f32384>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4")
...
public fun inlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4(block: InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4.Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4 = InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunTriggeringActorX8a4c06c4 is missing required property '" + name + "'")
