...
public class InlineOrgsActionsRunnerGroupsPatchRequestJsonXba8a4293 internal constructor(
  ...
  selectedWorkflowsState: FieldState<List<String>>,
  ...
  private val selectedWorkflowsState: FieldState<List<String>> =
      selectedWorkflowsState.copyValue { fieldValue -> fieldValue.toList() }
  ...
  public class Builder {
    ...
    public var selectedWorkflows: List<String>?
      get() = selectedWorkflowsState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        val present = requireNotNull(value) { "selectedWorkflows is not nullable; call unsetSelectedWorkflows() to omit it" }
        selectedWorkflowsState = FieldState.Value(present.toList())
      }
  ...
  internal object Serializer : KSerializer<InlineOrgsActionsRunnerGroupsPatchRequestJsonXba8a4293> {
