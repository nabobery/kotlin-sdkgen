...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_alert/properties/dismisser.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_alert/properties/dismisser
 */
@Serializable(with = InlineWebhooksAlertDismisserX41b1a79c.Serializer::class)
public class InlineWebhooksAlertDismisserX41b1a79c(
  public val id: Int,
  ...
  public val type: InlineWebhooksAlertDismisserTypeX333af9d4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksAlertDismisserTypeX333af9d4? = null
    ...
    public fun build(): InlineWebhooksAlertDismisserX41b1a79c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksAlertDismisserX41b1a79c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksAlertDismisserX41b1a79c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksAlertDismisserX41b1a79c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksAlertDismisserX41b1a79c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksAlertDismisserX41b1a79c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksAlertDismisserX41b1a79c must be a JSON object")
      ...
      return InlineWebhooksAlertDismisserX41b1a79c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksAlertDismisserTypeX333af9d4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksAlertDismisserX41b1a79c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksAlertDismisserX41b1a79c")
...
public fun inlineWebhooksAlertDismisserX41b1a79c(block: InlineWebhooksAlertDismisserX41b1a79c.Builder.() -> Unit): InlineWebhooksAlertDismisserX41b1a79c = InlineWebhooksAlertDismisserX41b1a79c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksAlertDismisserX41b1a79c is missing required property '" + name + "'")
