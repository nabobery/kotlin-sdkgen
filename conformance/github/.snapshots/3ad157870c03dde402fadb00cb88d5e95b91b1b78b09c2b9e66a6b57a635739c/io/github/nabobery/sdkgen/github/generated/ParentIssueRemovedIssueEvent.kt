...
@Serializable
public data class ParentIssueRemovedIssueEventView(
  ...
  public val parentIssue: NullableIssueReference?,
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/parent-issue-removed-issue-event
 */
@Serializable(with = ParentIssueRemovedIssueEvent.Serializer::class)
public class ParentIssueRemovedIssueEvent(
  public val actor: SimpleUser,
  public val commitId: String?,
  public val commitUrl: String?,
  public val createdAt: String,
  ...
  public class Builder {
    ...
    private var parentIssueState: FieldState<NullableIssueReference?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var parentIssue: NullableIssueReference?
      get() = parentIssueState.valueOrNull()
      set(`value`) {
        parentIssueState = value.toNullableFieldState()
      }
    ...
    public fun build(): ParentIssueRemovedIssueEvent {
      ...
      check(parentIssueState !== FieldState.Absent) { "parentIssue is required, even when null" }
      check(performedViaGithubAppState !== FieldState.Absent) { "performedViaGithubApp is required, even when null" }
      return ParentIssueRemovedIssueEvent(
        actor = actor,
        ...
        id = id,
        nodeId = nodeId,
        parentIssue = parentIssueState.valueOrNull(),
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ParentIssueRemovedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<ParentIssueRemovedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ParentIssueRemovedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("ParentIssueRemovedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ParentIssueRemovedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("ParentIssueRemovedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("ParentIssueRemovedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("parent_issue")) {
        throw SerializationException("ParentIssueRemovedIssueEvent is missing required property 'parent_issue'")
      }
      val parentIssue = rawObject["parent_issue"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<NullableIssueReference?>(requireNotNull(element)) }
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("ParentIssueRemovedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ParentIssueRemovedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("ParentIssueRemovedIssueEvent")
      ...
      val raw = buildJsonObject {
        ...
        put("parent_issue", value.parentIssue?.let { json.encodeToJsonElement(it) } ?: JsonNull)
...
public fun parentIssueRemovedIssueEvent(block: ParentIssueRemovedIssueEvent.Builder.() -> Unit): ParentIssueRemovedIssueEvent = ParentIssueRemovedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ParentIssueRemovedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ParentIssueRemovedIssueEvent property '" + name + "' is not nullable")
