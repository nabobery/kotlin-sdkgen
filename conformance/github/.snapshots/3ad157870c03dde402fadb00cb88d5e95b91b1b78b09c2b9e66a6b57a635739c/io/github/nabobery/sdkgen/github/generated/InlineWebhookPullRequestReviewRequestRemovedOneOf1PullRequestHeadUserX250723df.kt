 ...
 * request/properties/head/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-request-removed/oneOf/0/properties/pull_
 * request/properties/head/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadUserTypeXe7330255? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf1PullRequestHeadUserTypeXe7330255? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestHeadUserTypeXe7330255>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df(block: InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df = InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestHeadUserX250723df is missing required property '" + name + "'")
