 ...
 * github_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-milestoned/properties/issue/properties/performed_via_
 * github_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226.Serializer::class)
public class InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerTypeXae4b74de? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerTypeXae4b74de? =
        null
    ...
    public fun build(): InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226 must be a JSON object")
      ...
      return InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerTypeXae4b74de>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226")
...
public fun inlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226(block: InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226.Builder.() -> Unit): InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226 = InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppOwnerXaac56226 is missing required property '" + name + "'")
