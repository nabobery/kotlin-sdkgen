...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/user
 */
@Serializable(with = InlineWebhooksPullRequest5UserXf9196b04.Serializer::class)
public class InlineWebhooksPullRequest5UserXf9196b04(
  public val id: Long,
  ...
  public val type: InlineWebhooksPullRequest5UserTypeXde85a670? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksPullRequest5UserTypeXde85a670? = null
    ...
    public fun build(): InlineWebhooksPullRequest5UserXf9196b04 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksPullRequest5UserXf9196b04(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5UserXf9196b04 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5UserXf9196b04> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5UserXf9196b04 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5UserXf9196b04")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5UserXf9196b04 must be a JSON object")
      ...
      return InlineWebhooksPullRequest5UserXf9196b04(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksPullRequest5UserTypeXde85a670>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5UserXf9196b04) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5UserXf9196b04")
...
public fun inlineWebhooksPullRequest5UserXf9196b04(block: InlineWebhooksPullRequest5UserXf9196b04.Builder.() -> Unit): InlineWebhooksPullRequest5UserXf9196b04 = InlineWebhooksPullRequest5UserXf9196b04.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5UserXf9196b04 is missing required property '" + name + "'")
