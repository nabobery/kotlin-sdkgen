 ...
 * t/properties/milestone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-requested/oneOf/1/properties/pull_reques
 * t/properties/milestone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29.Serializer::class)
public class InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorTypeX7a0e43a4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorTypeX7a0e43a4? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29 must be a JSON object")
      ...
      return InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorTypeX7a0e43a4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29")
...
public fun inlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29(block: InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29.Builder.() -> Unit): InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29 = InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29 is missing required property '" + name + "'")
