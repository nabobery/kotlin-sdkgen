 ...
 * properties/assignees/items
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836.Serializer::class)
public class InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe8fbbPullRequestAssigneesItemTypeXd1bdd2af? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe8fbbPullRequestAssigneesItemTypeXd1bdd2af? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe8fbbPullRequestAssigneesItemTypeXd1bdd2af>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836")
...
public fun inlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836(block: InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836 = InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestAssigneesItemXf072c836 is missing required property '" + name + "'")
