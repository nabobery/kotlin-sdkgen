...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue/properties/assignees/items.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue/properties/assignees/items
 */
@Serializable(with = InlineWebhooksIssueAssigneesItemXc1de8a8c.Serializer::class)
public class InlineWebhooksIssueAssigneesItemXc1de8a8c(
  public val id: Int,
  ...
  public val type: InlineWebhooksIssueAssigneesItemTypeX597fc019? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksIssueAssigneesItemTypeX597fc019? = null
    ...
    public fun build(): InlineWebhooksIssueAssigneesItemXc1de8a8c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksIssueAssigneesItemXc1de8a8c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssueAssigneesItemXc1de8a8c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssueAssigneesItemXc1de8a8c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssueAssigneesItemXc1de8a8c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssueAssigneesItemXc1de8a8c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssueAssigneesItemXc1de8a8c must be a JSON object")
      ...
      return InlineWebhooksIssueAssigneesItemXc1de8a8c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksIssueAssigneesItemTypeX597fc019>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssueAssigneesItemXc1de8a8c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssueAssigneesItemXc1de8a8c")
...
public fun inlineWebhooksIssueAssigneesItemXc1de8a8c(block: InlineWebhooksIssueAssigneesItemXc1de8a8c.Builder.() -> Unit): InlineWebhooksIssueAssigneesItemXc1de8a8c = InlineWebhooksIssueAssigneesItemXc1de8a8c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssueAssigneesItemXc1de8a8c is missing required property '" + name + "'")
