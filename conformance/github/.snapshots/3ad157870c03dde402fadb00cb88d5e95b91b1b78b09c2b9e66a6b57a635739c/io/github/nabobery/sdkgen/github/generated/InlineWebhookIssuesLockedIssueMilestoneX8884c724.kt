 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-locked/properties/issue/properties/milestone
 */
@Serializable(with = InlineWebhookIssuesLockedIssueMilestoneX8884c724.Serializer::class)
public class InlineWebhookIssuesLockedIssueMilestoneX8884c724(
  /**
  ...
  public val creator: InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4?,
   ...
   */
  public val state: InlineWebhookIssuesLockedIssueMilestoneStateXcb14d0ea,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssuesLockedIssueMilestoneStateXcb14d0ea? = null

    public var state: InlineWebhookIssuesLockedIssueMilestoneStateXcb14d0ea
    ...
    private var creatorState: FieldState<InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4?
    ...
    public fun build(): InlineWebhookIssuesLockedIssueMilestoneX8884c724 {
      ...
      return InlineWebhookIssuesLockedIssueMilestoneX8884c724(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLockedIssueMilestoneX8884c724 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLockedIssueMilestoneX8884c724> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLockedIssueMilestoneX8884c724 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLockedIssueMilestoneX8884c724")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLockedIssueMilestoneX8884c724 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssuesLockedIssueMilestoneStateXcb14d0ea>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesLockedIssueMilestoneX8884c724 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssuesLockedIssueMilestoneX8884c724 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesLockedIssueMilestoneX8884c724 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssuesLockedIssueMilestoneX8884c724 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLockedIssueMilestoneX8884c724) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLockedIssueMilestoneX8884c724")
...
public fun inlineWebhookIssuesLockedIssueMilestoneX8884c724(block: InlineWebhookIssuesLockedIssueMilestoneX8884c724.Builder.() -> Unit): InlineWebhookIssuesLockedIssueMilestoneX8884c724 = InlineWebhookIssuesLockedIssueMilestoneX8884c724.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLockedIssueMilestoneX8884c724 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesLockedIssueMilestoneX8884c724 property '" + name + "' is not nullable")
