 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-deleted/properties/issue
 */
@Serializable(with = InlineWebhookIssuesDeletedIssueX49ce9b15.Serializer::class)
public class InlineWebhookIssuesDeletedIssueX49ce9b15 internal constructor(
  public val activeLockReason: InlineWebhookIssuesDeletedIssueActiveLockReasonX8200582b?,
  assignees: List<InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a?>,
  /**
   * How the author is associated with the repository.
   */
  public val authorAssociation: InlineWebhookIssuesDeletedIssueAuthorAssociationXf5fe6bd4,
  /**
   ...
   */
  public val milestone: InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhookIssuesDeletedIssueReactionsX3c741c26,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhookIssuesDeletedIssueUserX1fbd85fe?,
  private val assigneeState: FieldState<InlineWebhookIssuesDeletedIssueAssigneeX9b384f70?>,
  ...
  labelsState: FieldState<List<InlineWebhookIssuesDeletedIssueLabelsItemXf392726f>>,
  private val lockedState: FieldState<Boolean>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad?>,
  private val pinnedCommentState: FieldState<NullableIssueComment?>,
  private val pullRequestState: FieldState<InlineWebhookIssuesDeletedIssuePullRequestX8d1d1a7c>,
  private val stateState: FieldState<InlineWebhookIssuesDeletedIssueStateXa6dfb9f3>,
  ...
  public val assignees: List<InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a?> =
      assignees.toList()
  ...
  private val labelsState: FieldState<List<InlineWebhookIssuesDeletedIssueLabelsItemXf392726f>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssuesDeletedIssueAssigneeX9b384f70?
  ...
  public val labels: List<InlineWebhookIssuesDeletedIssueLabelsItemXf392726f>?
   ...
   */
  public val performedViaGithubApp: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad?
  ...
  public val pullRequest: InlineWebhookIssuesDeletedIssuePullRequestX8d1d1a7c?
    get() = pullRequestState.valueOrNull()

  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssuesDeletedIssueStateXa6dfb9f3?
  ...
  public constructor(
    activeLockReason: InlineWebhookIssuesDeletedIssueActiveLockReasonX8200582b?,
    assignees: List<InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a?>,
    authorAssociation: InlineWebhookIssuesDeletedIssueAuthorAssociationXf5fe6bd4,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    id: Long,
    labelsUrl: String,
    milestone: InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhookIssuesDeletedIssueReactionsX3c741c26,
    repositoryUrl: String,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhookIssuesDeletedIssueUserX1fbd85fe?,
  ...
  public class Builder {
    private var assigneesValue: List<InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a?>? = null

    public var assignees: List<InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a?>
      get() = requireNotNull(assigneesValue) { "assignees is required" }.toList()
      set(`value`) {
        assigneesValue = value.toList()
      }

    private var authorAssociationValue: InlineWebhookIssuesDeletedIssueAuthorAssociationXf5fe6bd4? =
        null

    public var authorAssociation: InlineWebhookIssuesDeletedIssueAuthorAssociationXf5fe6bd4
    ...
    private var reactionsValue: InlineWebhookIssuesDeletedIssueReactionsX3c741c26? = null

    public var reactions: InlineWebhookIssuesDeletedIssueReactionsX3c741c26
    ...
    private var activeLockReasonState:
        FieldState<InlineWebhookIssuesDeletedIssueActiveLockReasonX8200582b?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var activeLockReason: InlineWebhookIssuesDeletedIssueActiveLockReasonX8200582b?
    ...
    private var milestoneState: FieldState<InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhookIssuesDeletedIssueUserX1fbd85fe?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssuesDeletedIssueUserX1fbd85fe?
      get() = userState.valueOrNull()
      set(`value`) {
        userState = value.toNullableFieldState()
      }

    private var assigneeState: FieldState<InlineWebhookIssuesDeletedIssueAssigneeX9b384f70?> =
        FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var assignee: InlineWebhookIssuesDeletedIssueAssigneeX9b384f70?
      get() = assigneeState.valueOrNull()
      set(`value`) {
    ...
    private var labelsState: FieldState<List<InlineWebhookIssuesDeletedIssueLabelsItemXf392726f>> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhookIssuesDeletedIssueLabelsItemXf392726f>?
     ...
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var performedViaGithubApp: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad?
      get() = performedViaGithubAppState.valueOrNull()
      set(`value`) {
    ...
    private var pullRequestState: FieldState<InlineWebhookIssuesDeletedIssuePullRequestX8d1d1a7c> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhookIssuesDeletedIssuePullRequestX8d1d1a7c?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssuesDeletedIssueStateXa6dfb9f3> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var state: InlineWebhookIssuesDeletedIssueStateXa6dfb9f3?
      get() = stateState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesDeletedIssueX49ce9b15 {
      ...
      return InlineWebhookIssuesDeletedIssueX49ce9b15(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDeletedIssueX49ce9b15 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDeletedIssueX49ce9b15> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDeletedIssueX49ce9b15 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDeletedIssueX49ce9b15")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDeletedIssueX49ce9b15 must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhookIssuesDeletedIssueAssigneesItemX7f75c11a?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhookIssuesDeletedIssueAuthorAssociationXf5fe6bd4>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhookIssuesDeletedIssueReactionsX3c741c26>(rawObject, "reactions")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssueX49ce9b15 is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesDeletedIssueActiveLockReasonX8200582b?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssueX49ce9b15 is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssueX49ce9b15 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssueX49ce9b15 is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesDeletedIssueMilestoneXa3aaa153?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssueX49ce9b15 is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesDeletedIssueUserX1fbd85fe?>(requireNotNull(element)) }
      return InlineWebhookIssuesDeletedIssueX49ce9b15(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDeletedIssueX49ce9b15) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDeletedIssueX49ce9b15")
...
public fun inlineWebhookIssuesDeletedIssueX49ce9b15(block: InlineWebhookIssuesDeletedIssueX49ce9b15.Builder.() -> Unit): InlineWebhookIssuesDeletedIssueX49ce9b15 = InlineWebhookIssuesDeletedIssueX49ce9b15.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDeletedIssueX49ce9b15 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesDeletedIssueX49ce9b15 property '" + name + "' is not nullable")
