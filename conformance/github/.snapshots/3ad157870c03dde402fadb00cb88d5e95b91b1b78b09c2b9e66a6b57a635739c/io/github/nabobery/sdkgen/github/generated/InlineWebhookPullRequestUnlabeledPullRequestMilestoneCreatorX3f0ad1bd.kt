 ...
 * lestone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unlabeled/properties/pull_request/properties/mi
 * lestone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorTypeXe24220cf? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorTypeXe24220cf? =
        null
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorTypeXe24220cf>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd(block: InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd = InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd is missing required property '" + name + "'")
