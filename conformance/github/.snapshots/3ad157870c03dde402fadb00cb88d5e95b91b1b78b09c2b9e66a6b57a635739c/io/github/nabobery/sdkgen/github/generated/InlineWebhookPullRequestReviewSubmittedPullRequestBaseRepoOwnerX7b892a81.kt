 ...
 * ties/base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81.Serializer::class)
public class InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerTypeXa7221e89? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerTypeXa7221e89? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerTypeXa7221e89>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81")
...
public fun inlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81(block: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81.Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81 = InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81 is missing required property '" + name + "'")
