 ...
 * s/head_repository/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-review-rejected/properties/workflow_run/propertie
 * s/head_repository/properties/owner
 */
@Serializable(with = InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791.Serializer::class)
public class InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791 = InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791 must be a JSON object")
      return InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791")
...
public fun inlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791(block: InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791.Builder.() -> Unit): InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791 = InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791.build(block)
