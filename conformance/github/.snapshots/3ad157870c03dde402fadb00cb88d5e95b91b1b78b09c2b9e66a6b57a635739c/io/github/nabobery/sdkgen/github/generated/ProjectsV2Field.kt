...
public class ProjectsV2Field(
  ...
  options: List<ProjectsV2SingleSelectOptions>? = null,
) {
  /**
   * The options available for single select fields.
   */
  public val options: List<ProjectsV2SingleSelectOptions>? =
  ...
  public class Builder {
    ...
    private var optionsValue: List<ProjectsV2SingleSelectOptions>? = null

    /**
     * The options available for single select fields.
     */
    public var options: List<ProjectsV2SingleSelectOptions>?
  ...
  internal object Serializer : KSerializer<ProjectsV2Field> {
