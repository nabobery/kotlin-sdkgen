 ...
 * ser
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestUnassignedPullRequestUserTypeX1683acee? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnassignedPullRequestUserTypeX1683acee? = null
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee must be a JSON object")
      ...
      return InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestUserTypeX1683acee>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee")
...
public fun inlineWebhookPullRequestUnassignedPullRequestUserX289c1bee(block: InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee = InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestUserX289c1bee is missing required property '" + name + "'")
