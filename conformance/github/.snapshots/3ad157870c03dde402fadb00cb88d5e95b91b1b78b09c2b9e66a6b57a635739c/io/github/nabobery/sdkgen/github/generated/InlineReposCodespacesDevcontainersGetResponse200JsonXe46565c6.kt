...
public class InlineReposCodespacesDevcontainersGetResponse200JsonXe46565c6(
  ...
  public class Builder {
    ...
    public var devcontainers:
        List<InlineReposCodespacesDevcontainersGetResponse200JsonDevcontainersItemX09de1fb8>
      get() = requireNotNull(devcontainersValue) { "devcontainers is required" }.toList()
      set(`value`) {
        devcontainersValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<InlineReposCodespacesDevcontainersGetResponse200JsonXe46565c6> {
