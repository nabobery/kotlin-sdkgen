 ...
 * formed_via_github_app/properties/owner
 */
@Serializable(with = InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5.Serializer::class)
public class InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssueCommentP58c8IssueAllOf1PerformedViaGithubAppOwnerTypeX465e0c0a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5 must be a JSON object")
      ...
      return InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentP58c8IssueAllOf1PerformedViaGithubAppOwnerTypeX465e0c0a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5")
...
public fun inlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5(block: InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5.Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5 = InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1PerformedViaGithubAppOwnerXaae708e5 is missing required property '" + name + "'")
