 ...
 * ser
 */
@Serializable(with = InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4.Serializer::class)
public class InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4(
  public val id: Long,
  ...
  public val type: InlineWebhookIssueCommentUnpinnedIssueAllOf1UserTypeXc15cd46b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentUnpinnedIssueAllOf1UserTypeXc15cd46b? = null
    ...
    public fun build(): InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4 must be a JSON object")
      ...
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentUnpinnedIssueAllOf1UserTypeXc15cd46b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4")
...
public fun inlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4(block: InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4.Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4 = InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1UserX1342e2f4 is missing required property '" + name + "'")
