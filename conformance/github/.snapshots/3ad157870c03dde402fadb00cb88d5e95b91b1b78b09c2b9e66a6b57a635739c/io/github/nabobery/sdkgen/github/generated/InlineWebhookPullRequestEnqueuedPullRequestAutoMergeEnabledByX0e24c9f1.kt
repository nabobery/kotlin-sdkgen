 ...
 * o_merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-enqueued/properties/pull_request/properties/aut
 * o_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByTypeX35d27831? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByTypeX35d27831? =
        null
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1 must be a JSON object")
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByTypeX35d27831>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1(block: InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1 = InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByX0e24c9f1 is missing required property '" + name + "'")
