 ...
 * perties/requested_reviewers/items/oneOf/1
 */
@Serializable(with = InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873.Serializer::class)
public class InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873 internal constructor(
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemParentX597b1b5c?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent: InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemParentX597b1b5c?
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemPrivacyXc0086b5e? = null
     ...
     */
    public var parent:
        InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemParentX597b1b5c?
      get() = parentState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873 must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemPrivacyXc0086b5e>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873 is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873")
...
public fun inlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873(block: InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873.Builder.() -> Unit): InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873 = InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestAu1a35PullRequestRequestedReviewersItemOneOf2X622ec873 property '" + name + "' is not nullable")
