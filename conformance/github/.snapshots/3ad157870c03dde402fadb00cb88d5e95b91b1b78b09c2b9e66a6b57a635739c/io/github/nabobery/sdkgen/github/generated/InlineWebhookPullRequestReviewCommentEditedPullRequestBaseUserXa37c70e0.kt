 ...
 * roperties/base/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-edited/properties/pull_request/p
 * roperties/base/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0.Serializer::class)
public class InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0(
  public val id: Long,
  ...
  public val type:
      InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserTypeXc7c726c8? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserTypeXc7c726c8? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserTypeXc7c726c8>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0")
...
public fun inlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0(block: InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0 = InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestBaseUserXa37c70e0 is missing required property '" + name + "'")
