...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/assignee.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/assignee
 */
@Serializable(with = InlineWebhooksPullRequest5AssigneeXa65015f8.Serializer::class)
public class InlineWebhooksPullRequest5AssigneeXa65015f8(
  public val id: Int,
  ...
  public val type: InlineWebhooksPullRequest5AssigneeTypeXcc7b73fc? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksPullRequest5AssigneeTypeXcc7b73fc? = null
    ...
    public fun build(): InlineWebhooksPullRequest5AssigneeXa65015f8 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksPullRequest5AssigneeXa65015f8(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5AssigneeXa65015f8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5AssigneeXa65015f8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5AssigneeXa65015f8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5AssigneeXa65015f8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5AssigneeXa65015f8 must be a JSON object")
      ...
      return InlineWebhooksPullRequest5AssigneeXa65015f8(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksPullRequest5AssigneeTypeXcc7b73fc>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5AssigneeXa65015f8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5AssigneeXa65015f8")
...
public fun inlineWebhooksPullRequest5AssigneeXa65015f8(block: InlineWebhooksPullRequest5AssigneeXa65015f8.Builder.() -> Unit): InlineWebhooksPullRequest5AssigneeXa65015f8 = InlineWebhooksPullRequest5AssigneeXa65015f8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5AssigneeXa65015f8 is missing required property '" + name + "'")
