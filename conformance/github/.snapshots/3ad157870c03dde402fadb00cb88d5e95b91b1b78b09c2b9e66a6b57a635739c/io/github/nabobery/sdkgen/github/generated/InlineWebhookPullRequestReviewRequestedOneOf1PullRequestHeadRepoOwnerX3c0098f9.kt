 ...
 * t/properties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoOwnerTypeX69ed30a9? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoOwnerTypeX69ed30a9? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf1PullRequestHeadRepoOwnerTypeX69ed30a9>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9(block: InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9 = InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf1PullRequestHeadRepoOwnerX3c0098f9 is missing required property '" + name + "'")
