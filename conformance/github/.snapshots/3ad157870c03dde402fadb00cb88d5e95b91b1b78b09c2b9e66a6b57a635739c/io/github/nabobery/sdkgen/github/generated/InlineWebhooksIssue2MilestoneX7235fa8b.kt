 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_2/properties/milestone
 */
@Serializable(with = InlineWebhooksIssue2MilestoneX7235fa8b.Serializer::class)
public class InlineWebhooksIssue2MilestoneX7235fa8b(
  /**
  ...
  public val creator: InlineWebhooksIssue2MilestoneCreatorX2508857c?,
   ...
   */
  public val state: InlineWebhooksIssue2MilestoneStateX7861ab72,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhooksIssue2MilestoneStateX7861ab72? = null

    public var state: InlineWebhooksIssue2MilestoneStateX7861ab72
    ...
    private var creatorState: FieldState<InlineWebhooksIssue2MilestoneCreatorX2508857c?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhooksIssue2MilestoneCreatorX2508857c?
    ...
    public fun build(): InlineWebhooksIssue2MilestoneX7235fa8b {
      ...
      return InlineWebhooksIssue2MilestoneX7235fa8b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssue2MilestoneX7235fa8b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssue2MilestoneX7235fa8b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssue2MilestoneX7235fa8b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssue2MilestoneX7235fa8b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssue2MilestoneX7235fa8b must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhooksIssue2MilestoneStateX7861ab72>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhooksIssue2MilestoneX7235fa8b is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhooksIssue2MilestoneX7235fa8b is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksIssue2MilestoneCreatorX2508857c?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhooksIssue2MilestoneX7235fa8b is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhooksIssue2MilestoneX7235fa8b is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssue2MilestoneX7235fa8b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssue2MilestoneX7235fa8b")
...
public fun inlineWebhooksIssue2MilestoneX7235fa8b(block: InlineWebhooksIssue2MilestoneX7235fa8b.Builder.() -> Unit): InlineWebhooksIssue2MilestoneX7235fa8b = InlineWebhooksIssue2MilestoneX7235fa8b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssue2MilestoneX7235fa8b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhooksIssue2MilestoneX7235fa8b property '" + name + "' is not nullable")
