 ...
 * base/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-synchronize/properties/pull_request/properties/
 * base/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerTypeXb7f4b9e7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerTypeXb7f4b9e7? =
        null
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759 must be a JSON object")
      ...
      return InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerTypeXb7f4b9e7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759")
...
public fun inlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759(block: InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759 = InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseRepoOwnerX9cb4a759 is missing required property '" + name + "'")
