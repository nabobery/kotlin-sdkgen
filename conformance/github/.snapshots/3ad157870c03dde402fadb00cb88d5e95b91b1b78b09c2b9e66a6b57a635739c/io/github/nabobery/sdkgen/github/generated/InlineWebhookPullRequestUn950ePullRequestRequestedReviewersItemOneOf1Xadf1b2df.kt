 ...
 * quested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unlabeled/properties/pull_request/properties/re
 * quested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df.Serializer::class)
public class InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemTypeXb6745259? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemTypeXb6745259? =
        null
    ...
    public fun build(): InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df must be a JSON object")
      ...
      return InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemTypeXb6745259>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df")
...
public fun inlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df(block: InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df.Builder.() -> Unit): InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df = InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUn950ePullRequestRequestedReviewersItemOneOf1Xadf1b2df is missing required property '" + name + "'")
