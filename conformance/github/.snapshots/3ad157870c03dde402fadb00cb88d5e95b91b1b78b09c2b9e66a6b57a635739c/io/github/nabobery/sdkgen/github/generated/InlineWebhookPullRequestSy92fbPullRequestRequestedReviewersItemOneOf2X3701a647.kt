 ...
 * requested_reviewers/items/oneOf/1
 */
@Serializable(with = InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647.Serializer::class)
public class InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647 internal constructor(
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemParentX5c87db48?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent: InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemParentX5c87db48?
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemPrivacyX5fdcf8cb? = null
     ...
     */
    public var parent:
        InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemParentX5c87db48?
      get() = parentState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647 must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemPrivacyX5fdcf8cb>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647 is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647")
...
public fun inlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647(block: InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647.Builder.() -> Unit): InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647 = InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf2X3701a647 property '" + name + "' is not nullable")
