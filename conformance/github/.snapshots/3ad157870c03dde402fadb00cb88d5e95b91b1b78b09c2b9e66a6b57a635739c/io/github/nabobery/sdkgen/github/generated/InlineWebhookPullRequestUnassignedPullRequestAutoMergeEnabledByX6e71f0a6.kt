 ...
 * uto_merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unassigned/properties/pull_request/properties/a
 * uto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByTypeXa82e42f6? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByTypeXa82e42f6? =
        null
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByTypeXa82e42f6>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6")
...
public fun inlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6(block: InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6 = InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestAutoMergeEnabledByX6e71f0a6 is missing required property '" + name + "'")
