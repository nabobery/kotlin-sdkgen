...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/repository-rule-detailed/oneOf/21.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/repository-rule-detailed/oneOf/21
 */
@Serializable(with = InlineRepositoryRuleDetailedOneOf22Xda38550d.Serializer::class)
public class InlineRepositoryRuleDetailedOneOf22Xda38550d(
  ...
  public class Builder {
    ...
    public fun build(): InlineRepositoryRuleDetailedOneOf22Xda38550d {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineRepositoryRuleDetailedOneOf22Xda38550d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineRepositoryRuleDetailedOneOf22Xda38550d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineRepositoryRuleDetailedOneOf22Xda38550d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineRepositoryRuleDetailedOneOf22Xda38550d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineRepositoryRuleDetailedOneOf22Xda38550d must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineRepositoryRuleDetailedOneOf22Xda38550d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineRepositoryRuleDetailedOneOf22Xda38550d")
...
public fun inlineRepositoryRuleDetailedOneOf22Xda38550d(block: InlineRepositoryRuleDetailedOneOf22Xda38550d.Builder.() -> Unit): InlineRepositoryRuleDetailedOneOf22Xda38550d = InlineRepositoryRuleDetailedOneOf22Xda38550d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineRepositoryRuleDetailedOneOf22Xda38550d is missing required property '" + name + "'")
