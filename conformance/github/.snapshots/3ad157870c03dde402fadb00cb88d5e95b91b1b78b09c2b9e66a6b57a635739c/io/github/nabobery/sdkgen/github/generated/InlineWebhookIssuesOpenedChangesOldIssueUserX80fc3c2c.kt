 ...
 * ties/user
 */
@Serializable(with = InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c.Serializer::class)
public class InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c(
  public val id: Long,
  ...
  public val type: InlineWebhookIssuesOpenedChangesOldIssueUserTypeX5703478b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesOpenedChangesOldIssueUserTypeX5703478b? = null
    ...
    public fun build(): InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c must be a JSON object")
      ...
      return InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesOpenedChangesOldIssueUserTypeX5703478b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c")
...
public fun inlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c(block: InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c.Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c = InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueUserX80fc3c2c is missing required property '" + name + "'")
