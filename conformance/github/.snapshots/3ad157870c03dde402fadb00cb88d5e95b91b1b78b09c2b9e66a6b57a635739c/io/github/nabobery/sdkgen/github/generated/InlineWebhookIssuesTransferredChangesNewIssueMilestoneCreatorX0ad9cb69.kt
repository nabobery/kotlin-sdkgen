 ...
 * roperties/milestone/properties/creator
 */
@Serializable(with = InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69.Serializer::class)
public class InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorTypeX2aea5970? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorTypeX2aea5970? =
        null
    ...
    public fun build(): InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69 must be a JSON object")
      ...
      return InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorTypeX2aea5970>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69")
...
public fun inlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69(block: InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69.Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69 = InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69 is missing required property '" + name + "'")
