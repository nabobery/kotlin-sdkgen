...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-pinned/properties/issue/allOf/1.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-pinned/properties/issue/allOf/1
 */
@Serializable(with = InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad.Serializer::class)
public class InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad internal constructor(
  public val assignee: InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c?,
  labels: List<InlineWebhookIssueCommentPinnedIssueAllOf2LabelsItemXd4786f69>,
  public val locked: Boolean,
  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssueCommentPinnedIssueAllOf2StateXa98d58fe,
  ...
  private val reactionsState:
      FieldState<InlineWebhookIssueCommentPinnedIssueAllOf2ReactionsX0d4b2456>,
  ...
  private val userState: FieldState<InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523>,
) {
  public val labels: List<InlineWebhookIssueCommentPinnedIssueAllOf2LabelsItemXd4786f69> =
      labels.toList()
  ...
  public val reactions: InlineWebhookIssueCommentPinnedIssueAllOf2ReactionsX0d4b2456?
  ...
  public constructor(
    ...
    labels: List<InlineWebhookIssueCommentPinnedIssueAllOf2LabelsItemXd4786f69>,
    locked: Boolean,
    state: InlineWebhookIssueCommentPinnedIssueAllOf2StateXa98d58fe,
  ...
  public class Builder {
    private var labelsValue: List<InlineWebhookIssueCommentPinnedIssueAllOf2LabelsItemXd4786f69>? =
        null

    public var labels: List<InlineWebhookIssueCommentPinnedIssueAllOf2LabelsItemXd4786f69>
    ...
    private var stateValue: InlineWebhookIssueCommentPinnedIssueAllOf2StateXa98d58fe? = null

    public var state: InlineWebhookIssueCommentPinnedIssueAllOf2StateXa98d58fe
    ...
    private var reactionsState:
        FieldState<InlineWebhookIssueCommentPinnedIssueAllOf2ReactionsX0d4b2456> = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var reactions: InlineWebhookIssueCommentPinnedIssueAllOf2ReactionsX0d4b2456?
      get() = reactionsState.valueOrNull()
      set(`value`) {
    ...
    private var userState: FieldState<InlineWebhookIssueCommentPinnedIssueAllOf2UserX48658523> =
        FieldState.Absent
    ...
    public fun build(): InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad {
      ...
      return InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad must be a JSON object")
      val labels = json.decodeRequired<List<InlineWebhookIssueCommentPinnedIssueAllOf2LabelsItemXd4786f69>>(rawObject, "labels")
      val locked = json.decodeRequired<Boolean>(rawObject, "locked")
      val state = json.decodeRequired<InlineWebhookIssueCommentPinnedIssueAllOf2StateXa98d58fe>(rawObject, "state")
      if (!rawObject.containsKey("assignee")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad is missing required property 'assignee'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad")
...
public fun inlineWebhookIssueCommentPinnedIssueAllOf2X0936edad(block: InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad.Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad = InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf2X0936edad property '" + name + "' is not nullable")
