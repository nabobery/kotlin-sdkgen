 ...
 * roperties/milestone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-edited/properties/pull_request/p
 * roperties/milestone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d.Serializer::class)
public class InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRed95bPullRequestMilestoneCreatorTypeX2db2afca? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRed95bPullRequestMilestoneCreatorTypeX2db2afca? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRed95bPullRequestMilestoneCreatorTypeX2db2afca>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d")
...
public fun inlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d(block: InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d = InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorX75a16d1d is missing required property '" + name + "'")
