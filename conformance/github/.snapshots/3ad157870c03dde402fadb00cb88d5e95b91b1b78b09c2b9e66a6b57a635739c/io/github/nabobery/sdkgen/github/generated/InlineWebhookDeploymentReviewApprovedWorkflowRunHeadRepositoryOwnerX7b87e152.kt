 ...
 * s/head_repository/properties/owner
 */
@Serializable(with = InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152.Serializer::class)
public class InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152 = InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152 must be a JSON object")
      return InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152")
...
public fun inlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152(block: InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152.Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152 = InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152.build(block)
