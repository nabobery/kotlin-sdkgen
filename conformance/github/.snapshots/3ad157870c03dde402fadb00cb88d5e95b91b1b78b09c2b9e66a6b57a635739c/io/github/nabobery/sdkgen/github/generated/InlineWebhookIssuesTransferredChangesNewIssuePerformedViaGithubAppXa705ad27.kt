 ...
 * roperties/performed_via_github_app
 */
@Serializable(with = InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27.Serializer::class)
public class InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 internal constructor(
  /**
  ...
  public val owner:
      InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppItemX12922c9e>>,
  private val permissionsState:
      FieldState<InlineWebhookIssuesTransferredChangesNewIssuePermissionsXa58c65e1>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppItemX12922c9e>>
   ...
   */
  public val events:
      List<InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppItemX12922c9e>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssuesTransferredChangesNewIssuePermissionsXa58c65e1?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2?>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookIssuesTransferredChangesNewIssuePermissionsXa58c65e1?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 {
      ...
      return InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27")
...
public fun inlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27(block: InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27.Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 = InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppXa705ad27 property '" + name + "' is not nullable")
