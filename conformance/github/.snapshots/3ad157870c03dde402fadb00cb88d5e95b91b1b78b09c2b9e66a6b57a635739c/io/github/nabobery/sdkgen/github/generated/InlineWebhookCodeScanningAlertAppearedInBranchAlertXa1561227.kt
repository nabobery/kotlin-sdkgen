 ...
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-code-scanning-alert-appeared-in-branch/properties/alert
 */
@Serializable(with = InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227.Serializer::class)
public class InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 internal constructor(
  /**
  ...
  public val dismissedBy: InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e?,
  /**
  ...
  public val rule: InlineWebhookCodeScanningAlertAppearedInBranchAlertRuleX703c7ab7,
  /**
   ...
   */
  public val state: InlineWebhookCodeScanningAlertAppearedInBranchAlertStateXfd30945c?,
  public val tool: InlineWebhookCodeScanningAlertAppearedInBranchAlertToolX9bc2fb76,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val mostRecentInstanceState:
      FieldState<InlineWebhookCodeScanningAlertAppearedInBranchAlertMostRecentInstanceX710f607f?>,
) {
  ...
  public val mostRecentInstance:
      InlineWebhookCodeScanningAlertAppearedInBranchAlertMostRecentInstanceX710f607f?
    get() = mostRecentInstanceState.valueOrNull()

  public constructor(
    createdAt: String,
    dismissedAt: String?,
    dismissedBy: InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e?,
    dismissedReason: InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedReasonX03242d3b?,
    htmlUrl: String,
    number: Int,
    rule: InlineWebhookCodeScanningAlertAppearedInBranchAlertRuleX703c7ab7,
    state: InlineWebhookCodeScanningAlertAppearedInBranchAlertStateXfd30945c?,
    tool: InlineWebhookCodeScanningAlertAppearedInBranchAlertToolX9bc2fb76,
    url: String,
  ...
  public class Builder {
    ...
    private var ruleValue: InlineWebhookCodeScanningAlertAppearedInBranchAlertRuleX703c7ab7? = null

    public var rule: InlineWebhookCodeScanningAlertAppearedInBranchAlertRuleX703c7ab7
      get() = requireNotNull(ruleValue) { "rule is required" }
      set(`value`) {
        ruleValue = value
      }

    private var toolValue: InlineWebhookCodeScanningAlertAppearedInBranchAlertToolX9bc2fb76? = null

    public var tool: InlineWebhookCodeScanningAlertAppearedInBranchAlertToolX9bc2fb76
    ...
    private var dismissedByState:
        FieldState<InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var dismissedBy: InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e?
    ...
    private var dismissedReasonState:
        FieldState<InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedReasonX03242d3b?> =
        FieldState.Absent
    ...
    private var stateState:
        FieldState<InlineWebhookCodeScanningAlertAppearedInBranchAlertStateXfd30945c?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var state: InlineWebhookCodeScanningAlertAppearedInBranchAlertStateXfd30945c?
    ...
    public fun build(): InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 {
      ...
      return InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227(
        createdAt = createdAt,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 must be a JSON object")
      val createdAt = json.decodeRequired<String>(rawObject, "created_at")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val number = json.decodeRequired<Int>(rawObject, "number")
      val rule = json.decodeRequired<InlineWebhookCodeScanningAlertAppearedInBranchAlertRuleX703c7ab7>(rawObject, "rule")
      val tool = json.decodeRequired<InlineWebhookCodeScanningAlertAppearedInBranchAlertToolX9bc2fb76>(rawObject, "tool")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("dismissed_at")) {
        throw SerializationException("InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 is missing required property 'dismissed_at'")
      }
      ...
      if (!rawObject.containsKey("dismissed_by")) {
        throw SerializationException("InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 is missing required property 'dismissed_by'")
      }
      val dismissedBy = rawObject["dismissed_by"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedByXa174fc2e?>(requireNotNull(element)) }
      if (!rawObject.containsKey("dismissed_reason")) {
        throw SerializationException("InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 is missing required property 'dismissed_reason'")
      }
      val dismissedReason = rawObject["dismissed_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCodeScanningAlertAppearedInBranchAlertDismissedReasonX03242d3b?>(requireNotNull(element)) }
      if (!rawObject.containsKey("state")) {
        throw SerializationException("InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 is missing required property 'state'")
      }
      val state = rawObject["state"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCodeScanningAlertAppearedInBranchAlertStateXfd30945c?>(requireNotNull(element)) }
      return InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227(
        createdAt = createdAt,
        dismissedAt = dismissedAt,
        dismissedBy = dismissedBy,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227")
...
public fun inlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227(block: InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227.Builder.() -> Unit): InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 = InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookCodeScanningAlertAppearedInBranchAlertXa1561227 property '" + name + "' is not nullable")
