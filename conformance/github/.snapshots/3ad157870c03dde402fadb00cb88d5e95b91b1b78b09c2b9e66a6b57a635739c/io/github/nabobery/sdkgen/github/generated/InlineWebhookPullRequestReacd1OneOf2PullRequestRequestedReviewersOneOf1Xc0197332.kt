 ...
 * request/properties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332.Serializer::class)
public class InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersTypeXa0f526c4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersTypeXa0f526c4?
        = null
    ...
    public fun build(): InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332 must be a JSON object")
      ...
      return InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersTypeXa0f526c4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332")
...
public fun inlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332(block: InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332.Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332 = InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestRequestedReviewersOneOf1Xc0197332 is missing required property '" + name + "'")
