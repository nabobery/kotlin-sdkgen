 ...
 * ties/assignee
 */
@Serializable(with = InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a.Serializer::class)
public class InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesOpenedChangesOldIssueAssigneeTypeX5c8eb736? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesOpenedChangesOldIssueAssigneeTypeX5c8eb736? = null
    ...
    public fun build(): InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a must be a JSON object")
      ...
      return InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesOpenedChangesOldIssueAssigneeTypeX5c8eb736>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a")
...
public fun inlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a(block: InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a.Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a = InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueAssigneeXbed6bf6a is missing required property '" + name + "'")
