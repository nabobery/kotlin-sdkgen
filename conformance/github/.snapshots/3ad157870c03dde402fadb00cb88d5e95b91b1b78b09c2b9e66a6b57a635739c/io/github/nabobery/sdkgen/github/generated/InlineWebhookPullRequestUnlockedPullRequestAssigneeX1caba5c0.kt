 ...
 * ignee
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnlockedPullRequestAssigneeTypeXee565518? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlockedPullRequestAssigneeTypeXee565518? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestAssigneeTypeXee565518>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0")
...
public fun inlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0(block: InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0 = InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestAssigneeX1caba5c0 is missing required property '" + name + "'")
