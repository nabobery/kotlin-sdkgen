...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhook-org-block-blocked.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-org-block-blocked
 */
@Serializable(with = WebhookOrgBlockBlocked.Serializer::class)
public class WebhookOrgBlockBlocked internal constructor(
  public val action: InlineWebhookOrgBlockBlockedActionXec433f07,
  ...
  public constructor(
    action: InlineWebhookOrgBlockBlockedActionXec433f07,
  ...
  public class Builder {
    private var actionValue: InlineWebhookOrgBlockBlockedActionXec433f07? = null

    public var action: InlineWebhookOrgBlockBlockedActionXec433f07
    ...
    public fun build(): WebhookOrgBlockBlocked {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhookOrgBlockBlocked = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhookOrgBlockBlocked> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhookOrgBlockBlocked {
      val jsonDecoder = decoder.requireJsonDecoder("WebhookOrgBlockBlocked")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhookOrgBlockBlocked must be a JSON object")
      val action = json.decodeRequired<InlineWebhookOrgBlockBlockedActionXec433f07>(rawObject, "action")
      ...
      if (!rawObject.containsKey("blocked_user")) {
        throw SerializationException("WebhookOrgBlockBlocked is missing required property 'blocked_user'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: WebhookOrgBlockBlocked) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhookOrgBlockBlocked")
...
public fun webhookOrgBlockBlocked(block: WebhookOrgBlockBlocked.Builder.() -> Unit): WebhookOrgBlockBlocked = WebhookOrgBlockBlocked.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhookOrgBlockBlocked is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("WebhookOrgBlockBlocked property '" + name + "' is not nullable")
