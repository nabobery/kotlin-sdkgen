 ...
 * roperties/head/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-edited/properties/pull_request/p
 * roperties/head/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba.Serializer::class)
public class InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba(
  public val id: Long,
  ...
  public val type:
      InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserTypeXe7e43e39? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserTypeXe7e43e39? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserTypeXe7e43e39>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba")
...
public fun inlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba(block: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba = InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadUserX7368f6ba is missing required property '" + name + "'")
