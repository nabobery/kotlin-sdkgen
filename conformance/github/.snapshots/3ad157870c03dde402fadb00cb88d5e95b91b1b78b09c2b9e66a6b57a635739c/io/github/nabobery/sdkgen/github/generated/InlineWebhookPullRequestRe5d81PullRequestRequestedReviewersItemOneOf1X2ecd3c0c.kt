 ...
 * ties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c.Serializer::class)
public class InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemTypeXe66d9c5e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemTypeXe66d9c5e? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c must be a JSON object")
      ...
      return InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemTypeXe66d9c5e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c")
...
public fun inlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c(block: InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c.Builder.() -> Unit): InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c = InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf1X2ecd3c0c is missing required property '" + name + "'")
