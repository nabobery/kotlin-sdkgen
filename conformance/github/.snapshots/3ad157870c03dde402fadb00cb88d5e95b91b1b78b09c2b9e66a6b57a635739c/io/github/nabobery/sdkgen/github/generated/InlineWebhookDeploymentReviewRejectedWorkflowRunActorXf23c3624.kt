 ...
 * s/actor
 */
@Serializable(with = InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624.Serializer::class)
public class InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624(
  public val id: Int,
  ...
  public val type: InlineWebhookDeploymentReviewRejectedWorkflowRunActorTypeX45f7290f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentReviewRejectedWorkflowRunActorTypeX45f7290f? = null
    ...
    public fun build(): InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624 must be a JSON object")
      ...
      return InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewRejectedWorkflowRunActorTypeX45f7290f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624")
...
public fun inlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624(block: InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624.Builder.() -> Unit): InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624 = InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentReviewRejectedWorkflowRunActorXf23c3624 is missing required property '" + name + "'")
