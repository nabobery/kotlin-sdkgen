...
@Serializable
public data class MilestonedIssueEventView(
  ...
  public val id: Int,
  public val milestone: InlineMilestonedIssueEventMilestoneX1e0c4b14,
  @SerialName("node_id")
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/milestoned-issue-event
 */
@Serializable(with = MilestonedIssueEvent.Serializer::class)
public class MilestonedIssueEvent(
  ...
  public class Builder {
    ...
    private var milestoneValue: InlineMilestonedIssueEventMilestoneX1e0c4b14? = null

    public var milestone: InlineMilestonedIssueEventMilestoneX1e0c4b14
    ...
    public fun build(): MilestonedIssueEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): MilestonedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<MilestonedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): MilestonedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("MilestonedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("MilestonedIssueEvent must be a JSON object")
      ...
      val milestone = json.decodeRequired<InlineMilestonedIssueEventMilestoneX1e0c4b14>(rawObject, "milestone")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("MilestonedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("MilestonedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("MilestonedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: MilestonedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("MilestonedIssueEvent")
...
public fun milestonedIssueEvent(block: MilestonedIssueEvent.Builder.() -> Unit): MilestonedIssueEvent = MilestonedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("MilestonedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("MilestonedIssueEvent property '" + name + "' is not nullable")
