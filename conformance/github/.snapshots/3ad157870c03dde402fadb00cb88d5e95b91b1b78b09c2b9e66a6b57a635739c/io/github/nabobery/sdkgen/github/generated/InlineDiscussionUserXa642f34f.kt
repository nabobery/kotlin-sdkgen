...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/discussion/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/discussion/properties/user
 */
@Serializable(with = InlineDiscussionUserXa642f34f.Serializer::class)
public class InlineDiscussionUserXa642f34f(
  public val id: Long,
  ...
  public val type: InlineDiscussionUserTypeX228c4213? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineDiscussionUserTypeX228c4213? = null
    ...
    public fun build(): InlineDiscussionUserXa642f34f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineDiscussionUserXa642f34f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineDiscussionUserXa642f34f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineDiscussionUserXa642f34f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineDiscussionUserXa642f34f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineDiscussionUserXa642f34f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineDiscussionUserXa642f34f must be a JSON object")
      ...
      return InlineDiscussionUserXa642f34f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineDiscussionUserTypeX228c4213>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineDiscussionUserXa642f34f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineDiscussionUserXa642f34f")
...
public fun inlineDiscussionUserXa642f34f(block: InlineDiscussionUserXa642f34f.Builder.() -> Unit): InlineDiscussionUserXa642f34f = InlineDiscussionUserXa642f34f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineDiscussionUserXa642f34f is missing required property '" + name + "'")
