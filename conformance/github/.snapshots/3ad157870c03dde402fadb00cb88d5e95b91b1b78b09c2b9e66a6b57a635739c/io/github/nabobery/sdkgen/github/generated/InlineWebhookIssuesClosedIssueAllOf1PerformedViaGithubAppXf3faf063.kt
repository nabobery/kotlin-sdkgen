 ...
 * via_github_app
 */
@Serializable(with = InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063.Serializer::class)
public class InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppEventsItemXa81d7d78>>,
  private val permissionsState:
      FieldState<InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppPermissionsX53be5373>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppEventsItemXa81d7d78>>
   ...
   */
  public val events:
      List<InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppEventsItemXa81d7d78>?
  ...
  public val permissions:
      InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppPermissionsX53be5373?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998?
    ...
    public fun build(): InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 {
      ...
      return InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063")
...
public fun inlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063(block: InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063.Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 = InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063 property '" + name + "' is not nullable")
