 ...
 * ties/comments/items/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-thread-resolved/properties/thread/proper
 * ties/comments/items/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b.Serializer::class)
public class InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b(
  public val id: Long,
  ...
  public val type:
      InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserTypeXfd43c443? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserTypeXfd43c443>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b")
...
public fun inlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b(block: InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b = InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemUserX6dbb271b is missing required property '" + name + "'")
