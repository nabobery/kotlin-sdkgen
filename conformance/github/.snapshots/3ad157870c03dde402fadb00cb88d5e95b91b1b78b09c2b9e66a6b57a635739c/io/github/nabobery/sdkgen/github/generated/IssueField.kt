...
public class IssueField(
  ...
  options: List<InlineIssueFieldOptionsItemX25d2beb7>? = null,
  /**
   ...
   */
  public val options: List<InlineIssueFieldOptionsItemX25d2beb7>? =
  ...
  public class Builder {
    ...
    private var optionsValue: List<InlineIssueFieldOptionsItemX25d2beb7>? = null

    /**
     * Available options for single select and multi select fields.
     */
    public var options: List<InlineIssueFieldOptionsItemX25d2beb7>?
  ...
  internal object Serializer : KSerializer<IssueField> {
