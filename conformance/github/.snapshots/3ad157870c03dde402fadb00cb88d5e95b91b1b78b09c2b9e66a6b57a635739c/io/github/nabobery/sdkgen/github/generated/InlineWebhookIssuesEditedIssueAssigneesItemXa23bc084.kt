...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-edited/properties/issue/properties/assignees/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-edited/properties/issue/properties/assignees/items
 */
@Serializable(with = InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084.Serializer::class)
public class InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesEditedIssueAssigneesItemTypeX9817305a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesEditedIssueAssigneesItemTypeX9817305a? = null
    ...
    public fun build(): InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084 must be a JSON object")
      ...
      return InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesEditedIssueAssigneesItemTypeX9817305a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084")
...
public fun inlineWebhookIssuesEditedIssueAssigneesItemXa23bc084(block: InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084.Builder.() -> Unit): InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084 = InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesEditedIssueAssigneesItemXa23bc084 is missing required property '" + name + "'")
