...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/repository-rule-detailed/oneOf/12.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/repository-rule-detailed/oneOf/12
 */
@Serializable(with = InlineRepositoryRuleDetailedOneOf13X3070f621.Serializer::class)
public class InlineRepositoryRuleDetailedOneOf13X3070f621(
  ...
  public class Builder {
    ...
    public fun build(): InlineRepositoryRuleDetailedOneOf13X3070f621 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineRepositoryRuleDetailedOneOf13X3070f621 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineRepositoryRuleDetailedOneOf13X3070f621> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineRepositoryRuleDetailedOneOf13X3070f621 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineRepositoryRuleDetailedOneOf13X3070f621")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineRepositoryRuleDetailedOneOf13X3070f621 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineRepositoryRuleDetailedOneOf13X3070f621) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineRepositoryRuleDetailedOneOf13X3070f621")
...
public fun inlineRepositoryRuleDetailedOneOf13X3070f621(block: InlineRepositoryRuleDetailedOneOf13X3070f621.Builder.() -> Unit): InlineRepositoryRuleDetailedOneOf13X3070f621 = InlineRepositoryRuleDetailedOneOf13X3070f621.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineRepositoryRuleDetailedOneOf13X3070f621 is missing required property '" + name + "'")
