 ...
 * perties/assignees/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-disabled/properties/pull_request/pro
 * perties/assignees/items
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d.Serializer::class)
public class InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemTypeXac897072? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemTypeXac897072?
        = null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemTypeXac897072>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d")
...
public fun inlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d(block: InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d = InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestAssigneesItemXc4a4249d is missing required property '" + name + "'")
