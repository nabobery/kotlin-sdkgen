 ...
 * se/properties/user
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestUnlabeledPullRequestBaseUserTypeXd00f6aad? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlabeledPullRequestBaseUserTypeXd00f6aad? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestBaseUserTypeXd00f6aad>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047(block: InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047 = InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseUserX45bbf047 is missing required property '" + name + "'")
