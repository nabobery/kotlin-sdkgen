...
public class CampaignsClient(
  ...
  public companion object {
    public val campaignsDeleteCampaignMetadata: OperationMetadata by
    ...
    public val campaignsGetCampaignSummaryMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    public val campaignsListOrgCampaignsMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    public val campaignsUpdateCampaignMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
