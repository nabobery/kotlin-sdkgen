...
public class CodeQualityClient(
  ...
  public companion object {
    public val codeQualityGetFindingMetadata: OperationMetadata by
    ...
    public val codeQualityGetSetupMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    public val codeQualityListFindingsForRepoMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    public val codeQualityUpdateSetupMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
