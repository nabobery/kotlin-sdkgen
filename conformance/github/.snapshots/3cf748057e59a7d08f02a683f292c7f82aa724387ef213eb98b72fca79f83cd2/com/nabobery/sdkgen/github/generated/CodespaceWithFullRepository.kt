 ...
 * A codespace.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/codespace-with-full-repository
 */
@Serializable(with = CodespaceWithFullRepository.Serializer::class)
public class CodespaceWithFullRepository internal constructor(
   ...
   */
  public val gitStatus: InlineCodespaceWithFullRepositoryGitStatusX20871eed,
  public val id: Long,
  /**
   ...
   */
  public val location: InlineCodespaceWithFullRepositoryLocationX6b525165,
   ...
   */
  public val state: InlineCodespaceWithFullRepositoryStateXc01b6132,
  /**
  ...
  private val runtimeConstraintsState:
      FieldState<InlineCodespaceWithFullRepositoryRuntimeConstraintsX879d095d>,
) {
  ...
  public val runtimeConstraints: InlineCodespaceWithFullRepositoryRuntimeConstraintsX879d095d?
  ...
  public constructor(
    ...
    gitStatus: InlineCodespaceWithFullRepositoryGitStatusX20871eed,
    id: Long,
    idleTimeoutMinutes: Int?,
    lastUsedAt: String,
    location: InlineCodespaceWithFullRepositoryLocationX6b525165,
    ...
    startUrl: String,
    state: InlineCodespaceWithFullRepositoryStateXc01b6132,
    stopUrl: String,
    updatedAt: String,
    url: String,
    webUrl: String,
  ...
  public class Builder {
    ...
    private var gitStatusValue: InlineCodespaceWithFullRepositoryGitStatusX20871eed? = null

    public var gitStatus: InlineCodespaceWithFullRepositoryGitStatusX20871eed
    ...
    private var locationValue: InlineCodespaceWithFullRepositoryLocationX6b525165? = null

    public var location: InlineCodespaceWithFullRepositoryLocationX6b525165
    ...
    public var recentFolders: List<String>
      get() = requireNotNull(recentFoldersValue) { "recentFolders is required" }
      set(`value`) {
        recentFoldersValue = value
      }
    ...
    private var stateValue: InlineCodespaceWithFullRepositoryStateXc01b6132? = null

    public var state: InlineCodespaceWithFullRepositoryStateXc01b6132
    ...
    private var runtimeConstraintsState:
        FieldState<InlineCodespaceWithFullRepositoryRuntimeConstraintsX879d095d> = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var runtimeConstraints: InlineCodespaceWithFullRepositoryRuntimeConstraintsX879d095d?
      get() = runtimeConstraintsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): CodespaceWithFullRepository {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): CodespaceWithFullRepository = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<CodespaceWithFullRepository> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): CodespaceWithFullRepository {
      val jsonDecoder = decoder.requireJsonDecoder("CodespaceWithFullRepository")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CodespaceWithFullRepository must be a JSON object")
      val billableOwner = json.decodeRequired<SimpleUser>(rawObject, "billable_owner")
      val createdAt = json.decodeRequired<String>(rawObject, "created_at")
      val gitStatus = json.decodeRequired<InlineCodespaceWithFullRepositoryGitStatusX20871eed>(rawObject, "git_status")
      val id = json.decodeRequired<Long>(rawObject, "id")
      val lastUsedAt = json.decodeRequired<String>(rawObject, "last_used_at")
      val location = json.decodeRequired<InlineCodespaceWithFullRepositoryLocationX6b525165>(rawObject, "location")
      ...
      val state = json.decodeRequired<InlineCodespaceWithFullRepositoryStateXc01b6132>(rawObject, "state")
      ...
      if (!rawObject.containsKey("environment_id")) {
        throw SerializationException("CodespaceWithFullRepository is missing required property 'environment_id'")
      }
      ...
      if (!rawObject.containsKey("idle_timeout_minutes")) {
        throw SerializationException("CodespaceWithFullRepository is missing required property 'idle_timeout_minutes'")
      }
      ...
      if (!rawObject.containsKey("machine")) {
        throw SerializationException("CodespaceWithFullRepository is missing required property 'machine'")
      }
      ...
      if (!rawObject.containsKey("prebuild")) {
        throw SerializationException("CodespaceWithFullRepository is missing required property 'prebuild'")
      }
      ...
      if (!rawObject.containsKey("pulls_url")) {
        throw SerializationException("CodespaceWithFullRepository is missing required property 'pulls_url'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: CodespaceWithFullRepository) {
      val jsonEncoder = encoder.requireJsonEncoder("CodespaceWithFullRepository")
...
public fun codespaceWithFullRepository(block: CodespaceWithFullRepository.Builder.() -> Unit): CodespaceWithFullRepository = CodespaceWithFullRepository.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("CodespaceWithFullRepository is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("CodespaceWithFullRepository property '" + name + "' is not nullable")
