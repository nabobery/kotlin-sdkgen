...
public class InlineOrgsSecretScanningPatternConfigurationsPatchRequestJsonXed19f7d5 internal constructor(
  ...
  public class Builder {
    ...
    public var customPatternSettings:
      ...
      set(`value`) {
        ...
        customPatternSettingsState = FieldState.Value(present)
      }
    ...
    public var providerPatternSettings:
      ...
      set(`value`) {
        ...
        providerPatternSettingsState = FieldState.Value(present)
      }
  ...
  public object Serializer : KSerializer<InlineOrgsSecretScanningPatternConfigurationsPatchRequestJsonXed19f7d5> {
