...
public class WebhookInstallationRepositoriesRemoved internal constructor(
  ...
  public class Builder {
    ...
    public var repositoriesAdded: List<InlineWebhooksRepositoriesAddedItemXfb7d035a>
      get() = requireNotNull(repositoriesAddedValue) { "repositoriesAdded is required" }
      set(`value`) {
        repositoriesAddedValue = value
      }
    ...
    public var repositoriesRemoved:
        List<InlineWebhookInstallationRepositoriesRemovedRepositoriesRemovedItemXd74d803d>
      get() = requireNotNull(repositoriesRemovedValue) { "repositoriesRemoved is required" }
      set(`value`) {
        repositoriesRemovedValue = value
      }
  ...
  public object Serializer : KSerializer<WebhookInstallationRepositoriesRemoved> {
