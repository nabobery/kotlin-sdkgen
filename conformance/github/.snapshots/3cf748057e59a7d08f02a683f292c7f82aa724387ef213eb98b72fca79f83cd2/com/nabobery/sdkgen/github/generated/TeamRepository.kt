 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/team-repository
 */
@Serializable(with = TeamRepository.Serializer::class)
public class TeamRepository internal constructor(
  ...
  private val permissionsState: FieldState<InlineTeamRepositoryPermissionsXa1d908cc>,
  ...
  public val permissions: InlineTeamRepositoryPermissionsXa1d908cc?
  ...
  public class Builder {
    ...
    private var permissionsState: FieldState<InlineTeamRepositoryPermissionsXa1d908cc> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineTeamRepositoryPermissionsXa1d908cc?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): TeamRepository {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TeamRepository = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<TeamRepository> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): TeamRepository {
      val jsonDecoder = decoder.requireJsonDecoder("TeamRepository")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TeamRepository must be a JSON object")
      ...
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("TeamRepository is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("TeamRepository is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("TeamRepository is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("TeamRepository is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("TeamRepository is missing required property 'license'")
      }
      ...
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("TeamRepository is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("TeamRepository is missing required property 'owner'")
      }
      ...
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("TeamRepository is missing required property 'pushed_at'")
      }
      ...
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("TeamRepository is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: TeamRepository) {
      val jsonEncoder = encoder.requireJsonEncoder("TeamRepository")
...
public fun teamRepository(block: TeamRepository.Builder.() -> Unit): TeamRepository = TeamRepository.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TeamRepository is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("TeamRepository property '" + name + "' is not nullable")
