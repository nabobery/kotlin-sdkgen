...
public class CopilotUsageMetrics28DayReport(
  ...
  public class Builder {
    ...
    public var downloadLinks: List<String>
      get() = requireNotNull(downloadLinksValue) { "downloadLinks is required" }
      set(`value`) {
        downloadLinksValue = value
      }
  ...
  public object Serializer : KSerializer<CopilotUsageMetrics28DayReport> {
