...
public class InlineOrgsActionsHostedRunnersImagesCustomVersionsGetResponse200JsonX13b9cba0(
  ...
  public class Builder {
    ...
    public var imageVersions: List<ActionsHostedRunnerCustomImageVersion>
      get() = requireNotNull(imageVersionsValue) { "imageVersions is required" }
      set(`value`) {
        imageVersionsValue = value
      }
  ...
  public object Serializer : KSerializer<InlineOrgsActionsHostedRunnersImagesCustomVersionsGetResponse200JsonX13b9cba0> {
