...
public class InlineRepositoryRulesetCon23b6RepositoryPropertyX0ae562ba(
   ...
   */
  public val exclude: List<RepositoryRulesetConditionsRepositoryPropertySpec>? = null,
  /**
   * The repository properties and values to include. All of these properties must match for the condition to pass.
   */
  public val include: List<RepositoryRulesetConditionsRepositoryPropertySpec>? = null,
) {
  public class Builder {
    /**
     * The repository properties and values to exclude. The condition will not pass if any of these properties match.
     */
    public var exclude: List<RepositoryRulesetConditionsRepositoryPropertySpec>? = null

    /**
     * The repository properties and values to include. All of these properties must match for the condition to pass.
     */
    public var include: List<RepositoryRulesetConditionsRepositoryPropertySpec>? = null
  ...
  public object Serializer : KSerializer<InlineRepositoryRulesetCon23b6RepositoryPropertyX0ae562ba> {
