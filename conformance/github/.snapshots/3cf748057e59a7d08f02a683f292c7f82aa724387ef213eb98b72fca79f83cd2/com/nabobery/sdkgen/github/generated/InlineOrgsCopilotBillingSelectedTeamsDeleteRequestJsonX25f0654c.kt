...
public class InlineOrgsCopilotBillingSelectedTeamsDeleteRequestJsonX25f0654c(
  ...
  public class Builder {
    ...
    public var selectedTeams: List<String>
      get() = requireNotNull(selectedTeamsValue) { "selectedTeams is required" }
      set(`value`) {
        selectedTeamsValue = value
      }
  ...
  public object Serializer : KSerializer<InlineOrgsCopilotBillingSelectedTeamsDeleteRequestJsonX25f0654c> {
