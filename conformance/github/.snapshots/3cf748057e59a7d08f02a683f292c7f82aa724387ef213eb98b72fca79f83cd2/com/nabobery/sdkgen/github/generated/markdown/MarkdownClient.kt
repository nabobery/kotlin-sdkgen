...
public object MarkdownCodecs {
  public const val MARKDOWNRENDER_REQUEST_CODEC_ID: String = "markdown/render.request"
  ...
  public const val MARKDOWNRENDER_RESPONSE_CODEC_ID: String = "markdown/render.response"
  ...
  public val markdownRenderResponseCodecAlternative0Registry: MediaTypeCodecRegistry<String> =
      MediaTypeCodecRegistry.of(markdownRenderResponseCodecAlternative0Codec)

  public val markdownRenderRequestCodecRegistry:
      MediaTypeCodecRegistry<InlineMarkdownPostRequestJsonXb17226e1> =
      MediaTypeCodecRegistry.of(markdownRenderRequestCodec)

  public val markdownRenderResponseCodecRegistry: MediaTypeCodecRegistry<String> =
      MediaTypeCodecRegistry.of(markdownRenderResponseCodec)

  public const val MARKDOWNRENDERRAW_REQUEST_CODEC_ID: String = "markdown/render-raw.request"
  ...
  public const val MARKDOWNRENDERRAW_RESPONSE_CODEC_ID: String = "markdown/render-raw.response"
  ...
  public val markdownRenderRawResponseCodecAlternative0Registry: MediaTypeCodecRegistry<String> =
      MediaTypeCodecRegistry.of(markdownRenderRawResponseCodecAlternative0Codec)

  public val markdownRenderRawRequestCodecRegistry: MediaTypeCodecRegistry<String?> =
      MediaTypeCodecRegistry.of(markdownRenderRawRequestCodec)

  public val markdownRenderRawResponseCodecRegistry: MediaTypeCodecRegistry<String> =
...
public class MarkdownClient(
  ...
  public companion object {
    public val markdownRenderMetadata: OperationMetadata = OperationMetadata(
    ...
    public val markdownRenderRawMetadata: OperationMetadata = OperationMetadata(
