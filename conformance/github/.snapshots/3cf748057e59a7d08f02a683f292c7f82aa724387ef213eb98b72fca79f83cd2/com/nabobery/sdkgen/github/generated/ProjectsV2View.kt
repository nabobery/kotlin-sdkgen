...
public class ProjectsV2View(
   ...
   * or "desc".
   */
  public val sortBy: List<List<InlineProjectsV2ViewSortByItemItemX6dfa511b>> = sortBy.toList()
  ...
  public class Builder {
    ...
    public var groupBy: List<Int>
      get() = requireNotNull(groupByValue) { "groupBy is required" }
      set(`value`) {
        groupByValue = value
      }
    ...
    public var sortBy: List<List<InlineProjectsV2ViewSortByItemItemX6dfa511b>>
      get() = requireNotNull(sortByValue) { "sortBy is required" }
      set(`value`) {
        sortByValue = value
      }
    ...
    public var verticalGroupBy: List<Int>
      get() = requireNotNull(verticalGroupByValue) { "verticalGroupBy is required" }
      set(`value`) {
        verticalGroupByValue = value
      }

    private var visibleFieldsValue: List<Int>? = null

    public var visibleFields: List<Int>
      get() = requireNotNull(visibleFieldsValue) { "visibleFields is required" }
      set(`value`) {
        visibleFieldsValue = value
      }
  ...
  public object Serializer : KSerializer<ProjectsV2View> {
