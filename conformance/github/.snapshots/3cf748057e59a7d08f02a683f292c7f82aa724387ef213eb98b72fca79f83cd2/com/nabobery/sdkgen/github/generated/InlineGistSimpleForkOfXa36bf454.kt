 ...
 * Gist
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/gist-simple/properties/fork_of
 */
@Serializable(with = InlineGistSimpleForkOfXa36bf454.Serializer::class)
public class InlineGistSimpleForkOfXa36bf454 internal constructor(
  public val comments: Int,
  public val commentsUrl: String,
  public val commitsUrl: String,
  public val createdAt: String,
  public val description: String?,
  public val files: Map<String, InlineGistSimpleForkOfFilesAdditionalValueXae92c316>,
  ...
  private val ownerState: FieldState<NullableSimpleUser?>,
  ...
  public constructor(
    ...
    createdAt: String,
    description: String?,
    files: Map<String, InlineGistSimpleForkOfFilesAdditionalValueXae92c316>,
    forksUrl: String,
    gitPullUrl: String,
    gitPushUrl: String,
    htmlUrl: String,
  ...
  public class Builder {
    ...
    private var filesValue: Map<String, InlineGistSimpleForkOfFilesAdditionalValueXae92c316>? = null

    public var files: Map<String, InlineGistSimpleForkOfFilesAdditionalValueXae92c316>
    ...
    public var history: List<JsonElement>?
      ...
      set(`value`) {
        ...
        historyState = FieldState.Value(present)
      }
    ...
    public fun build(): InlineGistSimpleForkOfXa36bf454 {
      ...
      return InlineGistSimpleForkOfXa36bf454(
        comments = comments,
        commentsUrl = commentsUrl,
        commitsUrl = commitsUrl,
        createdAt = createdAt,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineGistSimpleForkOfXa36bf454 = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<InlineGistSimpleForkOfXa36bf454> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineGistSimpleForkOfXa36bf454 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineGistSimpleForkOfXa36bf454")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineGistSimpleForkOfXa36bf454 must be a JSON object")
      ...
      val files = json.decodeRequired<Map<String, InlineGistSimpleForkOfFilesAdditionalValueXae92c316>>(rawObject, "files")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineGistSimpleForkOfXa36bf454 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineGistSimpleForkOfXa36bf454 is missing required property 'user'")
      }
      ...
      return InlineGistSimpleForkOfXa36bf454(
        ...
        ownerState = json.decodeOptional(rawObject, "owner", nullable = true),
        truncatedState = json.decodeOptional(rawObject, "truncated", nullable = false),
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineGistSimpleForkOfXa36bf454) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineGistSimpleForkOfXa36bf454")
...
public fun inlineGistSimpleForkOfXa36bf454(block: InlineGistSimpleForkOfXa36bf454.Builder.() -> Unit): InlineGistSimpleForkOfXa36bf454 = InlineGistSimpleForkOfXa36bf454.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineGistSimpleForkOfXa36bf454 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineGistSimpleForkOfXa36bf454 property '" + name + "' is not nullable")
