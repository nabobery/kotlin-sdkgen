...
public class InlineOrgsSettingsNetworkConfigurationsGetResponse200JsonX36a5fb29(
  ...
  public class Builder {
    ...
    public var networkConfigurations: List<NetworkConfiguration>
      get() = requireNotNull(networkConfigurationsValue) { "networkConfigurations is required" }
      set(`value`) {
        networkConfigurationsValue = value
      }
  ...
  public object Serializer : KSerializer<InlineOrgsSettingsNetworkConfigurationsGetResponse200JsonX36a5fb29> {
