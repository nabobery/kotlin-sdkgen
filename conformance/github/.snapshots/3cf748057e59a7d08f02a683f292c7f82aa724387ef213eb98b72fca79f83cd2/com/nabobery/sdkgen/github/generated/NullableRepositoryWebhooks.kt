 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-repository-webhooks
 */
@Serializable(with = NullableRepositoryWebhooks.Serializer::class)
public class NullableRepositoryWebhooks internal constructor(
  ...
  private val mergeCommitMessageState:
      FieldState<InlineNullableRepositoryWebhooksMergeCommitMessageXa05d6245>,
  private val mergeCommitTitleState:
      FieldState<InlineNullableRepositoryWebhooksMergeCommitTitleX7377c8ff>,
  private val networkCountState: FieldState<Int>,
  private val organizationState: FieldState<NullableSimpleUser?>,
  private val permissionsState: FieldState<InlineNullableRepositoryWebhooksPermissionsXd59bd1a6>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineNullableRepositoryWebhooksPullRequestCreationPolicyXdc956c2e>,
  private val squashMergeCommitMessageState:
      FieldState<InlineNullableRepositoryWebhooksSquashMergeCommitMessageXfaeec695>,
  private val squashMergeCommitTitleState:
      FieldState<InlineNullableRepositoryWebhooksSquashMergeCommitTitleX0c7716af>,
  ...
  private val templateRepositoryState:
      FieldState<InlineNullableRepositoryWebhooksTemplateRepositoryXae59f3f0?>,
   ...
   */
  public val mergeCommitMessage: InlineNullableRepositoryWebhooksMergeCommitMessageXa05d6245?
   ...
   * branch-name).
   */
  public val mergeCommitTitle: InlineNullableRepositoryWebhooksMergeCommitTitleX7377c8ff?
  ...
  public val permissions: InlineNullableRepositoryWebhooksPermissionsXd59bd1a6?
  ...
  public val templateRepository: InlineNullableRepositoryWebhooksTemplateRepositoryXae59f3f0?
  ...
  public class Builder {
    ...
    private var mergeCommitMessageState:
        FieldState<InlineNullableRepositoryWebhooksMergeCommitMessageXa05d6245> = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var mergeCommitMessage: InlineNullableRepositoryWebhooksMergeCommitMessageXa05d6245?
      get() = mergeCommitMessageState.valueOrNull()
      set(`value`) {
    ...
    private var mergeCommitTitleState:
        FieldState<InlineNullableRepositoryWebhooksMergeCommitTitleX7377c8ff> = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var mergeCommitTitle: InlineNullableRepositoryWebhooksMergeCommitTitleX7377c8ff?
      get() = mergeCommitTitleState.valueOrNull()
      set(`value`) {
    ...
    private var permissionsState: FieldState<InlineNullableRepositoryWebhooksPermissionsXd59bd1a6> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineNullableRepositoryWebhooksPermissionsXd59bd1a6?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    private var templateRepositoryState:
        FieldState<InlineNullableRepositoryWebhooksTemplateRepositoryXae59f3f0?> = FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var templateRepository: InlineNullableRepositoryWebhooksTemplateRepositoryXae59f3f0?
      get() = templateRepositoryState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): NullableRepositoryWebhooks {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): NullableRepositoryWebhooks = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<NullableRepositoryWebhooks> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): NullableRepositoryWebhooks {
      val jsonDecoder = decoder.requireJsonDecoder("NullableRepositoryWebhooks")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("NullableRepositoryWebhooks must be a JSON object")
      ...
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("NullableRepositoryWebhooks is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("NullableRepositoryWebhooks is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("NullableRepositoryWebhooks is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("NullableRepositoryWebhooks is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("NullableRepositoryWebhooks is missing required property 'license'")
      }
      ...
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("NullableRepositoryWebhooks is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("NullableRepositoryWebhooks is missing required property 'pushed_at'")
      }
      ...
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("NullableRepositoryWebhooks is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: NullableRepositoryWebhooks) {
      val jsonEncoder = encoder.requireJsonEncoder("NullableRepositoryWebhooks")
...
public fun nullableRepositoryWebhooks(block: NullableRepositoryWebhooks.Builder.() -> Unit): NullableRepositoryWebhooks = NullableRepositoryWebhooks.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NullableRepositoryWebhooks is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("NullableRepositoryWebhooks property '" + name + "' is not nullable")
