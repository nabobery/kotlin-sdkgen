 ...
 * Minimal Repository
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-minimal-repository
 */
@Serializable(with = NullableMinimalRepository.Serializer::class)
public class NullableMinimalRepository internal constructor(
  ...
  private val licenseState: FieldState<InlineNullableMinimalRepositoryLicenseX6cd02b22?>,
  ...
  private val permissionsState: FieldState<InlineNullableMinimalRepositoryPermissionsXe25e01a9>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineNullableMinimalRepositoryPullRequestCreationPolicyX7ed962c5>,
  ...
  public val license: InlineNullableMinimalRepositoryLicenseX6cd02b22?
  ...
  public val permissions: InlineNullableMinimalRepositoryPermissionsXe25e01a9?
  ...
  public class Builder {
    ...
    private var licenseState: FieldState<InlineNullableMinimalRepositoryLicenseX6cd02b22?> =
        FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var license: InlineNullableMinimalRepositoryLicenseX6cd02b22?
      get() = licenseState.valueOrNull()
      set(`value`) {
    ...
    private var permissionsState: FieldState<InlineNullableMinimalRepositoryPermissionsXe25e01a9> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineNullableMinimalRepositoryPermissionsXe25e01a9?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): NullableMinimalRepository {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): NullableMinimalRepository = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<NullableMinimalRepository> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): NullableMinimalRepository {
      val jsonDecoder = decoder.requireJsonDecoder("NullableMinimalRepository")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("NullableMinimalRepository must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("NullableMinimalRepository is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: NullableMinimalRepository) {
      val jsonEncoder = encoder.requireJsonEncoder("NullableMinimalRepository")
...
public fun nullableMinimalRepository(block: NullableMinimalRepository.Builder.() -> Unit): NullableMinimalRepository = NullableMinimalRepository.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NullableMinimalRepository is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("NullableMinimalRepository property '" + name + "' is not nullable")
