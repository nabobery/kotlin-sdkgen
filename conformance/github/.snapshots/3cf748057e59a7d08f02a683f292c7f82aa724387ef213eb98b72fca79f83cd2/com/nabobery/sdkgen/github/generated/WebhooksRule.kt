...
public class WebhooksRule(
  ...
  public class Builder {
    ...
    public var authorizedActorNames: List<String>
      get() = requireNotNull(authorizedActorNamesValue) { "authorizedActorNames is required" }
      set(`value`) {
        authorizedActorNamesValue = value
      }
    ...
    public var requiredStatusChecks: List<String>
      get() = requireNotNull(requiredStatusChecksValue) { "requiredStatusChecks is required" }
      set(`value`) {
        requiredStatusChecksValue = value
      }
  ...
  public object Serializer : KSerializer<WebhooksRule> {
