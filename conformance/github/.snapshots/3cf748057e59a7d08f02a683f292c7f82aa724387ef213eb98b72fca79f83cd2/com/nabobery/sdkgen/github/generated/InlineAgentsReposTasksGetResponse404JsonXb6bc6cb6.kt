...
public class InlineAgentsReposTasksGetResponse404JsonXb6bc6cb6(
   ...
   */
  public val errors: List<InlineAgentsReposTasksGetResponse404JsonErrorsItemX857dd0b3>? = null,
) {
  public class Builder {
     ...
     * List of validation errors (present only for 422 responses)
     */
    public var errors: List<InlineAgentsReposTasksGetResponse404JsonErrorsItemX857dd0b3>? = null
  ...
  public object Serializer : KSerializer<InlineAgentsReposTasksGetResponse404JsonXb6bc6cb6> {
