...
public class InlineEnterprisesDependabotRepositoryAccessPatchRequestJsonX50899717 internal constructor(
  ...
  public class Builder {
    ...
    public var repositoryIdsToAdd: List<Int>?
      ...
      set(`value`) {
        ...
        repositoryIdsToAddState = FieldState.Value(present)
      }
    ...
    public var repositoryIdsToRemove: List<Int>?
      ...
      set(`value`) {
        ...
        repositoryIdsToRemoveState = FieldState.Value(present)
      }
  ...
  public object Serializer : KSerializer<InlineEnterprisesDependabotRepositoryAccessPatchRequestJsonX50899717> {
