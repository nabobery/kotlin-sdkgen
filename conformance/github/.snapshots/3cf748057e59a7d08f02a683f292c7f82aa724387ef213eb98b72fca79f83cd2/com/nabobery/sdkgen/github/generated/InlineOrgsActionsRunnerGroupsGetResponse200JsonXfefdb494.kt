...
public class InlineOrgsActionsRunnerGroupsGetResponse200JsonXfefdb494(
  ...
  public class Builder {
    ...
    public var runnerGroups: List<RunnerGroupsOrg>
      get() = requireNotNull(runnerGroupsValue) { "runnerGroups is required" }
      set(`value`) {
        runnerGroupsValue = value
      }
  ...
  public object Serializer : KSerializer<InlineOrgsActionsRunnerGroupsGetResponse200JsonXfefdb494> {
