...
public class InlineOrgsActionsRunnerGroupsPostRequestJsonX99329cdf(
   ...
   */
  public val runners: List<Int>? = null,
  /**
  ...
  public class Builder {
     ...
     * List of runner IDs to add to the runner group.
     */
    public var runners: List<Int>? = null
     ...
     * `restricted_to_workflows` is set to `true`.
     */
    public var selectedWorkflows: List<String>? = null
  ...
  public object Serializer : KSerializer<InlineOrgsActionsRunnerGroupsPostRequestJsonX99329cdf> {
