...
public class InlineRepositoryRuleFileExtensionRestrictionParametersXaa21c0a6(
  ...
  public class Builder {
    ...
    public var restrictedFileExtensions: List<String>
      get() = requireNotNull(restrictedFileExtensionsValue) { "restrictedFileExtensions is required" }
      set(`value`) {
        restrictedFileExtensionsValue = value
      }
  ...
  public object Serializer : KSerializer<InlineRepositoryRuleFileExtensionRestrictionParametersXaa21c0a6> {
