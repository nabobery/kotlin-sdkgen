 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/repo-search-result-item
 */
@Serializable(with = RepoSearchResultItem.Serializer::class)
public class RepoSearchResultItem internal constructor(
  ...
  private val permissionsState: FieldState<InlineRepoSearchResultItemPermissionsX64b6a67a>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineRepoSearchResultItemPullRequestCreationPolicyX7f770ef7>,
  ...
  public val permissions: InlineRepoSearchResultItemPermissionsX64b6a67a?
  ...
  public class Builder {
    ...
    private var permissionsState: FieldState<InlineRepoSearchResultItemPermissionsX64b6a67a> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineRepoSearchResultItemPermissionsX64b6a67a?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    private var pullRequestCreationPolicyState:
        FieldState<InlineRepoSearchResultItemPullRequestCreationPolicyX7f770ef7> = FieldState.Absent
    ...
    public var textMatches: List<InlineSearchResultTextMatchesItemXe380e62a>?
      ...
      set(`value`) {
        ...
        textMatchesState = FieldState.Value(present)
      }
    ...
    public fun build(): RepoSearchResultItem {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): RepoSearchResultItem = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<RepoSearchResultItem> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): RepoSearchResultItem {
      val jsonDecoder = decoder.requireJsonDecoder("RepoSearchResultItem")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RepoSearchResultItem must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("RepoSearchResultItem is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("RepoSearchResultItem is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("RepoSearchResultItem is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("RepoSearchResultItem is missing required property 'license'")
      }
      ...
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("RepoSearchResultItem is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("RepoSearchResultItem is missing required property 'owner'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: RepoSearchResultItem) {
      val jsonEncoder = encoder.requireJsonEncoder("RepoSearchResultItem")
...
public fun repoSearchResultItem(block: RepoSearchResultItem.Builder.() -> Unit): RepoSearchResultItem = RepoSearchResultItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("RepoSearchResultItem is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("RepoSearchResultItem property '" + name + "' is not nullable")
