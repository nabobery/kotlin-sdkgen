 ...
 * application~1json/schema/properties/repositories/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/paths/~1user~1installations~1{installation_id}~1repositories/get/responses/200/content/
 * application~1json/schema/properties/repositories/items
 */
@Serializable(with = InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7.Serializer::class)
public class InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 internal constructor(
  ...
  private val codeSearchIndexStatusState:
      FieldState<InlineRepositoryCodeSearchIndexStatusX027f967e>,
  ...
  private val mergeCommitMessageState: FieldState<InlineRepositoryMergeCommitMessageX21fe225b>,
  private val mergeCommitTitleState: FieldState<InlineRepositoryMergeCommitTitleX6aad05b2>,
  private val permissionsState: FieldState<InlineRepositoryPermissionsX5a23ef11>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineRepositoryPullRequestCreationPolicyX12172e16>,
  private val squashMergeCommitMessageState:
      FieldState<InlineRepositorySquashMergeCommitMessageXbd9e2684>,
  private val squashMergeCommitTitleState:
      FieldState<InlineRepositorySquashMergeCommitTitleXb44be5dd>,
  private val starredAtState: FieldState<String>,
  ...
  /**
   * Whether or not a pull request head branch that is behind its base branch can always be updated even if it is not
   ...
   */
  public val codeSearchIndexStatus: InlineRepositoryCodeSearchIndexStatusX027f967e?
    get() = codeSearchIndexStatusState.valueOrNull()
   ...
   */
  public val mergeCommitMessage: InlineRepositoryMergeCommitMessageX21fe225b?
   ...
   * branch-name).
   */
  public val mergeCommitTitle: InlineRepositoryMergeCommitTitleX6aad05b2?
    get() = mergeCommitTitleState.valueOrNull()

  public val permissions: InlineRepositoryPermissionsX5a23ef11?
    get() = permissionsState.valueOrNull()

  /**
   * The policy controlling who can create pull requests: all or collaborators_only.
   */
  public val pullRequestCreationPolicy: InlineRepositoryPullRequestCreationPolicyX12172e16?
   ...
   * - `BLANK` - default to a blank commit message.
   */
  public val squashMergeCommitMessage: InlineRepositorySquashMergeCommitMessageXbd9e2684?
   ...
   * than one commit).
   */
  public val squashMergeCommitTitle: InlineRepositorySquashMergeCommitTitleXb44be5dd?
  ...
  codeSearchIndexStatusState = FieldState.Absent,
  ...
  starredAtState = FieldState.Absent,
  ...
  /**
   * Returns the wire presence of `code_search_index_status`.
   */
  public fun codeSearchIndexStatusPresence(): FieldPresence = codeSearchIndexStatusState.presence
  ...
  /**
   * Returns the wire presence of `starred_at`.
   */
  public fun starredAtPresence(): FieldPresence = starredAtState.presence
  ...
  public class Builder {
    ...
    private var codeSearchIndexStatusState:
        FieldState<InlineRepositoryCodeSearchIndexStatusX027f967e> = FieldState.Absent

    /**
     * The status of the code search index for this repository
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var codeSearchIndexStatus: InlineRepositoryCodeSearchIndexStatusX027f967e?
      get() = codeSearchIndexStatusState.valueOrNull()
      set(`value`) {
        val present = requireNotNull(value) { "codeSearchIndexStatus is not nullable; call unsetCodeSearchIndexStatus() to omit it" }
        codeSearchIndexStatusState = FieldState.Value(present)
      }
    ...
    private var mergeCommitMessageState: FieldState<InlineRepositoryMergeCommitMessageX21fe225b> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var mergeCommitMessage: InlineRepositoryMergeCommitMessageX21fe225b?
      get() = mergeCommitMessageState.valueOrNull()
      set(`value`) {
    ...
    private var mergeCommitTitleState: FieldState<InlineRepositoryMergeCommitTitleX6aad05b2> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var mergeCommitTitle: InlineRepositoryMergeCommitTitleX6aad05b2?
      get() = mergeCommitTitleState.valueOrNull()
      set(`value`) {
    ...
    private var permissionsState: FieldState<InlineRepositoryPermissionsX5a23ef11> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineRepositoryPermissionsX5a23ef11?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    private var pullRequestCreationPolicyState:
        FieldState<InlineRepositoryPullRequestCreationPolicyX12172e16> = FieldState.Absent

    /**
     * The policy controlling who can create pull requests: all or collaborators_only.
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequestCreationPolicy: InlineRepositoryPullRequestCreationPolicyX12172e16?
      get() = pullRequestCreationPolicyState.valueOrNull()
      set(`value`) {
    ...
    private var squashMergeCommitMessageState:
        FieldState<InlineRepositorySquashMergeCommitMessageXbd9e2684> = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var squashMergeCommitMessage: InlineRepositorySquashMergeCommitMessageXbd9e2684?
      get() = squashMergeCommitMessageState.valueOrNull()
      set(`value`) {
    ...
    private var squashMergeCommitTitleState:
        FieldState<InlineRepositorySquashMergeCommitTitleXb44be5dd> = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var squashMergeCommitTitle: InlineRepositorySquashMergeCommitTitleXb44be5dd?
      get() = squashMergeCommitTitleState.valueOrNull()
      set(`value`) {
    ...
    private var starredAtState: FieldState<String> = FieldState.Absent
    ...
    public var starredAt: String?
      get() = starredAtState.valueOrNull()
      set(`value`) {
        val present = requireNotNull(value) { "starredAt is not nullable; call unsetStarredAt() to omit it" }
        starredAtState = FieldState.Value(present)
      }
    ...
    public var topics: List<String>?
      ...
      set(`value`) {
        ...
        topicsState = FieldState.Value(present)
      }
    ...
    /**
     * Omits `code_search_index_status` from serialized output.
     */
    public fun unsetCodeSearchIndexStatus() {
      codeSearchIndexStatusState = FieldState.Absent
    }
    ...
    /**
     * Omits `starred_at` from serialized output.
     */
    public fun unsetStarredAt() {
      starredAtState = FieldState.Absent
    }
    ...
    public fun build(): InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 {
      ...
      return InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7(
        ...
        codeSearchIndexStatusState = codeSearchIndexStatusState,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 must be a JSON object")
      ...
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 is missing required property 'license'")
      }
      ...
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 is missing required property 'updated_at'")
      }
      ...
      return InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7(
        ...
        codeSearchIndexStatusState = json.decodeOptional(rawObject, "code_search_index_status", nullable = false),
        ...
        starredAtState = json.decodeOptional(rawObject, "starred_at", nullable = false),
    ...
    override fun serialize(encoder: Encoder, `value`: InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7")
      ...
      val raw = buildJsonObject {
        ...
        putState("code_search_index_status", value.codeSearchIndexStatusState, json::encodeToJsonElement)
        ...
        putState("starred_at", value.starredAtState, json::encodeToJsonElement)
...
public fun inlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7(block: InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7.Builder.() -> Unit): InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 = InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineUserInstallationsRepositoriesGetResponse200JsonRepositoriesItemX95ab4dd7 property '" + name + "' is not nullable")
