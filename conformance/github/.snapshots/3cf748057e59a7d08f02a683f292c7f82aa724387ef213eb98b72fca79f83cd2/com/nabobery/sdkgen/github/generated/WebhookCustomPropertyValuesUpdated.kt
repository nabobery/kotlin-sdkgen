...
public class WebhookCustomPropertyValuesUpdated(
  ...
  public class Builder {
    ...
    public var newPropertyValues: List<CustomPropertyValue>
      get() = requireNotNull(newPropertyValuesValue) { "newPropertyValues is required" }
      set(`value`) {
        newPropertyValuesValue = value
      }

    private var oldPropertyValuesValue: List<CustomPropertyValue>? = null

    public var oldPropertyValues: List<CustomPropertyValue>
      get() = requireNotNull(oldPropertyValuesValue) { "oldPropertyValues is required" }
      set(`value`) {
        oldPropertyValuesValue = value
      }
  ...
  public object Serializer : KSerializer<WebhookCustomPropertyValuesUpdated> {
