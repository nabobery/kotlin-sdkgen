 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/repository-webhooks
 */
@Serializable(with = RepositoryWebhooks.Serializer::class)
public class RepositoryWebhooks internal constructor(
  ...
  private val mergeCommitMessageState:
      FieldState<InlineRepositoryWebhooksMergeCommitMessageX2fbdefd4>,
  private val mergeCommitTitleState: FieldState<InlineRepositoryWebhooksMergeCommitTitleX37966677>,
  private val networkCountState: FieldState<Int>,
  private val organizationState: FieldState<NullableSimpleUser?>,
  private val permissionsState: FieldState<InlineRepositoryWebhooksPermissionsXfac53a69>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineRepositoryWebhooksPullRequestCreationPolicyX83485f52>,
  private val squashMergeCommitMessageState:
      FieldState<InlineRepositoryWebhooksSquashMergeCommitMessageX8a8ef99d>,
  private val squashMergeCommitTitleState:
      FieldState<InlineRepositoryWebhooksSquashMergeCommitTitleX80637e1c>,
  ...
  private val templateRepositoryState:
      FieldState<InlineRepositoryWebhooksTemplateRepositoryXa8335f95?>,
   ...
   */
  public val mergeCommitMessage: InlineRepositoryWebhooksMergeCommitMessageX2fbdefd4?
   ...
   * branch-name).
   */
  public val mergeCommitTitle: InlineRepositoryWebhooksMergeCommitTitleX37966677?
  ...
  public val permissions: InlineRepositoryWebhooksPermissionsXfac53a69?
    get() = permissionsState.valueOrNull()

  /**
   * The policy controlling who can create pull requests: all or collaborators_only.
   */
  public val pullRequestCreationPolicy: InlineRepositoryWebhooksPullRequestCreationPolicyX83485f52?
   ...
   * - `BLANK` - default to a blank commit message.
   */
  public val squashMergeCommitMessage: InlineRepositoryWebhooksSquashMergeCommitMessageX8a8ef99d?
   ...
   * than one commit).
   */
  public val squashMergeCommitTitle: InlineRepositoryWebhooksSquashMergeCommitTitleX80637e1c?
  ...
  public val templateRepository: InlineRepositoryWebhooksTemplateRepositoryXa8335f95?
  ...
  public class Builder {
    ...
    private var mergeCommitMessageState:
        FieldState<InlineRepositoryWebhooksMergeCommitMessageX2fbdefd4> = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var mergeCommitMessage: InlineRepositoryWebhooksMergeCommitMessageX2fbdefd4?
      get() = mergeCommitMessageState.valueOrNull()
      set(`value`) {
    ...
    private var mergeCommitTitleState: FieldState<InlineRepositoryWebhooksMergeCommitTitleX37966677>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var mergeCommitTitle: InlineRepositoryWebhooksMergeCommitTitleX37966677?
      get() = mergeCommitTitleState.valueOrNull()
      set(`value`) {
    ...
    private var permissionsState: FieldState<InlineRepositoryWebhooksPermissionsXfac53a69> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineRepositoryWebhooksPermissionsXfac53a69?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    private var pullRequestCreationPolicyState:
        FieldState<InlineRepositoryWebhooksPullRequestCreationPolicyX83485f52> = FieldState.Absent
    ...
    private var squashMergeCommitMessageState:
        FieldState<InlineRepositoryWebhooksSquashMergeCommitMessageX8a8ef99d> = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var squashMergeCommitMessage: InlineRepositoryWebhooksSquashMergeCommitMessageX8a8ef99d?
      get() = squashMergeCommitMessageState.valueOrNull()
      set(`value`) {
    ...
    private var squashMergeCommitTitleState:
        FieldState<InlineRepositoryWebhooksSquashMergeCommitTitleX80637e1c> = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var squashMergeCommitTitle: InlineRepositoryWebhooksSquashMergeCommitTitleX80637e1c?
      get() = squashMergeCommitTitleState.valueOrNull()
      set(`value`) {
    ...
    private var templateRepositoryState:
        FieldState<InlineRepositoryWebhooksTemplateRepositoryXa8335f95?> = FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var templateRepository: InlineRepositoryWebhooksTemplateRepositoryXa8335f95?
      get() = templateRepositoryState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): RepositoryWebhooks {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): RepositoryWebhooks = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<RepositoryWebhooks> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): RepositoryWebhooks {
      val jsonDecoder = decoder.requireJsonDecoder("RepositoryWebhooks")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RepositoryWebhooks must be a JSON object")
      ...
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("RepositoryWebhooks is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("RepositoryWebhooks is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("RepositoryWebhooks is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("RepositoryWebhooks is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("RepositoryWebhooks is missing required property 'license'")
      }
      ...
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("RepositoryWebhooks is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("RepositoryWebhooks is missing required property 'pushed_at'")
      }
      ...
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("RepositoryWebhooks is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: RepositoryWebhooks) {
      val jsonEncoder = encoder.requireJsonEncoder("RepositoryWebhooks")
...
public fun repositoryWebhooks(block: RepositoryWebhooks.Builder.() -> Unit): RepositoryWebhooks = RepositoryWebhooks.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("RepositoryWebhooks is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("RepositoryWebhooks property '" + name + "' is not nullable")
