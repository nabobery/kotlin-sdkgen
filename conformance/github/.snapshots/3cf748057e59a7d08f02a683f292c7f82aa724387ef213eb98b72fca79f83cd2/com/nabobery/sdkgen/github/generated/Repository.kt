 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/repository
 */
...
public class Repository internal constructor(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): Repository = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<Repository> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): Repository {
      val jsonDecoder = decoder.requireJsonDecoder("Repository")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("Repository must be a JSON object")
      ...
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("Repository is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("Repository is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("Repository is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("Repository is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("Repository is missing required property 'license'")
      }
      ...
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("Repository is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("Repository is missing required property 'pushed_at'")
      }
      ...
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("Repository is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: Repository) {
      val jsonEncoder = encoder.requireJsonEncoder("Repository")
...
public fun repository(block: Repository.Builder.() -> Unit): Repository = Repository.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("Repository is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("Repository property '" + name + "' is not nullable")
