...
public class InlineEnterprisesTeamsOrganizationsAddPostRequestJsonX2c1125e4(
  ...
  public class Builder {
    ...
    public var organizationSlugs: List<String>
      get() = requireNotNull(organizationSlugsValue) { "organizationSlugs is required" }
      set(`value`) {
        organizationSlugsValue = value
      }
  ...
  public object Serializer : KSerializer<InlineEnterprisesTeamsOrganizationsAddPostRequestJsonX2c1125e4> {
