...
public class InlineWebhookPackageUpdatedPackageValuePackageVersionXcc1730e4 internal constructor(
  ...
  public class Builder {
    ...
    public var dockerMetadata:
      ...
      set(`value`) {
        ...
        dockerMetadataState = FieldState.Value(present)
      }
    ...
    public var rubygemsMetadata: List<WebhookRubygemsMetadata>?
      ...
      set(`value`) {
        ...
        rubygemsMetadataState = FieldState.Value(present)
      }
  ...
  public object Serializer : KSerializer<InlineWebhookPackageUpdatedPackageValuePackageVersionXcc1730e4> {
